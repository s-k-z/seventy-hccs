...
function selectBestFamiliar() {
  ...
  if (req === AdvReq.NoHipster && get("_hipsterAdv") < 7) {
    return {
      familiar: $familiar(_templateObject1013 || (_templateObject1013 = _taggedTemplateLiteral18(["Artistic Goth Kid"]))),
      famequip: $item(_templateObject1111 || (_templateObject1111 = _taggedTemplateLiteral18(["tiny stillsuit"])))
    };
  }
  if (get("_hipsterAdv") < 7) {
    return {
      familiar: $familiar(_templateObject1211 || (_templateObject1211 = _taggedTemplateLiteral18(["Mini-Hipster"]))),
      famequip: $item(_templateObject1311 || (_templateObject1311 = _taggedTemplateLiteral18(["tiny stillsuit"])))
    };
  }
  return {
    familiar: $familiar(_templateObject1411 || (_templateObject1411 = _taggedTemplateLiteral18(["Baby Sandworm"]))),
    famequip: $item(_templateObject1510 || (_templateObject1510 = _taggedTemplateLiteral18(["tiny stillsuit"])))
  };
}
function darkHorse() {
  return {
...
function innerElf() {
  return {
    ...
    completed: function() {
      return have($effect(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral18(["Inner Elf"]))));
    },
    prepare: function() {
    ...
    do: $location(_templateObject179 || (_templateObject179 = _taggedTemplateLiteral18(["The Slime Tube"]))),
    post: function() {
      Clan.join(config.main_clan);
      assert($effect(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral18(["Inner Elf"]))));
    },
    outfit: {
      acc3: $item(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral18(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral18(["Machine Elf"])))
    },
...
var defaultOutfit = {
  ...
  back: $item(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral19(["protonic accelerator pack"]))),
...
var CoilWire = {
  ...
  tasks: [{
    ...
    [$item(_templateObject2114 || (_templateObject2114 = _taggedTemplateLiteral19(["battery (AAA)"]))), function() {
      return harvestBatteries();
    }],
    [$item(_templateObject2211 || (_templateObject2211 = _taggedTemplateLiteral19(["battery (AA)"]))), function() {
    ...
    [$item(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral19(["green mana"]))), function() {
    ...
    name: "Ninja Costume",
    completed: function() {
      return have($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral19(["li'l ninja costume"]))));
    },
    choices: {
      297: 3
    },
    do: function() {
      return mapMonster($location(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral19(["The Haiku Dungeon"]))), $monster(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral19(["amateur ninja"]))));
    },
    post: function() {
      (0, import_kolmafia31.visitUrl)("questlog.php?which=1");
      assert(!!get("ghostLocation"), "Failed to get protonic ghost notice");
      assert($item(_templateObject6110 || (_templateObject6110 = _taggedTemplateLiteral19(["li'l ninja costume"]))));
    },
    outfit: function() {
      return _objectSpread6(_objectSpread6({
        back: $item(_templateObject624 || (_templateObject624 = _taggedTemplateLiteral19(["protonic accelerator pack"]))),
        shirt: $item(_templateObject633 || (_templateObject633 = _taggedTemplateLiteral19(["Jurassic Parka"])))
    ...
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject643 || (_templateObject643 = _taggedTemplateLiteral19(["Sing Along"])))).skill($skill(_templateObject653 || (_templateObject653 = _taggedTemplateLiteral19(["Spit jurassic acid"])))), $monster(_templateObject663 || (_templateObject663 = _taggedTemplateLiteral19(["amateur ninja"])))).macro(Macro.abort())
  }, {
    name: "Protonic Ghost",
    completed: function() {
    ...
    completed: function() {
      return have($item(_templateObject683 || (_templateObject683 = _taggedTemplateLiteral19(["box of old Crimbo decorations"]))));
    },
    do: function() {
      return (0, import_kolmafia31.useFamiliar)($familiar(_templateObject693 || (_templateObject693 = _taggedTemplateLiteral19(["Crimbo Shrub"]))));
    }
  }, {
    ...
    completed: function() {
      return DNALab_exports.isHybridized() || get("_saberForceUses") > 0 || CombatLoversLocket_exports.monstersReminisced().includes($monster(_templateObject703 || (_templateObject703 = _taggedTemplateLiteral19(["cocktail shrimp"]))));
    },
    do: function() {
      return CombatLoversLocket_exports.reminisce($monster(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral19(["cocktail shrimp"]))));
    },
    post: function() {
      assert($item(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral19(["shrimp cocktail"]))));
      assert(CombatLoversLocket_exports.monstersReminisced().includes($monster(_templateObject733 || (_templateObject733 = _taggedTemplateLiteral19(["cocktail shrimp"])))), "Failed to reminisce cocktail shrimp?");
    ...
    outfit: {
      weapon: $item(_templateObject743 || (_templateObject743 = _taggedTemplateLiteral19(["Fourth of May Cosplay Saber"]))),
      familiar: $familiar(_templateObject753 || (_templateObject753 = _taggedTemplateLiteral19(["Crimbo Shrub"])))
    },
    combat: new CombatStrategy().ccs(
      "item ".concat($item(_templateObject763 || (_templateObject763 = _taggedTemplateLiteral19(["DNA extraction syringe"]))), "\n          skill ").concat($skill(_templateObject773 || (_templateObject773 = _taggedTemplateLiteral19(["Open a Big Red Present"]))), "\n          twiddle your thumbs\n          skill ").concat($skill(_templateObject783 || (_templateObject783 = _taggedTemplateLiteral19(["Use the Force"])))),
      $monster(_templateObject793 || (_templateObject793 = _taggedTemplateLiteral19(["cocktail shrimp"])))
    ).macro(Macro.abort())
  }, {
    name: "Sausage Goblin",
    completed: function() {
    ...
    do: $location(_templateObject803 || (_templateObject803 = _taggedTemplateLiteral19(["Noob Cave"]))),
    post: function() {
      return assert(get("_sausageFights") > 0, "Didn't increment sausage counter?");
    },
    outfit: function() {
      return _objectSpread6(_objectSpread6({
        back: $item(_templateObject8110 || (_templateObject8110 = _taggedTemplateLiteral19(["unwrapped knock-off retro superhero cape"]))),
        offhand: $item(_templateObject824 || (_templateObject824 = _taggedTemplateLiteral19(["Kramco Sausage-o-Matic\u2122"])))
      }, selectBestFamiliar()), {}, {
        modes: {
    ...
    do: $location(_templateObject833 || (_templateObject833 = _taggedTemplateLiteral19(["Noob Cave"]))),
    post: function() {
    ...
    outfit: function() {
      return _objectSpread6({
        ...
        acc3: $item(_templateObject843 || (_templateObject843 = _taggedTemplateLiteral19(['"I Voted!" sticker'])))
      }, selectBestFamiliar());
    },
    combat: DefaultCombat
  }, {
    ...
    do: function() {
      AutumnAton_exports.sendTo($location(_templateObject853 || (_templateObject853 = _taggedTemplateLiteral19(["The Sleazy Back Alley"]))));
    }
  }, {
    name: "Coil Wire",
    completed: function() {
    ...
    effects: [$effect(_templateObject863 || (_templateObject863 = _taggedTemplateLiteral19(["[1458]Blood Sugar Sauce Magic"])))],
    outfit: {
      hat: $item(_templateObject873 || (_templateObject873 = _taggedTemplateLiteral19(["Iunion Crown"]))),
      back: $item(_templateObject883 || (_templateObject883 = _taggedTemplateLiteral19(["unwrapped knock-off retro superhero cape"]))),
      shirt: $item(_templateObject893 || (_templateObject893 = _taggedTemplateLiteral19(["Jurassic Parka"]))),
      weapon: $item(_templateObject903 || (_templateObject903 = _taggedTemplateLiteral19(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject918 || (_templateObject918 = _taggedTemplateLiteral19(["wrench, industrial fire extinguisher"]))),
      pants: $item(_templateObject923 || (_templateObject923 = _taggedTemplateLiteral19(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject933 || (_templateObject933 = _taggedTemplateLiteral19(["hewn moon-rune spoon"]))),
      acc2: $item(_templateObject943 || (_templateObject943 = _taggedTemplateLiteral19(["Retrospecs"]))),
      acc3: $item(_templateObject953 || (_templateObject953 = _taggedTemplateLiteral19(["Kremlin's Greatest Briefcase"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["heck", "thrill"]
      }
...
var CombatFrequencyQuest = {
  ...
  tasks: [darkHorse(), {
    ...
    effects: [$effect(_templateObject160 || (_templateObject160 = _taggedTemplateLiteral20(["Blood Bond"]))), $effect(_templateObject240 || (_templateObject240 = _taggedTemplateLiteral20(["Empathy"]))), $effect(_templateObject330 || (_templateObject330 = _taggedTemplateLiteral20(["Feeling Lonely"]))), $effect(_templateObject429 || (_templateObject429 = _taggedTemplateLiteral20(["Leash of Linguini"]))), $effect(_templateObject527 || (_templateObject527 = _taggedTemplateLiteral20(["Silence of the God Lobster"]))), $effect(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral20(["Silent Running"]))), $effect(_templateObject721 || (_templateObject721 = _taggedTemplateLiteral20(["Smooth Movements"]))), $effect(_templateObject820 || (_templateObject820 = _taggedTemplateLiteral20(["The Sonata of Sneakiness"]))), $effect(_templateObject919 || (_templateObject919 = _taggedTemplateLiteral20(["Throwing Some Shade"])))],
    outfit: {
      hat: $item(_templateObject1015 || (_templateObject1015 = _taggedTemplateLiteral20(["very pointy crown"]))),
      ...
      pants: $item(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral20(["pantogram pants"]))),
      acc2: $item(_templateObject1512 || (_templateObject1512 = _taggedTemplateLiteral20(["atlas of local maps"]))),
      acc3: $item(_templateObject1611 || (_templateObject1611 = _taggedTemplateLiteral20(["Kremlin's Greatest Briefcase"]))),
      famequip: $item(_templateObject1711 || (_templateObject1711 = _taggedTemplateLiteral20(["tiny stillsuit"]))),
...
var DonateQuest = {
  ...
  tasks: [{
    ...
    do: function() {
      return (0, import_kolmafia32.use)(1, $item(_templateObject1016 || (_templateObject1016 = _taggedTemplateLiteral21(["Batfellow comic"]))));
    },
    post: function() {
    ...
    do: function() {
      while (get("batmanTimeLeft") >= 4) {
        ...
        if ((0, import_kolmafia32.currentRound)() > 0)
          (0, import_kolmafia32.runCombat)(Macro.skill($skill(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral21(["Bat-Kick"])))).repeat().toString());
      }
    }
  }, {
    name: "End Comic",
...
var FamiliarWeightQuest = {
  ...
  tasks: [{
    ...
    do: $location(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral22(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject337 || (_templateObject337 = _taggedTemplateLiteral22(["Meteor Showered"]))));
    },
    outfit: {
      weapon: $item(_templateObject431 || (_templateObject431 = _taggedTemplateLiteral22(["Fourth of May Cosplay Saber"]))),
      familiar: $familiar(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral22(["Machine Elf"])))
    },
    combat: new CombatStrategy().ccs("skill ".concat($skill(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral22(["Meteor Shower"]))), "\n           twiddle your thumbs\n           skill ").concat($skill(_templateObject726 || (_templateObject726 = _taggedTemplateLiteral22(["Use the Force"])))), $monster(_templateObject825 || (_templateObject825 = _taggedTemplateLiteral22(["fluffy bunny"])))).macro(Macro.abort())
  }, {
    ...
    prepare: function() {
      (0, import_kolmafia33.visitUrl)("inv_equip.php?pwd=&action=equip&whichitem=".concat((0, import_kolmafia33.toInt)($item(_templateObject921 || (_templateObject921 = _taggedTemplateLiteral22(["homemade robot gear"]))))));
      ...
      if (needMore())
        useIfUnused($item(_templateObject1017 || (_templateObject1017 = _taggedTemplateLiteral22(["green candy heart"]))));
      if (needMore())
    ...
    effects: [$effect(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral22(["A Girl Named Sue"]))), $effect(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral22(["Billiards Belligerence"]))), $effect(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral22(["Blood Bond"]))), $effect(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral22(["Do I Know You From Somewhere?"]))), $effect(_templateObject1811 || (_templateObject1811 = _taggedTemplateLiteral22(["Empathy"]))), $effect(_templateObject1910 || (_templateObject1910 = _taggedTemplateLiteral22(["Human-Machine Hybrid"]))), $effect(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral22(["Human-Fish Hybrid"]))), $effect(_templateObject2115 || (_templateObject2115 = _taggedTemplateLiteral22(["Leash of Linguini"]))), $effect(_templateObject2212 || (_templateObject2212 = _taggedTemplateLiteral22(["Meteor Showered"]))), $effect(_templateObject2311 || (_templateObject2311 = _taggedTemplateLiteral22(["Open Heart Surgery"]))), $effect(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral22(["Puzzle Champ"]))), $effect(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral22(["Robot Friends"]))), $effect(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral22(["Shortly Stacked"]))), $effect(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral22(["Shrimpin' Ain't Easy"]))), $effect(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral22(["You Can Really Taste the Dormouse"])))],
    outfit: {
      ...
      acc1: $item(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral22(["Brutal brogues"]))),
...
var HotResistQuest = {
  ...
  tasks: [{
    ...
    do: $location(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral23(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral23(["Fireproof Foam Suit"]))));
    },
    outfit: {
      weapon: $item(_templateObject436 || (_templateObject436 = _taggedTemplateLiteral23(["Fourth of May Cosplay Saber"]))),
    ...
    effects: [$effect(_templateObject1018 || (_templateObject1018 = _taggedTemplateLiteral23(["Astral Shell"]))), $effect(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral23(["Blood Bond"]))), $effect(_templateObject1216 || (_templateObject1216 = _taggedTemplateLiteral23(["Elemental Saucesphere"]))), $effect(_templateObject1316 || (_templateObject1316 = _taggedTemplateLiteral23(["Empathy"]))), $effect(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral23(["Fireproof Foam Suit"]))), $effect(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral23(["Leash of Linguini"])))],
    outfit: {
      hat: $item(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral23(["Daylight Shavings Helmet"]))),
      back: $item(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral23(["unwrapped knock-off retro superhero cape"]))),
      ...
      pants: $item(_templateObject2116 || (_templateObject2116 = _taggedTemplateLiteral23(["designer sweatpants"]))),
...
var ItemDropQuest = {
  ...
  tasks: [{
    ...
    prepare: function() {
      return assert($item(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral24(["cosmic bowling ball"]))));
    },
    do: $location(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral24(["The Dire Warren"]))),
    post: function() {
      return $effects(_templateObject437 || (_templateObject437 = _taggedTemplateLiteral24(["Bat-Adjacent Form, Cosmic Ball in the Air"]))).forEach(function(e) {
        return assert(e);
      });
    },
    ...
    acquire: [{
      item: $item(_templateObject1019 || (_templateObject1019 = _taggedTemplateLiteral24(["wad of used tape"])))
    }],
    effects: [$effect(_templateObject1117 || (_templateObject1117 = _taggedTemplateLiteral24(["Bat-Adjacent Form"]))), $effect(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral24(["Blessing of the Bird"]))), $effect(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral24(["Blessing of your favorite Bird"]))), $effect(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral24(["Cosmic Ball in the Air"]))), $effect(_templateObject1516 || (_templateObject1516 = _taggedTemplateLiteral24(["Crunching Leaves"]))), $effect(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral24(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral24(["Feeling Lost"]))), $effect(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral24(["Human-Pirate Hybrid"]))), $effect(_templateObject1912 || (_templateObject1912 = _taggedTemplateLiteral24(["items.enh"]))), $effect(_templateObject2012 || (_templateObject2012 = _taggedTemplateLiteral24(["Nearly All-Natural"]))), $effect(_templateObject2117 || (_templateObject2117 = _taggedTemplateLiteral24(["Singer's Faithful Ocelot"]))), $effect(_templateObject2214 || (_templateObject2214 = _taggedTemplateLiteral24(["Steely-Eyed Squint"]))), $effect(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral24(["The Spirit of Taking"]))), $effect(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral24(["Uncucumbered"])))],
    outfit: {
      ...
      famequip: $item(_templateObject366 || (_templateObject366 = _taggedTemplateLiteral24(["li'l ninja costume"]))),
      familiar: $familiar(_templateObject376 || (_templateObject376 = _taggedTemplateLiteral24(["Trick-or-Treating Tot"]))),
      modes: {
...
function levelingOutfit(cap, req) {
  ...
  return _objectSpread7(_objectSpread7({
    ...
    back: $items(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral25(["LOV Epaulettes, unwrapped knock-off retro superhero cape"]))),
    shirt: get("garbageShirtCharge") > 0 ? $item(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral25(["makeshift garbage shirt"]))) : $item(_templateObject438 || (_templateObject438 = _taggedTemplateLiteral25(["Jurassic Parka"]))),
    ...
    acc2: $items(_templateObject1020 || (_templateObject1020 = _taggedTemplateLiteral25(["battle broom, gold detective badge"]))),
...
function lightweightOutfit() {
  return _objectSpread7(_objectSpread7({
    ...
    shirt: get("garbageShirtCharge") > 0 ? $item(_templateObject1418 || (_templateObject1418 = _taggedTemplateLiteral25(["makeshift garbage shirt"]))) : $item(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral25(["Jurassic Parka"]))),
    weapon: $item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral25(["June cleaver"]))),
    offhand: $item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral25(["unbreakable umbrella"]))),
    pants: $item(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral25(["Cargo Cultist Shorts"]))),
    ...
    acc3: $item(_templateObject2118 || (_templateObject2118 = _taggedTemplateLiteral25(["combat lover's locket"])))
...
function getHowManySausagesToEat() {
  if ((0, import_kolmafia34.myMaxmp)() - (0, import_kolmafia34.myMp)() < 999)
    return 0;
  if ((0, import_kolmafia34.itemAmount)($item(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral25(["magical sausage casing"])))) < 1)
    return 0;
...
var Leveling = {
  ...
  tasks: [{
    ...
    do: function() {
      ...
      (0, import_kolmafia34.eat)(toEat, $item(_templateObject367 || (_templateObject367 = _taggedTemplateLiteral25(["magical sausage"]))));
    }
  }, {
    name: "Remove Temporary Blindness",
    completed: function() {
      return !have($effect(_templateObject377 || (_templateObject377 = _taggedTemplateLiteral25(["Temporary Blindness"]))));
    },
    prepare: function() {
    ...
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject386 || (_templateObject386 = _taggedTemplateLiteral25(["Cannelloni Cocoon"]))));
    }
  }, {
    name: "Make Burning Paper Crane",
    ready: function() {
      return have($item(_templateObject396 || (_templateObject396 = _taggedTemplateLiteral25(["burning newspaper"]))));
    },
    completed: function() {
      return have($item(_templateObject406 || (_templateObject406 = _taggedTemplateLiteral25(["burning paper crane"]))));
    },
    do: function() {
      return (0, import_kolmafia34.create)($item(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral25(["burning paper crane"]))));
    }
  }, {
    name: "Make candy knife",
    ready: function() {
      return (0, import_kolmafia34.myBasestat)($stat(_templateObject4210 || (_templateObject4210 = _taggedTemplateLiteral25(["muscle"])))) >= 40;
    },
    completed: function() {
      return get("_discoKnife");
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject439 || (_templateObject439 = _taggedTemplateLiteral25(["That's Not a Knife"]))));
    }
  }, {
    ...
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject446 || (_templateObject446 = _taggedTemplateLiteral25(["Summon Alice's Army Cards"]))));
    }
  }, {
    name: "Ointment of the Occult",
    completed: function() {
      return have($item(_templateObject456 || (_templateObject456 = _taggedTemplateLiteral25(["ointment of the occult"]))));
    },
    do: function() {
      if (!have($item(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral25(["grapefruit"]))))) {
        (0, import_kolmafia34.useSkill)($skill(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral25(["Prevent Scurvy and Sobriety"]))));
      }
    ...
    effects: [
      ...
      $effect(_templateObject8111 || (_templateObject8111 = _taggedTemplateLiteral25(["Blood Bond"]))),
      $effect(_templateObject829 || (_templateObject829 = _taggedTemplateLiteral25(["Empathy"]))),
      $effect(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral25(["Leash of Linguini"])))
    ]
  }, {
    name: "Wish Effects",
    completed: function() {
      return $effects(_templateObject844 || (_templateObject844 = _taggedTemplateLiteral25(["Sparkly!, Witch Breaded"]))).every(function(e) {
        return have(e);
      });
    },
    do: function() {
      return $effects(_templateObject854 || (_templateObject854 = _taggedTemplateLiteral25(["Sparkly!, Witch Breaded"]))).forEach(wish);
    }
  }, {
    name: "Crimbo Carol",
    completed: function() {
      return [$effect(_templateObject864 || (_templateObject864 = _taggedTemplateLiteral25(["All I Want For Crimbo Is Stuff"]))), $effect(_templateObject874 || (_templateObject874 = _taggedTemplateLiteral25(["Crimbo Wrapping"]))), $effect(_templateObject884 || (_templateObject884 = _taggedTemplateLiteral25(["Do You Crush What I Crush?"]))), $effect(_templateObject894 || (_templateObject894 = _taggedTemplateLiteral25(["Holiday Yoked"]))), $effect(_templateObject904 || (_templateObject904 = _taggedTemplateLiteral25(["Let It Snow/Boil/Stink/Frighten/Grease"])))].some(function(carol) {
        return have(carol);
      });
    },
    do: $location(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral25(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral25(["Do You Crush What I Crush?"]))));
    },
    outfit: {
      back: $item(_templateObject934 || (_templateObject934 = _taggedTemplateLiteral25(["vampyric cloake"]))),
      acc3: $item(_templateObject944 || (_templateObject944 = _taggedTemplateLiteral25(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject954 || (_templateObject954 = _taggedTemplateLiteral25(["Ghost of Crimbo Carols"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill($skill(_templateObject963 || (_templateObject963 = _taggedTemplateLiteral25(["Giant Growth"])))).trySkill($skill(_templateObject973 || (_templateObject973 = _taggedTemplateLiteral25(["Become a Wolf"])))).trySkill($skill(_templateObject983 || (_templateObject983 = _taggedTemplateLiteral25(["Bowl Straight Up"])))).trySkill($skill(_templateObject993 || (_templateObject993 = _taggedTemplateLiteral25(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject1003 || (_templateObject1003 = _taggedTemplateLiteral25(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral25(["Reflex Hammer"])))).trySkill($skill(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral25(["Feel Hatred"])))).abort())
  }, {
    name: "Christmas Card",
    completed: function() {
      return haveItemOrEffect($item(_templateObject1033 || (_templateObject1033 = _taggedTemplateLiteral25(["Gene Tonic: Elf"])))) || get("_deckCardsSeen").includes("Christmas Card");
    },
    do: function() {
    ...
    post: function() {
      ...
      (0, import_kolmafia34.use)($item(_templateObject1043 || (_templateObject1043 = _taggedTemplateLiteral25(["Gene Tonic: Elf"]))));
      assert(get("_deckCardsSeen").includes("Christmas Card"), "Failed to record christmas card draw?");
    },
    effects: $effects(_templateObject1053 || (_templateObject1053 = _taggedTemplateLiteral25(["Inscrutable Gaze, Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject1063 || (_templateObject1063 = _taggedTemplateLiteral25(["Frumious Bandersnatch"])))
    },
    combat: new CombatStrategy().startingMacro(Macro.item($item(_templateObject1073 || (_templateObject1073 = _taggedTemplateLiteral25(["DNA extraction syringe"]))))).macro(Macro.skill($skill(_templateObject1083 || (_templateObject1083 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).skill($skill(_templateObject1093 || (_templateObject1093 = _taggedTemplateLiteral25(["Micrometeorite"])))).item($item(_templateObject1103 || (_templateObject1103 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject1133 || (_templateObject1133 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat(), $monster(_templateObject1143 || (_templateObject1143 = _taggedTemplateLiteral25(["Black Crayon Crimbo Elf"])))).macro(Macro.runaway())
  }, {
    name: "Glitter",
    completed: function() {
      return have($effect(_templateObject1153 || (_templateObject1153 = _taggedTemplateLiteral25(["Glittering Eyelashes"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject1163 || (_templateObject1163 = _taggedTemplateLiteral25(["glittery mascara"]))));
    },
    post: function() {
      return assert($effect(_templateObject1173 || (_templateObject1173 = _taggedTemplateLiteral25(["Glittering Eyelashes"]))));
    }
  }, {
    ...
    completed: function() {
      return haveItemOrEffect($item(_templateObject1183 || (_templateObject1183 = _taggedTemplateLiteral25(["imported taffy"])))) || get("_speakeasyFreeFights") >= 3;
    },
    do: function() {
      return mapMonster($location(_templateObject1193 || (_templateObject1193 = _taggedTemplateLiteral25(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject1202 || (_templateObject1202 = _taggedTemplateLiteral25(["goblin flapper"]))));
    },
    post: function() {
      return validateFreeFightCounter("_speakeasyFreeFights", "place.php?whichplace=speakeasy", $location(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral25(["An Unusually Quiet Barroom Brawl"]))));
    },
    outfit: function() {
      return levelingOutfit();
    },
    combat: new CombatStrategy().macro(function() {
      return Macro.skill($skill(_templateObject1223 || (_templateObject1223 = _taggedTemplateLiteral25(["Feel Envy"])))).step(DefaultMacro());
    }, $monster(_templateObject1233 || (_templateObject1233 = _taggedTemplateLiteral25(["goblin flapper"])))).macro(Macro.abort())
  }, {
    name: "Wanderer Sweep",
    completed: function() {
      return get("_speakeasyFreeFights") >= 3;
    },
    do: $location(_templateObject1243 || (_templateObject1243 = _taggedTemplateLiteral25(["An Unusually Quiet Barroom Brawl"]))),
    post: function() {
      return validateFreeFightCounter("_speakeasyFreeFights", "place.php?whichplace=speakeasy", $location(_templateObject1253 || (_templateObject1253 = _taggedTemplateLiteral25(["An Unusually Quiet Barroom Brawl"]))));
    },
    outfit: function() {
      var outfit2 = levelingOutfit();
      var wantOrb = !haveItemOrEffect($item(_templateObject1263 || (_templateObject1263 = _taggedTemplateLiteral25(["imported taffy"])))) && (get("crystalBallPredictions") === "" || get("crystalBallPredictions").includes("goblin flapper"));
      if (wantOrb)
    ...
    effects: [
      ...
      $effect(_templateObject1518 || (_templateObject1518 = _taggedTemplateLiteral25(["Oiled, Slick"]))),
      ...
      $effect(_templateObject1616 || (_templateObject1616 = _taggedTemplateLiteral25(["Carol of the Hells"]))),
      ...
      $effect(_templateObject1716 || (_templateObject1716 = _taggedTemplateLiteral25(["Curiosity of Br'er Tarrypin"]))),
      ...
      $effect(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral25(["Stevedave's Shanty of Superiority"]))),
    ...
    effects: [
      ...
      $effect(_templateObject2119 || (_templateObject2119 = _taggedTemplateLiteral25(["Pride of the Puffin"]))),
    ...
    prepare: function() {
      if (get("snojoSetting") !== $stat(_templateObject2152 || (_templateObject2152 = _taggedTemplateLiteral25(["Muscle"])))) {
        (0, import_kolmafia34.visitUrl)("place.php?whichplace=snojo&action=snojo_controller");
        (0, import_kolmafia34.runChoice)(1);
      }
    },
    do: $location(_templateObject2162 || (_templateObject2162 = _taggedTemplateLiteral25(["The X-32-F Combat Training Snowman"]))),
    post: function() {
      if (!haveItemOrEffect($item(_templateObject2172 || (_templateObject2172 = _taggedTemplateLiteral25(["Gene Tonic: Construct"])))))
        DNALab_exports.makeTonic();
    },
    outfit: function() {
      return levelingOutfit();
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.externalIf(!haveItemOrEffect($item(_templateObject2182 || (_templateObject2182 = _taggedTemplateLiteral25(["Gene Tonic: Construct"])))), Macro.item([$item(_templateObject2192 || (_templateObject2192 = _taggedTemplateLiteral25(["DNA extraction syringe"]))), $item(_templateObject2202 || (_templateObject2202 = _taggedTemplateLiteral25(["Time-Spinner"])))])).skill($skill(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral25(["Sing Along"])))).attack().repeat();
    })
  }, {
    ...
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral25(["closed-circuit pay phone"]))));
    },
    post: function() {
      assert($effect(_templateObject2232 || (_templateObject2232 = _taggedTemplateLiteral25(["Shadow Affinity"]))));
      assert(get("questRufus") !== "unstarted", "Failed to start Rufus quest?");
    }
  }, {
    name: "Shadow Monster",
    completed: function() {
      return (0, import_kolmafia34.haveEffect)($effect(_templateObject2242 || (_templateObject2242 = _taggedTemplateLiteral25(["Shadow Affinity"])))) <= 3;
    },
    do: $location(_templateObject2252 || (_templateObject2252 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    outfit: function() {
      return levelingOutfit();
    },
    combat: DefaultCombat
    ...
    do: function() {
      AutumnAton_exports.sendTo($location(_templateObject2262 || (_templateObject2262 = _taggedTemplateLiteral25(["Shadow Rift"]))));
    }
  }, {
    name: "BRICKOS",
    ready: function() {
      return have($item(_templateObject2272 || (_templateObject2272 = _taggedTemplateLiteral25(["BRICKO eye brick"])))) && have($item(_templateObject2282 || (_templateObject2282 = _taggedTemplateLiteral25(["BRICKO brick"]))), BRICKO_COST);
    },
    completed: function() {
    ...
    prepare: function() {
      return SourceTerminal_exports.educate($skill(_templateObject2292 || (_templateObject2292 = _taggedTemplateLiteral25(["Portscan"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject2302 || (_templateObject2302 = _taggedTemplateLiteral25(["Evoke Eldritch Horror"]))));
    },
    post: function() {
      if ((0, import_kolmafia34.myHp)() / (0, import_kolmafia34.myMaxhp)() < 0.5)
        (0, import_kolmafia34.useSkill)($skill(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral25(["Cannelloni Cocoon"]))));
      assert(counter_exports.exists("portscan.edu"), "Failed to setup portscan?");
    },
    outfit: function() {
      return levelingOutfit(400);
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2322 || (_templateObject2322 = _taggedTemplateLiteral25(["Portscan"])))).skill($skill(_templateObject2332 || (_templateObject2332 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject2342 || (_templateObject2342 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject2352 || (_templateObject2352 = _taggedTemplateLiteral25(["Micrometeorite"])))).skill($skill(_templateObject2362 || (_templateObject2362 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2372 || (_templateObject2372 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject2382 || (_templateObject2382 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    name: "God Lobster",
    completed: function() {
    ...
    choices: {
      1310: function() {
        return have($item(_templateObject2392 || (_templateObject2392 = _taggedTemplateLiteral25(["God Lobster's Ring"])))) ? 2 : 1;
      }
    },
    do: function() {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1500)), {}, {
        famequip: $items(_templateObject2402 || (_templateObject2402 = _taggedTemplateLiteral25(["God Lobster's Ring, God Lobster's Scepter, none"]))),
        familiar: $familiar(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral25(["God Lobster"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Shadow Agent",
    completed: function() {
      return !have($effect(_templateObject2422 || (_templateObject2422 = _taggedTemplateLiteral25(["Shadow Affinity"]))));
    },
    do: $location(_templateObject2432 || (_templateObject2432 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    outfit: function() {
      return levelingOutfit(1e4);
    },
    combat: new CombatStrategy().macro(Macro.if_("!haseffect ".concat($effect(_templateObject2442 || (_templateObject2442 = _taggedTemplateLiteral25(["Shadow Affinity"])))), Macro.abort()).trySkill($skill(_templateObject2452 || (_templateObject2452 = _taggedTemplateLiteral25(["Portscan"])))).skill($skill(_templateObject2462 || (_templateObject2462 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject2472 || (_templateObject2472 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject2482 || (_templateObject2482 = _taggedTemplateLiteral25(["Micrometeorite"])))).skill($skill(_templateObject2492 || (_templateObject2492 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2502 || (_templateObject2502 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat(), $monster(_templateObject2522 || (_templateObject2522 = _taggedTemplateLiteral25(["Government agent"])))).macro(Macro.abort())
  }, {
    name: "Shadow Entity",
    completed: function() {
      return get("encountersUntilSRChoice") !== 0 || have($effect(_templateObject2532 || (_templateObject2532 = _taggedTemplateLiteral25(["Inner Elf"]))));
    },
    prepare: topOffHp,
    do: $location(_templateObject2542 || (_templateObject2542 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    post: function() {
      assert(get("encountersUntilSRChoice") !== 0, "Spent fewer shadow rift combats than expected?");
      assert($effect(_templateObject2552 || (_templateObject2552 = _taggedTemplateLiteral25(["Inner Elf"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit()), {}, {
        ...
        famequip: $item(_templateObject2572 || (_templateObject2572 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2582 || (_templateObject2582 = _taggedTemplateLiteral25(["Saucegeyser"])))), $monsters(_templateObject2592 || (_templateObject2592 = _taggedTemplateLiteral25(["shadow cauldron, shadow matrix, shadow scythe, shadow spire, shadow tongue"])))).macro(Macro.skill($skill(_templateObject2602 || (_templateObject2602 = _taggedTemplateLiteral25(["Northern Explosion"])))), $monster(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral25(["shadow orrery"])))).macro(Macro.abort())
  }, {
    name: "Witchess Witch",
    completed: function() {
      return have($item(_templateObject2622 || (_templateObject2622 = _taggedTemplateLiteral25(["battle broom"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2632 || (_templateObject2632 = _taggedTemplateLiteral25(["Witchess Witch"]))));
    },
    outfit: function() {
    ...
    name: "Witchess King",
    completed: function() {
      return have($item(_templateObject2642 || (_templateObject2642 = _taggedTemplateLiteral25(["dented scepter"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2652 || (_templateObject2652 = _taggedTemplateLiteral25(["Witchess King"]))));
    },
    outfit: function() {
    ...
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2672 || (_templateObject2672 = _taggedTemplateLiteral25(["Witchess Queen"]))));
    },
    outfit: function() {
    ...
    do: $location(_templateObject2682 || (_templateObject2682 = _taggedTemplateLiteral25(["The Deep Machine Tunnels"]))),
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        familiar: $familiar(_templateObject2692 || (_templateObject2692 = _taggedTemplateLiteral25(["Machine Elf"]))),
        famequip: $item(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    post: function() {
      ...
      if (have($effect(_templateObject2722 || (_templateObject2722 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject2732 || (_templateObject2732 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject2742 || (_templateObject2742 = _taggedTemplateLiteral25(['"I Voted!" sticker'])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    post: function() {
      if (have($effect(_templateObject2762 || (_templateObject2762 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject2772 || (_templateObject2772 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject2782 || (_templateObject2782 = _taggedTemplateLiteral25(["Lil' Doctor\u2122 bag"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    post: function() {
      if (have($effect(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
    },
    outfit: function() {
    ...
    post: function() {
      if (have($effect(_templateObject2832 || (_templateObject2832 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject2842 || (_templateObject2842 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return lightweightOutfit();
    },
    ...
    prepare: topOffHp,
    do: $location(_templateObject2852 || (_templateObject2852 = _taggedTemplateLiteral25(["The Toxic Teacups"]))),
    post: function() {
      return assert(get("_pocketProfessorLectures") > 0, "Failed to lecture?");
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        offhand: $item(_templateObject2862 || (_templateObject2862 = _taggedTemplateLiteral25(["Kramco Sausage-o-Matic\u2122"]))),
        familiar: $familiar(_templateObject2872 || (_templateObject2872 = _taggedTemplateLiteral25(["Pocket Professor"]))),
        famequip: $item(_templateObject2882 || (_templateObject2882 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2892 || (_templateObject2892 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral25(["Micrometeorite"])))).if_("hasskill ".concat((0, import_kolmafia34.toInt)($skill(_templateObject2922 || (_templateObject2922 = _taggedTemplateLiteral25(["lecture on relativity"]))))), Macro.skill($skill(_templateObject2932 || (_templateObject2932 = _taggedTemplateLiteral25(["lecture on relativity"])))).skill($skill(_templateObject2942 || (_templateObject2942 = _taggedTemplateLiteral25(["Saucy Salve"]))))).skill($skill(_templateObject2952 || (_templateObject2952 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2962 || (_templateObject2962 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject2972 || (_templateObject2972 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    ...
    do: $location(_templateObject2982 || (_templateObject2982 = _taggedTemplateLiteral25(["The Neverending Party"]))),
    post: function() {
      return validateFreeFightCounter("_neverendingPartyFreeTurns", "place.php?whichplace=town_wrong", $location(_templateObject2992 || (_templateObject2992 = _taggedTemplateLiteral25(["The Neverending Party"]))));
    },
    outfit: function() {
      return levelingOutfit(2e4);
    },
    combat: new CombatStrategy().startingMacro(Macro.if_(notAllowList, Macro.abort())).macro(Macro.externalIf(get("cosmicBowlingBallReturnCombats") > 1, Macro.trySkill($skill(_templateObject300 || (_templateObject300 = _taggedTemplateLiteral25(["Feel Pride"]))))).trySkill($skill(_templateObject301 || (_templateObject301 = _taggedTemplateLiteral25(["Bowl Sideways"])))).skill($skill(_templateObject3022 || (_templateObject3022 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).skill($skill(_templateObject3032 || (_templateObject3032 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject3042 || (_templateObject3042 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject3052 || (_templateObject3052 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    name: "Drink Lattes",
    completed: function() {
    ...
    do: $location(_templateObject3062 || (_templateObject3062 = _taggedTemplateLiteral25(["The Dire Warren"]))),
    effects: $effects(_templateObject3072 || (_templateObject3072 = _taggedTemplateLiteral25(["Ode to Booze"]))),
    outfit: {
      back: $item(_templateObject3082 || (_templateObject3082 = _taggedTemplateLiteral25(["unwrapped knock-off retro superhero cape"]))),
      shirt: $item(_templateObject3092 || (_templateObject3092 = _taggedTemplateLiteral25(["Jurassic Parka"]))),
      offhand: $item(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral25(["latte lovers member's mug"]))),
      pants: $item(_templateObject3115 || (_templateObject3115 = _taggedTemplateLiteral25(["Cargo Cultist Shorts"]))),
      acc2: $items(_templateObject3122 || (_templateObject3122 = _taggedTemplateLiteral25(["battle broom"]))),
      acc3: $item(_templateObject3132 || (_templateObject3132 = _taggedTemplateLiteral25(['"I Voted!" sticker']))),
      familiar: $familiar(_templateObject3142 || (_templateObject3142 = _taggedTemplateLiteral25(["Frumious Bandersnatch"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["heck", "hold"]
      }
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.trySkill($skill(_templateObject3152 || (_templateObject3152 = _taggedTemplateLiteral25(["Gulp Latte"])))).externalIf(get("_latteRefillsUsed") < 2, Macro.trySkill($skill(_templateObject3162 || (_templateObject3162 = _taggedTemplateLiteral25(["Throw Latte on Opponent"]))))).runaway();
    })
  }]
};
...
var SpellDamageQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      back: $item(_templateObject1021 || (_templateObject1021 = _taggedTemplateLiteral26(["unwrapped knock-off retro superhero cape"]))),
      ...
      acc3: $item(_templateObject1519 || (_templateObject1519 = _taggedTemplateLiteral26(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject1617 || (_templateObject1617 = _taggedTemplateLiteral26(["Exotic Parrot"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["vampire", "hold"]
      }
    ...
    name: "Cowrruption",
    completed: function() {
      return haveItemOrEffect($item(_templateObject1717 || (_templateObject1717 = _taggedTemplateLiteral26(["corrupted marrow"]))));
    },
    prepare: function() {
      var fax = $item(_templateObject1816 || (_templateObject1816 = _taggedTemplateLiteral26(["photocopied monster"])));
    ...
    post: function() {
      ...
      assert($effect(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral26(["Meteor Showered"]))));
    },
    outfit: {
    ...
    combat: new CombatStrategy().ccs("skill ".concat($skill(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral26(["Meteor Shower"]))), "\n          twiddle your thumbs\n          skill ").concat($skill(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral26(["Use the Force"])))), $monster(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral26(["ungulith"])))).macro(Macro.abort())
  }, {
    ...
    effects: [$effect(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral26(["AA-Charged"]))), $effect(_templateObject3116 || (_templateObject3116 = _taggedTemplateLiteral26(["AAA-Charged"]))), $effect(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral26(["Arched Eyebrow of the Archmage"]))), $effect(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral26(["Carol of the Hells"]))), $effect(_templateObject3410 || (_templateObject3410 = _taggedTemplateLiteral26(["Concentration"]))), $effect(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral26(["Cowrruption"]))), $effect(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral26(["Do You Crush What I Crush?"]))), $effect(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral26(["Grumpy and Ornery"]))), $effect(_templateObject387 || (_templateObject387 = _taggedTemplateLiteral26(["Human-Elf Hybrid"]))), $effect(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral26(["Imported Strength"]))), $effect(_templateObject407 || (_templateObject407 = _taggedTemplateLiteral26(["Inner Elf"]))), $effect(_templateObject4113 || (_templateObject4113 = _taggedTemplateLiteral26(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral26(["Mental A-cue-ity"]))), $effect(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral26(["Meteor Showered"]))), $effect(_templateObject447 || (_templateObject447 = _taggedTemplateLiteral26(["Nanobrainy"]))), $effect(_templateObject457 || (_templateObject457 = _taggedTemplateLiteral26(["Pisces in the Skyces"]))), $effect(_templateObject467 || (_templateObject467 = _taggedTemplateLiteral26(["Pointy Wizard Beard"]))), $effect(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral26(["Ready to Survive"]))), $effect(_templateObject487 || (_templateObject487 = _taggedTemplateLiteral26(["Sigils of Yeg"]))), $effect(_templateObject497 || (_templateObject497 = _taggedTemplateLiteral26(["Song of Sauce"]))), $effect(_templateObject507 || (_templateObject507 = _taggedTemplateLiteral26(["Sparkly!"]))), $effect(_templateObject5112 || (_templateObject5112 = _taggedTemplateLiteral26(["Spirit of Garlic"]))), $effect(_templateObject5211 || (_templateObject5211 = _taggedTemplateLiteral26(["Spit Upon"]))), $effect(_templateObject538 || (_templateObject538 = _taggedTemplateLiteral26(["The Magic of LOV"]))), $effect(_templateObject546 || (_templateObject546 = _taggedTemplateLiteral26(["Toxic Vengeance"]))), $effect(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral26(["Visions of the Deep Dark Deeps"]))), $effect(_templateObject566 || (_templateObject566 = _taggedTemplateLiteral26(["Warlock, Warstock, and Warbarrel"]))), $effect(_templateObject576 || (_templateObject576 = _taggedTemplateLiteral26(["We're All Made of Starfish"]))), $effect(_templateObject586 || (_templateObject586 = _taggedTemplateLiteral26(["Witch Breaded"])))],
    outfit: {
...
var MoxieQuest = {
  ...
  tasks: [{
    ...
    do: function() {
      ...
      if (CommunityService.Moxie.actualCost() > 1) {
        if (!haveItemOrEffect($item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral27(["oil of expertise"]))))) {
    ...
    outfit: {
      hat: $item(_templateObject1520 || (_templateObject1520 = _taggedTemplateLiteral27(["very pointy crown"]))),
      back: $item(_templateObject1618 || (_templateObject1618 = _taggedTemplateLiteral27(["unwrapped knock-off retro superhero cape"]))),
      weapon: $item(_templateObject1718 || (_templateObject1718 = _taggedTemplateLiteral27(["Fourth of May Cosplay Saber"]))),
...
var MuscleQuest = {
  ...
  tasks: [{
    ...
    acquire: [{
      item: $item(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral27(["wad of used tape"])))
    }],
    ...
    outfit: {
      ...
      acc3: $item(_templateObject3313 || (_templateObject3313 = _taggedTemplateLiteral27(['"I Voted!" sticker']))),
      modes: {
...
var MysticalityQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      ...
      back: $item(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral27(["unwrapped knock-off retro superhero cape"]))),
...
var WeaponDamageQuest = {
  ...
  tasks: [innerElf(), {
    ...
    outfit: {
      weapon: $item(_templateObject448 || (_templateObject448 = _taggedTemplateLiteral28(["Fourth of May Cosplay Saber"]))),
    ...
    post: function() {
      return (0, import_kolmafia37.equip)($slot(_templateObject930 || (_templateObject930 = _taggedTemplateLiteral28(["familiar"]))), $item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral28(["none"]))));
    },
    acquire: [{
      item: $item(_templateObject1124 || (_templateObject1124 = _taggedTemplateLiteral28(["broken champagne bottle"])))
    }],
    effects: [$effect(_templateObject1224 || (_templateObject1224 = _taggedTemplateLiteral28(["Billiards Belligerence"]))), $effect(_templateObject1324 || (_templateObject1324 = _taggedTemplateLiteral28(["Blessing of your favorite Bird"]))), $effect(_templateObject1424 || (_templateObject1424 = _taggedTemplateLiteral28(["Bow-Legged Swagger"]))), $effect(_templateObject1521 || (_templateObject1521 = _taggedTemplateLiteral28(["Carol of the Bulls"]))), $effect(_templateObject1619 || (_templateObject1619 = _taggedTemplateLiteral28(["Cowrruption"]))), $effect(_templateObject1719 || (_templateObject1719 = _taggedTemplateLiteral28(["Do You Crush What I Crush?"]))), $effect(_templateObject1818 || (_templateObject1818 = _taggedTemplateLiteral28(["Frenzied, Bloody"]))), $effect(_templateObject1916 || (_templateObject1916 = _taggedTemplateLiteral28(["Grumpy and Ornery"]))), $effect(_templateObject2016 || (_templateObject2016 = _taggedTemplateLiteral28(["Imported Strength"]))), $effect(_templateObject2123 || (_templateObject2123 = _taggedTemplateLiteral28(["Inner Elf"]))), $effect(_templateObject2219 || (_templateObject2219 = _taggedTemplateLiteral28(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject2318 || (_templateObject2318 = _taggedTemplateLiteral28(["Lack of Body-Building"]))), $effect(_templateObject2417 || (_templateObject2417 = _taggedTemplateLiteral28(["Meteor Showered"]))), $effect(_templateObject2516 || (_templateObject2516 = _taggedTemplateLiteral28(["Rage of the Reindeer"]))), $effect(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral28(["Ready to Survive"]))), $effect(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral28(["Scowl of the Auk"]))), $effect(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral28(["Song of the North"]))), $effect(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral28(["Spit Upon"]))), $effect(_templateObject3012 || (_templateObject3012 = _taggedTemplateLiteral28(["Tenacity of the Snapper"]))), $effect(_templateObject3118 || (_templateObject3118 = _taggedTemplateLiteral28(["The Power of LOV"])))],
    outfit: {
      hat: $items(_templateObject3216 || (_templateObject3216 = _taggedTemplateLiteral28(["extra-wide head candle, none"]))),
      weapon: $item(_templateObject3314 || (_templateObject3314 = _taggedTemplateLiteral28(["dented scepter"]))),
      offhand: $item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral28(["unbreakable umbrella"]))),
      ...
      famequip: $item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral28(["broken champagne bottle"]))),
