...
function prepareToAscend() {
  if ((0, import_kolmafia26.myPath)() !== $path(_templateObject227 || (_templateObject227 = _taggedTemplateLiteral15(["Community Service"])))) {
    prepareAscension({
...
function prepAndAscendIfNecessary() {
  if ((0, import_kolmafia26.myPath)() !== $path(_templateObject320 || (_templateObject320 = _taggedTemplateLiteral15(["Community Service"])))) {
    prepareToAscend();
    (0, import_kolmafia26.visitUrl)("council.php");
    (0, import_kolmafia26.visitUrl)("charsheet.php");
    ascend($path(_templateObject419 || (_templateObject419 = _taggedTemplateLiteral15(["Community Service"]))), $class(_templateObject515 || (_templateObject515 = _taggedTemplateLiteral15(["Sauceror"]))), Lifestyle.hardcore, "blender", $item(_templateObject615 || (_templateObject615 = _taggedTemplateLiteral15(["astral six-pack"]))), $item(_templateObject714 || (_templateObject714 = _taggedTemplateLiteral15(["astral chapeau"]))), {
...
var config = Args.create("seventyhccs", "Automate 1/70 Community Service.", {
  ...
  RIFT: Args.location({
    default: $location(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral16(["Shadow Rift (The Right Side of the Tracks)"]))),
    help: "Default Shadow Rift Location",
    hidden: true,
    setting: ""
  })
});
var BRICKO_TARGET_ITEM = $item(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral16(["BRICKO bat"])));
var BRICKO_COST = (_Map$get = (/* @__PURE__ */ new Map([[$item(_templateObject321 || (_templateObject321 = _taggedTemplateLiteral16(["BRICKO ooze"]))), 2], [$item(_templateObject420 || (_templateObject420 = _taggedTemplateLiteral16(["BRICKO bat"]))), 5], [$item(_templateObject516 || (_templateObject516 = _taggedTemplateLiteral16(["BRICKO oyster"]))), 8], [$item(_templateObject616 || (_templateObject616 = _taggedTemplateLiteral16(["BRICKO turtle"]))), 11], [$item(_templateObject715 || (_templateObject715 = _taggedTemplateLiteral16(["BRICKO elephant"]))), 23], [$item(_templateObject813 || (_templateObject813 = _taggedTemplateLiteral16(["BRICKO octopus"]))), 37], [$item(_templateObject911 || (_templateObject911 = _taggedTemplateLiteral16(["BRICKO python"]))), 69]])).get(BRICKO_TARGET_ITEM)) !== null && _Map$get !== void 0 ? _Map$get : 9999;
var BRICKO_DROP = (_Map$get2 = (/* @__PURE__ */ new Map([[$item(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral16(["BRICKO ooze"]))), 1], [$item(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral16(["BRICKO bat"]))), 2], [$item(_templateObject127 || (_templateObject127 = _taggedTemplateLiteral16(["BRICKO oyster"]))), 0], [$item(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral16(["BRICKO turtle"]))), 0], [$item(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral16(["BRICKO elephant"]))), 0], [$item(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral16(["BRICKO octopus"]))), 3], [$item(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral16(["BRICKO python"]))), 4]])).get(BRICKO_TARGET_ITEM)) !== null && _Map$get2 !== void 0 ? _Map$get2 : 0;
...
var notAllowList = [
  ...
  $monster(_templateObject814 || (_templateObject814 = _taggedTemplateLiteral17(["The ghost of Richard Cockingham"]))),
  ...
  $monster(_templateObject168 || (_templateObject168 = _taggedTemplateLiteral17(["gingerbread tech bro"]))),
  ...
  $monster(_templateObject815 || (_templateObject815 = _taggedTemplateLiteral17(["shadow orb"]))),
  ...
  $monster(_templateObject892 || (_templateObject892 = _taggedTemplateLiteral17(["shadow cauldron"]))),
  $monster(_templateObject902 || (_templateObject902 = _taggedTemplateLiteral17(["shadow matrix"]))),
  $monster(_templateObject913 || (_templateObject913 = _taggedTemplateLiteral17(["shadow orrery"]))),
  $monster(_templateObject922 || (_templateObject922 = _taggedTemplateLiteral17(["shadow scythe"]))),
  $monster(_templateObject932 || (_templateObject932 = _taggedTemplateLiteral17(["shadow spire"]))),
  $monster(_templateObject942 || (_templateObject942 = _taggedTemplateLiteral17(["shadow tongue"])))
].map(function(m) {
  return "!monsterid ".concat(m.id);
}).join(" && ");
var Fast = Macro.skill($skill(_templateObject952 || (_templateObject952 = _taggedTemplateLiteral17(["Sing Along"])))).item($item(_templateObject962 || (_templateObject962 = _taggedTemplateLiteral17(["Time-Spinner"])))).skill($skill(_templateObject972 || (_templateObject972 = _taggedTemplateLiteral17(["Micrometeorite"])))).attack().repeat();
var Slow = Macro.skill($skill(_templateObject982 || (_templateObject982 = _taggedTemplateLiteral17(["Curse of Weaksauce"])))).item($item(_templateObject992 || (_templateObject992 = _taggedTemplateLiteral17(["Time-Spinner"])))).skill($skill(_templateObject1002 || (_templateObject1002 = _taggedTemplateLiteral17(["Micrometeorite"])))).skill($skill(_templateObject1012 || (_templateObject1012 = _taggedTemplateLiteral17(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia28.mpCost)($skill(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral17(["Saucestorm"]))))), Macro.skill($skill(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral17(["Saucestorm"]))))).attack().repeat();
...
var DefaultCombat = new CombatStrategy().startingMacro(Macro.if_(notAllowList, Macro.abort())).macro(Macro.if_("hasskill ".concat((0, import_kolmafia28.toInt)($skill(_templateObject1042 || (_templateObject1042 = _taggedTemplateLiteral17(["Shoot Ghost"]))))), Macro.skill($skill(_templateObject1052 || (_templateObject1052 = _taggedTemplateLiteral17(["Summon Love Gnats"])))).skill($skill(_templateObject1062 || (_templateObject1062 = _taggedTemplateLiteral17(["Sing Along"])))).skill($skill(_templateObject1072 || (_templateObject1072 = _taggedTemplateLiteral17(["Shoot Ghost"])))).skill($skill(_templateObject1082 || (_templateObject1082 = _taggedTemplateLiteral17(["Shoot Ghost"])))).skill($skill(_templateObject1092 || (_templateObject1092 = _taggedTemplateLiteral17(["Shoot Ghost"])))).skill($skill(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral17(["Trap Ghost"])))).abort()), [$monster(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral17(["boneless blobghost"]))), $monster(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral17(["Emily Koops, a spooky lime"]))), $monster(_templateObject1132 || (_templateObject1132 = _taggedTemplateLiteral17(["The ghost of Ebenoozer Screege"]))), $monster(_templateObject1142 || (_templateObject1142 = _taggedTemplateLiteral17(["The ghost of Jim Unfortunato"]))), $monster(_templateObject1152 || (_templateObject1152 = _taggedTemplateLiteral17(["The ghost of Lord Montague Spookyraven"]))), $monster(_templateObject1162 || (_templateObject1162 = _taggedTemplateLiteral17(["the ghost of Monsieur Baguelle"]))), $monster(_templateObject1172 || (_templateObject1172 = _taggedTemplateLiteral17(["the ghost of Oily McBindle"]))), $monster(_templateObject1182 || (_templateObject1182 = _taggedTemplateLiteral17(["The ghost of Richard Cockingham"]))), $monster(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral17(["The ghost of Sam McGee"]))), $monster(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral17(['The ghost of Vanillica "Trashblossom" Gorton']))), $monster(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral17(["The ghost of Waldo the Carpathian"]))), $monster(_templateObject1222 || (_templateObject1222 = _taggedTemplateLiteral17(["The Headless Horseman"]))), $monster(_templateObject1232 || (_templateObject1232 = _taggedTemplateLiteral17(["The Icewoman"])))]).macro(Macro.skill($skill(_templateObject1242 || (_templateObject1242 = _taggedTemplateLiteral17(["Sing Along"])))).if_("monsterid ".concat((0, import_kolmafia28.toInt)($monster(_templateObject1252 || (_templateObject1252 = _taggedTemplateLiteral17(["gingerbread gentrifier"]))))), Macro.trySkill($skill(_templateObject1262 || (_templateObject1262 = _taggedTemplateLiteral17(["Meteor Shower"]))))).trySkill($skill(_templateObject1272 || (_templateObject1272 = _taggedTemplateLiteral17(["Chest X-Ray"])))).trySkill($skill(_templateObject1282 || (_templateObject1282 = _taggedTemplateLiteral17(["Shattering Punch"])))).trySkill($skill(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral17(["Gingerbread Mob Hit"])))).trySkill($skill(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral17(["Shocking Lick"])))).abort(), $monsters(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral17(["gingerbread finance bro, gingerbread gentrifier, gingerbread tech bro"])))).macro(Macro.attack().repeat(), $monster(_templateObject1322 || (_templateObject1322 = _taggedTemplateLiteral17(["LOV Enforcer"])))).macro(Macro.skill($skill(_templateObject1332 || (_templateObject1332 = _taggedTemplateLiteral17(["Candyblast"])))).repeat(), $monster(_templateObject1342 || (_templateObject1342 = _taggedTemplateLiteral17(["LOV Engineer"])))).macro(Macro.trySkill($skill(_templateObject1352 || (_templateObject1352 = _taggedTemplateLiteral17(["KGB tranquilizer dart"])))).skill($skill(_templateObject1362 || (_templateObject1362 = _taggedTemplateLiteral17(["Snokebomb"])))).abort(), $monster(_templateObject1372 || (_templateObject1372 = _taggedTemplateLiteral17(["Mother Slime"])))).macro(Macro.if_("!haseffect ".concat($effect(_templateObject1382 || (_templateObject1382 = _taggedTemplateLiteral17(["Shadow Affinity"])))), Macro.abort()).skill($skill(_templateObject139 || (_templateObject139 = _taggedTemplateLiteral17(["Saucegeyser"])))).abort(), $monsters(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral17(["shadow cauldron, shadow matrix, shadow scythe, shadow spire, shadow tongue"])))).macro(Macro.if_("!haseffect ".concat($effect(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral17(["Shadow Affinity"])))), Macro.abort()).skill($skill(_templateObject1422 || (_templateObject1422 = _taggedTemplateLiteral17(["Northern Explosion"])))).attack().abort(), $monster(_templateObject1432 || (_templateObject1432 = _taggedTemplateLiteral17(["shadow orrery"])))).macro(function() {
  return Macro.externalIf(!haveItemOrEffect($item(_templateObject1442 || (_templateObject1442 = _taggedTemplateLiteral17(["abstraction: joy"])))) && !have($item(_templateObject1452 || (_templateObject1452 = _taggedTemplateLiteral17(["abstraction: action"])))), Macro.skill($skill(_templateObject1462 || (_templateObject1462 = _taggedTemplateLiteral17(["Feel Envy"])))));
}, $monster(_templateObject1472 || (_templateObject1472 = _taggedTemplateLiteral17(["Performer of Actions"])))).macro(Macro.tryItem($item(_templateObject1482 || (_templateObject1482 = _taggedTemplateLiteral17(["abstraction: action"])))), $monster(_templateObject149 || (_templateObject149 = _taggedTemplateLiteral17(["Thinker of Thoughts"])))).macro(function() {
  ...
  return Macro.if_("hasskill ".concat((0, import_kolmafia28.toInt)($skill(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral17(["Back-Up to your Last Enemy"]))))), Macro.skill($skill(_templateObject151 || (_templateObject151 = _taggedTemplateLiteral17(["Back-Up to your Last Enemy"]))))).skill($skill(_templateObject1522 || (_templateObject1522 = _taggedTemplateLiteral17(["Saucy Salve"])))).if_("monsterid ".concat($monster(_templateObject1532 || (_templateObject1532 = _taggedTemplateLiteral17(["toxic beastie"]))).id), Macro.if_("monsterhpabove ".concat(2 * safe), Macro.skill($skill(_templateObject1542 || (_templateObject1542 = _taggedTemplateLiteral17(["Summon Love Gnats"]))))).if_("monsterhpabove ".concat(safe), Macro.trySkill($skill(_templateObject1552 || (_templateObject1552 = _taggedTemplateLiteral17(["Bowl Sideways"]))))).if_("monsterhpabove ".concat(safe), Macro.skill($skill(_templateObject1562 || (_templateObject1562 = _taggedTemplateLiteral17(["Sing Along"]))))).trySkill($skill(_templateObject1572 || (_templateObject1572 = _taggedTemplateLiteral17(["Chest X-Ray"])))).trySkill($skill(_templateObject1582 || (_templateObject1582 = _taggedTemplateLiteral17(["Shattering Punch"])))).trySkill($skill(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral17(["Gingerbread Mob Hit"])))).trySkill($skill(_templateObject160 || (_templateObject160 = _taggedTemplateLiteral17(["Shocking Lick"])))).abort());
}, $monster(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral17(["toxic beastie"])))).macro(Macro.item($item(_templateObject1622 || (_templateObject1622 = _taggedTemplateLiteral17(["Time-Spinner"])))).attack().repeat(), $monster(_templateObject1632 || (_templateObject1632 = _taggedTemplateLiteral17(["Witchess Queen"])))).macro(Macro.skill($skill(_templateObject1642 || (_templateObject1642 = _taggedTemplateLiteral17(["Curse of Weaksauce"])))).skill($skill(_templateObject1652 || (_templateObject1652 = _taggedTemplateLiteral17(["Sing Along"])))).attack().repeat(), $monster(_templateObject1662 || (_templateObject1662 = _taggedTemplateLiteral17(["Witchess Witch"])))).macro(DefaultMacro);
var StenchCombat = new CombatStrategy().macro(function() {
  var weight = 20 + (0, import_kolmafia28.weightAdjustment)();
  var bonus = get2("Familiar Damage");
  var maxVintnerDamage = 3 + weight + bonus;
  var safe = 2 * (maxVintnerDamage + 25);
  return Macro.if_("monsterid ".concat($monster(_templateObject1672 || (_templateObject1672 = _taggedTemplateLiteral17(["toxic beastie"]))).id), Macro.if_("hasskill ".concat((0, import_kolmafia28.toInt)($skill(_templateObject1682 || (_templateObject1682 = _taggedTemplateLiteral17(["Back-Up to your Last Enemy"]))))), Macro.skill($skill(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral17(["Back-Up to your Last Enemy"])))))).skill($skill(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral17(["Saucy Salve"])))).if_("monsterid ".concat($monster(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral17(["toxic beastie"]))).id), Macro.abort()).if_("monsterhpabove ".concat(safe, " && snarfblat ").concat($location(_templateObject1722 || (_templateObject1722 = _taggedTemplateLiteral17(["The Neverending Party"]))).id), Macro.trySkill($skill(_templateObject1732 || (_templateObject1732 = _taggedTemplateLiteral17(["Bowl Sideways"]))))).externalIf(get("cosmicBowlingBallReturnCombats") > 1, Macro.if_("monsterhpabove ".concat(safe, " && snarfblat ").concat($location(_templateObject1742 || (_templateObject1742 = _taggedTemplateLiteral17(["The Neverending Party"]))).id), Macro.trySkill($skill(_templateObject1752 || (_templateObject1752 = _taggedTemplateLiteral17(["Feel Pride"])))))).if_("monsterhpabove ".concat(safe), Macro.skill($skill(_templateObject1762 || (_templateObject1762 = _taggedTemplateLiteral17(["Sing Along"]))))).skill($skill(_templateObject1772 || (_templateObject1772 = _taggedTemplateLiteral17(["Stuffed Mortar Shell"])))).skill($skill(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral17(["Silent Treatment"])))).abort();
});
...
function mapMonster(location, monster) {
  ...
  if (!get("mappingMonsters"))
    (0, import_kolmafia28.useSkill)($skill(_templateObject179 || (_templateObject179 = _taggedTemplateLiteral17(["Map the Monsters"]))));
...
function getPantogramPants() {
  if (!have($item(_templateObject1310 || (_templateObject1310 = _taggedTemplateLiteral18(["portable pantogram"])))) || have($item(_templateObject1410 || (_templateObject1410 = _taggedTemplateLiteral18(["pantogram pants"])))))
    return;
  var m = (/* @__PURE__ */ new Map([[$stat(_templateObject1510 || (_templateObject1510 = _taggedTemplateLiteral18(["Muscle"]))), 1], [$stat(_templateObject1610 || (_templateObject1610 = _taggedTemplateLiteral18(["Mysticality"]))), 2], [$stat(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral18(["Moxie"]))), 3]])).get((0, import_kolmafia29.myPrimestat)());
  var element;
  (function(element2) {
...
function selectBestFamiliar() {
  ...
  if (!have($effect(_templateObject181 || (_templateObject181 = _taggedTemplateLiteral19(["Spit Upon"])))) && get("camelSpit") < 100) {
    return {
  ...
  if (!$items(_templateObject719 || (_templateObject719 = _taggedTemplateLiteral19(["rope, burning newspaper, burning paper crane"]))).some(function(i) {
    ...
    return {
      familiar: $familiar(_templateObject817 || (_templateObject817 = _taggedTemplateLiteral19(["Garbage Fire"]))),
      famequip: $item(_templateObject915 || (_templateObject915 = _taggedTemplateLiteral19(["tiny stillsuit"])))
    };
  }
...
function deepDarkVisions() {
  ...
  return {
    ...
    completed: function() {
      return have($effect(_templateObject1611 || (_templateObject1611 = _taggedTemplateLiteral19(["Visions of the Deep Dark Deeps"]))));
    },
    do: function() {
      ...
      if ((0, import_kolmafia30.myHp)() < (0, import_kolmafia30.myMaxhp)())
        (0, import_kolmafia30.useSkill)(Math.ceil((0, import_kolmafia30.myMaxhp)() / (0, import_kolmafia30.myHp)()), $skill(_templateObject1711 || (_templateObject1711 = _taggedTemplateLiteral19(["Cannelloni Cocoon"]))));
...
function _toConsumableArray8(arr) {
  return _arrayWithoutHoles8(arr) || _iterableToArray8(arr) || _unsupportedIterableToArray18(arr) || _nonIterableSpread8();
}
...
var defaultOutfit = {
  hat: $item(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral20(["Daylight Shavings Helmet"]))),
  ...
  acc2: $item(_templateObject818 || (_templateObject818 = _taggedTemplateLiteral20(["Powerful Glove"]))),
  acc3: $item(_templateObject916 || (_templateObject916 = _taggedTemplateLiteral20(["Kremlin's Greatest Briefcase"]))),
  modes: {
    parka: "dilophosaur"
  }
};
...
var CoilWire = {
  ...
  tasks: [{
    ...
    [$effect(_templateObject1512 || (_templateObject1512 = _taggedTemplateLiteral20(["The Odour of Magick"]))), function() {
      return (0, import_kolmafia31.use)($item(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral20(["natural magick candle"]))));
    }],
    [$item(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral20(['"I Voted!" sticker']))), function() {
      return vote();
    }],
    [$item(_templateObject1810 || (_templateObject1810 = _taggedTemplateLiteral20(["pantogram pants"]))), function() {
      return getPantogramPants();
    }],
    [$item(_templateObject1910 || (_templateObject1910 = _taggedTemplateLiteral20(["box of Familiar Jacks"]))), function() {
      return (0, import_kolmafia31.create)($item(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral20(["box of Familiar Jacks"]))));
    }],
    [$item(_templateObject2115 || (_templateObject2115 = _taggedTemplateLiteral20(["Brutal brogues"]))), function() {
      return (0, import_kolmafia31.cliExecute)("bastille bbq brutalist catapult");
    }],
    [$item(_templateObject2213 || (_templateObject2213 = _taggedTemplateLiteral20(["cuppa Loyal tea"]))), function() {
      return (0, import_kolmafia31.cliExecute)("teatree loyal");
    }],
    [$item(_templateObject2310 || (_templateObject2310 = _taggedTemplateLiteral20(["green mana"]))), function() {
      return (0, import_kolmafia31.cliExecute)("cheat forest");
    }],
    [$item(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral20(["wrench"]))), function() {
      return (0, import_kolmafia31.cliExecute)("cheat wrench");
    }],
    [$item(_templateObject2510 || (_templateObject2510 = _taggedTemplateLiteral20(["Yeg's Motel hand soap"]))), function() {
      return (0, import_kolmafia31.cliExecute)("cargo item ".concat($item(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral20(["Yeg's Motel hand soap"])))));
    }],
    [$item(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral20(["gold detective badge"]))), function() {
      return (0, import_kolmafia31.visitUrl)("place.php?whichplace=town_wrong&action=townwrong_precinct");
    }],
    [$item(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral20(["your cowboy boots"]))), function() {
      return (0, import_kolmafia31.visitUrl)("place.php?whichplace=town_right&action=townright_ltt");
    }],
    [$item(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral20(["weeping willow wand"]))), function() {
      (0, import_kolmafia31.visitUrl)("shop.php?whichshop=lathe");
      (0, import_kolmafia31.create)($item(_templateObject307 || (_templateObject307 = _taggedTemplateLiteral20(["weeping willow wand"]))));
    }],
    [$item(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral20(["toy accordion"]))), function() {
      return (0, import_kolmafia31.retrieveItem)($item(_templateObject3210 || (_templateObject3210 = _taggedTemplateLiteral20(["toy accordion"]))));
    }],
    [$skill(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral20(["Seek out a Bird"]))), function() {
      return (0, import_kolmafia31.use)($item(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral20(["Bird-a-Day calendar"]))));
    }]
  ].map(function(_ref3) {
    ...
    completed: function() {
      return have($item(_templateObject356 || (_templateObject356 = _taggedTemplateLiteral20(["sombrero-mounted sparkler"]))));
    },
    prepare: function() {
      return Clan.join(config.main_clan);
    },
    do: function() {
      (0, import_kolmafia31.retrieveItem)($item(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral20(["sombrero-mounted sparkler"]))));
      assert($item(_templateObject375 || (_templateObject375 = _taggedTemplateLiteral20(["sombrero-mounted sparkler"]))));
    }
  }, {
    name: "Gaze at the Stars",
    completed: function() {
      return have($effect(_templateObject385 || (_templateObject385 = _taggedTemplateLiteral20(["That's Just Cloud-Talk, Man"])))) || get("_campAwaySmileBuffs") > 0;
    },
    do: function() {
    ...
    acquire: [{
      item: $item(_templateObject395 || (_templateObject395 = _taggedTemplateLiteral20(["borrowed time"]))),
      get: function() {
        return (0, import_kolmafia31.create)($item(_templateObject405 || (_templateObject405 = _taggedTemplateLiteral20(["borrowed time"]))));
      }
    }],
    do: function() {
      return (0, import_kolmafia31.use)($item(_templateObject4111 || (_templateObject4111 = _taggedTemplateLiteral20(["borrowed time"]))));
    }
  }, {
    name: "Setup & Heal",
    completed: function() {
    ...
    effects: [$effect(_templateObject428 || (_templateObject428 = _taggedTemplateLiteral20(["Feeling Excited"]))), $effect(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral20(["Feeling Peaceful"]))), $effect(_templateObject445 || (_templateObject445 = _taggedTemplateLiteral20(["Inscrutable Gaze"]))), $effect(_templateObject455 || (_templateObject455 = _taggedTemplateLiteral20(["Spirit of Garlic"]))), $effect(_templateObject465 || (_templateObject465 = _taggedTemplateLiteral20(["Triple-Sized"]))), $effect(_templateObject475 || (_templateObject475 = _taggedTemplateLiteral20(["Uncucumbered"])))],
    outfit: defaultOutfit
  }, {
    name: "Use energy blobs",
    completed: function() {
      return !have($item(_templateObject485 || (_templateObject485 = _taggedTemplateLiteral20(["psychokinetic energy blob"])))) || ((0, import_kolmafia31.myMaxmp)() - (0, import_kolmafia31.myMp)()) / 30 < 1;
    },
    do: function() {
      var blob = $item(_templateObject495 || (_templateObject495 = _taggedTemplateLiteral20(["psychokinetic energy blob"])));
    ...
    completed: function() {
      return (0, import_kolmafia31.getWorkshed)() === $item(_templateObject505 || (_templateObject505 = _taggedTemplateLiteral20(["Little Geneticist DNA-Splicing Lab"])));
    },
    do: function() {
      return (0, import_kolmafia31.use)($item(_templateObject5110 || (_templateObject5110 = _taggedTemplateLiteral20(["Little Geneticist DNA-Splicing Lab"]))));
    }
  }, {
    name: "Reminisce pterodactyl",
    completed: function() {
      return monstersReminisced().includes($monster(_templateObject524 || (_templateObject524 = _taggedTemplateLiteral20(["pterodactyl"]))));
    },
    do: function() {
      return reminisce($monster(_templateObject533 || (_templateObject533 = _taggedTemplateLiteral20(["pterodactyl"]))));
    },
    post: function() {
      assert(monstersReminisced().includes($monster(_templateObject543 || (_templateObject543 = _taggedTemplateLiteral20(["pterodactyl"])))), "Failed to reminisce?");
    },
    outfit: {
      familiar: $familiar(_templateObject553 || (_templateObject553 = _taggedTemplateLiteral20(["Pair of Stomping Boots"])))
    },
    combat: RunawayCombat
  }, {
    name: "Ninja Costume",
    completed: function() {
      return have($item(_templateObject563 || (_templateObject563 = _taggedTemplateLiteral20(["li'l ninja costume"]))));
    },
    choices: {
      297: 3
    },
    do: function() {
      return mapMonster($location(_templateObject573 || (_templateObject573 = _taggedTemplateLiteral20(["The Haiku Dungeon"]))), $monster(_templateObject583 || (_templateObject583 = _taggedTemplateLiteral20(["amateur ninja"]))));
    },
    post: function() {
      return refreshGhost();
    },
    outfit: function() {
      return _objectSpread6(_objectSpread6({
        back: $item(_templateObject593 || (_templateObject593 = _taggedTemplateLiteral20(["protonic accelerator pack"]))),
        shirt: $item(_templateObject603 || (_templateObject603 = _taggedTemplateLiteral20(["Jurassic Parka"])))
    ...
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject6110 || (_templateObject6110 = _taggedTemplateLiteral20(["Feel Nostalgic"])))).skill($skill(_templateObject624 || (_templateObject624 = _taggedTemplateLiteral20(["Sing Along"])))).skill($skill(_templateObject633 || (_templateObject633 = _taggedTemplateLiteral20(["Spit jurassic acid"])))), $monster(_templateObject643 || (_templateObject643 = _taggedTemplateLiteral20(["amateur ninja"])))).macro(Macro.abort())
  }, {
    ...
    post: function() {
      ...
      (0, import_kolmafia31.equip)($slot(_templateObject653 || (_templateObject653 = _taggedTemplateLiteral20(["familiar"]))), $item(_templateObject663 || (_templateObject663 = _taggedTemplateLiteral20(["none"]))));
    },
    outfit: {
      back: $item(_templateObject673 || (_templateObject673 = _taggedTemplateLiteral20(["protonic accelerator pack"]))),
      familiar: $familiar(_templateObject683 || (_templateObject683 = _taggedTemplateLiteral20(["Stocking Mimic"]))),
      famequip: $item(_templateObject693 || (_templateObject693 = _taggedTemplateLiteral20(["none"])))
    },
    combat: DefaultCombat
  }, {
    name: "Get Crimbo Shrub decorations",
    completed: function() {
      return have($item(_templateObject703 || (_templateObject703 = _taggedTemplateLiteral20(["box of old Crimbo decorations"]))));
    },
    do: function() {
      return (0, import_kolmafia31.useFamiliar)($familiar(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral20(["Crimbo Shrub"]))));
    }
  }, {
    ...
    completed: function() {
      return DNALab_exports.isHybridized() || get("_saberForceUses") > 0 || monstersReminisced().includes($monster(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral20(["cocktail shrimp"]))));
    },
    do: function() {
      return reminisce($monster(_templateObject733 || (_templateObject733 = _taggedTemplateLiteral20(["cocktail shrimp"]))));
    },
    post: function() {
      return DNALab_exports.hybridize();
    },
    outfit: {
      weapon: $item(_templateObject743 || (_templateObject743 = _taggedTemplateLiteral20(["Fourth of May Cosplay Saber"]))),
      familiar: $familiar(_templateObject753 || (_templateObject753 = _taggedTemplateLiteral20(["Crimbo Shrub"])))
    },
    combat: new CombatStrategy().ccs(
      "item ".concat($item(_templateObject763 || (_templateObject763 = _taggedTemplateLiteral20(["DNA extraction syringe"]))), "\n          skill ").concat($skill(_templateObject773 || (_templateObject773 = _taggedTemplateLiteral20(["Open a Big Red Present"]))), "\n          twiddle your thumbs\n          skill ").concat($skill(_templateObject783 || (_templateObject783 = _taggedTemplateLiteral20(["Use the Force"])))),
      $monster(_templateObject793 || (_templateObject793 = _taggedTemplateLiteral20(["cocktail shrimp"])))
    ).macro(Macro.abort())
  }, {
    name: "Sausage Goblin",
    completed: function() {
    ...
    outfit: function() {
      return _objectSpread6(_objectSpread6({
        back: $item(_templateObject819 || (_templateObject819 = _taggedTemplateLiteral20(["unwrapped knock-off retro superhero cape"]))),
        offhand: $item(_templateObject824 || (_templateObject824 = _taggedTemplateLiteral20(["Kramco Sausage-o-Matic\u2122"])))
      }, selectBestFamiliar()), {}, {
        modes: {
    ...
    do: $location(_templateObject833 || (_templateObject833 = _taggedTemplateLiteral20(["Noob Cave"]))),
    post: function() {
    ...
    outfit: function() {
      return _objectSpread6({
        ...
        acc3: $item(_templateObject843 || (_templateObject843 = _taggedTemplateLiteral20(['"I Voted!" sticker'])))
      }, selectBestFamiliar());
    },
    combat: DefaultCombat
  }, {
    ...
    do: function() {
      return AutumnAton_exports.sendTo($location(_templateObject853 || (_templateObject853 = _taggedTemplateLiteral20(["The Sleazy Back Alley"]))));
    }
  }, {
    name: "Coil Wire",
    completed: function() {
    ...
    effects: [$effect(_templateObject863 || (_templateObject863 = _taggedTemplateLiteral20(["[1458]Blood Sugar Sauce Magic"])))],
    outfit: {
      hat: $item(_templateObject873 || (_templateObject873 = _taggedTemplateLiteral20(["Iunion Crown"]))),
      back: $item(_templateObject883 || (_templateObject883 = _taggedTemplateLiteral20(["unwrapped knock-off retro superhero cape"]))),
      shirt: $item(_templateObject893 || (_templateObject893 = _taggedTemplateLiteral20(["Jurassic Parka"]))),
      weapon: $item(_templateObject903 || (_templateObject903 = _taggedTemplateLiteral20(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject917 || (_templateObject917 = _taggedTemplateLiteral20(["wrench, industrial fire extinguisher"]))),
      pants: $item(_templateObject923 || (_templateObject923 = _taggedTemplateLiteral20(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject933 || (_templateObject933 = _taggedTemplateLiteral20(["hewn moon-rune spoon"]))),
      acc2: $item(_templateObject943 || (_templateObject943 = _taggedTemplateLiteral20(["Retrospecs"]))),
      acc3: $item(_templateObject953 || (_templateObject953 = _taggedTemplateLiteral20(["Kremlin's Greatest Briefcase"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["heck", "thrill"]
      }
...
var DonateQuest = {
  ...
  tasks: [{
    name: "Grab Comic",
    ready: function() {
      return (0, import_kolmafia32.storageAmount)($item(_templateObject200 || (_templateObject200 = _taggedTemplateLiteral22(["Batfellow comic"])))) > 0;
    },
    completed: function() {
    ...
    outfit: function() {
      ...
      (0, import_kolmafia32.equip)(stillFam, $item(_templateObject919 || (_templateObject919 = _taggedTemplateLiteral22(["tiny stillsuit"]))));
...
var FamiliarWeightQuest = {
  ...
  tasks: [{
    ...
    completed: function() {
      return have($effect(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral23(["Meteor Showered"]))));
    },
    prepare: function() {
    ...
    outfit: {
      weapon: $item(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral23(["Fourth of May Cosplay Saber"]))),
      familiar: $familiar(_templateObject726 || (_templateObject726 = _taggedTemplateLiteral23(["Machine Elf"])))
    },
    combat: new CombatStrategy().ccs("skill ".concat($skill(_templateObject825 || (_templateObject825 = _taggedTemplateLiteral23(["Meteor Shower"]))), "\n        twiddle your thumbs\n        skill ").concat($skill(_templateObject920 || (_templateObject920 = _taggedTemplateLiteral23(["Use the Force"])))), $monster(_templateObject1017 || (_templateObject1017 = _taggedTemplateLiteral23(["toothless mastiff bitch"])))).macro(Macro.abort())
  }, {
    ...
    prepare: function() {
      ...
      if (needMore() && haveUnused($item(_templateObject1115 || (_templateObject1115 = _taggedTemplateLiteral23(["resolution: be kinder"]))))) {
        (0, import_kolmafia33.use)($item(_templateObject1215 || (_templateObject1215 = _taggedTemplateLiteral23(["resolution: be kinder"]))));
      }
      if (needMore() && haveUnused($item(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral23(["green candy heart"])))))
        (0, import_kolmafia33.use)($item(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral23(["green candy heart"]))));
      var librams = [[4, $item(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral23(["love song of icy revenge"])))], [5, $item(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral23(["pulled blue taffy"])))]];
      ...
      if (needMore()) {
        acquireEffect($effect(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral23(["Ode to Booze"]))));
        (0, import_kolmafia33.drink)($item(_templateObject1811 || (_templateObject1811 = _taggedTemplateLiteral23(["1950 Vampire Vintner wine"]))));
      }
      tuneMoon(MoonSign.Platypus);
      if (needMore() && have($item(_templateObject1911 || (_templateObject1911 = _taggedTemplateLiteral23(["abstraction: joy"])))))
    ...
    effects: [$effect(_templateObject2311 || (_templateObject2311 = _taggedTemplateLiteral23(["A Girl Named Sue"]))), $effect(_templateObject2411 || (_templateObject2411 = _taggedTemplateLiteral23(["All Is Forgiven"]))), $effect(_templateObject2511 || (_templateObject2511 = _taggedTemplateLiteral23(["Billiards Belligerence"]))), $effect(_templateObject2610 || (_templateObject2610 = _taggedTemplateLiteral23(["Blood Bond"]))), $effect(_templateObject2710 || (_templateObject2710 = _taggedTemplateLiteral23(["Do I Know You From Somewhere?"]))), $effect(_templateObject288 || (_templateObject288 = _taggedTemplateLiteral23(["Empathy"]))), $effect(_templateObject298 || (_templateObject298 = _taggedTemplateLiteral23(["Fidoxene"]))), $effect(_templateObject308 || (_templateObject308 = _taggedTemplateLiteral23(["Human-Machine Hybrid"]))), $effect(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral23(["Human-Fish Hybrid"]))), $effect(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral23(["Leash of Linguini"]))), $effect(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral23(["Loyal Tea"]))), $effect(_templateObject347 || (_templateObject347 = _taggedTemplateLiteral23(["Man's Worst Enemy"]))), $effect(_templateObject357 || (_templateObject357 = _taggedTemplateLiteral23(["Meteor Showered"]))), $effect(_templateObject366 || (_templateObject366 = _taggedTemplateLiteral23(["Open Heart Surgery"]))), $effect(_templateObject376 || (_templateObject376 = _taggedTemplateLiteral23(["Over-Familiar With Dactyls"]))), $effect(_templateObject386 || (_templateObject386 = _taggedTemplateLiteral23(["Puzzle Champ"]))), $effect(_templateObject396 || (_templateObject396 = _taggedTemplateLiteral23(["Robot Friends"]))), $effect(_templateObject406 || (_templateObject406 = _taggedTemplateLiteral23(["Shortly Stacked"]))), $effect(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral23(["Shrimpin' Ain't Easy"]))), $effect(_templateObject4210 || (_templateObject4210 = _taggedTemplateLiteral23(["Whole Latte Love"]))), $effect(_templateObject436 || (_templateObject436 = _taggedTemplateLiteral23(["You Can Really Taste the Dormouse"])))],
    outfit: {
      hat: $item(_templateObject446 || (_templateObject446 = _taggedTemplateLiteral23(["Daylight Shavings Helmet"]))),
      weapon: $item(_templateObject456 || (_templateObject456 = _taggedTemplateLiteral23(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral23(["burning paper crane, rope, familiar scrapbook"]))),
      acc1: $item(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral23(["Brutal brogues"]))),
      acc2: $item(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral23(["hewn moon-rune spoon"]))),
      acc3: $item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral23(["Beach Comb"]))),
      famequip: $item(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral23(["overloaded Yule battery"]))),
      familiar: $familiar(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral23(["Mini-Trainbot"])))
    }
  }]
};
...
var HotResistQuest = {
  ...
  tasks: [{
    ...
    completed: function() {
      return have($effect(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral24(["Fireproof Foam Suit"]))));
    },
    ...
    outfit: {
      ...
      offhand: $item(_templateObject528 || (_templateObject528 = _taggedTemplateLiteral24(["industrial fire extinguisher"]))),
      familiar: $familiar(_templateObject628 || (_templateObject628 = _taggedTemplateLiteral24(["Machine Elf"])))
    },
    combat: new CombatStrategy().ccs("skill ".concat($skill(_templateObject727 || (_templateObject727 = _taggedTemplateLiteral24(["Fire Extinguisher: Foam Yourself"]))), "\n          twiddle your thumbs\n          skill ").concat($skill(_templateObject826 || (_templateObject826 = _taggedTemplateLiteral24(["Use the Force"])))), $monster(_templateObject921 || (_templateObject921 = _taggedTemplateLiteral24(["fluffy bunny"])))).macro(Macro.abort())
  }, {
    ...
    outfit: {
      hat: $item(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral24(["Daylight Shavings Helmet"]))),
      back: $item(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral24(["unwrapped knock-off retro superhero cape"]))),
...
var ItemDropQuest = {
  ...
  tasks: [{
    name: "Become a Bat",
    completed: function() {
      return have($effect(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral25(["Bat-Adjacent Form"]))));
    },
    do: $location(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral25(["The Dire Warren"]))),
    post: function() {
    ...
    outfit: {
      back: $item(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral25(["vampyric cloake"]))),
...
function levelingOutfit(cap, req) {
  ...
  return _objectSpread7(_objectSpread7({
    hat: $item(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral26(["Daylight Shavings Helmet"]))),
    back: $items(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral26(["LOV Epaulettes, unwrapped knock-off retro superhero cape"]))),
    ...
    weapon: $item(_templateObject530 || (_templateObject530 = _taggedTemplateLiteral26(["Fourth of May Cosplay Saber"]))),
    ...
    acc1: $item(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral26(["hewn moon-rune spoon"]))),
...
function lightweightOutfit() {
  return _objectSpread7(_objectSpread7({
    ...
    weapon: $item(_templateObject1616 || (_templateObject1616 = _taggedTemplateLiteral26(["June cleaver"]))),
    offhand: $item(_templateObject1716 || (_templateObject1716 = _taggedTemplateLiteral26(["unbreakable umbrella"]))),
...
var Leveling = {
  ...
  tasks: [{
    ...
    do: function() {
      (0, import_kolmafia34.equip)($slot(_templateObject704 || (_templateObject704 = _taggedTemplateLiteral26(["acc2"]))), $item(_templateObject7111 || (_templateObject7111 = _taggedTemplateLiteral26(["Powerful Glove"]))));
      acquireEffect($effect(_templateObject7210 || (_templateObject7210 = _taggedTemplateLiteral26(["Triple-Sized"]))));
    }
  }, {
    name: "Ten-percent Bonus",
    completed: function() {
      return !have($item(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral26(["a ten-percent bonus"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject744 || (_templateObject744 = _taggedTemplateLiteral26(["a ten-percent bonus"]))));
    },
    effects: $effects(_templateObject754 || (_templateObject754 = _taggedTemplateLiteral26(["Inscrutable Gaze, Synthesis: Learning"]))),
    outfit: {
      offhand: $item(_templateObject764 || (_templateObject764 = _taggedTemplateLiteral26(["familiar scrapbook"])))
    }
  }, {
    name: "Chateau Rest",
    completed: function() {
    ...
    effects: $effects(_templateObject774 || (_templateObject774 = _taggedTemplateLiteral26(["Inscrutable Gaze, Synthesis: Learning"]))),
    outfit: {
      offhand: $item(_templateObject784 || (_templateObject784 = _taggedTemplateLiteral26(["familiar scrapbook"])))
    }
  }, {
    ...
    do: function() {
      (0, import_kolmafia34.create)(1, $item(_templateObject794 || (_templateObject794 = _taggedTemplateLiteral26(["magical sausage"]))));
      (0, import_kolmafia34.eat)(1, $item(_templateObject804 || (_templateObject804 = _taggedTemplateLiteral26(["magical sausage"]))));
    }
  }, {
    name: "Advance Clock",
    completed: function() {
    ...
    do: $location(_templateObject8110 || (_templateObject8110 = _taggedTemplateLiteral26(["Gingerbread Civic Center"]))),
    effects: $effects(_templateObject829 || (_templateObject829 = _taggedTemplateLiteral26(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral26(["Frumious Bandersnatch"])))
    },
    combat: new CombatStrategy().startingMacro(Macro.abort())
  }, {
    name: "Nanobrainy",
    completed: function() {
      return have($effect(_templateObject844 || (_templateObject844 = _taggedTemplateLiteral26(["Nanobrainy"]))));
    },
    do: $location(_templateObject854 || (_templateObject854 = _taggedTemplateLiteral26(["Gingerbread Upscale Retail District"]))),
    post: function() {
      return assert($effect(_templateObject864 || (_templateObject864 = _taggedTemplateLiteral26(["Nanobrainy"]))));
    },
    outfit: {
      offhand: $item(_templateObject874 || (_templateObject874 = _taggedTemplateLiteral26(["latte lovers member's mug"]))),
      familiar: $familiar(_templateObject884 || (_templateObject884 = _taggedTemplateLiteral26(["Nanorhino"])))
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject894 || (_templateObject894 = _taggedTemplateLiteral26(["Entangling Noodles"])))).trySkill($skill(_templateObject904 || (_templateObject904 = _taggedTemplateLiteral26(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral26(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject926 || (_templateObject926 = _taggedTemplateLiteral26(["Reflex Hammer"])))).trySkill($skill(_templateObject934 || (_templateObject934 = _taggedTemplateLiteral26(["Feel Hatred"])))).abort())
  }, {
    ...
    outfit: {
      pants: $item(_templateObject944 || (_templateObject944 = _taggedTemplateLiteral26(["designer sweatpants"])))
    }
  }, {
    ...
    effects: [
      $effect(_templateObject954 || (_templateObject954 = _taggedTemplateLiteral26(["A Girl Named Sue"]))),
      $effect(_templateObject963 || (_templateObject963 = _taggedTemplateLiteral26(["Billiards Belligerence"]))),
      $effect(_templateObject973 || (_templateObject973 = _taggedTemplateLiteral26(["Fidoxene"]))),
      $effect(_templateObject983 || (_templateObject983 = _taggedTemplateLiteral26(["Loyal Tea"]))),
      $effect(_templateObject993 || (_templateObject993 = _taggedTemplateLiteral26(["Over-Familiar With Dactyls"]))),
      $effect(_templateObject1003 || (_templateObject1003 = _taggedTemplateLiteral26(["Puzzle Champ"]))),
      $effect(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral26(["Shrimpin' Ain't Easy"]))),
      $effect(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral26(["You Can Really Taste the Dormouse"]))),
      $effect(_templateObject1033 || (_templateObject1033 = _taggedTemplateLiteral26(["Blood Bond"]))),
      $effect(_templateObject1043 || (_templateObject1043 = _taggedTemplateLiteral26(["Empathy"]))),
      $effect(_templateObject1053 || (_templateObject1053 = _taggedTemplateLiteral26(["Leash of Linguini"])))
    ]
  }, {
    name: "Wish Effects",
    completed: function() {
      return $effects(_templateObject1063 || (_templateObject1063 = _taggedTemplateLiteral26(["All Is Forgiven, Sparkly!, Witch Breaded"]))).every(function(e) {
        return have(e);
      });
    },
    do: function() {
      return $effects(_templateObject1073 || (_templateObject1073 = _taggedTemplateLiteral26(["All Is Forgiven, Sparkly!, Witch Breaded"]))).forEach(wishEffect);
    }
  }, {
    name: "Crimbo Carol",
    completed: function() {
      return [$effect(_templateObject1083 || (_templateObject1083 = _taggedTemplateLiteral26(["All I Want For Crimbo Is Stuff"]))), $effect(_templateObject1093 || (_templateObject1093 = _taggedTemplateLiteral26(["Crimbo Wrapping"]))), $effect(_templateObject1102 || (_templateObject1102 = _taggedTemplateLiteral26(["Do You Crush What I Crush?"]))), $effect(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral26(["Holiday Yoked"]))), $effect(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral26(["Let It Snow/Boil/Stink/Frighten/Grease"])))].some(function(carol) {
        return have(carol);
      });
    },
    do: $location(_templateObject1133 || (_templateObject1133 = _taggedTemplateLiteral26(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject1143 || (_templateObject1143 = _taggedTemplateLiteral26(["Do You Crush What I Crush?"]))));
    },
    outfit: {
      back: $item(_templateObject1153 || (_templateObject1153 = _taggedTemplateLiteral26(["vampyric cloake"]))),
      acc3: $item(_templateObject1163 || (_templateObject1163 = _taggedTemplateLiteral26(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject1173 || (_templateObject1173 = _taggedTemplateLiteral26(["Ghost of Crimbo Carols"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill($skill(_templateObject1183 || (_templateObject1183 = _taggedTemplateLiteral26(["Giant Growth"])))).trySkill($skill(_templateObject1192 || (_templateObject1192 = _taggedTemplateLiteral26(["Become a Wolf"])))).trySkill($skill(_templateObject1202 || (_templateObject1202 = _taggedTemplateLiteral26(["Bowl Straight Up"])))).trySkill($skill(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral26(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject1223 || (_templateObject1223 = _taggedTemplateLiteral26(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject1233 || (_templateObject1233 = _taggedTemplateLiteral26(["Reflex Hammer"])))).trySkill($skill(_templateObject1243 || (_templateObject1243 = _taggedTemplateLiteral26(["Feel Hatred"])))).abort())
  }, {
    name: "Christmas Card",
    completed: function() {
      return haveItemOrEffect($item(_templateObject1253 || (_templateObject1253 = _taggedTemplateLiteral26(["Gene Tonic: Elf"])))) || get("_deckCardsSeen").includes("Christmas Card");
    },
    do: function() {
    ...
    post: function() {
      ...
      (0, import_kolmafia34.use)($item(_templateObject1263 || (_templateObject1263 = _taggedTemplateLiteral26(["Gene Tonic: Elf"]))));
      assert(get("_deckCardsSeen").includes("Christmas Card"), "Failed to record christmas card draw?");
    },
    effects: $effects(_templateObject1273 || (_templateObject1273 = _taggedTemplateLiteral26(["Inscrutable Gaze, Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject1283 || (_templateObject1283 = _taggedTemplateLiteral26(["Frumious Bandersnatch"])))
    },
    combat: new CombatStrategy().startingMacro(Macro.item($item(_templateObject1292 || (_templateObject1292 = _taggedTemplateLiteral26(["DNA extraction syringe"]))))).macro(Macro.skill($skill(_templateObject1302 || (_templateObject1302 = _taggedTemplateLiteral26(["Curse of Weaksauce"])))).skill($skill(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral26(["Micrometeorite"])))).item($item(_templateObject1323 || (_templateObject1323 = _taggedTemplateLiteral26(["Time-Spinner"])))).skill($skill(_templateObject1333 || (_templateObject1333 = _taggedTemplateLiteral26(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject1343 || (_templateObject1343 = _taggedTemplateLiteral26(["Saucestorm"]))))), Macro.skill($skill(_templateObject1353 || (_templateObject1353 = _taggedTemplateLiteral26(["Saucestorm"]))))).attack().repeat(), $monster(_templateObject1363 || (_templateObject1363 = _taggedTemplateLiteral26(["Black Crayon Crimbo Elf"])))).macro(Macro.runaway())
  }, {
    name: "Glitter",
    completed: function() {
      return have($effect(_templateObject1373 || (_templateObject1373 = _taggedTemplateLiteral26(["Glittering Eyelashes"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject1383 || (_templateObject1383 = _taggedTemplateLiteral26(["glittery mascara"]))));
    }
  }, {
    ...
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral26(["Feel Envy"])))).skill($skill(_templateObject1433 || (_templateObject1433 = _taggedTemplateLiteral26(["Sing Along"])))).attack(), $monster(_templateObject1443 || (_templateObject1443 = _taggedTemplateLiteral26(["goblin flapper"])))).macro(Macro.abort())
  }, {
    name: "Wanderer Sweep",
    completed: function() {
      return get("_speakeasyFreeFights") >= 3;
    },
    do: $location(_templateObject1453 || (_templateObject1453 = _taggedTemplateLiteral26(["An Unusually Quiet Barroom Brawl"]))),
    post: function() {
      return (0, import_kolmafia34.visitUrl)("place.php?whichplace=speakeasy");
    },
    outfit: function() {
    ...
    effects: [
      $effect(_templateObject1463 || (_templateObject1463 = _taggedTemplateLiteral26(["Broad-Spectrum Vaccine"]))),
      $effect(_templateObject1473 || (_templateObject1473 = _taggedTemplateLiteral26(["Favored by Lyle"]))),
      $effect(_templateObject1483 || (_templateObject1483 = _taggedTemplateLiteral26(["Grumpy and Ornery"]))),
      $effect(_templateObject1492 || (_templateObject1492 = _taggedTemplateLiteral26(["Hustlin'"]))),
      $effect(_templateObject1502 || (_templateObject1502 = _taggedTemplateLiteral26(["Mental A-cue-ity"]))),
      $effect(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral26(["Mystically Oiled"]))),
      $effect(_templateObject1523 || (_templateObject1523 = _taggedTemplateLiteral26(["Pisces in the Skyces"]))),
      $effect(_templateObject1533 || (_templateObject1533 = _taggedTemplateLiteral26(["Sigils of Yeg"]))),
      $effect(_templateObject1543 || (_templateObject1543 = _taggedTemplateLiteral26(["Starry-Eyed"]))),
      $effect(_templateObject1553 || (_templateObject1553 = _taggedTemplateLiteral26(["Total Protonic Reversal"]))),
      $effect(_templateObject1563 || (_templateObject1563 = _taggedTemplateLiteral26(["Warlock, Warstock, and Warbarrel"]))),
      $effect(_templateObject1573 || (_templateObject1573 = _taggedTemplateLiteral26(["items.enh"]))),
      $effect(_templateObject1583 || (_templateObject1583 = _taggedTemplateLiteral26(["meat.enh"]))),
      $effect(_templateObject1592 || (_templateObject1592 = _taggedTemplateLiteral26(["Cold as Nice"]))),
      $effect(_templateObject1602 || (_templateObject1602 = _taggedTemplateLiteral26(["A Brush with Grossness"]))),
      $effect(_templateObject1617 || (_templateObject1617 = _taggedTemplateLiteral26(["Do I Know You From Somewhere?"]))),
      $effect(_templateObject1623 || (_templateObject1623 = _taggedTemplateLiteral26(["Does It Have a Skull In There??"]))),
      $effect(_templateObject1633 || (_templateObject1633 = _taggedTemplateLiteral26(["Hot-Headed"]))),
      $effect(_templateObject1643 || (_templateObject1643 = _taggedTemplateLiteral26(["Lack of Body-Building"]))),
      $effect(_templateObject1653 || (_templateObject1653 = _taggedTemplateLiteral26(["Oiled, Slick"]))),
      $effect(_templateObject1663 || (_templateObject1663 = _taggedTemplateLiteral26(["Pomp & Circumsands"]))),
      $effect(_templateObject1673 || (_templateObject1673 = _taggedTemplateLiteral26(["Resting Beach Face"]))),
      $effect(_templateObject1683 || (_templateObject1683 = _taggedTemplateLiteral26(["We're All Made of Starfish"]))),
      $effect(_templateObject1692 || (_templateObject1692 = _taggedTemplateLiteral26(["You Learned Something Maybe!"]))),
      $effect(_templateObject1702 || (_templateObject1702 = _taggedTemplateLiteral26(["Big"]))),
      $effect(_templateObject1717 || (_templateObject1717 = _taggedTemplateLiteral26(["Blessing of the Bird"]))),
      $effect(_templateObject1723 || (_templateObject1723 = _taggedTemplateLiteral26(["Blessing of your favorite Bird"]))),
      $effect(_templateObject1733 || (_templateObject1733 = _taggedTemplateLiteral26(["Blood Bubble"]))),
      $effect(_templateObject1743 || (_templateObject1743 = _taggedTemplateLiteral26(["Carol of the Bulls"]))),
      $effect(_templateObject1753 || (_templateObject1753 = _taggedTemplateLiteral26(["Carol of the Hells"]))),
      $effect(_templateObject1763 || (_templateObject1763 = _taggedTemplateLiteral26(["Carol of the Thrills"]))),
      $effect(_templateObject1773 || (_templateObject1773 = _taggedTemplateLiteral26(["Feeling Excited"]))),
      $effect(_templateObject1782 || (_templateObject1782 = _taggedTemplateLiteral26(["Feeling Peaceful"]))),
      $effect(_templateObject1792 || (_templateObject1792 = _taggedTemplateLiteral26(["Frenzied, Bloody"]))),
      $effect(_templateObject1802 || (_templateObject1802 = _taggedTemplateLiteral26(["Inscrutable Gaze"]))),
      $effect(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral26(["Ruthlessly Efficient"]))),
      $effect(_templateObject1822 || (_templateObject1822 = _taggedTemplateLiteral26(["Singer's Faithful Ocelot"]))),
      $effect(_templateObject1832 || (_templateObject1832 = _taggedTemplateLiteral26(["Walberg's Dim Bulb"]))),
      $effect(_templateObject1842 || (_templateObject1842 = _taggedTemplateLiteral26(["Astral Shell"]))),
      $effect(_templateObject1852 || (_templateObject1852 = _taggedTemplateLiteral26(["Curiosity of Br'er Tarrypin"]))),
      $effect(_templateObject1862 || (_templateObject1862 = _taggedTemplateLiteral26(["Elemental Saucesphere"]))),
      $effect(_templateObject1872 || (_templateObject1872 = _taggedTemplateLiteral26(["Flimsy Shield of the Pastalord"]))),
      $effect(_templateObject1882 || (_templateObject1882 = _taggedTemplateLiteral26(["Ghostly Shell"]))),
      $effect(_templateObject1892 || (_templateObject1892 = _taggedTemplateLiteral26(["Sauce Monocle"]))),
      $effect(_templateObject1902 || (_templateObject1902 = _taggedTemplateLiteral26(["Springy Fusilli"]))),
      $effect(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral26(["Ode to Booze"]))),
      $effect(_templateObject1922 || (_templateObject1922 = _taggedTemplateLiteral26(["Polka of Plenty"]))),
      $effect(_templateObject1932 || (_templateObject1932 = _taggedTemplateLiteral26(["Stevedave's Shanty of Superiority"]))),
      $effect(_templateObject1942 || (_templateObject1942 = _taggedTemplateLiteral26(["Song of Sauce"])))
    ]
  }, {
    ...
    do: $location(_templateObject1952 || (_templateObject1952 = _taggedTemplateLiteral26(["The Tunnel of L.O.V.E."]))),
    post: function() {
      assert($effect(_templateObject1962 || (_templateObject1962 = _taggedTemplateLiteral26(["Open Heart Surgery"]))));
      $items(_templateObject1972 || (_templateObject1972 = _taggedTemplateLiteral26(["LOV Elixir #3, LOV Elixir #6, LOV Epaulettes"]))).forEach(function(l) {
        return assert(l);
      });
      (0, import_kolmafia34.use)($item(_templateObject1982 || (_templateObject1982 = _taggedTemplateLiteral26(["LOV Elixir #3"]))));
      (0, import_kolmafia34.use)($item(_templateObject1992 || (_templateObject1992 = _taggedTemplateLiteral26(["LOV Elixir #6"]))));
      (0, import_kolmafia34.use)($item(_templateObject2002 || (_templateObject2002 = _taggedTemplateLiteral26(["LOV Extraterrestrial Chocolate"]))));
    },
    outfit: function() {
    ...
    ready: function() {
      return get("camelSpit") >= 100 && get("lastCopyableMonster") !== $monster(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral26(["sausage goblin"]))) && !counter_exports.exists("portscan.edu");
    },
    completed: function() {
      return have($effect(_templateObject2022 || (_templateObject2022 = _taggedTemplateLiteral26(["Spit Upon"])))) || haveItemOrEffect($item(_templateObject2032 || (_templateObject2032 = _taggedTemplateLiteral26(["Gene Tonic: Pirate"]))));
    },
    do: $location(_templateObject2042 || (_templateObject2042 = _taggedTemplateLiteral26(["Pirates of the Garbage Barges"]))),
    post: function() {
      if (get("lastEncounter") === "Dead Men Smell No Tales")
        return;
      if (get("dnaSyringe") === $phylum(_templateObject2052 || (_templateObject2052 = _taggedTemplateLiteral26(["pirate"])))) {
        DNALab_exports.makeTonic();
      }
      assert($item(_templateObject2062 || (_templateObject2062 = _taggedTemplateLiteral26(["Gene Tonic: Pirate"]))));
      assert($effect(_templateObject2072 || (_templateObject2072 = _taggedTemplateLiteral26(["Spit Upon"]))));
    },
    effects: $effects(_templateObject2082 || (_templateObject2082 = _taggedTemplateLiteral26(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject2092 || (_templateObject2092 = _taggedTemplateLiteral26(["Melodramedary"]))),
      acc3: $item(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral26(["Kremlin's Greatest Briefcase"])))
    },
    combat: new CombatStrategy().macro(Macro.tryItem($item(_templateObject21110 || (_templateObject21110 = _taggedTemplateLiteral26(["DNA extraction syringe"])))).trySkill($skill(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral26(["%fn, spit on me!"])))).trySkill($skill(_templateObject2132 || (_templateObject2132 = _taggedTemplateLiteral26(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject2142 || (_templateObject2142 = _taggedTemplateLiteral26(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject2152 || (_templateObject2152 = _taggedTemplateLiteral26(["Reflex Hammer"])))).trySkill($skill(_templateObject2162 || (_templateObject2162 = _taggedTemplateLiteral26(["Feel Hatred"])))).abort(), $monsters(_templateObject2172 || (_templateObject2172 = _taggedTemplateLiteral26(["filthy pirate, fishy pirate, flashy pirate, funky pirate"])))).macro(Macro.abort())
  }, {
    name: "Witchess Rook",
    completed: function() {
      return haveItemOrEffect($item(_templateObject2182 || (_templateObject2182 = _taggedTemplateLiteral26(["Greek fire"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2192 || (_templateObject2192 = _taggedTemplateLiteral26(["Witchess Rook"]))));
    },
    post: function() {
      refreshGhost();
      (0, import_kolmafia34.use)($item(_templateObject2202 || (_templateObject2202 = _taggedTemplateLiteral26(["Greek fire"]))));
    },
    effects: [
      $effect(_templateObject2218 || (_templateObject2218 = _taggedTemplateLiteral26(["Drescher's Annoying Noise"]))),
      $effect(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral26(["Imported Strength"]))),
      $effect(_templateObject2232 || (_templateObject2232 = _taggedTemplateLiteral26(["Pride of the Puffin"]))),
      $effect(_templateObject2242 || (_templateObject2242 = _taggedTemplateLiteral26(["Ur-Kel's Aria of Annoyance"])))
    ],
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(600)), {}, {
        back: $item(_templateObject2252 || (_templateObject2252 = _taggedTemplateLiteral26(["protonic accelerator pack"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(void 0, AdvReq.NoAttack)), {}, {
        back: $item(_templateObject2262 || (_templateObject2262 = _taggedTemplateLiteral26(["protonic accelerator pack"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Get Sprinkles",
    completed: function() {
      return haveItemOrEffect($item(_templateObject2272 || (_templateObject2272 = _taggedTemplateLiteral26(["gingerbread spice latte"])))) || have($item(_templateObject2282 || (_templateObject2282 = _taggedTemplateLiteral26(["sprinkles"]))), 50);
    },
    prepare: function() {
    ...
    do: $location(_templateObject2292 || (_templateObject2292 = _taggedTemplateLiteral26(["Gingerbread Upscale Retail District"]))),
    post: function() {
      return assert(have($item(_templateObject2302 || (_templateObject2302 = _taggedTemplateLiteral26(["sprinkles"]))), 50), "Failed to get 50 sprinkles");
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e3)), {}, {
        hat: $item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral26(["Daylight Shavings Helmet"]))),
        weapon: $item(_templateObject2322 || (_templateObject2322 = _taggedTemplateLiteral26(["Fourth of May Cosplay Saber"]))),
        offhand: $items(_templateObject2332 || (_templateObject2332 = _taggedTemplateLiteral26(["burning paper crane, rope, familiar scrapbook"]))),
        acc1: $item(_templateObject2342 || (_templateObject2342 = _taggedTemplateLiteral26(["hewn moon-rune spoon"]))),
        acc2: $item(_templateObject2352 || (_templateObject2352 = _taggedTemplateLiteral26(["Brutal brogues"]))),
        acc3: $item(_templateObject2362 || (_templateObject2362 = _taggedTemplateLiteral26(["Beach Comb"]))),
        familiar: $familiar(_templateObject2372 || (_templateObject2372 = _taggedTemplateLiteral26(["Chocolate Lab"]))),
        famequip: $item(_templateObject2382 || (_templateObject2382 = _taggedTemplateLiteral26(["tiny stillsuit"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    ready: function() {
      return have($item(_templateObject2392 || (_templateObject2392 = _taggedTemplateLiteral26(["sprinkles"]))), 50);
    },
    completed: function() {
      return haveItemOrEffect($item(_templateObject2402 || (_templateObject2402 = _taggedTemplateLiteral26(["gingerbread spice latte"])))) || get("_gingerbreadCityTurns") >= 5;
    },
    choices: {
      1208: 3
    },
    do: $location(_templateObject2415 || (_templateObject2415 = _taggedTemplateLiteral26(["Gingerbread Upscale Retail District"]))),
    effects: $effects(_templateObject2422 || (_templateObject2422 = _taggedTemplateLiteral26(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject2432 || (_templateObject2432 = _taggedTemplateLiteral26(["Frumious Bandersnatch"])))
    },
    combat: RunawayCombat
  }, {
    name: "Snojo",
    ...
    prepare: function() {
      if (get("snojoSetting") !== $stat(_templateObject2442 || (_templateObject2442 = _taggedTemplateLiteral26(["Muscle"])))) {
        (0, import_kolmafia34.visitUrl)("place.php?whichplace=snojo&action=snojo_controller");
        (0, import_kolmafia34.runChoice)(1);
      }
    },
    do: $location(_templateObject2452 || (_templateObject2452 = _taggedTemplateLiteral26(["The X-32-F Combat Training Snowman"]))),
    post: function() {
      if (!haveItemOrEffect($item(_templateObject2462 || (_templateObject2462 = _taggedTemplateLiteral26(["Gene Tonic: Construct"])))))
        DNALab_exports.makeTonic();
    },
    outfit: function() {
      return levelingOutfit();
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.externalIf(!haveItemOrEffect($item(_templateObject2472 || (_templateObject2472 = _taggedTemplateLiteral26(["Gene Tonic: Construct"])))), Macro.item([$item(_templateObject2482 || (_templateObject2482 = _taggedTemplateLiteral26(["DNA extraction syringe"]))), $item(_templateObject2492 || (_templateObject2492 = _taggedTemplateLiteral26(["Time-Spinner"])))])).skill($skill(_templateObject2502 || (_templateObject2502 = _taggedTemplateLiteral26(["Sing Along"])))).attack().repeat();
    })
  }, {
    name: "Shadow Runaway",
    completed: function() {
      return config.RIFT.turnsSpent > 0;
    },
    do: config.RIFT,
    post: function() {
      return assert(config.RIFT.turnsSpent > 0, "Shadow Rift turns spent still 0?");
    },
    effects: $effects(_templateObject2515 || (_templateObject2515 = _taggedTemplateLiteral26(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject2522 || (_templateObject2522 = _taggedTemplateLiteral26(["Frumious Bandersnatch"])))
    },
    combat: RunawayCombat
  }, {
    ...
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject2532 || (_templateObject2532 = _taggedTemplateLiteral26(["closed-circuit pay phone"]))));
    },
    post: function() {
      assert($effect(_templateObject2542 || (_templateObject2542 = _taggedTemplateLiteral26(["Shadow Affinity"]))));
      assert(get("questRufus") !== "unstarted", "Failed to start Rufus quest?");
    }
  }, {
    name: "Shadow Monster",
    completed: function() {
      return (0, import_kolmafia34.haveEffect)($effect(_templateObject2552 || (_templateObject2552 = _taggedTemplateLiteral26(["Shadow Affinity"])))) <= 4;
    },
    do: config.RIFT,
    outfit: function() {
      return levelingOutfit();
    ...
    name: "BRICKOS",
    ready: function() {
      return have($item(_templateObject2562 || (_templateObject2562 = _taggedTemplateLiteral26(["BRICKO eye brick"])))) && have($item(_templateObject2572 || (_templateObject2572 = _taggedTemplateLiteral26(["BRICKO brick"]))), BRICKO_COST);
    },
    completed: function() {
    ...
    prepare: function() {
      return SourceTerminal_exports.educate($skill(_templateObject2582 || (_templateObject2582 = _taggedTemplateLiteral26(["Portscan"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject2592 || (_templateObject2592 = _taggedTemplateLiteral26(["Evoke Eldritch Horror"]))));
    },
    post: function() {
      ...
      if ((0, import_kolmafia34.myHp)() / (0, import_kolmafia34.myMaxhp)() < 0.5) {
        (0, import_kolmafia34.useSkill)($skill(_templateObject2602 || (_templateObject2602 = _taggedTemplateLiteral26(["Tongue of the Walrus"]))));
        (0, import_kolmafia34.useSkill)($skill(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral26(["Cannelloni Cocoon"]))));
      }
    },
    outfit: function() {
      return levelingOutfit(400);
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2622 || (_templateObject2622 = _taggedTemplateLiteral26(["Portscan"])))).skill($skill(_templateObject2632 || (_templateObject2632 = _taggedTemplateLiteral26(["Curse of Weaksauce"])))).item($item(_templateObject2642 || (_templateObject2642 = _taggedTemplateLiteral26(["Time-Spinner"])))).skill($skill(_templateObject2652 || (_templateObject2652 = _taggedTemplateLiteral26(["Micrometeorite"])))).skill($skill(_templateObject2662 || (_templateObject2662 = _taggedTemplateLiteral26(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2672 || (_templateObject2672 = _taggedTemplateLiteral26(["Saucestorm"]))))), Macro.skill($skill(_templateObject2682 || (_templateObject2682 = _taggedTemplateLiteral26(["Saucestorm"]))))).attack().repeat())
  }, {
    name: "God Lobster",
    completed: function() {
    ...
    choices: {
      1310: function() {
        return have($item(_templateObject2692 || (_templateObject2692 = _taggedTemplateLiteral26(["God Lobster's Ring"])))) ? 2 : 1;
      }
    },
    do: function() {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1500)), {}, {
        famequip: $items(_templateObject2702 || (_templateObject2702 = _taggedTemplateLiteral26(["God Lobster's Ring, God Lobster's Scepter, none"]))),
        familiar: $familiar(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral26(["God Lobster"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Shadow Agent",
    completed: function() {
      return (0, import_kolmafia34.haveEffect)($effect(_templateObject2722 || (_templateObject2722 = _taggedTemplateLiteral26(["Shadow Affinity"])))) <= 1;
    },
    prepare: function() {
      return (0, import_kolmafia34.print)("Have portscan? ".concat(SourceTerminal_exports.isCurrentSkill($skill(_templateObject2732 || (_templateObject2732 = _taggedTemplateLiteral26(["Portscan"]))))));
    },
    do: config.RIFT,
    outfit: function() {
      return levelingOutfit(1e4);
    },
    combat: new CombatStrategy().macro(Macro.if_("!haseffect ".concat($effect(_templateObject2742 || (_templateObject2742 = _taggedTemplateLiteral26(["Shadow Affinity"])))), Macro.abort()).trySkill($skill(_templateObject2752 || (_templateObject2752 = _taggedTemplateLiteral26(["Portscan"])))).skill($skill(_templateObject2762 || (_templateObject2762 = _taggedTemplateLiteral26(["Curse of Weaksauce"])))).item($item(_templateObject2772 || (_templateObject2772 = _taggedTemplateLiteral26(["Time-Spinner"])))).skill($skill(_templateObject2782 || (_templateObject2782 = _taggedTemplateLiteral26(["Micrometeorite"])))).skill($skill(_templateObject2792 || (_templateObject2792 = _taggedTemplateLiteral26(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2802 || (_templateObject2802 = _taggedTemplateLiteral26(["Saucestorm"]))))), Macro.skill($skill(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral26(["Saucestorm"]))))).attack().repeat(), $monster(_templateObject2822 || (_templateObject2822 = _taggedTemplateLiteral26(["Government agent"])))).macro(Macro.abort())
  }, {
    name: "Shadow Entity",
    completed: function() {
      return !have($effect(_templateObject2832 || (_templateObject2832 = _taggedTemplateLiteral26(["Shadow Affinity"]))));
    },
    prepare: topOffHp,
    do: config.RIFT,
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit()), {}, {
        familiar: $familiar(_templateObject2842 || (_templateObject2842 = _taggedTemplateLiteral26(["Machine Elf"]))),
        famequip: $item(_templateObject2852 || (_templateObject2852 = _taggedTemplateLiteral26(["tiny stillsuit"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Witchess Witch",
    completed: function() {
      return have($item(_templateObject2862 || (_templateObject2862 = _taggedTemplateLiteral26(["battle broom"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2872 || (_templateObject2872 = _taggedTemplateLiteral26(["Witchess Witch"]))));
    },
    post: function() {
      return (0, import_kolmafia34.equip)($item(_templateObject2882 || (_templateObject2882 = _taggedTemplateLiteral26(["battle broom"]))));
    },
    outfit: function() {
    ...
    name: "Witchess King",
    completed: function() {
      return have($item(_templateObject2892 || (_templateObject2892 = _taggedTemplateLiteral26(["dented scepter"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral26(["Witchess King"]))));
    },
    outfit: function() {
    ...
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral26(["Witchess Queen"]))));
    },
    outfit: function() {
    ...
    do: $location(_templateObject2922 || (_templateObject2922 = _taggedTemplateLiteral26(["The Deep Machine Tunnels"]))),
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        familiar: $familiar(_templateObject2932 || (_templateObject2932 = _taggedTemplateLiteral26(["Machine Elf"]))),
        famequip: $item(_templateObject2942 || (_templateObject2942 = _taggedTemplateLiteral26(["tiny stillsuit"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    do: $location(_templateObject2952 || (_templateObject2952 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      assert(get("_voteFreeFights") > 0, "Didn't increment vote counter?");
      if (have($effect(_templateObject2962 || (_templateObject2962 = _taggedTemplateLiteral26(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject2972 || (_templateObject2972 = _taggedTemplateLiteral26(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject2982 || (_templateObject2982 = _taggedTemplateLiteral26(['"I Voted!" sticker'])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    do: $location(_templateObject2992 || (_templateObject2992 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      if (have($effect(_templateObject300 || (_templateObject300 = _taggedTemplateLiteral26(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject301 || (_templateObject301 = _taggedTemplateLiteral26(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject3022 || (_templateObject3022 = _taggedTemplateLiteral26(["Lil' Doctor\u2122 bag"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    acquire: function() {
      return get("_shatteringPunchUsed") === 2 ? [{
        item: $item(_templateObject3032 || (_templateObject3032 = _taggedTemplateLiteral26(["makeshift garbage shirt"])))
      }] : [];
    },
    choices: {
      1467: 3,
    ...
    do: $location(_templateObject3042 || (_templateObject3042 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      if (have($effect(_templateObject3052 || (_templateObject3052 = _taggedTemplateLiteral26(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject3062 || (_templateObject3062 = _taggedTemplateLiteral26(["Tongue of the Walrus"]))));
    },
    outfit: function() {
    ...
    acquire: [{
      item: $item(_templateObject3072 || (_templateObject3072 = _taggedTemplateLiteral26(["makeshift garbage shirt"])))
    }],
    choices: {
      1467: 3,
      1468: 4,
    ...
    do: $location(_templateObject3082 || (_templateObject3082 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      if (have($effect(_templateObject3092 || (_templateObject3092 = _taggedTemplateLiteral26(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral26(["Tongue of the Walrus"]))));
    },
    outfit: function() {
      return lightweightOutfit();
    },
    ...
    acquire: [{
      item: $item(_templateObject3116 || (_templateObject3116 = _taggedTemplateLiteral26(["makeshift garbage shirt"])))
    }],
    prepare: function() {
      topOffHp();
      assert((0, import_kolmafia34.myAdventures)() > 1, "Can't cast relativity");
    },
    do: $location(_templateObject3122 || (_templateObject3122 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      return assert(get("_pocketProfessorLectures") > 0, "Failed to lecture?");
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        offhand: $item(_templateObject3132 || (_templateObject3132 = _taggedTemplateLiteral26(["Kramco Sausage-o-Matic\u2122"]))),
        familiar: $familiar(_templateObject3142 || (_templateObject3142 = _taggedTemplateLiteral26(["Pocket Professor"]))),
        famequip: $item(_templateObject3152 || (_templateObject3152 = _taggedTemplateLiteral26(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject3162 || (_templateObject3162 = _taggedTemplateLiteral26(["Curse of Weaksauce"])))).item($item(_templateObject3172 || (_templateObject3172 = _taggedTemplateLiteral26(["Time-Spinner"])))).skill($skill(_templateObject3182 || (_templateObject3182 = _taggedTemplateLiteral26(["Micrometeorite"])))).if_("hasskill ".concat((0, import_kolmafia34.toInt)($skill(_templateObject3192 || (_templateObject3192 = _taggedTemplateLiteral26(["lecture on relativity"]))))), Macro.skill($skill(_templateObject3202 || (_templateObject3202 = _taggedTemplateLiteral26(["lecture on relativity"])))).skill($skill(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral26(["Saucy Salve"]))))).skill($skill(_templateObject3222 || (_templateObject3222 = _taggedTemplateLiteral26(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject3232 || (_templateObject3232 = _taggedTemplateLiteral26(["Saucestorm"]))))), Macro.skill($skill(_templateObject3242 || (_templateObject3242 = _taggedTemplateLiteral26(["Saucestorm"]))))).attack().repeat())
  }, deepDarkVisions(), {
    name: "Backup Camera Fights",
    ready: function() {
      return get("lastCopyableMonster") === $monster(_templateObject3252 || (_templateObject3252 = _taggedTemplateLiteral26(["sausage goblin"])));
    },
    completed: function() {
      return get("_backUpUses") >= 7;
    },
    acquire: [{
      item: $item(_templateObject3262 || (_templateObject3262 = _taggedTemplateLiteral26(["makeshift garbage shirt"])))
    }],
    do: $location(_templateObject3272 || (_templateObject3272 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      return assert(get("lastCopyableMonster") === $monster(_templateObject3282 || (_templateObject3282 = _taggedTemplateLiteral26(["sausage goblin"]))), "Encountered a ".concat(get("lastCopyableMonster"), "?"));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        shirt: $item(_templateObject3292 || (_templateObject3292 = _taggedTemplateLiteral26(["makeshift garbage shirt"]))),
        acc3: $item(_templateObject3302 || (_templateObject3302 = _taggedTemplateLiteral26(["backup camera"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    ready: function() {
      return get("lastCopyableMonster") === $monster(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral26(["sausage goblin"])));
    },
    completed: function() {
      return get("_backUpUses") >= 11;
    },
    do: $location(_templateObject3322 || (_templateObject3322 = _taggedTemplateLiteral26(["The Toxic Teacups"]))),
    post: function() {
      return assert(get("lastCopyableMonster") === $monster(_templateObject3332 || (_templateObject3332 = _taggedTemplateLiteral26(["sausage goblin"]))), "Encountered a ".concat(get("lastCopyableMonster"), "?"));
    },
    effects: $effects(_templateObject3342 || (_templateObject3342 = _taggedTemplateLiteral26(["Spirit of Garlic, Wizard Squint"]))),
    outfit: function() {
    ...
    do: $location(_templateObject3352 || (_templateObject3352 = _taggedTemplateLiteral26(["The Neverending Party"]))),
    effects: $effects(_templateObject3362 || (_templateObject3362 = _taggedTemplateLiteral26(["Spirit of Garlic, Wizard Squint"]))),
    outfit: function() {
      return vintnerOutfit();
    },
    combat: StenchCombat
    ...
    do: $location(_templateObject3372 || (_templateObject3372 = _taggedTemplateLiteral26(["The Dire Warren"]))),
    effects: $effects(_templateObject3382 || (_templateObject3382 = _taggedTemplateLiteral26(["Ode to Booze"]))),
    outfit: {
      back: $item(_templateObject3392 || (_templateObject3392 = _taggedTemplateLiteral26(["unwrapped knock-off retro superhero cape"]))),
      shirt: $item(_templateObject3402 || (_templateObject3402 = _taggedTemplateLiteral26(["Jurassic Parka"]))),
      offhand: $item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral26(["latte lovers member's mug"]))),
      pants: $item(_templateObject3422 || (_templateObject3422 = _taggedTemplateLiteral26(["Cargo Cultist Shorts"]))),
      acc2: $items(_templateObject3432 || (_templateObject3432 = _taggedTemplateLiteral26(["battle broom"]))),
      acc3: $item(_templateObject3442 || (_templateObject3442 = _taggedTemplateLiteral26(['"I Voted!" sticker']))),
      familiar: $familiar(_templateObject3452 || (_templateObject3452 = _taggedTemplateLiteral26(["Frumious Bandersnatch"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["heck", "hold"]
      }
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.trySkill($skill(_templateObject3462 || (_templateObject3462 = _taggedTemplateLiteral26(["Gulp Latte"])))).externalIf(get("_latteRefillsUsed") < 2, Macro.trySkill($skill(_templateObject3472 || (_templateObject3472 = _taggedTemplateLiteral26(["Throw Latte on Opponent"]))))).runaway();
    })
  }]
};
...
var SpellDamageQuest = {
  ...
  tasks: [{
    ...
    completed: function() {
      return have($item(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral27(["cordial of concentration"]))));
    },
    do: function() {
    ...
    post: function() {
      return assert($item(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral27(["cordial of concentration"]))));
    }
    ...
    prepare: function() {
      var fax = $item(_templateObject531 || (_templateObject531 = _taggedTemplateLiteral27(["photocopied monster"])));
    ...
    post: function() {
      ...
      assert($effect(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral27(["Meteor Showered"]))));
    },
    outfit: {
...
var HPQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      ...
      shirt: $item(_templateObject535 || (_templateObject535 = _taggedTemplateLiteral28(["Jurassic Parka"]))),
...
var MuscleQuest = {
  ...
  tasks: [{
    ...
    acquire: [{
      item: $item(_templateObject1619 || (_templateObject1619 = _taggedTemplateLiteral28(["wad of used tape"])))
    }],
    effects: [$effect(_templateObject1719 || (_templateObject1719 = _taggedTemplateLiteral28(["Giant Growth"]))), $effect(_templateObject1817 || (_templateObject1817 = _taggedTemplateLiteral28(["Quiet Determination"]))), $effect(_templateObject1917 || (_templateObject1917 = _taggedTemplateLiteral28(["Rage of the Reindeer"])))],
    outfit: {
...
var MysticalityQuest = {
  ...
  tasks: [{
    ...
    effects: $effects(_templateObject2715 || (_templateObject2715 = _taggedTemplateLiteral28(["Nanobrainy, Quiet Judgement, Witch Breaded"]))),
    outfit: {
      hat: $item(_templateObject2813 || (_templateObject2813 = _taggedTemplateLiteral28(["wad of used tape"]))),
...
var WeaponDamageQuest = {
  ...
  tasks: [innerElf(), {
    ...
    outfit: {
      ...
      familiar: $familiar(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral29(["Machine Elf"])))
    },
...
function main() {
  ...
  if (!config.RIFT.toString().match(/Shadow Rift (\(The Right Side of the Tracks\)|\(The Nearby Plains\))/)) {
    (0, import_kolmafia37.print)("Bad shadow rift location: ".concat(config.RIFT));
    return;
  }
  if (config.prep) {
    prepareToAscend();
