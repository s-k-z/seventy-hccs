...
var notAllowList = [
  ...
  $monster(_templateObject816 || (_templateObject816 = _taggedTemplateLiteral16(["shadow devil"]))),
  ...
  $monster(_templateObject914 || (_templateObject914 = _taggedTemplateLiteral16(["Mother Slime"])))
].map(function(m) {
...
function mapMonster(location, monster) {
  ...
  if (!get("mappingMonsters"))
    (0, import_kolmafia28.useSkill)($skill(_templateObject1442 || (_templateObject1442 = _taggedTemplateLiteral16(["Map the Monsters"]))));
...
function topOffHp() {
  ...
  var restorers = /* @__PURE__ */ new Map([[$skill(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral25(["Cannelloni Cocoon"]))), 1e3], [$skill(_templateObject2611 || (_templateObject2611 = _taggedTemplateLiteral25(["Disco Nap"]))), 40], [$skill(_templateObject2711 || (_templateObject2711 = _taggedTemplateLiteral25(["Lasagna Bandages"]))), 20], [$skill(_templateObject289 || (_templateObject289 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))), 35]]);
  while ((0, import_kolmafia34.myHp)() < (0, import_kolmafia34.myMaxhp)()) {
    var best = Array.from(restorers).reduce(function(target, _ref) {
      var _ref2 = _slicedToArray15(_ref, 2), skill = _ref2[0], restores = _ref2[1];
      var rate = Math.min(delta, restores) / (0, import_kolmafia34.mpCost)(skill);
      if (rate > target[1])
        return [skill, rate];
      else
        return target;
    }, [$skill(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral25(["none"]))), 0])[0];
    if (best === $skill(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral25(["none"]))))
...
var Leveling = {
  ...
  tasks: [{
    ...
    completed: function() {
      return (0, import_kolmafia34.myMp)() - (0, import_kolmafia34.mpCost)($skill(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral25(["Summon BRICKOs"])))) < config.MP_SAFE_LIMIT;
    },
    do: function() {
    ...
    name: "Cast Soul Food",
    completed: function() {
      return (0, import_kolmafia34.mySoulsauce)() / (0, import_kolmafia34.soulsauceCost)($skill(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral25(["Soul Food"])))) < 1 || (0, import_kolmafia34.myMaxmp)() - (0, import_kolmafia34.myMp)() < 15;
    },
    do: function() {
      var maxMpGain = ((0, import_kolmafia34.myMaxmp)() - (0, import_kolmafia34.myMp)()) / 15;
      var maxSoulFoodCasts = (0, import_kolmafia34.mySoulsauce)() / (0, import_kolmafia34.soulsauceCost)($skill(_templateObject3311 || (_templateObject3311 = _taggedTemplateLiteral25(["Soul Food"]))));
      var soulFoodCasts = Math.floor(Math.min(maxMpGain, maxSoulFoodCasts));
      if (soulFoodCasts > 0)
        (0, import_kolmafia34.useSkill)(soulFoodCasts, $skill(_templateObject349 || (_templateObject349 = _taggedTemplateLiteral25(["Soul Food"]))));
    }
  }, {
    ...
    do: function() {
      ...
      (0, import_kolmafia34.create)(toEat, $item(_templateObject358 || (_templateObject358 = _taggedTemplateLiteral25(["magical sausage"]))));
      (0, import_kolmafia34.eat)(toEat, $item(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral25(["magical sausage"]))));
    }
  }, {
    name: "Remove Temporary Blindness",
    completed: function() {
      return !have($effect(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral25(["Temporary Blindness"]))));
    },
    prepare: function() {
    ...
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral25(["Cannelloni Cocoon"]))));
    }
  }, {
    name: "Make Burning Paper Crane",
    ready: function() {
      return have($item(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral25(["burning newspaper"]))));
    },
    completed: function() {
      return have($item(_templateObject407 || (_templateObject407 = _taggedTemplateLiteral25(["burning paper crane"]))));
    },
    do: function() {
      return (0, import_kolmafia34.create)($item(_templateObject4113 || (_templateObject4113 = _taggedTemplateLiteral25(["burning paper crane"]))));
    }
  }, {
    name: "Make candy knife",
    ready: function() {
      return (0, import_kolmafia34.myBasestat)($stat(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral25(["muscle"])))) >= 40;
    },
    completed: function() {
      return get("_discoKnife");
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral25(["That's Not a Knife"]))));
    }
  }, {
    ...
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject447 || (_templateObject447 = _taggedTemplateLiteral25(["Summon Alice's Army Cards"]))));
    }
  }, {
    name: "Ointment of the Occult",
    completed: function() {
      return have($item(_templateObject457 || (_templateObject457 = _taggedTemplateLiteral25(["ointment of the occult"]))));
    },
    do: function() {
      if (!have($item(_templateObject467 || (_templateObject467 = _taggedTemplateLiteral25(["grapefruit"]))))) {
        (0, import_kolmafia34.useSkill)($skill(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral25(["Prevent Scurvy and Sobriety"]))));
      }
      (0, import_kolmafia34.useSkill)($skill(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral25(["Advanced Saucecrafting"]))));
      (0, import_kolmafia34.create)($item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral25(["ointment of the occult"]))));
    }
  }, {
    name: "Summon Chubby and Plump Bar",
    completed: function() {
      return haveItemOrEffect($item(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral25(["Chubby and Plump bar"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral25(["Chubby and Plump"]))));
    }
  }, {
    name: "Use box of familiar jacks",
    completed: function() {
      return have($item(_templateObject5210 || (_templateObject5210 = _taggedTemplateLiteral25(["overloaded Yule battery"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral25(["box of Familiar Jacks"]))));
    },
    outfit: {
      familiar: $familiar(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral25(["Mini-Trainbot"])))
    }
  }, {
    name: "Open MayDay package",
    completed: function() {
      return have($effect(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral25(["Ready to Survive"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral25(["MayDay\u2122 supply package"]))));
    }
  }, {
    name: "Configure KGB",
    completed: function() {
    ...
    name: "Triple-Size",
    completed: function() {
      return have($effect(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral25(["Triple-Sized"]))));
    },
    do: function() {
      return acquireEffect($effect(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral25(["Triple-Sized"]))));
    },
    outfit: {
      acc2: $item(_templateObject595 || (_templateObject595 = _taggedTemplateLiteral25(["Powerful Glove"])))
    }
  }, {
    name: "Ten-percent Bonus",
    completed: function() {
      return !have($item(_templateObject605 || (_templateObject605 = _taggedTemplateLiteral25(["a ten-percent bonus"]))));
    },
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject6111 || (_templateObject6111 = _taggedTemplateLiteral25(["a ten-percent bonus"]))));
    },
    effects: $effects(_templateObject6210 || (_templateObject6210 = _taggedTemplateLiteral25(["Inscrutable Gaze"]))),
    outfit: {
      offhand: $item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral25(["familiar scrapbook"])))
    }
  }, {
    name: "Chateau Rest",
    completed: function() {
    ...
    effects: $effects(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral25(["Inscrutable Gaze"]))),
    outfit: {
      offhand: $item(_templateObject654 || (_templateObject654 = _taggedTemplateLiteral25(["familiar scrapbook"])))
    }
  }, {
    ...
    do: function() {
      spendAllMpOnLibrams();
      (0, import_kolmafia34.create)(1, $item(_templateObject664 || (_templateObject664 = _taggedTemplateLiteral25(["magical sausage"]))));
      (0, import_kolmafia34.eat)(1, $item(_templateObject674 || (_templateObject674 = _taggedTemplateLiteral25(["magical sausage"]))));
    ...
    do: $location(_templateObject684 || (_templateObject684 = _taggedTemplateLiteral25(["Gingerbread Civic Center"]))),
    effects: $effects(_templateObject694 || (_templateObject694 = _taggedTemplateLiteral25(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject704 || (_templateObject704 = _taggedTemplateLiteral25(["Frumious Bandersnatch"])))
    },
    combat: new CombatStrategy().macro(Macro.abort())
  }, {
    name: "Nanobrainy",
    completed: function() {
      return have($effect(_templateObject7111 || (_templateObject7111 = _taggedTemplateLiteral25(["Nanobrainy"]))));
    },
    do: $location(_templateObject7210 || (_templateObject7210 = _taggedTemplateLiteral25(["Gingerbread Upscale Retail District"]))),
    post: function() {
      return assert($effect(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral25(["Nanobrainy"]))));
    },
    outfit: {
      offhand: $item(_templateObject744 || (_templateObject744 = _taggedTemplateLiteral25(["latte lovers member's mug"]))),
      familiar: $familiar(_templateObject754 || (_templateObject754 = _taggedTemplateLiteral25(["Nanorhino"])))
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject764 || (_templateObject764 = _taggedTemplateLiteral25(["Entangling Noodles"])))).trySkill($skill(_templateObject774 || (_templateObject774 = _taggedTemplateLiteral25(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject784 || (_templateObject784 = _taggedTemplateLiteral25(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject794 || (_templateObject794 = _taggedTemplateLiteral25(["Reflex Hammer"])))).trySkill($skill(_templateObject804 || (_templateObject804 = _taggedTemplateLiteral25(["Feel Hatred"])))).abort())
  }, {
    ...
    outfit: {
      pants: $item(_templateObject8111 || (_templateObject8111 = _taggedTemplateLiteral25(["designer sweatpants"])))
    }
  }, {
    ...
    effects: [
      $effect(_templateObject829 || (_templateObject829 = _taggedTemplateLiteral25(["A Girl Named Sue"]))),
      $effect(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral25(["Billiards Belligerence"]))),
      $effect(_templateObject844 || (_templateObject844 = _taggedTemplateLiteral25(["Fidoxene"]))),
      $effect(_templateObject854 || (_templateObject854 = _taggedTemplateLiteral25(["Loyal Tea"]))),
      $effect(_templateObject864 || (_templateObject864 = _taggedTemplateLiteral25(["Puzzle Champ"]))),
      $effect(_templateObject874 || (_templateObject874 = _taggedTemplateLiteral25(["Shrimpin' Ain't Easy"]))),
      $effect(_templateObject884 || (_templateObject884 = _taggedTemplateLiteral25(["You Can Really Taste the Dormouse"]))),
      $effect(_templateObject894 || (_templateObject894 = _taggedTemplateLiteral25(["Blood Bond"]))),
      $effect(_templateObject904 || (_templateObject904 = _taggedTemplateLiteral25(["Empathy"]))),
      $effect(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral25(["Leash of Linguini"])))
    ]
  }, {
    name: "Wish Effects",
    completed: function() {
      return $effects(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral25(["[1701]Hip to the Jive, Sparkly!, Witch Breaded"]))).every(function(e) {
        return have(e);
      });
    },
    do: function() {
      return $effects(_templateObject934 || (_templateObject934 = _taggedTemplateLiteral25(["[1701]Hip to the Jive, Sparkly!, Witch Breaded"]))).forEach(wish);
    }
  }, {
    name: "Crimbo Carol",
    completed: function() {
      return [$effect(_templateObject944 || (_templateObject944 = _taggedTemplateLiteral25(["All I Want For Crimbo Is Stuff"]))), $effect(_templateObject954 || (_templateObject954 = _taggedTemplateLiteral25(["Crimbo Wrapping"]))), $effect(_templateObject964 || (_templateObject964 = _taggedTemplateLiteral25(["Do You Crush What I Crush?"]))), $effect(_templateObject974 || (_templateObject974 = _taggedTemplateLiteral25(["Holiday Yoked"]))), $effect(_templateObject984 || (_templateObject984 = _taggedTemplateLiteral25(["Let It Snow/Boil/Stink/Frighten/Grease"])))].some(function(carol) {
        return have(carol);
      });
    },
    do: $location(_templateObject994 || (_templateObject994 = _taggedTemplateLiteral25(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject1004 || (_templateObject1004 = _taggedTemplateLiteral25(["Do You Crush What I Crush?"]))));
    },
    outfit: {
      back: $item(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral25(["vampyric cloake"]))),
      acc3: $item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral25(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject1034 || (_templateObject1034 = _taggedTemplateLiteral25(["Ghost of Crimbo Carols"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill($skill(_templateObject1043 || (_templateObject1043 = _taggedTemplateLiteral25(["Giant Growth"])))).trySkill($skill(_templateObject1053 || (_templateObject1053 = _taggedTemplateLiteral25(["Become a Wolf"])))).trySkill($skill(_templateObject1063 || (_templateObject1063 = _taggedTemplateLiteral25(["Bowl Straight Up"])))).trySkill($skill(_templateObject1073 || (_templateObject1073 = _taggedTemplateLiteral25(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject1083 || (_templateObject1083 = _taggedTemplateLiteral25(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject1093 || (_templateObject1093 = _taggedTemplateLiteral25(["Reflex Hammer"])))).trySkill($skill(_templateObject1103 || (_templateObject1103 = _taggedTemplateLiteral25(["Feel Hatred"])))).abort())
  }, {
    name: "Christmas Card",
    completed: function() {
    ...
    completed: function() {
      return haveItemOrEffect($item(_templateObject1263 || (_templateObject1263 = _taggedTemplateLiteral25(["imported taffy"])))) || get("_speakeasyFreeFights") >= 3;
    },
    do: function() {
      return mapMonster($location(_templateObject1273 || (_templateObject1273 = _taggedTemplateLiteral25(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject1283 || (_templateObject1283 = _taggedTemplateLiteral25(["goblin flapper"]))));
    },
    post: function() {
    ...
    outfit: function() {
      ...
      if (wantOrb)
        outfit2.famequip = $item(_templateObject1323 || (_templateObject1323 = _taggedTemplateLiteral25(["miniature crystal ball"])));
      return outfit2;
    },
    combat: new CombatStrategy().macro(function() {
      return Macro.externalIf(!haveItemOrEffect($item(_templateObject1333 || (_templateObject1333 = _taggedTemplateLiteral25(["imported taffy"])))), Macro.skill($skill(_templateObject1343 || (_templateObject1343 = _taggedTemplateLiteral25(["Feel Envy"])))));
    }, $monster(_templateObject1353 || (_templateObject1353 = _taggedTemplateLiteral25(["goblin flapper"])))).macro(DefaultMacro),
    effects: [
      $effect(_templateObject1363 || (_templateObject1363 = _taggedTemplateLiteral25(["Broad-Spectrum Vaccine"]))),
      $effect(_templateObject1373 || (_templateObject1373 = _taggedTemplateLiteral25(["Favored by Lyle"]))),
      $effect(_templateObject1383 || (_templateObject1383 = _taggedTemplateLiteral25(["Grumpy and Ornery"]))),
      $effect(_templateObject1392 || (_templateObject1392 = _taggedTemplateLiteral25(["Mental A-cue-ity"]))),
      $effect(_templateObject1402 || (_templateObject1402 = _taggedTemplateLiteral25(["Mystically Oiled"]))),
      $effect(_templateObject1419 || (_templateObject1419 = _taggedTemplateLiteral25(["Pisces in the Skyces"]))),
      $effect(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral25(["Plump and Chubby"]))),
      $effect(_templateObject1433 || (_templateObject1433 = _taggedTemplateLiteral25(["Purity of Spirit"]))),
      $effect(_templateObject1443 || (_templateObject1443 = _taggedTemplateLiteral25(["Sigils of Yeg"]))),
      $effect(_templateObject1452 || (_templateObject1452 = _taggedTemplateLiteral25(["Starry-Eyed"]))),
      $effect(_templateObject1462 || (_templateObject1462 = _taggedTemplateLiteral25(["Total Protonic Reversal"]))),
      $effect(_templateObject1472 || (_templateObject1472 = _taggedTemplateLiteral25(["Warlock, Warstock, and Warbarrel"]))),
      $effect(_templateObject1482 || (_templateObject1482 = _taggedTemplateLiteral25(["items.enh"]))),
      $effect(_templateObject1492 || (_templateObject1492 = _taggedTemplateLiteral25(["meat.enh"]))),
      $effect(_templateObject1502 || (_templateObject1502 = _taggedTemplateLiteral25(["Cold as Nice"]))),
      $effect(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral25(["A Brush with Grossness"]))),
      $effect(_templateObject1522 || (_templateObject1522 = _taggedTemplateLiteral25(["Do I Know You From Somewhere?"]))),
      $effect(_templateObject1532 || (_templateObject1532 = _taggedTemplateLiteral25(["Does It Have a Skull In There??"]))),
      $effect(_templateObject1542 || (_templateObject1542 = _taggedTemplateLiteral25(["Hot-Headed"]))),
      $effect(_templateObject1552 || (_templateObject1552 = _taggedTemplateLiteral25(["Lack of Body-Building"]))),
      $effect(_templateObject1562 || (_templateObject1562 = _taggedTemplateLiteral25(["Oiled, Slick"]))),
      $effect(_templateObject1572 || (_templateObject1572 = _taggedTemplateLiteral25(["Pomp & Circumsands"]))),
      $effect(_templateObject1582 || (_templateObject1582 = _taggedTemplateLiteral25(["Resting Beach Face"]))),
      $effect(_templateObject1592 || (_templateObject1592 = _taggedTemplateLiteral25(["We're All Made of Starfish"]))),
      $effect(_templateObject1602 || (_templateObject1602 = _taggedTemplateLiteral25(["You Learned Something Maybe!"]))),
      $effect(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral25(["Big"]))),
      $effect(_templateObject1622 || (_templateObject1622 = _taggedTemplateLiteral25(["Blessing of the Bird"]))),
      $effect(_templateObject1632 || (_templateObject1632 = _taggedTemplateLiteral25(["Blessing of your favorite Bird"]))),
      $effect(_templateObject1642 || (_templateObject1642 = _taggedTemplateLiteral25(["Blood Bubble"]))),
      $effect(_templateObject1652 || (_templateObject1652 = _taggedTemplateLiteral25(["Carol of the Bulls"]))),
      $effect(_templateObject1662 || (_templateObject1662 = _taggedTemplateLiteral25(["Carol of the Hells"]))),
      $effect(_templateObject1672 || (_templateObject1672 = _taggedTemplateLiteral25(["Carol of the Thrills"]))),
      $effect(_templateObject1682 || (_templateObject1682 = _taggedTemplateLiteral25(["Feeling Excited"]))),
      $effect(_templateObject1692 || (_templateObject1692 = _taggedTemplateLiteral25(["Feeling Peaceful"]))),
      $effect(_templateObject1702 || (_templateObject1702 = _taggedTemplateLiteral25(["Frenzied, Bloody"]))),
      $effect(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral25(["Inscrutable Gaze"]))),
      $effect(_templateObject1722 || (_templateObject1722 = _taggedTemplateLiteral25(["Ruthlessly Efficient"]))),
      $effect(_templateObject1732 || (_templateObject1732 = _taggedTemplateLiteral25(["Singer's Faithful Ocelot"]))),
      $effect(_templateObject1742 || (_templateObject1742 = _taggedTemplateLiteral25(["Walberg's Dim Bulb"]))),
      $effect(_templateObject1752 || (_templateObject1752 = _taggedTemplateLiteral25(["Astral Shell"]))),
      $effect(_templateObject1762 || (_templateObject1762 = _taggedTemplateLiteral25(["Curiosity of Br'er Tarrypin"]))),
      $effect(_templateObject1772 || (_templateObject1772 = _taggedTemplateLiteral25(["Elemental Saucesphere"]))),
      $effect(_templateObject1782 || (_templateObject1782 = _taggedTemplateLiteral25(["Flimsy Shield of the Pastalord"]))),
      $effect(_templateObject1792 || (_templateObject1792 = _taggedTemplateLiteral25(["Ghostly Shell"]))),
      $effect(_templateObject1802 || (_templateObject1802 = _taggedTemplateLiteral25(["Sauce Monocle"]))),
      $effect(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral25(["Springy Fusilli"]))),
      $effect(_templateObject1822 || (_templateObject1822 = _taggedTemplateLiteral25(["AA-Charged"]))),
      $effect(_templateObject1832 || (_templateObject1832 = _taggedTemplateLiteral25(["AAA-Charged"]))),
      $effect(_templateObject1842 || (_templateObject1842 = _taggedTemplateLiteral25(["Ode to Booze"]))),
      $effect(_templateObject1852 || (_templateObject1852 = _taggedTemplateLiteral25(["Polka of Plenty"]))),
      $effect(_templateObject1862 || (_templateObject1862 = _taggedTemplateLiteral25(["Stevedave's Shanty of Superiority"]))),
      $effect(_templateObject1872 || (_templateObject1872 = _taggedTemplateLiteral25(["Song of Sauce"])))
    ]
  }, {
    ...
    do: $location(_templateObject1882 || (_templateObject1882 = _taggedTemplateLiteral25(["The Tunnel of L.O.V.E."]))),
    post: function() {
      assert($effect(_templateObject1892 || (_templateObject1892 = _taggedTemplateLiteral25(["Open Heart Surgery"]))));
      $items(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral25(["LOV Elixir #3, LOV Elixir #6, LOV Epaulettes"]))).forEach(function(l) {
        return assert(l);
      });
      (0, import_kolmafia34.use)($item(_templateObject191 || (_templateObject191 = _taggedTemplateLiteral25(["LOV Elixir #3"]))));
      (0, import_kolmafia34.use)($item(_templateObject1922 || (_templateObject1922 = _taggedTemplateLiteral25(["LOV Elixir #6"]))));
      (0, import_kolmafia34.use)($item(_templateObject1932 || (_templateObject1932 = _taggedTemplateLiteral25(["LOV Extraterrestrial Chocolate"]))));
    },
    outfit: function() {
    ...
    ready: function() {
      return get("camelSpit") >= 100 && get("lastCopyableMonster") !== $monster(_templateObject1942 || (_templateObject1942 = _taggedTemplateLiteral25(["sausage goblin"]))) && !counter_exports.exists("portscan.edu");
    },
    completed: function() {
      return have($effect(_templateObject1952 || (_templateObject1952 = _taggedTemplateLiteral25(["Spit Upon"])))) || haveItemOrEffect($item(_templateObject1962 || (_templateObject1962 = _taggedTemplateLiteral25(["Gene Tonic: Pirate"]))));
    },
    do: $location(_templateObject1972 || (_templateObject1972 = _taggedTemplateLiteral25(["Pirates of the Garbage Barges"]))),
    post: function() {
      if (get("lastEncounter") === "Dead Men Smell No Tales")
        return;
      if (get("dnaSyringe") === $phylum(_templateObject1982 || (_templateObject1982 = _taggedTemplateLiteral25(["pirate"])))) {
        DNALab_exports.makeTonic();
      }
      assert($item(_templateObject1992 || (_templateObject1992 = _taggedTemplateLiteral25(["Gene Tonic: Pirate"]))));
      assert($effect(_templateObject200 || (_templateObject200 = _taggedTemplateLiteral25(["Spit Upon"]))));
    },
    effects: $effects(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral25(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject2022 || (_templateObject2022 = _taggedTemplateLiteral25(["Melodramedary"]))),
      acc3: $item(_templateObject2032 || (_templateObject2032 = _taggedTemplateLiteral25(["Kremlin's Greatest Briefcase"])))
    },
    combat: new CombatStrategy().macro(Macro.tryItem($item(_templateObject2042 || (_templateObject2042 = _taggedTemplateLiteral25(["DNA extraction syringe"])))).trySkill($skill(_templateObject2052 || (_templateObject2052 = _taggedTemplateLiteral25(["%fn, spit on me!"])))).trySkill($skill(_templateObject2062 || (_templateObject2062 = _taggedTemplateLiteral25(["Throw Latte on Opponent"])))).trySkill($skill(_templateObject2072 || (_templateObject2072 = _taggedTemplateLiteral25(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject2082 || (_templateObject2082 = _taggedTemplateLiteral25(["Reflex Hammer"])))).trySkill($skill(_templateObject2092 || (_templateObject2092 = _taggedTemplateLiteral25(["Feel Hatred"])))).abort(), $monsters(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral25(["filthy pirate, fishy pirate, flashy pirate, funky pirate"])))).macro(Macro.abort())
  }, {
    name: "Witchess Rook",
    completed: function() {
      return haveItemOrEffect($item(_templateObject21110 || (_templateObject21110 = _taggedTemplateLiteral25(["Greek fire"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral25(["Witchess Rook"]))));
    },
    post: function() {
      (0, import_kolmafia34.use)($item(_templateObject2132 || (_templateObject2132 = _taggedTemplateLiteral25(["Greek fire"]))));
      (0, import_kolmafia34.visitUrl)("questlog.php?which=1");
      assert(!!get("ghostLocation"), "Failed to get protonic ghost notice");
    },
    effects: [
      $effect(_templateObject2142 || (_templateObject2142 = _taggedTemplateLiteral25(["Drescher's Annoying Noise"]))),
      $effect(_templateObject2152 || (_templateObject2152 = _taggedTemplateLiteral25(["Imported Strength"]))),
      $effect(_templateObject2162 || (_templateObject2162 = _taggedTemplateLiteral25(["Pride of the Puffin"]))),
      $effect(_templateObject2172 || (_templateObject2172 = _taggedTemplateLiteral25(["Ur-Kel's Aria of Annoyance"])))
    ],
    outfit: function() {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(void 0, AdvReq.NoAttack)), {}, {
        back: $item(_templateObject2192 || (_templateObject2192 = _taggedTemplateLiteral25(["protonic accelerator pack"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Get Sprinkles",
    completed: function() {
      return haveItemOrEffect($item(_templateObject2202 || (_templateObject2202 = _taggedTemplateLiteral25(["gingerbread spice latte"])))) || have($item(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral25(["sprinkles"]))), 50);
    },
    prepare: function() {
    ...
    do: $location(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral25(["Gingerbread Upscale Retail District"]))),
    post: function() {
      assert(have($item(_templateObject2232 || (_templateObject2232 = _taggedTemplateLiteral25(["sprinkles"]))), 50), "Failed to get 50 sprinkles");
      assert(get("_shatteringPunchUsed") === 1, "Didn't record shattering punch?");
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e3)), {}, {
        hat: $item(_templateObject2242 || (_templateObject2242 = _taggedTemplateLiteral25(["Daylight Shavings Helmet"]))),
        weapon: $item(_templateObject2252 || (_templateObject2252 = _taggedTemplateLiteral25(["Fourth of May Cosplay Saber"]))),
        offhand: $items(_templateObject2262 || (_templateObject2262 = _taggedTemplateLiteral25(["burning paper crane, rope, familiar scrapbook"]))),
        acc1: $item(_templateObject2272 || (_templateObject2272 = _taggedTemplateLiteral25(["hewn moon-rune spoon"]))),
        acc2: $item(_templateObject2282 || (_templateObject2282 = _taggedTemplateLiteral25(["Brutal brogues"]))),
        acc3: $item(_templateObject2292 || (_templateObject2292 = _taggedTemplateLiteral25(["Beach Comb"]))),
        familiar: $familiar(_templateObject2302 || (_templateObject2302 = _taggedTemplateLiteral25(["Chocolate Lab"]))),
        famequip: $item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2322 || (_templateObject2322 = _taggedTemplateLiteral25(["Sing Along"])))).if_("monsterid ".concat((0, import_kolmafia34.toInt)($monster(_templateObject2332 || (_templateObject2332 = _taggedTemplateLiteral25(["gingerbread gentrifier"]))))), Macro.trySkill($skill(_templateObject2342 || (_templateObject2342 = _taggedTemplateLiteral25(["Meteor Shower"]))))).trySkill($skill(_templateObject2352 || (_templateObject2352 = _taggedTemplateLiteral25(["Shattering Punch"])))).abort(), $monsters(_templateObject2362 || (_templateObject2362 = _taggedTemplateLiteral25(["gingerbread finance bro, gingerbread gentrifier, gingerbread tech bro"])))).macro(Macro.abort())
  }, {
    name: "Get Gingerbread Spice Latte",
    ready: function() {
      return have($item(_templateObject2372 || (_templateObject2372 = _taggedTemplateLiteral25(["sprinkles"]))), 50);
    },
    completed: function() {
      return haveItemOrEffect($item(_templateObject2382 || (_templateObject2382 = _taggedTemplateLiteral25(["gingerbread spice latte"])))) || get("_gingerbreadCityTurns") >= 5;
    },
    choices: {
      1208: 3
    },
    do: $location(_templateObject2392 || (_templateObject2392 = _taggedTemplateLiteral25(["Gingerbread Upscale Retail District"]))),
    effects: $effects(_templateObject2402 || (_templateObject2402 = _taggedTemplateLiteral25(["Ode to Booze"]))),
    outfit: {
      familiar: $familiar(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral25(["Frumious Bandersnatch"])))
    },
    combat: new CombatStrategy().macro(Macro.runaway())
  }, {
    name: "Snojo",
    ...
    prepare: function() {
      if (get("snojoSetting") !== $stat(_templateObject2422 || (_templateObject2422 = _taggedTemplateLiteral25(["Muscle"])))) {
        (0, import_kolmafia34.visitUrl)("place.php?whichplace=snojo&action=snojo_controller");
        (0, import_kolmafia34.runChoice)(1);
      }
    },
    do: $location(_templateObject2432 || (_templateObject2432 = _taggedTemplateLiteral25(["The X-32-F Combat Training Snowman"]))),
    post: function() {
      if (!haveItemOrEffect($item(_templateObject2442 || (_templateObject2442 = _taggedTemplateLiteral25(["Gene Tonic: Construct"])))))
        DNALab_exports.makeTonic();
    },
    outfit: function() {
      return levelingOutfit();
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.externalIf(!haveItemOrEffect($item(_templateObject2452 || (_templateObject2452 = _taggedTemplateLiteral25(["Gene Tonic: Construct"])))), Macro.item([$item(_templateObject2462 || (_templateObject2462 = _taggedTemplateLiteral25(["DNA extraction syringe"]))), $item(_templateObject2472 || (_templateObject2472 = _taggedTemplateLiteral25(["Time-Spinner"])))])).skill($skill(_templateObject2482 || (_templateObject2482 = _taggedTemplateLiteral25(["Sing Along"])))).attack().repeat();
    })
  }, {
    ...
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject2492 || (_templateObject2492 = _taggedTemplateLiteral25(["closed-circuit pay phone"]))));
    },
    post: function() {
      assert($effect(_templateObject2502 || (_templateObject2502 = _taggedTemplateLiteral25(["Shadow Affinity"]))));
      assert(get("questRufus") !== "unstarted", "Failed to start Rufus quest?");
    }
  }, {
    name: "Shadow Monster",
    completed: function() {
      return (0, import_kolmafia34.haveEffect)($effect(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral25(["Shadow Affinity"])))) <= 3;
    },
    do: $location(_templateObject2522 || (_templateObject2522 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    outfit: function() {
      return levelingOutfit();
    },
    combat: DefaultCombat
    ...
    do: function() {
      AutumnAton_exports.sendTo($location(_templateObject2532 || (_templateObject2532 = _taggedTemplateLiteral25(["Shadow Rift"]))));
    }
  }, {
    name: "BRICKOS",
    ready: function() {
      return have($item(_templateObject2542 || (_templateObject2542 = _taggedTemplateLiteral25(["BRICKO eye brick"])))) && have($item(_templateObject2552 || (_templateObject2552 = _taggedTemplateLiteral25(["BRICKO brick"]))), BRICKO_COST);
    },
    completed: function() {
    ...
    prepare: function() {
      return SourceTerminal_exports.educate($skill(_templateObject2562 || (_templateObject2562 = _taggedTemplateLiteral25(["Portscan"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject2572 || (_templateObject2572 = _taggedTemplateLiteral25(["Evoke Eldritch Horror"]))));
    },
    post: function() {
      if ((0, import_kolmafia34.myHp)() / (0, import_kolmafia34.myMaxhp)() < 0.5)
        (0, import_kolmafia34.useSkill)($skill(_templateObject2582 || (_templateObject2582 = _taggedTemplateLiteral25(["Cannelloni Cocoon"]))));
      assert(counter_exports.exists("portscan.edu"), "Failed to setup portscan?");
    },
    outfit: function() {
      return levelingOutfit(400);
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2592 || (_templateObject2592 = _taggedTemplateLiteral25(["Portscan"])))).skill($skill(_templateObject2602 || (_templateObject2602 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject2622 || (_templateObject2622 = _taggedTemplateLiteral25(["Micrometeorite"])))).skill($skill(_templateObject2632 || (_templateObject2632 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2642 || (_templateObject2642 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject2652 || (_templateObject2652 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    name: "God Lobster",
    completed: function() {
    ...
    choices: {
      1310: function() {
        return have($item(_templateObject2662 || (_templateObject2662 = _taggedTemplateLiteral25(["God Lobster's Ring"])))) ? 2 : 1;
      }
    },
    do: function() {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1500)), {}, {
        famequip: $items(_templateObject2672 || (_templateObject2672 = _taggedTemplateLiteral25(["God Lobster's Ring, God Lobster's Scepter, none"]))),
        familiar: $familiar(_templateObject2682 || (_templateObject2682 = _taggedTemplateLiteral25(["God Lobster"])))
      });
    },
    combat: DefaultCombat
  }, {
    name: "Shadow Agent",
    completed: function() {
      return !have($effect(_templateObject2692 || (_templateObject2692 = _taggedTemplateLiteral25(["Shadow Affinity"]))));
    },
    do: $location(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    outfit: function() {
      return levelingOutfit(1e4);
    },
    combat: new CombatStrategy().macro(Macro.if_("!haseffect ".concat($effect(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral25(["Shadow Affinity"])))), Macro.abort()).trySkill($skill(_templateObject2722 || (_templateObject2722 = _taggedTemplateLiteral25(["Portscan"])))).skill($skill(_templateObject2732 || (_templateObject2732 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject2742 || (_templateObject2742 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject2752 || (_templateObject2752 = _taggedTemplateLiteral25(["Micrometeorite"])))).skill($skill(_templateObject2762 || (_templateObject2762 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject2772 || (_templateObject2772 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject2782 || (_templateObject2782 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat(), $monster(_templateObject2792 || (_templateObject2792 = _taggedTemplateLiteral25(["Government agent"])))).macro(Macro.abort())
  }, {
    name: "Shadow Entity",
    completed: function() {
      return get("_shadowRiftCombats", 12) >= 12 || have($effect(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral25(["Inner Elf"]))));
    },
    prepare: topOffHp,
    do: $location(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral25(["Shadow Rift (The Right Side of the Tracks)"]))),
    post: function() {
      assert(get("_shadowRiftCombats", 12) >= 12, "Spent fewer shadow rift combats than expected?");
      assert($effect(_templateObject2822 || (_templateObject2822 = _taggedTemplateLiteral25(["Inner Elf"]))));
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit()), {}, {
        familiar: $familiar(_templateObject2832 || (_templateObject2832 = _taggedTemplateLiteral25(["Machine Elf"]))),
        famequip: $item(_templateObject2842 || (_templateObject2842 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject2852 || (_templateObject2852 = _taggedTemplateLiteral25(["Saucegeyser"])))), $monsters(_templateObject2862 || (_templateObject2862 = _taggedTemplateLiteral25(["shadow cauldron, shadow matrix, shadow scythe, shadow spire, shadow tongue"])))).macro(Macro.skill($skill(_templateObject2872 || (_templateObject2872 = _taggedTemplateLiteral25(["Northern Explosion"])))), $monster(_templateObject2882 || (_templateObject2882 = _taggedTemplateLiteral25(["shadow orrery"])))).macro(Macro.abort())
  }, {
    name: "Witchess Witch",
    completed: function() {
      return have($item(_templateObject2892 || (_templateObject2892 = _taggedTemplateLiteral25(["battle broom"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral25(["Witchess Witch"]))));
    },
    outfit: function() {
    ...
    name: "Witchess King",
    completed: function() {
      return have($item(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral25(["dented scepter"]))));
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2922 || (_templateObject2922 = _taggedTemplateLiteral25(["Witchess King"]))));
    },
    outfit: function() {
    ...
    acquire: [{
      item: $item(_templateObject2932 || (_templateObject2932 = _taggedTemplateLiteral25(["makeshift garbage shirt"])))
    }],
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2942 || (_templateObject2942 = _taggedTemplateLiteral25(["Witchess Queen"]))));
    },
    outfit: function() {
    ...
    do: $location(_templateObject2952 || (_templateObject2952 = _taggedTemplateLiteral25(["The Deep Machine Tunnels"]))),
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        familiar: $familiar(_templateObject2962 || (_templateObject2962 = _taggedTemplateLiteral25(["Machine Elf"]))),
        famequip: $item(_templateObject2972 || (_templateObject2972 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject3022 || (_templateObject3022 = _taggedTemplateLiteral25(['"I Voted!" sticker'])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, lightweightOutfit()), {}, {
        acc3: $item(_templateObject3072 || (_templateObject3072 = _taggedTemplateLiteral25(["Lil' Doctor\u2122 bag"])))
      });
    },
    combat: DefaultCombat
  }, {
    ...
    do: $location(_templateObject3082 || (_templateObject3082 = _taggedTemplateLiteral25(["The Toxic Teacups"]))),
    post: function() {
      if (have($effect(_templateObject3092 || (_templateObject3092 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
      assert($item(_templateObject3115 || (_templateObject3115 = _taggedTemplateLiteral25(["groveling gravel"]))));
    },
    outfit: function() {
    ...
    post: function() {
      ...
      assert($item(_templateObject3152 || (_templateObject3152 = _taggedTemplateLiteral25(["groveling gravel"]))));
    },
    outfit: function() {
      return lightweightOutfit();
    },
    ...
    completed: function() {
      return !have($item(_templateObject3162 || (_templateObject3162 = _taggedTemplateLiteral25(["groveling gravel"]))));
    },
    choices: {
      1467: 3,
      1468: 4,
    ...
    do: $location(_templateObject3172 || (_templateObject3172 = _taggedTemplateLiteral25(["The Toxic Teacups"]))),
    post: function() {
      if (have($effect(_templateObject3182 || (_templateObject3182 = _taggedTemplateLiteral25(["Beaten Up"])))))
        (0, import_kolmafia34.useSkill)($skill(_templateObject3192 || (_templateObject3192 = _taggedTemplateLiteral25(["Tongue of the Walrus"]))));
      ...
      assert(!have($item(_templateObject3202 || (_templateObject3202 = _taggedTemplateLiteral25(["groveling gravel"])))), "Still have groveling gravel");
    },
    outfit: function() {
      return lightweightOutfit();
    },
    ...
    prepare: topOffHp,
    do: $location(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral25(["The Toxic Teacups"]))),
    post: function() {
      return assert(get("_pocketProfessorLectures") > 0, "Failed to lecture?");
    },
    outfit: function() {
      return _objectSpread7(_objectSpread7({}, levelingOutfit(1e4)), {}, {
        offhand: $item(_templateObject3222 || (_templateObject3222 = _taggedTemplateLiteral25(["Kramco Sausage-o-Matic\u2122"]))),
        familiar: $familiar(_templateObject3232 || (_templateObject3232 = _taggedTemplateLiteral25(["Pocket Professor"]))),
        famequip: $item(_templateObject3242 || (_templateObject3242 = _taggedTemplateLiteral25(["tiny stillsuit"])))
      });
    },
    combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject3252 || (_templateObject3252 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).item($item(_templateObject3262 || (_templateObject3262 = _taggedTemplateLiteral25(["Time-Spinner"])))).skill($skill(_templateObject3272 || (_templateObject3272 = _taggedTemplateLiteral25(["Micrometeorite"])))).if_("hasskill ".concat((0, import_kolmafia34.toInt)($skill(_templateObject3282 || (_templateObject3282 = _taggedTemplateLiteral25(["lecture on relativity"]))))), Macro.skill($skill(_templateObject3292 || (_templateObject3292 = _taggedTemplateLiteral25(["lecture on relativity"])))).skill($skill(_templateObject3302 || (_templateObject3302 = _taggedTemplateLiteral25(["Saucy Salve"]))))).skill($skill(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject3322 || (_templateObject3322 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject3332 || (_templateObject3332 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    ...
    do: $location(_templateObject3342 || (_templateObject3342 = _taggedTemplateLiteral25(["The Neverending Party"]))),
    post: function() {
    ...
    combat: new CombatStrategy().startingMacro(Macro.if_(notAllowList, Macro.abort())).macro(Macro.externalIf(get("cosmicBowlingBallReturnCombats") > 1, Macro.trySkill($skill(_templateObject3352 || (_templateObject3352 = _taggedTemplateLiteral25(["Feel Pride"]))))).trySkill($skill(_templateObject3362 || (_templateObject3362 = _taggedTemplateLiteral25(["Bowl Sideways"])))).skill($skill(_templateObject3372 || (_templateObject3372 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).skill($skill(_templateObject3382 || (_templateObject3382 = _taggedTemplateLiteral25(["Sing Along"])))).while_("!mpbelow ".concat((0, import_kolmafia34.mpCost)($skill(_templateObject3392 || (_templateObject3392 = _taggedTemplateLiteral25(["Saucestorm"]))))), Macro.skill($skill(_templateObject3402 || (_templateObject3402 = _taggedTemplateLiteral25(["Saucestorm"]))))).attack().repeat())
  }, {
    name: "Drink Lattes",
    completed: function() {
    ...
    do: $location(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral25(["The Dire Warren"]))),
    effects: $effects(_templateObject3422 || (_templateObject3422 = _taggedTemplateLiteral25(["Ode to Booze"]))),
    outfit: {
      back: $item(_templateObject3432 || (_templateObject3432 = _taggedTemplateLiteral25(["unwrapped knock-off retro superhero cape"]))),
      shirt: $item(_templateObject3442 || (_templateObject3442 = _taggedTemplateLiteral25(["Jurassic Parka"]))),
      offhand: $item(_templateObject3452 || (_templateObject3452 = _taggedTemplateLiteral25(["latte lovers member's mug"]))),
      pants: $item(_templateObject3462 || (_templateObject3462 = _taggedTemplateLiteral25(["Cargo Cultist Shorts"]))),
      acc2: $items(_templateObject3472 || (_templateObject3472 = _taggedTemplateLiteral25(["battle broom"]))),
      acc3: $item(_templateObject3482 || (_templateObject3482 = _taggedTemplateLiteral25(['"I Voted!" sticker']))),
      familiar: $familiar(_templateObject3492 || (_templateObject3492 = _taggedTemplateLiteral25(["Frumious Bandersnatch"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["heck", "hold"]
      }
    ...
    combat: new CombatStrategy().macro(function() {
      return Macro.trySkill($skill(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral25(["Gulp Latte"])))).externalIf(get("_latteRefillsUsed") < 2, Macro.trySkill($skill(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral25(["Throw Latte on Opponent"]))))).runaway();
    })
  }]
};
...
function safeHpLimit() {
  var resist = 1 - (0, import_kolmafia35.elementalResistance)($element(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral26(["spooky"])))) / 100;
...
var SpellDamageQuest = {
  ...
  tasks: [{
    ...
    do: function() {
      return (0, import_kolmafia35.create)($item(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral26(["cordial of concentration"]))));
    },
    post: function() {
...
var HPQuest = {
  ...
  tasks: [{
    ...
    acquire: [{
      item: $item(_templateObject361 || (_templateObject361 = _taggedTemplateLiteral27(["wad of used tape"])))
    }],
    effects: $effects(_templateObject2101 || (_templateObject2101 = _taggedTemplateLiteral27(["Song of Starch"]))),
    outfit: {
      hat: $items(_templateObject370 || (_templateObject370 = _taggedTemplateLiteral27(["extra-wide head candle, wad of used tape"]))),
...
var MysticalityQuest = {
  ...
  tasks: [{
    ...
    effects: $effects(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral27(["Nanobrainy, Quiet Judgement, Witch Breaded"]))),
    outfit: {
...
var WeaponDamageQuest = {
  ...
  tasks: [innerElf(), {
    name: "Meteor Showered",
    completed: function() {
      return have($effect(_templateObject371 || (_templateObject371 = _taggedTemplateLiteral28(["Meteor Showered"]))));
    },
    do: $location(_templateObject2103 || (_templateObject2103 = _taggedTemplateLiteral28(["The Dire Warren"]))),
    post: function() {
      return assert($effect(_templateObject380 || (_templateObject380 = _taggedTemplateLiteral28(["Meteor Showered"]))));
    },
    outfit: {
    ...
    outfit: {
      ...
      acc1: $item(_templateObject3512 || (_templateObject3512 = _taggedTemplateLiteral28(["Powerful Glove"]))),
...
function main() {
  ...
  for (var _i = 0, _Object$entries = Object.entries(toCheck); _i < _Object$entries.length; _i++) {
    var _Object$entries$_i = _slicedToArray16(_Object$entries[_i], 2), key = _Object$entries$_i[0], val = _Object$entries$_i[1];
    if (val === "") {
