...
var Leveling = {
  ...
  tasks: [{
    ...
    effects: [
      ...
      $effect(_templateObject1442 || (_templateObject1442 = _taggedTemplateLiteral25(["You Can Really Taste the Dormouse"]))),
    ...
    prepare: function() {
      return SourceTerminal_exports.educate($skill(_templateObject2672 || (_templateObject2672 = _taggedTemplateLiteral25(["Turbo"]))));
    },
    ...
    outfit: function() {
      return {
        ...
        acc3: $item(_templateObject2702 || (_templateObject2702 = _taggedTemplateLiteral25(["Lil' Doctor\u2122 bag"]))),
        familiar: selectBestFamiliar(AdvReq.Toxic)
      };
    },
    combat: DefaultCombat
    ...
    acquire: [{
      item: $item(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral25(["makeshift garbage shirt"])))
    }],
