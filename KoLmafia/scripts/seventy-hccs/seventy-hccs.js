...
function acquireGumOrHermitItem(i) {
  ...
  if (source[0] === gum.name) {
    ...
    if ((0,external_kolmafia_.myMeat)() < 50) throw "Out of meat for chewing gums!!!";
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(lib_templateObject2 || (lib_templateObject2 = lib_taggedTemplateLiteral(["hermit permit"]))));
...
function checkFax(monster) {
  var id = $item(lib_templateObject3 || (lib_templateObject3 = lib_taggedTemplateLiteral(["photocopied monster"]))).descid;
...
var recipes = new Map([[(0,dist.$item)(diet_templateObject || (diet_templateObject = diet_taggedTemplateLiteral(["bugged balaclava"]))), () => {
...
}], [(0,dist.$item)(_templateObject14 || (_templateObject14 = diet_taggedTemplateLiteral(["hot buttered roll"]))), () => acquireGumOrHermitItem((0,dist.$item)(_templateObject15 || (_templateObject15 = diet_taggedTemplateLiteral(["hot buttered roll"]))))], [(0,dist.$item)(_templateObject16 || (_templateObject16 = diet_taggedTemplateLiteral(["perfect dark and stormy"]))), () => (0,external_kolmafia_.cliExecute)("make ".concat((0,dist.$item)(_templateObject17 || (_templateObject17 = diet_taggedTemplateLiteral(["perfect dark and stormy"])))))], [(0,dist.$item)(_templateObject18 || (_templateObject18 = diet_taggedTemplateLiteral(["ravioli hat"]))), () => acquireGumOrHermitItem((0,dist.$item)(_templateObject19 || (_templateObject19 = diet_taggedTemplateLiteral(["ravioli hat"]))))], [(0,dist.$item)(_templateObject20 || (_templateObject20 = diet_taggedTemplateLiteral(["useless powder"]))), () => {
  ...
  (0,external_kolmafia_.cliExecute)("pulverize ".concat((0,dist.$item)(_templateObject23 || (_templateObject23 = diet_taggedTemplateLiteral(["cool whip"])))));
}], [(0,dist.$item)(_templateObject24 || (_templateObject24 = diet_taggedTemplateLiteral(["wooden figurine"]))), () => acquireGumOrHermitItem((0,dist.$item)(_templateObject25 || (_templateObject25 = diet_taggedTemplateLiteral(["wooden figurine"]))))]]);
var diabolicPizzas = {
  1: {
    effect: (0,dist.$effect)(_templateObject26 || (_templateObject26 = diet_taggedTemplateLiteral(["Bureaucratized"]))),
    equip: (0,dist.$item)(_templateObject27 || (_templateObject27 = diet_taggedTemplateLiteral(["none"]))),
    // Don't equip the licorice boa
    familiar: (0,dist.$familiar)(_templateObject28 || (_templateObject28 = diet_taggedTemplateLiteral(["Peppermint Rhino"]))),
    ingredients: tuple((0,dist.$item)(_templateObject29 || (_templateObject29 = diet_taggedTemplateLiteral(["bugged balaclava"]))), (0,dist.$item)(_templateObject30 || (_templateObject30 = diet_taggedTemplateLiteral(["useless powder"]))), (0,dist.$item)(_templateObject31 || (_templateObject31 = diet_taggedTemplateLiteral(["ravioli hat"]))), (0,dist.$item)(_templateObject32 || (_templateObject32 = diet_taggedTemplateLiteral(["eyedrops of the ermine"]))))
  },
  2: {
    effect: (0,dist.$effect)(_templateObject33 || (_templateObject33 = diet_taggedTemplateLiteral(["Chorale of Companionship"]))),
    equip: (0,dist.$item)(_templateObject34 || (_templateObject34 = diet_taggedTemplateLiteral(["dromedary drinking helmet"]))),
    familiar: (0,dist.$familiar)(_templateObject35 || (_templateObject35 = diet_taggedTemplateLiteral(["Melodramedary"]))),
    ingredients: tuple((0,dist.$item)(_templateObject36 || (_templateObject36 = diet_taggedTemplateLiteral(["chiptune guitar"]))), (0,dist.$item)(_templateObject37 || (_templateObject37 = diet_taggedTemplateLiteral(["hot buttered roll"]))), (0,dist.$item)(_templateObject38 || (_templateObject38 = diet_taggedTemplateLiteral(["ointment of the occult"]))), (0,dist.$item)(_templateObject39 || (_templateObject39 = diet_taggedTemplateLiteral(["ravioli hat"]))))
  },
  3: {
    effect: (0,dist.$effect)(_templateObject40 || (_templateObject40 = diet_taggedTemplateLiteral(["Down With Chow"]))),
    equip: (0,dist.$item)(_templateObject41 || (_templateObject41 = diet_taggedTemplateLiteral(["Pocket Professor memory chip"]))),
    familiar: (0,dist.$familiar)(_templateObject42 || (_templateObject42 = diet_taggedTemplateLiteral(["Pocket Professor"]))),
    ingredients: tuple((0,dist.$item)(_templateObject43 || (_templateObject43 = diet_taggedTemplateLiteral(["dripping meat crossbow"]))), (0,dist.$item)(_templateObject44 || (_templateObject44 = diet_taggedTemplateLiteral(["ointment of the occult"]))), (0,dist.$item)(_templateObject45 || (_templateObject45 = diet_taggedTemplateLiteral(["wooden figurine"]))), (0,dist.$item)(_templateObject46 || (_templateObject46 = diet_taggedTemplateLiteral(["blood-faced volleyball"]))))
  },
  4: {
    effect: (0,dist.$effect)(_templateObject47 || (_templateObject47 = diet_taggedTemplateLiteral(["Optimist Primal"]))),
    equip: (0,dist.$item)(_templateObject48 || (_templateObject48 = diet_taggedTemplateLiteral(["cracker"]))),
    familiar: (0,dist.$familiar)(_templateObject49 || (_templateObject49 = diet_taggedTemplateLiteral(["Exotic Parrot"]))),
    ingredients: tuple((0,dist.$item)(_templateObject50 || (_templateObject50 = diet_taggedTemplateLiteral(["oil of expertise"]))), (0,dist.$item)(_templateObject51 || (_templateObject51 = diet_taggedTemplateLiteral(["perfect dark and stormy"]))), (0,dist.$item)(_templateObject52 || (_templateObject52 = diet_taggedTemplateLiteral(["blood-faced volleyball"]))), (0,dist.$item)(_templateObject53 || (_templateObject53 = diet_taggedTemplateLiteral(["cog and sprocket assembly"]))))
  }
};
function eatPizzas() {
  for (var _i = 0, _Object$values = Object.values(diabolicPizzas); _i < _Object$values.length; _i++) {
    ...
    if (!(0,dist.have)(pizza.effect)) {
      ...
      (0,external_kolmafia_.eat)((0,dist.$item)(_templateObject54 || (_templateObject54 = diet_taggedTemplateLiteral(["diabolic pizza"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(_templateObject55 || (_templateObject55 = diet_taggedTemplateLiteral(["familiar"]))), pizza.equip);
    }
  }
}
...
function cookPizza(a, b, c, d) {
  ...
  var _iterator2 = _createForOfIteratorHelper(counts),
      _step2;
...
var LOVEnforcer = (0,dist.$monster)(combat_templateObject4 || (combat_templateObject4 = combat_taggedTemplateLiteral(["LOV Enforcer"]))).id;
var LOVEngineer = (0,dist.$monster)(combat_templateObject5 || (combat_templateObject5 = combat_taggedTemplateLiteral(["LOV Engineer"]))).id;
var DMTSquareMon = (0,dist.$monster)(combat_templateObject6 || (combat_templateObject6 = combat_taggedTemplateLiteral(["Performer of Actions"]))).id;
var DMTCircleMon = (0,dist.$monster)(combat_templateObject7 || (combat_templateObject7 = combat_taggedTemplateLiteral(["Thinker of Thoughts"]))).id;
var retailDistrict = (0,external_kolmafia_.toUrl)((0,dist.$location)(combat_templateObject8 || (combat_templateObject8 = combat_taggedTemplateLiteral(["Gingerbread Upscale Retail District"])))).split("=")[1];
var EnvyNostalgia = new dist.Macro().trySkill((0,dist.$skill)(combat_templateObject9 || (combat_templateObject9 = combat_taggedTemplateLiteral(["Feel Envy"])))).trySkill((0,dist.$skill)(combat_templateObject10 || (combat_templateObject10 = combat_taggedTemplateLiteral(["Feel Nostalgic"]))));
var GhostMacro = new dist.Macro().skill((0,dist.$skill)(combat_templateObject11 || (combat_templateObject11 = combat_taggedTemplateLiteral(["Summon Love Gnats"])))) // kind of a hack but the plan is to always runaway before the second ghost
.if_("haseffect ".concat((0,external_kolmafia_.toInt)((0,dist.$effect)(combat_templateObject12 || (combat_templateObject12 = combat_taggedTemplateLiteral(["Ode to Booze"]))))), EnvyNostalgia).skill((0,dist.$skill)(combat_templateObject13 || (combat_templateObject13 = combat_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(combat_templateObject14 || (combat_templateObject14 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(combat_templateObject15 || (combat_templateObject15 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(combat_templateObject16 || (combat_templateObject16 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(combat_templateObject17 || (combat_templateObject17 = combat_taggedTemplateLiteral(["Trap Ghost"])))).abort();
var TryBanish = new dist.Macro() // Reserve Snokebomb for Mother Slime
.trySkill((0,dist.$skill)(combat_templateObject18 || (combat_templateObject18 = combat_taggedTemplateLiteral(["Throw Latte on Opponent"])))).trySkill((0,dist.$skill)(combat_templateObject19 || (combat_templateObject19 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).trySkill((0,dist.$skill)(combat_templateObject20 || (combat_templateObject20 = combat_taggedTemplateLiteral(["Reflex Hammer"])))).trySkill((0,dist.$skill)(combat_templateObject21 || (combat_templateObject21 = combat_taggedTemplateLiteral(["Feel Hatred"])))).abort();
...
.skill((0,dist.$skill)(combat_templateObject22 || (combat_templateObject22 = combat_taggedTemplateLiteral(["Macrometeorite"]))));
var FreeInstaKill = new dist.Macro().skill((0,dist.$skill)(combat_templateObject23 || (combat_templateObject23 = combat_taggedTemplateLiteral(["Sing Along"])))).trySkill((0,dist.$skill)(combat_templateObject24 || (combat_templateObject24 = combat_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill((0,dist.$skill)(combat_templateObject25 || (combat_templateObject25 = combat_taggedTemplateLiteral(["Shattering Punch"])))).trySkill((0,dist.$skill)(combat_templateObject26 || (combat_templateObject26 = combat_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort();
var CigKill = new dist.Macro().skill((0,dist.$skill)(combat_templateObject27 || (combat_templateObject27 = combat_taggedTemplateLiteral(["Sing Along"])))).tryItem((0,dist.$item)(combat_templateObject28 || (combat_templateObject28 = combat_taggedTemplateLiteral(["gingerbread cigarette"])))).abort();
var DefaultMacro = new dist.Macro().if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(combat_templateObject29 || (combat_templateObject29 = combat_taggedTemplateLiteral(["Shoot Ghost"]))))), GhostMacro).if_("monsterid ".concat(toxicBeastie), dist.Macro.trySkill((0,dist.$skill)(combat_templateObject30 || (combat_templateObject30 = combat_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).skill((0,dist.$skill)(combat_templateObject31 || (combat_templateObject31 = combat_taggedTemplateLiteral(["Summon Love Mosquito"]))))).if_("monsterid ".concat(amateurNinja, " || monsterid ").concat(toxicBeastie), FreeInstaKill).if_("snarfblat ".concat(retailDistrict), CigKill).trySkill((0,dist.$skill)(combat_templateObject32 || (combat_templateObject32 = combat_taggedTemplateLiteral(["Digitize"])))).trySkill((0,dist.$skill)(combat_templateObject33 || (combat_templateObject33 = combat_taggedTemplateLiteral(["%fn, spit on me!"])))).if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(combat_templateObject34 || (combat_templateObject34 = combat_taggedTemplateLiteral(["Turbo"]))))), dist.Macro.trySkill((0,dist.$skill)(combat_templateObject35 || (combat_templateObject35 = combat_taggedTemplateLiteral(["Feel Pride"]))))) // Turbo used a flag to cast pride
.skill((0,dist.$skill)(combat_templateObject36 || (combat_templateObject36 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(combat_templateObject37 || (combat_templateObject37 = combat_taggedTemplateLiteral(["Micrometeorite"])))).if_("!hascombatitem ".concat((0,external_kolmafia_.toInt)((0,dist.$item)(combat_templateObject38 || (combat_templateObject38 = combat_taggedTemplateLiteral(["blue rocket"]))))), dist.Macro.item((0,dist.$item)(combat_templateObject39 || (combat_templateObject39 = combat_taggedTemplateLiteral(["Time-Spinner"]))))).if_("hascombatitem ".concat((0,external_kolmafia_.toInt)((0,dist.$item)(combat_templateObject40 || (combat_templateObject40 = combat_taggedTemplateLiteral(["blue rocket"]))))), dist.Macro.item((0,dist.$item)(combat_templateObject41 || (combat_templateObject41 = combat_taggedTemplateLiteral(["Time-Spinner"]))), (0,dist.$item)(combat_templateObject42 || (combat_templateObject42 = combat_taggedTemplateLiteral(["blue rocket"]))))).if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(combat_templateObject43 || (combat_templateObject43 = combat_taggedTemplateLiteral(["lecture on relativity"]))))), dist.Macro.skill((0,dist.$skill)(combat_templateObject44 || (combat_templateObject44 = combat_taggedTemplateLiteral(["lecture on relativity"])))).skill((0,dist.$skill)(combat_templateObject45 || (combat_templateObject45 = combat_taggedTemplateLiteral(["Saucy Salve"]))))).skill((0,dist.$skill)(combat_templateObject46 || (combat_templateObject46 = combat_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(combat_templateObject47 || (combat_templateObject47 = combat_taggedTemplateLiteral(["Candyblast"])))).repeat();
var MacroList = {
  FreeFight: DefaultMacro,
  // Just runaway on its own causes a null pointer exception?
  Runaway: new dist.Macro().trySkill((0,dist.$skill)(combat_templateObject48 || (combat_templateObject48 = combat_taggedTemplateLiteral(["Saucy Salve"])))).step("runaway"),
  Banish: TryBanish,
  Nanobrainy: new dist.Macro().skill((0,dist.$skill)(combat_templateObject49 || (combat_templateObject49 = combat_taggedTemplateLiteral(["Entangling Noodles"])))).trySkill((0,dist.$skill)(combat_templateObject50 || (combat_templateObject50 = combat_taggedTemplateLiteral(["Giant Growth"])))).trySkill((0,dist.$skill)(combat_templateObject51 || (combat_templateObject51 = combat_taggedTemplateLiteral(["Become a Wolf"])))).step(TryBanish),
  Sprinkles: new dist.Macro().if_("monsterid ".concat(gentrifier), Replace).skill((0,dist.$skill)(combat_templateObject52 || (combat_templateObject52 = combat_taggedTemplateLiteral(["Meteor Shower"])))).step(FreeInstaKill),
  TropicalSkeleton: new dist.Macro().trySkill((0,dist.$skill)(combat_templateObject53 || (combat_templateObject53 = combat_taggedTemplateLiteral(["Open a Big Red Present"])))).skill((0,dist.$skill)(combat_templateObject54 || (combat_templateObject54 = combat_taggedTemplateLiteral(["Use the Force"])))),
  TunnelOfLOV: new dist.Macro().if_("monsterid ".concat(LOVEnforcer), dist.Macro.attack().repeat()).if_("monsterid ".concat(LOVEngineer), dist.Macro.skill((0,dist.$skill)(combat_templateObject55 || (combat_templateObject55 = combat_taggedTemplateLiteral(["Candyblast"])))).repeat()).step(DefaultMacro),
  WitchessQueen: new dist.Macro().item((0,dist.$item)(_templateObject56 || (_templateObject56 = combat_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat(),
  WitchessWitch: new dist.Macro().skill((0,dist.$skill)(_templateObject57 || (_templateObject57 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(_templateObject58 || (_templateObject58 = combat_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(),
  DMTSquare: new dist.Macro().if_("!monsterid ".concat(DMTSquareMon), Replace).skill((0,dist.$skill)(_templateObject59 || (_templateObject59 = combat_taggedTemplateLiteral(["Feel Envy"])))).step(DefaultMacro),
  DMTCircle: new dist.Macro().if_("!monsterid ".concat(DMTCircleMon), Replace).tryItem((0,dist.$item)(_templateObject60 || (_templateObject60 = combat_taggedTemplateLiteral(["abstraction: action"])))).step(DefaultMacro),
  MotherSlime: new dist.Macro().trySkill((0,dist.$skill)(_templateObject61 || (_templateObject61 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).skill((0,dist.$skill)(_templateObject62 || (_templateObject62 = combat_taggedTemplateLiteral(["Snokebomb"])))),
  BatForm: new dist.Macro().trySkill((0,dist.$skill)(_templateObject63 || (_templateObject63 = combat_taggedTemplateLiteral(["Become a Bat"])))).step(TryBanish),
  LatteGulpRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject64 || (_templateObject64 = combat_taggedTemplateLiteral(["Gulp Latte"])))).step("runaway"),
  MeteorForce: new dist.Macro().skill((0,dist.$skill)(_templateObject65 || (_templateObject65 = combat_taggedTemplateLiteral(["Meteor Shower"])))).skill((0,dist.$skill)(_templateObject66 || (_templateObject66 = combat_taggedTemplateLiteral(["Use the Force"])))),
  FoamForce: new dist.Macro().skill((0,dist.$skill)(_templateObject67 || (_templateObject67 = combat_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).skill((0,dist.$skill)(_templateObject68 || (_templateObject68 = combat_taggedTemplateLiteral(["Use the Force"]))))
...
function mapMonster(location, monster, macro) {
  if ((0,dist.get)("_monstersMapped") < 3) {
    ...
    if (!(0,dist.get)("mappingMonsters")) {
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject69 || (_templateObject69 = combat_taggedTemplateLiteral(["Map the Monsters"]))));
...
function castBestLibram() {
  var needed = BRICKOS_PER_FIGHT * (3 - (0,dist.get)("_brickoFights"));
...
(function (Quest) {
  ...
  Quest[Quest["DeepDark"] = 902] = "DeepDark";
})(Quest || (Quest = {}));

var questOutfits = (_questOutfits = {}, _defineProperty(_questOutfits, Quest.Beginning, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(quests_templateObject || (quests_templateObject = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject2 || (quests_templateObject2 = quests_taggedTemplateLiteral(["Iunion Crown"])))], [(0,dist.$slot)(quests_templateObject3 || (quests_templateObject3 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(quests_templateObject4 || (quests_templateObject4 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], //[$slot`shirt`, $item`fresh coat of paint`],
    [(0,dist.$slot)(quests_templateObject5 || (quests_templateObject5 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject6 || (quests_templateObject6 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject7 || (quests_templateObject7 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject8 || (quests_templateObject8 = quests_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))], [(0,dist.$slot)(quests_templateObject9 || (quests_templateObject9 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(quests_templateObject10 || (quests_templateObject10 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(quests_templateObject11 || (quests_templateObject11 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject12 || (quests_templateObject12 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(quests_templateObject13 || (quests_templateObject13 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject14 || (quests_templateObject14 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(quests_templateObject15 || (quests_templateObject15 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject16 || (quests_templateObject16 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]])
  };
}), _defineProperty(_questOutfits, Quest.CoilWire, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(quests_templateObject17 || (quests_templateObject17 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject18 || (quests_templateObject18 = quests_taggedTemplateLiteral(["Iunion Crown"])))], [(0,dist.$slot)(quests_templateObject19 || (quests_templateObject19 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject20 || (quests_templateObject20 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject21 || (quests_templateObject21 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject22 || (quests_templateObject22 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(quests_templateObject23 || (quests_templateObject23 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(quests_templateObject24 || (quests_templateObject24 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(quests_templateObject25 || (quests_templateObject25 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject26 || (quests_templateObject26 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(quests_templateObject27 || (quests_templateObject27 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject28 || (quests_templateObject28 = quests_taggedTemplateLiteral(["Retrospecs"])))], [(0,dist.$slot)(quests_templateObject29 || (quests_templateObject29 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject30 || (quests_templateObject30 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]])
  };
}), _defineProperty(_questOutfits, Quest.Leveling, () => {
  var mpSavings = (0,external_kolmafia_.numericModifier)((0,dist.$item)(quests_templateObject31 || (quests_templateObject31 = quests_taggedTemplateLiteral(["pantogram pants"]))), "mana cost") !== 0;
  var outfit = new Map([[(0,dist.$slot)(quests_templateObject32 || (quests_templateObject32 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject33 || (quests_templateObject33 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject34 || (quests_templateObject34 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject35 || (quests_templateObject35 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(quests_templateObject36 || (quests_templateObject36 = quests_taggedTemplateLiteral(["pants"]))), mpSavings ? (0,dist.$item)(quests_templateObject37 || (quests_templateObject37 = quests_taggedTemplateLiteral(["pantogram pants"]))) : (0,dist.$item)(quests_templateObject38 || (quests_templateObject38 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(quests_templateObject39 || (quests_templateObject39 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject40 || (quests_templateObject40 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(quests_templateObject41 || (quests_templateObject41 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.have)((0,dist.$item)(quests_templateObject42 || (quests_templateObject42 = quests_taggedTemplateLiteral(["battle broom"])))) ? (0,dist.$item)(quests_templateObject43 || (quests_templateObject43 = quests_taggedTemplateLiteral(["battle broom"]))) : (0,dist.$item)(quests_templateObject44 || (quests_templateObject44 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(quests_templateObject45 || (quests_templateObject45 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject46 || (quests_templateObject46 = quests_taggedTemplateLiteral(["Beach Comb"])))]]);
  if ((0,dist.have)((0,dist.$item)(quests_templateObject47 || (quests_templateObject47 = quests_taggedTemplateLiteral(["LOV Epaulettes"]))))) outfit.set((0,dist.$slot)(quests_templateObject48 || (quests_templateObject48 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(quests_templateObject49 || (quests_templateObject49 = quests_taggedTemplateLiteral(["LOV Epaulettes"]))));
  return {
    equipment: outfit
  };
}), _defineProperty(_questOutfits, Quest.Muscle, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(quests_templateObject50 || (quests_templateObject50 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject51 || (quests_templateObject51 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(quests_templateObject52 || (quests_templateObject52 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject53 || (quests_templateObject53 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject54 || (quests_templateObject54 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject55 || (quests_templateObject55 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(quests_templateObject56 || (quests_templateObject56 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject57 || (quests_templateObject57 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(quests_templateObject58 || (quests_templateObject58 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject59 || (quests_templateObject59 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questOutfits, Quest.Moxie, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(quests_templateObject60 || (quests_templateObject60 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject61 || (quests_templateObject61 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(quests_templateObject62 || (quests_templateObject62 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject63 || (quests_templateObject63 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject64 || (quests_templateObject64 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject65 || (quests_templateObject65 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(quests_templateObject66 || (quests_templateObject66 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject67 || (quests_templateObject67 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(quests_templateObject68 || (quests_templateObject68 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject69 || (quests_templateObject69 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questOutfits, Quest.HP, () => {
  var candle = (0,dist.$item)(_templateObject70 || (_templateObject70 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject71 || (_templateObject71 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.have)(candle) ? candle : (0,dist.$item)(_templateObject72 || (_templateObject72 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject73 || (_templateObject73 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject74 || (_templateObject74 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject75 || (_templateObject75 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject76 || (_templateObject76 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject77 || (_templateObject77 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject78 || (_templateObject78 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questOutfits, Quest.DeepDark, () => {
  var outfit = new Map([[(0,dist.$slot)(_templateObject79 || (_templateObject79 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject80 || (_templateObject80 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject81 || (_templateObject81 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject82 || (_templateObject82 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject83 || (_templateObject83 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject84 || (_templateObject84 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
  if ((0,dist.have)((0,dist.$item)(_templateObject85 || (_templateObject85 = quests_taggedTemplateLiteral(["burning paper crane"]))))) outfit.set((0,dist.$slot)(_templateObject86 || (_templateObject86 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject87 || (_templateObject87 = quests_taggedTemplateLiteral(["burning paper crane"]))));
  return {
    equipment: outfit
  };
}), _defineProperty(_questOutfits, Quest.SpellDamage, () => {
  // TODO: handle spell damage candle
  //const candle = [$slot`off-hand`, $item`Abracandalabra`];
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject88 || (_templateObject88 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject89 || (_templateObject89 = quests_taggedTemplateLiteral(["wrench"])))], [(0,dist.$slot)(_templateObject90 || (_templateObject90 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject91 || (_templateObject91 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject92 || (_templateObject92 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject93 || (_templateObject93 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject94 || (_templateObject94 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject95 || (_templateObject95 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject96 || (_templateObject96 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject97 || (_templateObject97 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(_templateObject98 || (_templateObject98 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject99 || (_templateObject99 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [(0,dist.$slot)(_templateObject100 || (_templateObject100 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject101 || (_templateObject101 = quests_taggedTemplateLiteral(["astral statuette"])))]]),
    familiar: (0,dist.$familiar)(_templateObject102 || (_templateObject102 = quests_taggedTemplateLiteral(["Left-Hand Man"])))
  };
}), _defineProperty(_questOutfits, Quest.WeaponDamage, () => {
  var outfit = new Map([[(0,dist.$slot)(_templateObject103 || (_templateObject103 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject104 || (_templateObject104 = quests_taggedTemplateLiteral(["broken champagne bottle"])))], [(0,dist.$slot)(_templateObject105 || (_templateObject105 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject106 || (_templateObject106 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject107 || (_templateObject107 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject108 || (_templateObject108 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject109 || (_templateObject109 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject110 || (_templateObject110 = quests_taggedTemplateLiteral(["Powerful Glove"])))]]);
  var candle = (0,dist.$item)(_templateObject111 || (_templateObject111 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  if ((0,dist.have)(candle)) outfit.set((0,dist.$slot)(_templateObject112 || (_templateObject112 = quests_taggedTemplateLiteral(["hat"]))), candle);
  return {
    equipment: outfit
  };
}), _defineProperty(_questOutfits, Quest.Mysticality, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject113 || (_templateObject113 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject114 || (_templateObject114 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject115 || (_templateObject115 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject116 || (_templateObject116 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject117 || (_templateObject117 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject118 || (_templateObject118 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject119 || (_templateObject119 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject120 || (_templateObject120 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questOutfits, Quest.CombatFrequency, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject121 || (_templateObject121 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject122 || (_templateObject122 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject123 || (_templateObject123 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject124 || (_templateObject124 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(_templateObject125 || (_templateObject125 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject126 || (_templateObject126 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject127 || (_templateObject127 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject128 || (_templateObject128 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]),
    familiar: (0,dist.$familiar)(_templateObject129 || (_templateObject129 = quests_taggedTemplateLiteral(["Disgeist"])))
  };
}), _defineProperty(_questOutfits, Quest.HotResist, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject130 || (_templateObject130 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject131 || (_templateObject131 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject132 || (_templateObject132 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject133 || (_templateObject133 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(_templateObject134 || (_templateObject134 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject135 || (_templateObject135 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject136 || (_templateObject136 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject137 || (_templateObject137 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject138 || (_templateObject138 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject139 || (_templateObject139 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject140 || (_templateObject140 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject141 || (_templateObject141 = quests_taggedTemplateLiteral(["cracker"])))]]),
    familiar: (0,dist.$familiar)(_templateObject142 || (_templateObject142 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questOutfits, Quest.FamiliarWeight, () => {
  return {
    equipment: new Map([[(0,dist.$slot)(_templateObject143 || (_templateObject143 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject144 || (_templateObject144 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject145 || (_templateObject145 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.have)((0,dist.$item)(_templateObject146 || (_templateObject146 = quests_taggedTemplateLiteral(["rope"])))) ? (0,dist.$item)(_templateObject147 || (_templateObject147 = quests_taggedTemplateLiteral(["rope"]))) : (0,dist.$item)(_templateObject148 || (_templateObject148 = quests_taggedTemplateLiteral(["familiar scrapbook"])))], [(0,dist.$slot)(_templateObject149 || (_templateObject149 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject150 || (_templateObject150 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject151 || (_templateObject151 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject152 || (_templateObject152 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject153 || (_templateObject153 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject154 || (_templateObject154 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject155 || (_templateObject155 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject156 || (_templateObject156 = quests_taggedTemplateLiteral(["cracker"])))]]),
    familiar: (0,dist.$familiar)(_templateObject157 || (_templateObject157 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questOutfits, Quest.ItemDrop, () => {
  var carrot = (0,external_kolmafia_.numericModifier)((0,dist.$item)(_templateObject158 || (_templateObject158 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))), "item drop") > 0;
  var candles = [(0,dist.$item)(_templateObject159 || (_templateObject159 = quests_taggedTemplateLiteral(["extra-large utility candle"]))), (0,dist.$item)(_templateObject160 || (_templateObject160 = quests_taggedTemplateLiteral(["novelty sparkling candle"]))), (0,dist.$item)(_templateObject161 || (_templateObject161 = quests_taggedTemplateLiteral(["runed taper candle"])))];
  var sparkler = (0,dist.$item)(_templateObject162 || (_templateObject162 = quests_taggedTemplateLiteral(["oversized sparkler"])));
  var outfit = new Map([[(0,dist.$slot)(_templateObject163 || (_templateObject163 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject164 || (_templateObject164 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject165 || (_templateObject165 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject166 || (_templateObject166 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject167 || (_templateObject167 = quests_taggedTemplateLiteral(["off-hand"]))), carrot ? (0,dist.$item)(_templateObject168 || (_templateObject168 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))) : (0,dist.$item)(_templateObject169 || (_templateObject169 = quests_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))], [(0,dist.$slot)(_templateObject170 || (_templateObject170 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject171 || (_templateObject171 = quests_taggedTemplateLiteral(["Guzzlr tablet"])))], [(0,dist.$slot)(_templateObject172 || (_templateObject172 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject173 || (_templateObject173 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject174 || (_templateObject174 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject175 || (_templateObject175 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject176 || (_templateObject176 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject177 || (_templateObject177 = quests_taggedTemplateLiteral(["li'l ninja costume"])))]]);
  if (!candles.some(dist.have) && (0,dist.have)(sparkler)) outfit.set((0,dist.$slot)(_templateObject178 || (_templateObject178 = quests_taggedTemplateLiteral(["weapon"]))), sparkler); // can only have one candle

  for (var _i = 0, _candles = candles; _i < _candles.length; _i++) {
    var c = _candles[_i];
    if ((0,dist.have)(c)) outfit.set((0,dist.$slot)(_templateObject179 || (_templateObject179 = quests_taggedTemplateLiteral(["weapon"]))), c);
  }

  return {
    equipment: outfit,
    familiar: (0,dist.$familiar)(_templateObject180 || (_templateObject180 = quests_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
  };
}), _defineProperty(_questOutfits, Quest.Donate, () => {
  return {
    equipment: new Map()
  };
}), _questOutfits);
function equipOutfit(quest) {
  ...
  if (outfit.familiar) (0,external_kolmafia_.useFamiliar)(outfit.familiar);

  if (!outfit.equipment.get((0,dist.$slot)(_templateObject181 || (_templateObject181 = quests_taggedTemplateLiteral(["back"]))))) {
    var _mode$get;

    (0,external_kolmafia_.cliExecute)("retrocape ".concat((_mode$get = mode.get(quest)) !== null && _mode$get !== void 0 ? _mode$get : "heck thrill"));
  }
...
var sharedStats = new Map([[(0,dist.$effect)(_templateObject182 || (_templateObject182 = quests_taggedTemplateLiteral(["Feeling Excited"]))), Context.beginning], [(0,dist.$effect)(_templateObject183 || (_templateObject183 = quests_taggedTemplateLiteral(["Triple-Sized"]))), Context.beginning], [(0,dist.$effect)(_templateObject184 || (_templateObject184 = quests_taggedTemplateLiteral(["Big"]))), Context.leveling], [(0,dist.$effect)(_templateObject185 || (_templateObject185 = quests_taggedTemplateLiteral(["Favored by Lyle"]))), Context.leveling], [(0,dist.$effect)(_templateObject186 || (_templateObject186 = quests_taggedTemplateLiteral(["Starry-Eyed"]))), Context.leveling], [(0,dist.$effect)(_templateObject187 || (_templateObject187 = quests_taggedTemplateLiteral(["Total Protonic Reversal"]))), Context.leveling], [(0,dist.$effect)(_templateObject188 || (_templateObject188 = quests_taggedTemplateLiteral(["Spit Upon"]))), Context.special]]);
var sharedSpellWeaponDamage = new Map([[(0,dist.$effect)(_templateObject189 || (_templateObject189 = quests_taggedTemplateLiteral(["Grumpy and Ornery"]))), Context.leveling], [(0,dist.$effect)(_templateObject190 || (_templateObject190 = quests_taggedTemplateLiteral(["Cowrruption"]))), Context.test], [(0,dist.$effect)(_templateObject191 || (_templateObject191 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject192 || (_templateObject192 = quests_taggedTemplateLiteral(["In a Lather"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject193 || (_templateObject193 = quests_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), Context.special], [(0,dist.$effect)(_templateObject194 || (_templateObject194 = quests_taggedTemplateLiteral(["Inner Elf"]))), Context.special], [(0,dist.$effect)(_templateObject195 || (_templateObject195 = quests_taggedTemplateLiteral(["Meteor Showered"]))), Context.special], [(0,dist.$effect)(_templateObject196 || (_templateObject196 = quests_taggedTemplateLiteral(["Spit Upon"]))), Context.special]]);
var questEffects = (_questEffects = {}, _defineProperty(_questEffects, Quest.Beginning, new Map([[(0,dist.$effect)(_templateObject197 || (_templateObject197 = quests_taggedTemplateLiteral(["Inscrutable Gaze"]))), Context.beginning], [(0,dist.$effect)(_templateObject198 || (_templateObject198 = quests_taggedTemplateLiteral(["Spirit of Peppermint"]))), Context.beginning], [(0,dist.$effect)(_templateObject199 || (_templateObject199 = quests_taggedTemplateLiteral(["meat.enh"]))), Context.beginning], [(0,dist.$effect)(_templateObject200 || (_templateObject200 = quests_taggedTemplateLiteral(["init.enh"]))), Context.beginning]])), _defineProperty(_questEffects, Quest.CoilWire, new Map()), _defineProperty(_questEffects, Quest.Leveling, new Map([[(0,dist.$effect)(_templateObject201 || (_templateObject201 = quests_taggedTemplateLiteral(["Blood Bubble"]))), Context.leveling], [(0,dist.$effect)(_templateObject202 || (_templateObject202 = quests_taggedTemplateLiteral(["Carol of the Thrills"]))), Context.leveling], [(0,dist.$effect)(_templateObject203 || (_templateObject203 = quests_taggedTemplateLiteral(["Ghostly Shell"]))), Context.leveling], [(0,dist.$effect)(_templateObject204 || (_templateObject204 = quests_taggedTemplateLiteral(["Inscrutable Gaze"]))), Context.leveling], //[$effect`Purity of Spirit`, EffectContext.leveling],
[(0,dist.$effect)(_templateObject205 || (_templateObject205 = quests_taggedTemplateLiteral(["Ruthlessly Efficient"]))), Context.leveling], // Need the non-flimsy effect for PM
[(0,dist.$effect)(_templateObject206 || (_templateObject206 = quests_taggedTemplateLiteral(["Flimsy Shield of the Pastalord"]))), Context.leveling], [(0,dist.$effect)(_templateObject207 || (_templateObject207 = quests_taggedTemplateLiteral(["Springy Fusilli"]))), Context.leveling], // Take the stat vaccine instead of resists now
[(0,dist.$effect)(_templateObject208 || (_templateObject208 = quests_taggedTemplateLiteral(["Broad-Spectrum Vaccine"]))), Context.leveling], // Beach comb
[(0,dist.$effect)(_templateObject209 || (_templateObject209 = quests_taggedTemplateLiteral(["Cold as Nice"]))), Context.leveling], [(0,dist.$effect)(_templateObject210 || (_templateObject210 = quests_taggedTemplateLiteral(["A Brush with Grossness"]))), Context.leveling], [(0,dist.$effect)(_templateObject211 || (_templateObject211 = quests_taggedTemplateLiteral(["Does It Have a Skull In There??"]))), Context.leveling], [(0,dist.$effect)(_templateObject212 || (_templateObject212 = quests_taggedTemplateLiteral(["Oiled, Slick"]))), Context.leveling], [(0,dist.$effect)(_templateObject213 || (_templateObject213 = quests_taggedTemplateLiteral(["Resting Beach Face"]))), Context.leveling], [(0,dist.$effect)(_templateObject214 || (_templateObject214 = quests_taggedTemplateLiteral(["You Learned Something Maybe!"]))), Context.leveling], // Class buffs
[(0,dist.$effect)(_templateObject215 || (_templateObject215 = quests_taggedTemplateLiteral(["Polka of Plenty"]))), Context.leveling], [(0,dist.$effect)(_templateObject216 || (_templateObject216 = quests_taggedTemplateLiteral(["Ode to Booze"]))), Context.leveling], [(0,dist.$effect)(_templateObject217 || (_templateObject217 = quests_taggedTemplateLiteral(["Astral Shell"]))), Context.leveling], [(0,dist.$effect)(_templateObject218 || (_templateObject218 = quests_taggedTemplateLiteral(["Elemental Saucesphere"]))), Context.leveling] //[$effect`Scarysauce`, EffectContext.leveling],
])), _defineProperty(_questEffects, Quest.Muscle, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject219 || (_templateObject219 = quests_taggedTemplateLiteral(["Lack of Body-Building"]))), Context.leveling], [(0,dist.$effect)(_templateObject220 || (_templateObject220 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), Context.test], [(0,dist.$effect)(_templateObject221 || (_templateObject221 = quests_taggedTemplateLiteral(["Phorcefullness"]))), Context.test], [(0,dist.$effect)(_templateObject222 || (_templateObject222 = quests_taggedTemplateLiteral(["Quiet Determination"]))), Context.test], [(0,dist.$effect)(_templateObject223 || (_templateObject223 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), Context.test], [(0,dist.$effect)(_templateObject224 || (_templateObject224 = quests_taggedTemplateLiteral(["Giant Growth"]))), Context.special]]))), _defineProperty(_questEffects, Quest.Moxie, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject225 || (_templateObject225 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject226 || (_templateObject226 = quests_taggedTemplateLiteral(["Pomp & Circumsands"]))), Context.leveling], [(0,dist.$effect)(_templateObject227 || (_templateObject227 = quests_taggedTemplateLiteral(["Disco Fever"]))), Context.test], [(0,dist.$effect)(_templateObject228 || (_templateObject228 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), Context.test], [(0,dist.$effect)(_templateObject229 || (_templateObject229 = quests_taggedTemplateLiteral(["Quiet Desperation"]))), Context.test], // Wish
[(0,dist.$effect)(_templateObject230 || (_templateObject230 = quests_taggedTemplateLiteral(["Sparkly!"]))), Context.special]]))), _defineProperty(_questEffects, Quest.HP, new Map([[(0,dist.$effect)(_templateObject231 || (_templateObject231 = quests_taggedTemplateLiteral(["Song of Starch"]))), Context.test]])), _defineProperty(_questEffects, Quest.DeepDark, new Map()), _defineProperty(_questEffects, Quest.SpellDamage, new Map([].concat(quests_toConsumableArray(sharedSpellWeaponDamage), [[(0,dist.$effect)(_templateObject232 || (_templateObject232 = quests_taggedTemplateLiteral(["Spirit of Peppermint"]))), Context.beginning], [(0,dist.$effect)(_templateObject233 || (_templateObject233 = quests_taggedTemplateLiteral(["AAA-Charged"]))), Context.leveling], [(0,dist.$effect)(_templateObject234 || (_templateObject234 = quests_taggedTemplateLiteral(["Carol of the Hells"]))), Context.leveling], [(0,dist.$effect)(_templateObject235 || (_templateObject235 = quests_taggedTemplateLiteral(["Full Bottle in front of Me"]))), Context.leveling], [(0,dist.$effect)(_templateObject236 || (_templateObject236 = quests_taggedTemplateLiteral(["Mental A-cue-ity"]))), Context.leveling], [(0,dist.$effect)(_templateObject237 || (_templateObject237 = quests_taggedTemplateLiteral(["Pisces in the Skyces"]))), Context.leveling], [(0,dist.$effect)(_templateObject238 || (_templateObject238 = quests_taggedTemplateLiteral(["Sigils of Yeg"]))), Context.leveling], [(0,dist.$effect)(_templateObject239 || (_templateObject239 = quests_taggedTemplateLiteral(["Warlock, Warstock, and Warbarrel"]))), Context.leveling], [(0,dist.$effect)(_templateObject240 || (_templateObject240 = quests_taggedTemplateLiteral(["We're All Made of Starfish"]))), Context.leveling], [(0,dist.$effect)(_templateObject241 || (_templateObject241 = quests_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"]))), Context.test], [(0,dist.$effect)(_templateObject242 || (_templateObject242 = quests_taggedTemplateLiteral(["Song of Sauce"]))), Context.test], [(0,dist.$effect)(_templateObject243 || (_templateObject243 = quests_taggedTemplateLiteral(["The Magic of LOV"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject244 || (_templateObject244 = quests_taggedTemplateLiteral(["Filled with Magic"]))), Context.special], //[$effect`Drunk With Power`, Context.special],
// Wish
[(0,dist.$effect)(_templateObject245 || (_templateObject245 = quests_taggedTemplateLiteral(["Sparkly!"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject246 || (_templateObject246 = quests_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"]))), Context.special], [(0,dist.$effect)(_templateObject247 || (_templateObject247 = quests_taggedTemplateLiteral(["Nanobrainy"]))), Context.special], [(0,dist.$effect)(_templateObject248 || (_templateObject248 = quests_taggedTemplateLiteral(["Toxic Vengeance"]))), Context.special]]))), _defineProperty(_questEffects, Quest.WeaponDamage, new Map([].concat(quests_toConsumableArray(sharedSpellWeaponDamage), [[(0,dist.$effect)(_templateObject249 || (_templateObject249 = quests_taggedTemplateLiteral(["Billiards Belligerence"]))), Context.leveling], [(0,dist.$effect)(_templateObject250 || (_templateObject250 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject251 || (_templateObject251 = quests_taggedTemplateLiteral(["Carol of the Bulls"]))), Context.leveling], [(0,dist.$effect)(_templateObject252 || (_templateObject252 = quests_taggedTemplateLiteral(["Frenzied, Bloody"]))), Context.leveling], [(0,dist.$effect)(_templateObject253 || (_templateObject253 = quests_taggedTemplateLiteral(["Lack of Body-Building"]))), Context.leveling], [(0,dist.$effect)(_templateObject254 || (_templateObject254 = quests_taggedTemplateLiteral(["Bow-Legged Swagger"]))), Context.test], [(0,dist.$effect)(_templateObject255 || (_templateObject255 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), Context.test], [(0,dist.$effect)(_templateObject256 || (_templateObject256 = quests_taggedTemplateLiteral(["Scowl of the Auk"]))), Context.test], [(0,dist.$effect)(_templateObject257 || (_templateObject257 = quests_taggedTemplateLiteral(["Song of the North"]))), Context.test], [(0,dist.$effect)(_templateObject258 || (_templateObject258 = quests_taggedTemplateLiteral(["Tenacity of the Snapper"]))), Context.test], [(0,dist.$effect)(_templateObject259 || (_templateObject259 = quests_taggedTemplateLiteral(["The Power of LOV"]))), Context.test]]))), _defineProperty(_questEffects, Quest.Mysticality, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject260 || (_templateObject260 = quests_taggedTemplateLiteral(["Uncucumbered"]))), Context.beginning], [(0,dist.$effect)(_templateObject261 || (_templateObject261 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject262 || (_templateObject262 = quests_taggedTemplateLiteral(["Mystically Oiled"]))), Context.leveling], [(0,dist.$effect)(_templateObject263 || (_templateObject263 = quests_taggedTemplateLiteral(["We're All Made of Starfish"]))), Context.leveling], [(0,dist.$effect)(_templateObject264 || (_templateObject264 = quests_taggedTemplateLiteral(["Quiet Judgement"]))), Context.test], // Wish
[(0,dist.$effect)(_templateObject265 || (_templateObject265 = quests_taggedTemplateLiteral(["Witch Breaded"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject266 || (_templateObject266 = quests_taggedTemplateLiteral(["Nanobrainy"]))), Context.special]]))), _defineProperty(_questEffects, Quest.CombatFrequency, new Map([[(0,dist.$effect)(_templateObject267 || (_templateObject267 = quests_taggedTemplateLiteral(["Become Superficially interested"]))), Context.test], [(0,dist.$effect)(_templateObject268 || (_templateObject268 = quests_taggedTemplateLiteral(["Feeling Lonely"]))), Context.test], [(0,dist.$effect)(_templateObject269 || (_templateObject269 = quests_taggedTemplateLiteral(["Gummed Shoes"]))), Context.test], [(0,dist.$effect)(_templateObject270 || (_templateObject270 = quests_taggedTemplateLiteral(["Invisible Avatar"]))), Context.test], [(0,dist.$effect)(_templateObject271 || (_templateObject271 = quests_taggedTemplateLiteral(["Silent Running"]))), Context.test], [(0,dist.$effect)(_templateObject272 || (_templateObject272 = quests_taggedTemplateLiteral(["Smooth Movements"]))), Context.test], [(0,dist.$effect)(_templateObject273 || (_templateObject273 = quests_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), Context.test], [(0,dist.$effect)(_templateObject274 || (_templateObject274 = quests_taggedTemplateLiteral(["Throwing Some Shade"]))), Context.test], [(0,dist.$effect)(_templateObject275 || (_templateObject275 = quests_taggedTemplateLiteral(["Silence of the God Lobster"]))), Context.special]])), _defineProperty(_questEffects, Quest.HotResist, new Map([[(0,dist.$effect)(_templateObject276 || (_templateObject276 = quests_taggedTemplateLiteral(["Feeling Peaceful"]))), Context.beginning], [(0,dist.$effect)(_templateObject277 || (_templateObject277 = quests_taggedTemplateLiteral(["Astral Shell"]))), Context.leveling], [(0,dist.$effect)(_templateObject278 || (_templateObject278 = quests_taggedTemplateLiteral(["Elemental Saucesphere"]))), Context.leveling], [(0,dist.$effect)(_templateObject279 || (_templateObject279 = quests_taggedTemplateLiteral(["Hot-Headed"]))), Context.leveling], [(0,dist.$effect)(_templateObject280 || (_templateObject280 = quests_taggedTemplateLiteral(["Fireproof Foam Suit"]))), Context.special]])), _defineProperty(_questEffects, Quest.FamiliarWeight, new Map([[(0,dist.$effect)(_templateObject281 || (_templateObject281 = quests_taggedTemplateLiteral(["Loyal Tea"]))), Context.leveling], [(0,dist.$effect)(_templateObject282 || (_templateObject282 = quests_taggedTemplateLiteral(["A Girl Named Sue"]))), Context.leveling], [(0,dist.$effect)(_templateObject283 || (_templateObject283 = quests_taggedTemplateLiteral(["Billiards Belligerence"]))), Context.leveling], [(0,dist.$effect)(_templateObject284 || (_templateObject284 = quests_taggedTemplateLiteral(["Blood Bond"]))), Context.leveling], [(0,dist.$effect)(_templateObject285 || (_templateObject285 = quests_taggedTemplateLiteral(["Do I Know You From Somewhere?"]))), Context.leveling], [(0,dist.$effect)(_templateObject286 || (_templateObject286 = quests_taggedTemplateLiteral(["Empathy"]))), Context.leveling], [(0,dist.$effect)(_templateObject287 || (_templateObject287 = quests_taggedTemplateLiteral(["Fidoxene"]))), Context.leveling], [(0,dist.$effect)(_templateObject288 || (_templateObject288 = quests_taggedTemplateLiteral(["Leash of Linguini"]))), Context.leveling], [(0,dist.$effect)(_templateObject289 || (_templateObject289 = quests_taggedTemplateLiteral(["Puzzle Champ"]))), Context.leveling], //[$effect`Man's Worst Enemy`, Context.test],
[(0,dist.$effect)(_templateObject290 || (_templateObject290 = quests_taggedTemplateLiteral(["Over-Familiar With Dactyls"]))), Context.test], [(0,dist.$effect)(_templateObject291 || (_templateObject291 = quests_taggedTemplateLiteral(["Robot Friends"]))), Context.test], [(0,dist.$effect)(_templateObject292 || (_templateObject292 = quests_taggedTemplateLiteral(["Whole Latte Love"]))), Context.test], [(0,dist.$effect)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["Shortly Stacked"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), Context.special], [(0,dist.$effect)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["Joy"]))), Context.special], [(0,dist.$effect)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["Smart Drunk"]))), Context.special], // Librams
//[$effect`Cold Hearted`, Context.special],
//[$effect`Heart of Green`, Context.special],
// Wishes
[(0,dist.$effect)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["All Is Forgiven"]))), Context.special], [(0,dist.$effect)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["Bureaucratized"]))), Context.special], [(0,dist.$effect)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["Chorale of Companionship"]))), Context.special], [(0,dist.$effect)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["Down With Chow"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["Meteor Showered"]))), Context.special], [(0,dist.$effect)(_templateObject302 || (_templateObject302 = quests_taggedTemplateLiteral(["Open Heart Surgery"]))), Context.special]])), _defineProperty(_questEffects, Quest.ItemDrop, new Map([[(0,dist.$effect)(_templateObject303 || (_templateObject303 = quests_taggedTemplateLiteral(["items.enh"]))), Context.beginning], [(0,dist.$effect)(_templateObject304 || (_templateObject304 = quests_taggedTemplateLiteral(["Uncucumbered"]))), Context.beginning], [(0,dist.$effect)(_templateObject305 || (_templateObject305 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject306 || (_templateObject306 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject307 || (_templateObject307 = quests_taggedTemplateLiteral(["Ermine Eyes"]))), Context.leveling], [(0,dist.$effect)(_templateObject308 || (_templateObject308 = quests_taggedTemplateLiteral(["Hustlin'"]))), Context.leveling], [(0,dist.$effect)(_templateObject309 || (_templateObject309 = quests_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), Context.leveling], [(0,dist.$effect)(_templateObject310 || (_templateObject310 = quests_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), Context.leveling], [(0,dist.$effect)(_templateObject311 || (_templateObject311 = quests_taggedTemplateLiteral(["Feeling Lost"]))), Context.test], [(0,dist.$effect)(_templateObject312 || (_templateObject312 = quests_taggedTemplateLiteral(["Nearly All-Natural"]))), Context.test], [(0,dist.$effect)(_templateObject313 || (_templateObject313 = quests_taggedTemplateLiteral(["Steely-Eyed Squint"]))), Context.test], [(0,dist.$effect)(_templateObject314 || (_templateObject314 = quests_taggedTemplateLiteral(["The Spirit of Taking"]))), Context.test], [(0,dist.$effect)(_templateObject315 || (_templateObject315 = quests_taggedTemplateLiteral(["Bat-Adjacent Form"]))), Context.special], [(0,dist.$effect)(_templateObject316 || (_templateObject316 = quests_taggedTemplateLiteral(["Synthesis: Collection"]))), Context.special]])), _defineProperty(_questEffects, Quest.Donate, new Map()), _questEffects);
...
function buffUp(progress) {
  for (var _i2 = 0, _Object$values = Object.values(questEffects); _i2 < _Object$values.length; _i2++) {
    var qe = _Object$values[_i2];
...
function prepAndDoQuest(id) {
  var turns = (0,external_kolmafia_.totalTurnsPlayed)();
...
var loveTunnel = (0,dist.$location)(events_templateObject5 || (events_templateObject5 = events_taggedTemplateLiteral(["The Tunnel of L.O.V.E."])));
var neverendingParty = (0,dist.$location)(events_templateObject6 || (events_templateObject6 = events_taggedTemplateLiteral(["The Neverending Party"])));
var noobCave = (0,dist.$location)(events_templateObject7 || (events_templateObject7 = events_taggedTemplateLiteral(["Noob Cave"])));
var skeletonStore = (0,dist.$location)(events_templateObject8 || (events_templateObject8 = events_taggedTemplateLiteral(["The Skeleton Store"])));
var slimeTube = (0,dist.$location)(events_templateObject9 || (events_templateObject9 = events_taggedTemplateLiteral(["The Slime Tube"])));
var snojo = (0,dist.$location)(events_templateObject10 || (events_templateObject10 = events_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"])));
var statelyPleasureDome = (0,dist.$location)(events_templateObject11 || (events_templateObject11 = events_taggedTemplateLiteral(["The Stately Pleasure Dome"])));
var toxicTeacups = (0,dist.$location)(events_templateObject12 || (events_templateObject12 = events_taggedTemplateLiteral(["The Toxic Teacups"])));
var upscaleDistrict = (0,dist.$location)(events_templateObject13 || (events_templateObject13 = events_taggedTemplateLiteral(["Gingerbread Upscale Retail District"]))); // Structure events in the form of: [ if(check()<max) run(); ]
// Events are prioritized in order from top to bottom

var events = {
  protonicGhost: {
    max: 1,
    current: () => (0,dist.get)("ghostLocation") === null || (0,dist.get)("lastCopyableMonster") !== (0,dist.$monster)(events_templateObject14 || (events_templateObject14 = events_taggedTemplateLiteral(["pterodactyl"]))) ? 1 : 0,
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject15 || (events_templateObject15 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject16 || (events_templateObject16 = events_taggedTemplateLiteral(["protonic accelerator pack"]))));
      ...
      checkAvailable((0,dist.$item)(events_templateObject17 || (events_templateObject17 = events_taggedTemplateLiteral(["Friendliness Beverage"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject18 || (events_templateObject18 = events_taggedTemplateLiteral(["Friendliness Beverage"]))));
    }
  },
  backupCamera: {
    max: 11,
    current: () => (0,dist.get)("lastCopyableMonster") !== (0,dist.$monster)(events_templateObject19 || (events_templateObject19 = events_taggedTemplateLiteral(["sausage goblin"]))) ? 11 : (0,dist.get)("_backUpUses"),
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject20 || (events_templateObject20 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject21 || (events_templateObject21 = events_taggedTemplateLiteral(["backup camera"]))));
      selectBestFamiliar();
  ...
  latteCarrot: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject22 || (events_templateObject22 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject23 || (events_templateObject23 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      checkEffect((0,dist.$effect)(events_templateObject24 || (events_templateObject24 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject25 || (events_templateObject25 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.Runaway);
    }
  },
  chateauPainting: {
    max: 0,
    current: () => (0,dist.get)("_chateauMonsterFought") ? 0 : -1,
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject26 || (events_templateObject26 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject27 || (events_templateObject27 = events_taggedTemplateLiteral(["protonic accelerator pack"]))));
      var monster = dist.ChateauMantegna.paintingMonster();
      if (!monster) throw "Empty Chateau painting?";
      var carols = (0,dist.$phyla)(events_templateObject28 || (events_templateObject28 = events_taggedTemplateLiteral(["beast, bug, constellation, elf, goblin, humanoid"])));

      if (carols.includes(monster.phylum)) {
        (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject29 || (events_templateObject29 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject30 || (events_templateObject30 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
        familiar((0,dist.$familiar)(events_templateObject31 || (events_templateObject31 = events_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))));
      ...
      if ((0,dist.get)("ghostLocation") === null) throw "Failed to get protonic ghost message?";
    }
  },
  ghostCarol: {
    max: 0,
    current: () => [(0,dist.$effect)(events_templateObject34 || (events_templateObject34 = events_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"]))), (0,dist.$effect)(events_templateObject35 || (events_templateObject35 = events_taggedTemplateLiteral(["Crimbo Wrapping"]))), (0,dist.$effect)(events_templateObject36 || (events_templateObject36 = events_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(events_templateObject37 || (events_templateObject37 = events_taggedTemplateLiteral(["Holiday Yoked"]))), (0,dist.$effect)(events_templateObject38 || (events_templateObject38 = events_taggedTemplateLiteral(["Let It Snow/Boil/Stink/Frighten/Grease"])))].reduce((sum, carol) => sum + (0,external_kolmafia_.haveEffect)(carol), 0) - 1,
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject39 || (events_templateObject39 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject40 || (events_templateObject40 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
      familiar((0,dist.$familiar)(events_templateObject41 || (events_templateObject41 = events_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))));
      adventure(direWarren, MacroList.Banish);
      checkEffect((0,dist.$effect)(events_templateObject42 || (events_templateObject42 = events_taggedTemplateLiteral(["Do You Crush What I Crush?"]))));
    }
  },
  loveTunnel: {
    max: 3,
    current: () => (0,dist.get)("_loveTunnelUsed") ? 3 : 0,
    run: () => {
      spendAllMpOnLibrams();
      selectBestFamiliar(FamiliarFlag.NoAttack);
      adventure(loveTunnel, MacroList.TunnelOfLOV);
      if ((0,external_kolmafia_.handlingChoice)()) throw "Stuck in LOV?";
      checkEffect((0,dist.$effect)(events_templateObject43 || (events_templateObject43 = events_taggedTemplateLiteral(["Open Heart Surgery"]))));
      (0,dist.$items)(events_templateObject44 || (events_templateObject44 = events_taggedTemplateLiteral(["LOV Elixir #3, LOV Elixir #6, LOV Epaulettes"]))).forEach(l => checkAvailable(l, 1));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject45 || (events_templateObject45 = events_taggedTemplateLiteral(["LOV Elixir #3"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject46 || (events_templateObject46 = events_taggedTemplateLiteral(["LOV Elixir #6"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject47 || (events_templateObject47 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject48 || (events_templateObject48 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
    }
  },
  tenPercentBonus: {
    max: 0,
    current: () => 0 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject49 || (events_templateObject49 = events_taggedTemplateLiteral(["a ten-percent bonus"])))),
    run: () => {
      [(0,dist.$effect)(events_templateObject50 || (events_templateObject50 = events_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))), (0,dist.$effect)(events_templateObject51 || (events_templateObject51 = events_taggedTemplateLiteral(["Inscrutable Gaze"]))), (0,dist.$effect)(events_templateObject52 || (events_templateObject52 = events_taggedTemplateLiteral(["Synthesis: Learning"])))].forEach(checkEffect);
      checkAvailable((0,dist.$item)(events_templateObject53 || (events_templateObject53 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject54 || (events_templateObject54 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject55 || (events_templateObject55 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
      withEquipment(() => (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject56 || (events_templateObject56 = events_taggedTemplateLiteral(["a ten-percent bonus"])))), [[(0,dist.$slot)(events_templateObject57 || (events_templateObject57 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject58 || (events_templateObject58 = events_taggedTemplateLiteral(["familiar scrapbook"])))]]);
    }
  },
  upscaleDistrictKill: {
    max: 1,
    current: () => (0,dist.have)((0,dist.$effect)(events_templateObject59 || (events_templateObject59 = events_taggedTemplateLiteral(["Whole Latte Love"])))) ? 1 : (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject60 || (events_templateObject60 = events_taggedTemplateLiteral(["sprinkles"])))) - 54,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject61 || (events_templateObject61 = events_taggedTemplateLiteral(["Chocolate Lab"]))));
      withEquipment(() => adventure(upscaleDistrict, MacroList.Sprinkles), [[(0,dist.$slot)(events_templateObject62 || (events_templateObject62 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject63 || (events_templateObject63 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(events_templateObject64 || (events_templateObject64 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.have)((0,dist.$item)(events_templateObject65 || (events_templateObject65 = events_taggedTemplateLiteral(["rope"])))) ? (0,dist.$item)(events_templateObject66 || (events_templateObject66 = events_taggedTemplateLiteral(["rope"]))) : (0,dist.$item)(events_templateObject67 || (events_templateObject67 = events_taggedTemplateLiteral(["familiar scrapbook"])))], [(0,dist.$slot)(events_templateObject68 || (events_templateObject68 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject69 || (events_templateObject69 = events_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(events_templateObject70 || (events_templateObject70 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject71 || (events_templateObject71 = events_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(events_templateObject72 || (events_templateObject72 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject73 || (events_templateObject73 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]]);
      checkAvailable((0,dist.$item)(events_templateObject74 || (events_templateObject74 = events_taggedTemplateLiteral(["sprinkles"]))), 55);
    }
  },
  upscaleDistrictRunaway: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject75 || (events_templateObject75 = events_taggedTemplateLiteral(["Whole Latte Love"])))) - 1,
    run: () => {
      checkEffect((0,dist.$effect)(events_templateObject76 || (events_templateObject76 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject77 || (events_templateObject77 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(upscaleDistrict, MacroList.Runaway);
      var latte = (0,dist.$item)(events_templateObject78 || (events_templateObject78 = events_taggedTemplateLiteral(["gingerbread spice latte"])));

      if ((0,dist.have)(latte)) {
        (0,external_kolmafia_.use)(latte);
        checkAvailable((0,dist.$item)(events_templateObject79 || (events_templateObject79 = events_taggedTemplateLiteral(["sprinkles"]))), 5);
  ...
  civicCenterRunaway: {
    ...
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject80 || (events_templateObject80 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject81 || (events_templateObject81 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(civicCenter, MacroList.Runaway);
      var cig = (0,dist.$item)(events_templateObject82 || (events_templateObject82 = events_taggedTemplateLiteral(["gingerbread cigarette"])));
      if ((0,dist.get)("_gingerbreadCityTurns") === 15 && !(0,dist.have)(cig)) throw "Failed to obtain ".concat(cig);
    }
  },
  witchessRook: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject83 || (events_templateObject83 = events_taggedTemplateLiteral(["Sweetbreads Flamb\xE9"])))) - 1,
    run: () => {
      acquireEffect((0,dist.$effect)(events_templateObject84 || (events_templateObject84 = events_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))));
      equipOutfit(Quest.Leveling);
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject85 || (events_templateObject85 = events_taggedTemplateLiteral(["Witchess Rook"]))), MacroList.FreeFight);
      checkAvailable((0,dist.$item)(events_templateObject86 || (events_templateObject86 = events_taggedTemplateLiteral(["Greek fire"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject87 || (events_templateObject87 = events_taggedTemplateLiteral(["Greek fire"]))));
    }
  },
  snojo: {
    max: 10,
    ...
    run: () => {
      if (!(0,dist.get)("snojoSetting") !== (0,dist.$stat)(events_templateObject88 || (events_templateObject88 = events_taggedTemplateLiteral(["Muscle"])))) {
  ...
  bricko: {
    max: 3,
    current: () => !(0,dist.have)(BRICKO_TARGET_ITEM) ? 3 : (0,dist.get)("_brickoFights"),
    run: () => {
      selectBestFamiliar();
  ...
  witchessWitch: {
    max: 0,
    current: () => (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject89 || (events_templateObject89 = events_taggedTemplateLiteral(["battle broom"])))) - 1,
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject90 || (events_templateObject90 = events_taggedTemplateLiteral(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject91 || (events_templateObject91 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject92 || (events_templateObject92 = events_taggedTemplateLiteral(["battle broom"]))));
    }
  },
  eldritch: {
    max: 1,
    current: () => (0,dist.get)("_eldritchHorrorEvoked") ? 1 : 0,
    run: () => {
      selectBestFamiliar();
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject93 || (events_templateObject93 = events_taggedTemplateLiteral(["Evoke Eldritch Horror"])))); // In case Sssshhsssblllrrggghsssssggggrrgglsssshhssslblgl was summoned, I guess this is enough?
  ...
  gingerbreadCig: {
    max: 5,
    current: () => 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject94 || (events_templateObject94 = events_taggedTemplateLiteral(["gingerbread cigarette"])))),
    run: () => {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  digitize: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject95 || (events_templateObject95 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject96 || (events_templateObject96 = events_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  ninjaCostume: {
    max: 1,
    current: () => (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject97 || (events_templateObject97 = events_taggedTemplateLiteral(["li'l ninja costume"])))),
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject98 || (events_templateObject98 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject99 || (events_templateObject99 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      mapMonster(haikuDungeon, (0,dist.$monster)(events_templateObject100 || (events_templateObject100 = events_taggedTemplateLiteral(["amateur ninja"]))), MacroList.FreeFight);
      checkAvailable((0,dist.$item)(events_templateObject101 || (events_templateObject101 = events_taggedTemplateLiteral(["li'l ninja costume"]))));
    }
  },
  vote: {
    max: 1,
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(toxicTeacups, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject102 || (events_templateObject102 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject103 || (events_templateObject103 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
    }
  },
  godLobster: {
    max: 3,
    ...
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject104 || (events_templateObject104 = events_taggedTemplateLiteral(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      ...
      var ring = (0,dist.$item)(events_templateObject105 || (events_templateObject105 = events_taggedTemplateLiteral(["God Lobster's Ring"])));
      var scepter = (0,dist.$item)(events_templateObject106 || (events_templateObject106 = events_taggedTemplateLiteral(["God Lobster's Scepter"])));
      if ((0,dist.have)(ring)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject107 || (events_templateObject107 = events_taggedTemplateLiteral(["familiar"]))), ring);else if ((0,dist.have)(scepter)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject108 || (events_templateObject108 = events_taggedTemplateLiteral(["familiar"]))), scepter);
    }
  },
  witchessKing: {
    max: 0,
    current: () => (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject109 || (events_templateObject109 = events_taggedTemplateLiteral(["dented scepter"])))) - 1,
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject110 || (events_templateObject110 = events_taggedTemplateLiteral(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    max: 5,
    ...
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject111 || (events_templateObject111 = events_taggedTemplateLiteral(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  dmtSquare: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject112 || (events_templateObject112 = events_taggedTemplateLiteral(["Joy"])))) + (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject113 || (events_templateObject113 = events_taggedTemplateLiteral(["abstraction: action"])))) - 1,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject114 || (events_templateObject114 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTSquare);
      checkAvailable((0,dist.$item)(events_templateObject115 || (events_templateObject115 = events_taggedTemplateLiteral(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject116 || (events_templateObject116 = events_taggedTemplateLiteral(["Joy"])))) - 1,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject117 || (events_templateObject117 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable((0,dist.$item)(events_templateObject118 || (events_templateObject118 = events_taggedTemplateLiteral(["abstraction: joy"]))));
      (0,external_kolmafia_.chew)((0,dist.$item)(events_templateObject119 || (events_templateObject119 = events_taggedTemplateLiteral(["abstraction: joy"]))));
    }
  },
  dmt: {
    max: 5,
    ...
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject120 || (events_templateObject120 = events_taggedTemplateLiteral(["Machine Elf"]))));
  ...
  lecture: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject121 || (events_templateObject121 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject122 || (events_templateObject122 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      familiar((0,dist.$familiar)(events_templateObject123 || (events_templateObject123 = events_taggedTemplateLiteral(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  nep: {
    ...
    run: () => {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject126 || (events_templateObject126 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject127 || (events_templateObject127 = events_taggedTemplateLiteral(["Beach Comb"]))));
      selectBestFamiliar();
  ...
  chestXRay: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject128 || (events_templateObject128 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject129 || (events_templateObject129 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject130 || (events_templateObject130 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject131 || (events_templateObject131 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  ...
  shatterPunch: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject132 || (events_templateObject132 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject133 || (events_templateObject133 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      selectBestFamiliar(FamiliarFlag.ToxicTeacups);
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  mobHit: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject134 || (events_templateObject134 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject135 || (events_templateObject135 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      selectBestFamiliar(FamiliarFlag.ToxicTeacups);
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  ...
  shockingLick: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject136 || (events_templateObject136 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject137 || (events_templateObject137 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      selectBestFamiliar(FamiliarFlag.ToxicTeacups);
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  latteRefills: {
    ...
    run: () => {
      checkEffect((0,dist.$effect)(events_templateObject138 || (events_templateObject138 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject139 || (events_templateObject139 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject140 || (events_templateObject140 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      if ((0,dist.get)("_latteDrinkUsed")) (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon carrot");
      familiar((0,dist.$familiar)(events_templateObject141 || (events_templateObject141 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.LatteGulpRunaway);
    }
  }
};
function getRemainingFreeFights() {
  return Object.values(events).reduce((sum, _ref) => {
    var max = _ref.max,
...
var oneOffEvents = {
  innerElf: () => {
    if ((0,external_kolmafia_.myLevel)() >= 13 && !(0,dist.have)((0,dist.$effect)(events_templateObject142 || (events_templateObject142 = events_taggedTemplateLiteral(["Inner Elf"]))))) {
      familiar((0,dist.$familiar)(events_templateObject143 || (events_templateObject143 = events_taggedTemplateLiteral(["Machine Elf"]))));
      dist.Clan.with(FAX_AND_SLIME_CLAN, () => adventure(slimeTube, MacroList.MotherSlime));
      checkEffect((0,dist.$effect)(events_templateObject144 || (events_templateObject144 = events_taggedTemplateLiteral(["Inner Elf"]))));
    }
  },
  hipster: () => {
    if (!(0,dist.get)("_ironicMoustache")) {
      familiar((0,dist.$familiar)(events_templateObject145 || (events_templateObject145 = events_taggedTemplateLiteral(["Mini-Hipster"]))));
      ...
      withEquipment(() => adventure(noobCave, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject148 || (events_templateObject148 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject149 || (events_templateObject149 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))]]);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject150 || (events_templateObject150 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject151 || (events_templateObject151 = events_taggedTemplateLiteral(["none"]))));
      checkAvailable((0,dist.$item)(events_templateObject152 || (events_templateObject152 = events_taggedTemplateLiteral(["ironic moustache"]))));
      (0,external_kolmafia_.cliExecute)("fold ".concat((0,dist.$item)(events_templateObject153 || (events_templateObject153 = events_taggedTemplateLiteral(["chiptune guitar"])))));
    }
  },
  mimic: () => {
    if (!(0,dist.get)("_bagOfCandy")) {
      familiar((0,dist.$familiar)(events_templateObject154 || (events_templateObject154 = events_taggedTemplateLiteral(["Stocking Mimic"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject155 || (events_templateObject155 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject156 || (events_templateObject156 = events_taggedTemplateLiteral(["none"]))));
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject157 || (events_templateObject157 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject158 || (events_templateObject158 = events_taggedTemplateLiteral(["none"]))));
      checkAvailable((0,dist.$item)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["bag of many confections"]))));
    }
  },
  tropicalSkeleton: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject160 || (events_templateObject160 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject161 || (events_templateObject161 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      familiar((0,dist.$familiar)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["Crimbo Shrub"]))));

      if (!(0,dist.get)("_shrubDecorated")) {
        (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=&which=99&whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject164 || (events_templateObject164 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))))));
        (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=999&pwd=&option=1&topper=2&lights=5&garland=3&gift=2");
      }

      mapMonster(skeletonStore, (0,dist.$monster)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["novelty tropical skeleton"]))), MacroList.TropicalSkeleton);
      checkEffect((0,dist.$effect)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["Everything Looks Red"]))));
      (0,dist.$items)(events_templateObject167 || (events_templateObject167 = events_taggedTemplateLiteral(["cherry, grapefruit, lemon, strawberry"]))).forEach(fruit => checkAvailable(fruit));
    }
  },
  nanobrainy: () => {
    if (!(0,dist.get)("_gingerbreadClockAdvanced")) adventure(civicCenter, dist.Macro.abort());

    if (!(0,dist.have)((0,dist.$effect)(events_templateObject168 || (events_templateObject168 = events_taggedTemplateLiteral(["Nanobrainy"])))) && (0,dist.get)("_nanorhinoCharge") > 99) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject169 || (events_templateObject169 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject170 || (events_templateObject170 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject171 || (events_templateObject171 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject172 || (events_templateObject172 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      familiar((0,dist.$familiar)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
      checkEffect((0,dist.$effect)(events_templateObject174 || (events_templateObject174 = events_taggedTemplateLiteral(["Nanobrainy"]))));
    }
  },
  meteorUngulith: () => {
    var fax = (0,dist.$item)(events_templateObject175 || (events_templateObject175 = events_taggedTemplateLiteral(["photocopied monster"])));
    var faxMon = (0,dist.$monster)(events_templateObject176 || (events_templateObject176 = events_taggedTemplateLiteral(["ungulith"])));
    if (!(0,dist.have)(fax)) dist.Clan.with(FAX_AND_SLIME_CLAN, () => (0,external_kolmafia_.cliExecute)("fax receive"));

    if (!(0,external_kolmafia_.containsText)((0,external_kolmafia_.visitUrl)("desc_item.php?whichitem=".concat(fax.descid)), "".concat(faxMon))) {
    ...
    checkAvailable((0,dist.$item)(events_templateObject177 || (events_templateObject177 = events_taggedTemplateLiteral(["corrupted marrow"]))));
  },
  foamYourself: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject178 || (events_templateObject178 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))))) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject179 || (events_templateObject179 = events_taggedTemplateLiteral(["Exotic Parrot"]))));
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject182 || (events_templateObject182 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject183 || (events_templateObject183 = events_taggedTemplateLiteral(["industrial fire extinguisher"]))));
      adventure(direWarren, MacroList.FoamForce);
      checkEffect((0,dist.$effect)(events_templateObject184 || (events_templateObject184 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))));
    }
  },
  meteorShower: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject185 || (events_templateObject185 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      tryUse((0,dist.$item)(events_templateObject186 || (events_templateObject186 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));
      ...
      if ((0,dist.have)((0,dist.$effect)(events_templateObject187 || (events_templateObject187 = events_taggedTemplateLiteral(["Absinthe-Minded"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject188 || (events_templateObject188 = events_taggedTemplateLiteral(["disintegrating spiky collar"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject189 || (events_templateObject189 = events_taggedTemplateLiteral(["Man's Worst Enemy"]))))) {
        (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject191 || (events_templateObject191 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
        mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.MeteorForce);
        checkAvailable((0,dist.$item)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
        checkEffect((0,dist.$effect)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["Meteor Showered"]))));
        tryUse((0,dist.$item)(events_templateObject195 || (events_templateObject195 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
      } else {
        (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject196 || (events_templateObject196 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject197 || (events_templateObject197 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
        adventure(direWarren, MacroList.MeteorForce);
        checkEffect((0,dist.$effect)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["Meteor Showered"]))));
      }
    }
  },
  batform: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject202 || (events_templateObject202 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.BatForm);
      checkEffect((0,dist.$effect)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))));
    }
  }
};
...
function familiar(fam) {
  ...
  var costume = new Map([[(0,dist.$familiar)(events_templateObject205 || (events_templateObject205 = events_taggedTemplateLiteral(["Green Pixie"]))), "mp"], [(0,dist.$familiar)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["Machine Elf"]))), "meat"], [(0,dist.$familiar)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["Melodramedary"]))), "myst"], [(0,dist.$familiar)(events_templateObject208 || (events_templateObject208 = events_taggedTemplateLiteral(["Pocket Professor"]))), "hp"], [(0,dist.$familiar)(events_templateObject209 || (events_templateObject209 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))), "item"]]).get(fam);
...
function selectBestFamiliar() {
  ...
  if (!(0,dist.have)((0,dist.$effect)(events_templateObject210 || (events_templateObject210 = events_taggedTemplateLiteral(["Spit Upon"]))))) {
    familiar((0,dist.$familiar)(events_templateObject211 || (events_templateObject211 = events_taggedTemplateLiteral(["Melodramedary"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject212 || (events_templateObject212 = events_taggedTemplateLiteral(["short stack of pancakes"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject213 || (events_templateObject213 = events_taggedTemplateLiteral(["Shortly Stacked"]))))) {
    familiar((0,dist.$familiar)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject215 || (events_templateObject215 = events_taggedTemplateLiteral(["tiny bottle of absinthe"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["Absinthe-Minded"]))))) {
    familiar((0,dist.$familiar)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["Green Pixie"]))));
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject218 || (events_templateObject218 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject219 || (events_templateObject219 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject220 || (events_templateObject220 = events_taggedTemplateLiteral(["burning paper crane"])))) && (0,dist.get)("garbageFireProgress") + getRemainingFreeFights() >= 30) {
    familiar((0,dist.$familiar)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Garbage Fire"]))));
  } else if (flag === FamiliarFlag.ToxicTeacups && (0,dist.get)("_hipsterAdv") < 7) {
    familiar((0,dist.$familiar)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else {
    familiar((0,dist.$familiar)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["Machine Elf"]))));
  }
}
...
function synthesize() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _iterator2 = sweetsynthesis_createForOfIteratorHelper(pair),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var creatable = _step2.value;
      ...
      (0,external_kolmafia_.sweetSynthesis)(pair[0], pair[1]);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
[1387, 3] // Using the Force: (1) banish (2) find friends (3) force item drops
  ...
  return ["choiceAdventure".concat(id), val];
});
...
function levelAndDoQuests() {
  ...
  var completeQuest = quest => results.set(quest, prepAndDoQuest(quest));
    ...
    (function () {
      ...
      leveling: while (true) {
        ...
        if (chateauNapReady()) {
          ...
          }, [[(0,dist.$slot)(main_templateObject6 || (main_templateObject6 = main_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(main_templateObject7 || (main_templateObject7 = main_taggedTemplateLiteral(["familiar scrapbook"])))]]);
        }

        if (!(0,dist.have)((0,dist.$effect)(main_templateObject8 || (main_templateObject8 = main_taggedTemplateLiteral(["Soulerskates"]))))) {
          if ((0,external_kolmafia_.mySoulsauce)() >= (0,external_kolmafia_.soulsauceCost)((0,dist.$skill)(main_templateObject9 || (main_templateObject9 = main_taggedTemplateLiteral(["Soul Rotation"]))))) {
            acquireEffect((0,dist.$effect)(main_templateObject10 || (main_templateObject10 = main_taggedTemplateLiteral(["Soulerskates"]))));
          }
        } else {
          while ((0,external_kolmafia_.mySoulsauce)() >= (0,external_kolmafia_.soulsauceCost)((0,dist.$skill)(main_templateObject11 || (main_templateObject11 = main_taggedTemplateLiteral(["Soul Food"])))) && (0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.myMp)() >= 15) {
            (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject12 || (main_templateObject12 = main_taggedTemplateLiteral(["Soul Food"]))));
          }
        }

        while ((0,dist.have)((0,dist.$item)(main_templateObject13 || (main_templateObject13 = main_taggedTemplateLiteral(["magical sausage casing"])))) && ((0,dist.get)("_sausagesMade") + 1) * 111 < (0,external_kolmafia_.myMeat)() - MEAT_SAFE_LIMIT && (0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.myMp)() > 1000 && (0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.mpCost)((0,dist.$skill)(main_templateObject14 || (main_templateObject14 = main_taggedTemplateLiteral(["Summon BRICKOs"])))) > MP_SAFE_LIMIT && (0,dist.get)("_sausagesEaten") < 23) {
          (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject15 || (main_templateObject15 = main_taggedTemplateLiteral(["magical sausage"]))));
          (0,external_kolmafia_.eat)((0,dist.$item)(main_templateObject16 || (main_templateObject16 = main_taggedTemplateLiteral(["magical sausage"]))));
        }

        while ((0,external_kolmafia_.myMp)() - (0,external_kolmafia_.mpCost)((0,dist.$skill)(main_templateObject17 || (main_templateObject17 = main_taggedTemplateLiteral(["Summon BRICKOs"])))) > MP_SAFE_LIMIT) {
          castBestLibram();
        ...
        while ((0,dist.have)((0,dist.$item)(main_templateObject18 || (main_templateObject18 = main_taggedTemplateLiteral(["BRICKO eye brick"])))) && (0,dist.have)((0,dist.$item)(main_templateObject19 || (main_templateObject19 = main_taggedTemplateLiteral(["BRICKO brick"]))), BRICKOS_PER_FIGHT)) {
          (0,external_kolmafia_.create)(BRICKO_TARGET_ITEM);
        }

        if ((0,dist.have)((0,dist.$item)(main_templateObject20 || (main_templateObject20 = main_taggedTemplateLiteral(["burning newspaper"]))))) (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject21 || (main_templateObject21 = main_taggedTemplateLiteral(["burning paper crane"]))));
        tryUse((0,dist.$item)(main_templateObject22 || (main_templateObject22 = main_taggedTemplateLiteral(["short stack of pancakes"])))); // Save the Garbage shirt for the last 37 fights
        // Swap from Iunion Crown to Wad of Used Tape once Myst is high enough

        var crown = (0,dist.$item)(main_templateObject23 || (main_templateObject23 = main_taggedTemplateLiteral(["Iunion Crown"])));
        var garbageShirt = (0,dist.$item)(main_templateObject24 || (main_templateObject24 = main_taggedTemplateLiteral(["makeshift garbage shirt"])));
        var wad = (0,dist.$item)(main_templateObject25 || (main_templateObject25 = main_taggedTemplateLiteral(["wad of used tape"])));

        if ((0,external_kolmafia_.haveEquipped)(garbageShirt) || getRemainingFreeFights() <= 37) {
          if (!(0,dist.have)(garbageShirt)) {
            (0,external_kolmafia_.cliExecute)("fold ".concat(garbageShirt)); // Turbo used a flag to cast pride

            dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject26 || (main_templateObject26 = main_taggedTemplateLiteral(["Turbo"]))));
            ...
            (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject28 || (main_templateObject28 = main_taggedTemplateLiteral(["hat"]))), crown);
          }
        } else if ((0,external_kolmafia_.myBasestat)(mainstat) > 100) {
          if (!(0,dist.have)(wad)) (0,external_kolmafia_.cliExecute)("fold ".concat(wad));
          (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject29 || (main_templateObject29 = main_taggedTemplateLiteral(["hat"]))), wad);
        } else {
          (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject30 || (main_templateObject30 = main_taggedTemplateLiteral(["hat"]))), crown);
        }
  ...
  shrugEffect((0,dist.$effect)(main_templateObject31 || (main_templateObject31 = main_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))));
  shrugEffect((0,dist.$effect)(main_templateObject32 || (main_templateObject32 = main_taggedTemplateLiteral(["Polka of Plenty"]))));
  (0,external_kolmafia_.changeMcd)(0);
  wishEffect((0,dist.$effect)(main_templateObject33 || (main_templateObject33 = main_taggedTemplateLiteral(["Sparkly!"]))));
  ...
  if (haveQuest(Quest.SpellDamage)) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(main_templateObject34 || (main_templateObject34 = main_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"]))))) {
      ...
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject35 || (main_templateObject35 = main_taggedTemplateLiteral(["Deep Dark Visions"]))));
      (0,external_kolmafia_.print)("Current HP after Deep Dark Visions: ".concat((0,external_kolmafia_.myHp)()));
    }

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject36 || (main_templateObject36 = main_taggedTemplateLiteral(["Cowrruption"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject37 || (main_templateObject37 = main_taggedTemplateLiteral(["corrupted marrow"]))));
      if ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() * 0.5) (0,external_kolmafia_.cliExecute)("hottub");
    }
  ...
  shrugEffect((0,dist.$effect)(main_templateObject38 || (main_templateObject38 = main_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))));
  completeQuest(Quest.Mysticality);

  if (haveQuest(Quest.CombatFrequency)) {
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject39 || (main_templateObject39 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject40 || (main_templateObject40 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  ...
  shrugEffect((0,dist.$effect)(main_templateObject41 || (main_templateObject41 = main_taggedTemplateLiteral(["The Sonata of Sneakiness"]))));

  if (haveQuest(Quest.FamiliarWeight)) {
    oneOffEvents.meteorShower();

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject42 || (main_templateObject42 = main_taggedTemplateLiteral(["Smart Drunk"]))))) {
      (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(main_templateObject43 || (main_templateObject43 = main_taggedTemplateLiteral(["The Ode to Booze"]))));
      (0,external_kolmafia_.drink)((0,dist.$item)(main_templateObject44 || (main_templateObject44 = main_taggedTemplateLiteral(["vintage smart drink"])))); // 10 drunk
    }

    var icyRevenge = (0,dist.$item)(main_templateObject45 || (main_templateObject45 = main_taggedTemplateLiteral(["love song of icy revenge"])));

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject46 || (main_templateObject46 = main_taggedTemplateLiteral(["Cold Hearted"])))) && (0,dist.have)(icyRevenge)) {
...
function preCoilWire() {
  ...
  [(0,dist.$item)(main_templateObject47 || (main_templateObject47 = main_taggedTemplateLiteral(["letter from King Ralph XI"]))), (0,dist.$item)(main_templateObject48 || (main_templateObject48 = main_taggedTemplateLiteral(["pork elf goodies sack"]))), (0,dist.$item)(main_templateObject49 || (main_templateObject49 = main_taggedTemplateLiteral(["banana candle"]))), (0,dist.$item)(main_templateObject50 || (main_templateObject50 = main_taggedTemplateLiteral(["ear candle"]))), (0,dist.$item)(main_templateObject51 || (main_templateObject51 = main_taggedTemplateLiteral(["natural magick candle"]))), (0,dist.$item)(main_templateObject52 || (main_templateObject52 = main_taggedTemplateLiteral(["rainbow glitter candle"]))), (0,dist.$item)(main_templateObject53 || (main_templateObject53 = main_taggedTemplateLiteral(["votive of confidence"])))].forEach(gift => tryUse(gift)); // Only need one consult for a candy
  ...
  (0,dist.$items)(main_templateObject54 || (main_templateObject54 = main_taggedTemplateLiteral(["baconstone, hamethyst, porquoise"]))).forEach(gem => (0,external_kolmafia_.autosell)(5, gem));
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject55 || (main_templateObject55 = main_taggedTemplateLiteral(["Communism!"]))));
  var calculation = "14";
  ...
  (0,external_kolmafia_.autosell)(14 * (0,dist.get)("skillLevel144"), (0,dist.$item)(main_templateObject56 || (main_templateObject56 = main_taggedTemplateLiteral(["moxie weed"]))));
  ...
  dist.SongBoom.setSong("Total Eclipse of Your Meat"); // 8601 meat

  openQuestZones();
  buffUpBeginning();

  var _iterator = main_createForOfIteratorHelper([[(0,dist.$effect)(main_templateObject64 || (main_templateObject64 = main_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))), () => (0,external_kolmafia_.visitUrl)("place.php?whichplace=campaway&action=campaway_sky")], [(0,dist.$item)(main_templateObject65 || (main_templateObject65 = main_taggedTemplateLiteral(["\"DRINK ME\" potion"]))), // Why is this necessary? I don't know why it won't just grab the potion
  () => (0,external_kolmafia_.visitUrl)("clan_viplounge.php?action=lookingglass&whichfloor=2")], [(0,dist.$item)(main_templateObject66 || (main_templateObject66 = main_taggedTemplateLiteral(["your cowboy boots"]))), () => (0,external_kolmafia_.visitUrl)("place.php?whichplace=town_right&action=townright_ltt")], [(0,dist.$item)(main_templateObject67 || (main_templateObject67 = main_taggedTemplateLiteral(["detuned radio"]))), () => {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject68 || (main_templateObject68 = main_taggedTemplateLiteral(["detuned radio"])))); // 8601 - 285 = 8316 meat

    (0,external_kolmafia_.changeMcd)(10);
  }], [(0,dist.$item)(main_templateObject69 || (main_templateObject69 = main_taggedTemplateLiteral(["flimsy hardwood scraps"]))), () => (0,external_kolmafia_.visitUrl)("shop.php?whichshop=lathe")], [(0,dist.$item)(main_templateObject70 || (main_templateObject70 = main_taggedTemplateLiteral(["weeping willow wand"]))), () => {
    (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject71 || (main_templateObject71 = main_taggedTemplateLiteral(["weeping willow wand"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject72 || (main_templateObject72 = main_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(main_templateObject73 || (main_templateObject73 = main_taggedTemplateLiteral(["weeping willow wand"]))));
  }], [(0,dist.$item)(main_templateObject74 || (main_templateObject74 = main_taggedTemplateLiteral(["battery (AAA)"]))), () => harvestBatteries()], [(0,dist.$item)(main_templateObject75 || (main_templateObject75 = main_taggedTemplateLiteral(["Brutal brogues"]))), () => (0,external_kolmafia_.cliExecute)("bastille bbq brutalist gesture")], [(0,dist.$item)(main_templateObject76 || (main_templateObject76 = main_taggedTemplateLiteral(["cop dollar"]))), () => (0,external_kolmafia_.cliExecute)("Detective Solver")], [(0,dist.$item)(main_templateObject77 || (main_templateObject77 = main_taggedTemplateLiteral(["green mana"]))), () => (0,external_kolmafia_.cliExecute)("cheat forest")], [(0,dist.$item)(main_templateObject78 || (main_templateObject78 = main_taggedTemplateLiteral(["wrench"]))), () => (0,external_kolmafia_.cliExecute)("cheat wrench")], [(0,dist.$item)(main_templateObject79 || (main_templateObject79 = main_taggedTemplateLiteral(["rope"]))), () => (0,external_kolmafia_.cliExecute)("cheat rope")], [(0,dist.$item)(main_templateObject80 || (main_templateObject80 = main_taggedTemplateLiteral(["occult jelly donut"]))), () => (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject81 || (main_templateObject81 = main_taggedTemplateLiteral(["occult jelly donut"]))))], [(0,dist.$item)(main_templateObject82 || (main_templateObject82 = main_taggedTemplateLiteral(["Yeg's Motel hand soap"]))), () => (0,external_kolmafia_.cliExecute)("cargo item ".concat((0,dist.$item)(main_templateObject83 || (main_templateObject83 = main_taggedTemplateLiteral(["Yeg's Motel hand soap"])))))], [(0,dist.$skill)(main_templateObject84 || (main_templateObject84 = main_taggedTemplateLiteral(["Seek out a Bird"]))), () => (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject85 || (main_templateObject85 = main_taggedTemplateLiteral(["Bird-a-Day calendar"]))))]]),
      _step;
  ...
  if (!(0,dist.get)("_borrowedTimeUsed")) {
    if (!(0,dist.have)((0,dist.$item)(main_templateObject57 || (main_templateObject57 = main_taggedTemplateLiteral(["borrowed time"]))))) (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject58 || (main_templateObject58 = main_taggedTemplateLiteral(["borrowed time"]))));
    (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject59 || (main_templateObject59 = main_taggedTemplateLiteral(["borrowed time"]))));
  }

  if ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)()) (0,external_kolmafia_.cliExecute)("hottub");
  if ((0,dist.get)("_sourceTerminalDigitizeUses") < 1) dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject60 || (main_templateObject60 = main_taggedTemplateLiteral(["Digitize"]))));
  oneOffEvents.hipster();

  if ((0,dist.get)("_sourceTerminalDigitizeUses") > 0) {
    dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject61 || (main_templateObject61 = main_taggedTemplateLiteral(["Compress"]))));
    dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject62 || (main_templateObject62 = main_taggedTemplateLiteral(["Extract"]))));
  ...
  oneOffEvents.tropicalSkeleton(); // 8316 + 2000 = 10316 meat
  // TODO: handle non-sauceror [1457]Blood Sugar Sauce Magic

  acquireEffect((0,dist.$effect)(main_templateObject63 || (main_templateObject63 = main_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"]))));
  spendAllMpOnLibrams();
}

function postCoilWire() {
  gazeAtTheStars();
  if ((0,dist.have)((0,dist.$item)(main_templateObject86 || (main_templateObject86 = main_taggedTemplateLiteral(["occult jelly donut"]))))) (0,external_kolmafia_.eat)((0,dist.$item)(main_templateObject87 || (main_templateObject87 = main_taggedTemplateLiteral(["occult jelly donut"]))));
  ...
  (0,dist.$skill)(main_templateObject91 || (main_templateObject91 = main_taggedTemplateLiteral(["Advanced Cocktailcrafting"]))), (0,dist.$skill)(main_templateObject92 || (main_templateObject92 = main_taggedTemplateLiteral(["Advanced Saucecrafting"]))), (0,dist.$skill)(main_templateObject93 || (main_templateObject93 = main_taggedTemplateLiteral(["Chubby and Plump"]))), (0,dist.$skill)(main_templateObject94 || (main_templateObject94 = main_taggedTemplateLiteral(["Perfect Freeze"]))), (0,dist.$skill)(main_templateObject95 || (main_templateObject95 = main_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))), // Only need Alice's Army and Crimbo Candy for now
  (0,dist.$skill)(main_templateObject96 || (main_templateObject96 = main_taggedTemplateLiteral(["Summon Alice's Army Cards"]))), //$skill`Summon Confiscated Things`,
  (0,dist.$skill)(main_templateObject97 || (main_templateObject97 = main_taggedTemplateLiteral(["Summon Crimbo Candy"]))), //$skill`Summon Geeky Gifts`,
  //$skill`Summon Tasteful Items`,
  // Buffs that can't fit elsewhere
  (0,dist.$skill)(main_templateObject98 || (main_templateObject98 = main_taggedTemplateLiteral(["Incredible Self-Esteem"])))].forEach(skill => (0,external_kolmafia_.useSkill)(skill)); // 143 mp
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject103 || (main_templateObject103 = main_taggedTemplateLiteral(["toy accordion"]))));
  acquireEffect((0,dist.$effect)(main_templateObject104 || (main_templateObject104 = main_taggedTemplateLiteral(["Ode to Booze"])))); // 9366 - 142 = 9224 meat

  checkMainClan();
  (0,dist.$effects)(main_templateObject105 || (main_templateObject105 = main_taggedTemplateLiteral(["[1701]Hip to the Jive, In a Lather"]))).forEach(speakeasy => acquireEffect(speakeasy)); // 5 drunk, 5500 meat
  // 9224 - 5500 = 3724 meat
  ...
  var water = (0,dist.$item)(main_templateObject106 || (main_templateObject106 = main_taggedTemplateLiteral(["cold-filtered water"])));
  if ((0,dist.get)("tomeSummons") < 3 && !(0,dist.have)(water) && !(0,dist.have)((0,dist.$effect)(main_templateObject107 || (main_templateObject107 = main_taggedTemplateLiteral(["Purity of Spirit"]))))) (0,external_kolmafia_.create)(water);
  tryUse(water); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  [(0,dist.$item)(main_templateObject108 || (main_templateObject108 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))), (0,dist.$item)(main_templateObject109 || (main_templateObject109 = main_taggedTemplateLiteral(["Napalm In The Morning\u2122 candle"]))), (0,dist.$item)(main_templateObject110 || (main_templateObject110 = main_taggedTemplateLiteral(["Salsa Caliente\u2122 candle"]))), (0,dist.$item)(main_templateObject111 || (main_templateObject111 = main_taggedTemplateLiteral(["Smoldering Clover\u2122 candle"])))].forEach(potion => tryUse(potion));
  (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject112 || (main_templateObject112 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject113 || (main_templateObject113 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject114 || (main_templateObject114 = main_taggedTemplateLiteral(["turtle totem"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject115 || (main_templateObject115 = main_taggedTemplateLiteral(["saucepan"]))));
  buffUpLeveling(); // 316 mp
