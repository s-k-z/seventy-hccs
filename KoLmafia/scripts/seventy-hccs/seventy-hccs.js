...
function equipOutfit(outfit) {
  ...
  if (!equipment.get((0,dist.$slot)(_templateObject182 || (_templateObject182 = quests_taggedTemplateLiteral(["back"]))))) retrocape(outfit);
...
function retrocape(quest) {
  switch (quest) {
    case Quest.Muscle:
      (0,external_kolmafia_.cliExecute)("retrocape ".concat((0,dist.$stat)(_templateObject183 || (_templateObject183 = quests_taggedTemplateLiteral(["Muscle"])))));
      return;

    case Quest.Mysticality:
      (0,external_kolmafia_.cliExecute)("retrocape ".concat((0,dist.$stat)(_templateObject184 || (_templateObject184 = quests_taggedTemplateLiteral(["Mysticality"])))));
      return;

    case Quest.Moxie:
      (0,external_kolmafia_.cliExecute)("retrocape ".concat((0,dist.$stat)(_templateObject185 || (_templateObject185 = quests_taggedTemplateLiteral(["Moxie"])))));
      return;
...
var sharedStats = new Map([[(0,dist.$effect)(_templateObject186 || (_templateObject186 = quests_taggedTemplateLiteral(["Feeling Excited"]))), Context.beginning], [(0,dist.$effect)(_templateObject187 || (_templateObject187 = quests_taggedTemplateLiteral(["Triple-Sized"]))), Context.beginning], [(0,dist.$effect)(_templateObject188 || (_templateObject188 = quests_taggedTemplateLiteral(["Big"]))), Context.leveling], [(0,dist.$effect)(_templateObject189 || (_templateObject189 = quests_taggedTemplateLiteral(["Favored by Lyle"]))), Context.leveling], [(0,dist.$effect)(_templateObject190 || (_templateObject190 = quests_taggedTemplateLiteral(["Starry-Eyed"]))), Context.leveling], [(0,dist.$effect)(_templateObject191 || (_templateObject191 = quests_taggedTemplateLiteral(["Total Protonic Reversal"]))), Context.leveling], [(0,dist.$effect)(_templateObject192 || (_templateObject192 = quests_taggedTemplateLiteral(["Spit Upon"]))), Context.special]]);
...
])), _defineProperty(_questEffects, Quest.Sprinkles, new Map()), _defineProperty(_questEffects, Quest.Muscle, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject222 || (_templateObject222 = quests_taggedTemplateLiteral(["Lack of Body-Building"]))), Context.leveling], [(0,dist.$effect)(_templateObject223 || (_templateObject223 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), Context.test], [(0,dist.$effect)(_templateObject224 || (_templateObject224 = quests_taggedTemplateLiteral(["Phorcefullness"]))), Context.test], [(0,dist.$effect)(_templateObject225 || (_templateObject225 = quests_taggedTemplateLiteral(["Quiet Determination"]))), Context.test], [(0,dist.$effect)(_templateObject226 || (_templateObject226 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), Context.test], [(0,dist.$effect)(_templateObject227 || (_templateObject227 = quests_taggedTemplateLiteral(["Giant Growth"]))), Context.special]]))), _defineProperty(_questEffects, Quest.Moxie, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject228 || (_templateObject228 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject229 || (_templateObject229 = quests_taggedTemplateLiteral(["Pomp & Circumsands"]))), Context.leveling], [(0,dist.$effect)(_templateObject230 || (_templateObject230 = quests_taggedTemplateLiteral(["Disco Fever"]))), Context.test], [(0,dist.$effect)(_templateObject231 || (_templateObject231 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), Context.test], [(0,dist.$effect)(_templateObject232 || (_templateObject232 = quests_taggedTemplateLiteral(["Quiet Desperation"]))), Context.test], // Wish
[(0,dist.$effect)(_templateObject233 || (_templateObject233 = quests_taggedTemplateLiteral(["Sparkly!"]))), Context.special]]))), _defineProperty(_questEffects, Quest.HP, new Map([[(0,dist.$effect)(_templateObject234 || (_templateObject234 = quests_taggedTemplateLiteral(["Song of Starch"]))), Context.test]])), _defineProperty(_questEffects, Quest.DeepDark, new Map()), _defineProperty(_questEffects, Quest.SpellDamage, new Map([].concat(quests_toConsumableArray(sharedSpellWeaponDamage), [[(0,dist.$effect)(_templateObject235 || (_templateObject235 = quests_taggedTemplateLiteral(["Spirit of Peppermint"]))), Context.beginning], [(0,dist.$effect)(_templateObject236 || (_templateObject236 = quests_taggedTemplateLiteral(["AAA-Charged"]))), Context.leveling], [(0,dist.$effect)(_templateObject237 || (_templateObject237 = quests_taggedTemplateLiteral(["Carol of the Hells"]))), Context.leveling], [(0,dist.$effect)(_templateObject238 || (_templateObject238 = quests_taggedTemplateLiteral(["Full Bottle in front of Me"]))), Context.leveling], [(0,dist.$effect)(_templateObject239 || (_templateObject239 = quests_taggedTemplateLiteral(["Mental A-cue-ity"]))), Context.leveling], [(0,dist.$effect)(_templateObject240 || (_templateObject240 = quests_taggedTemplateLiteral(["Pisces in the Skyces"]))), Context.leveling], [(0,dist.$effect)(_templateObject241 || (_templateObject241 = quests_taggedTemplateLiteral(["Sigils of Yeg"]))), Context.leveling], [(0,dist.$effect)(_templateObject242 || (_templateObject242 = quests_taggedTemplateLiteral(["Warlock, Warstock, and Warbarrel"]))), Context.leveling], [(0,dist.$effect)(_templateObject243 || (_templateObject243 = quests_taggedTemplateLiteral(["We're All Made of Starfish"]))), Context.leveling], [(0,dist.$effect)(_templateObject244 || (_templateObject244 = quests_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"]))), Context.test], [(0,dist.$effect)(_templateObject245 || (_templateObject245 = quests_taggedTemplateLiteral(["Song of Sauce"]))), Context.test], [(0,dist.$effect)(_templateObject246 || (_templateObject246 = quests_taggedTemplateLiteral(["The Magic of LOV"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject247 || (_templateObject247 = quests_taggedTemplateLiteral(["Filled with Magic"]))), Context.special], [(0,dist.$effect)(_templateObject248 || (_templateObject248 = quests_taggedTemplateLiteral(["Drunk With Power"]))), Context.special], // Wish
[(0,dist.$effect)(_templateObject249 || (_templateObject249 = quests_taggedTemplateLiteral(["Sparkly!"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject250 || (_templateObject250 = quests_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"]))), Context.special], [(0,dist.$effect)(_templateObject251 || (_templateObject251 = quests_taggedTemplateLiteral(["Nanobrainy"]))), Context.special], [(0,dist.$effect)(_templateObject252 || (_templateObject252 = quests_taggedTemplateLiteral(["Toxic Vengeance"]))), Context.special]]))), _defineProperty(_questEffects, Quest.WeaponDamage, new Map([].concat(quests_toConsumableArray(sharedSpellWeaponDamage), [[(0,dist.$effect)(_templateObject253 || (_templateObject253 = quests_taggedTemplateLiteral(["Billiards Belligerence"]))), Context.leveling], [(0,dist.$effect)(_templateObject254 || (_templateObject254 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject255 || (_templateObject255 = quests_taggedTemplateLiteral(["Carol of the Bulls"]))), Context.leveling], [(0,dist.$effect)(_templateObject256 || (_templateObject256 = quests_taggedTemplateLiteral(["Frenzied, Bloody"]))), Context.leveling], [(0,dist.$effect)(_templateObject257 || (_templateObject257 = quests_taggedTemplateLiteral(["Lack of Body-Building"]))), Context.leveling], [(0,dist.$effect)(_templateObject258 || (_templateObject258 = quests_taggedTemplateLiteral(["Bow-Legged Swagger"]))), Context.test], [(0,dist.$effect)(_templateObject259 || (_templateObject259 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), Context.test], [(0,dist.$effect)(_templateObject260 || (_templateObject260 = quests_taggedTemplateLiteral(["Scowl of the Auk"]))), Context.test], [(0,dist.$effect)(_templateObject261 || (_templateObject261 = quests_taggedTemplateLiteral(["Song of the North"]))), Context.test], [(0,dist.$effect)(_templateObject262 || (_templateObject262 = quests_taggedTemplateLiteral(["Tenacity of the Snapper"]))), Context.test], [(0,dist.$effect)(_templateObject263 || (_templateObject263 = quests_taggedTemplateLiteral(["The Power of LOV"]))), Context.test]]))), _defineProperty(_questEffects, Quest.Mysticality, new Map([].concat(quests_toConsumableArray(sharedStats), [[(0,dist.$effect)(_templateObject264 || (_templateObject264 = quests_taggedTemplateLiteral(["Uncucumbered"]))), Context.beginning], [(0,dist.$effect)(_templateObject265 || (_templateObject265 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject266 || (_templateObject266 = quests_taggedTemplateLiteral(["Mystically Oiled"]))), Context.leveling], [(0,dist.$effect)(_templateObject267 || (_templateObject267 = quests_taggedTemplateLiteral(["We're All Made of Starfish"]))), Context.leveling], [(0,dist.$effect)(_templateObject268 || (_templateObject268 = quests_taggedTemplateLiteral(["Quiet Judgement"]))), Context.test], // Wish
[(0,dist.$effect)(_templateObject269 || (_templateObject269 = quests_taggedTemplateLiteral(["Witch Breaded"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject270 || (_templateObject270 = quests_taggedTemplateLiteral(["Nanobrainy"]))), Context.special]]))), _defineProperty(_questEffects, Quest.CombatFrequency, new Map([[(0,dist.$effect)(_templateObject271 || (_templateObject271 = quests_taggedTemplateLiteral(["Become Superficially interested"]))), Context.test], [(0,dist.$effect)(_templateObject272 || (_templateObject272 = quests_taggedTemplateLiteral(["Feeling Lonely"]))), Context.test], [(0,dist.$effect)(_templateObject273 || (_templateObject273 = quests_taggedTemplateLiteral(["Gummed Shoes"]))), Context.test], [(0,dist.$effect)(_templateObject274 || (_templateObject274 = quests_taggedTemplateLiteral(["Invisible Avatar"]))), Context.test], [(0,dist.$effect)(_templateObject275 || (_templateObject275 = quests_taggedTemplateLiteral(["Silent Running"]))), Context.test], [(0,dist.$effect)(_templateObject276 || (_templateObject276 = quests_taggedTemplateLiteral(["Smooth Movements"]))), Context.test], [(0,dist.$effect)(_templateObject277 || (_templateObject277 = quests_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), Context.test], [(0,dist.$effect)(_templateObject278 || (_templateObject278 = quests_taggedTemplateLiteral(["Throwing Some Shade"]))), Context.test], [(0,dist.$effect)(_templateObject279 || (_templateObject279 = quests_taggedTemplateLiteral(["Silence of the God Lobster"]))), Context.special]])), _defineProperty(_questEffects, Quest.HotResist, new Map([[(0,dist.$effect)(_templateObject280 || (_templateObject280 = quests_taggedTemplateLiteral(["Feeling Peaceful"]))), Context.beginning], [(0,dist.$effect)(_templateObject281 || (_templateObject281 = quests_taggedTemplateLiteral(["Astral Shell"]))), Context.leveling], [(0,dist.$effect)(_templateObject282 || (_templateObject282 = quests_taggedTemplateLiteral(["Elemental Saucesphere"]))), Context.leveling], [(0,dist.$effect)(_templateObject283 || (_templateObject283 = quests_taggedTemplateLiteral(["Hot-Headed"]))), Context.leveling], [(0,dist.$effect)(_templateObject284 || (_templateObject284 = quests_taggedTemplateLiteral(["Rainbow Vaccine"]))), Context.leveling], [(0,dist.$effect)(_templateObject285 || (_templateObject285 = quests_taggedTemplateLiteral(["Amazing"]))), Context.test], //[$effect`Egged On`, Context.special],
[(0,dist.$effect)(_templateObject286 || (_templateObject286 = quests_taggedTemplateLiteral(["Misty Form"]))), Context.special]])), _defineProperty(_questEffects, Quest.FamiliarWeight, new Map([[(0,dist.$effect)(_templateObject287 || (_templateObject287 = quests_taggedTemplateLiteral(["Loyal Tea"]))), Context.leveling], [(0,dist.$effect)(_templateObject288 || (_templateObject288 = quests_taggedTemplateLiteral(["A Girl Named Sue"]))), Context.leveling], [(0,dist.$effect)(_templateObject289 || (_templateObject289 = quests_taggedTemplateLiteral(["Billiards Belligerence"]))), Context.leveling], [(0,dist.$effect)(_templateObject290 || (_templateObject290 = quests_taggedTemplateLiteral(["Blood Bond"]))), Context.leveling], [(0,dist.$effect)(_templateObject291 || (_templateObject291 = quests_taggedTemplateLiteral(["Do I Know You From Somewhere?"]))), Context.leveling], [(0,dist.$effect)(_templateObject292 || (_templateObject292 = quests_taggedTemplateLiteral(["Empathy"]))), Context.leveling], [(0,dist.$effect)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["Fidoxene"]))), Context.leveling], [(0,dist.$effect)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["Leash of Linguini"]))), Context.leveling], [(0,dist.$effect)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["Puzzle Champ"]))), Context.leveling], //[$effect`Man's Worst Enemy`, Context.test],
[(0,dist.$effect)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["Over-Familiar With Dactyls"]))), Context.test], [(0,dist.$effect)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["Robot Friends"]))), Context.test], [(0,dist.$effect)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["Whole Latte Love"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), Context.special], [(0,dist.$effect)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["Joy"]))), Context.special], [(0,dist.$effect)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["Smart Drunk"]))), Context.special], // Librams
...
var oneOffEvents = {
  ...
  meteorShower: function meteorShower() {
    if ((0,dist.have)((0,dist.$item)(events_templateObject197 || (events_templateObject197 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));
    ...
    if ((0,dist.have)((0,dist.$effect)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["absinthe minded"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["Meteor Showered"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) {
      ...
      if (!(0,dist.have)((0,dist.$effect)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["Meteor Showered"]))))) throw "Failed to get Meteor howered?";
    }

    if ((0,dist.have)((0,dist.$item)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject208 || (events_templateObject208 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));

    if (!(0,dist.have)((0,dist.$effect)(events_templateObject209 || (events_templateObject209 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
...
var mummingConstumes = new Map([[(0,dist.$familiar)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["Green Pixie"]))), "mp"], [(0,dist.$familiar)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["Machine Elf"]))), "meat"], [(0,dist.$familiar)(events_templateObject218 || (events_templateObject218 = events_taggedTemplateLiteral(["Melodramedary"]))), "myst"], [(0,dist.$familiar)(events_templateObject219 || (events_templateObject219 = events_taggedTemplateLiteral(["Pocket Professor"]))), "hp"], [(0,dist.$familiar)(events_templateObject220 || (events_templateObject220 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))), "item"]]);

function selectBestFamiliar() {
  var flag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : FamiliarFlag.Default;

  if (!(0,dist.have)((0,dist.$effect)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Spit Upon"]))))) {
    familiar((0,dist.$familiar)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["Melodramedary"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["short stack of pancakes"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject224 || (events_templateObject224 = events_taggedTemplateLiteral(["Shortly Stacked"]))))) {
    familiar((0,dist.$familiar)(events_templateObject225 || (events_templateObject225 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject226 || (events_templateObject226 = events_taggedTemplateLiteral(["tiny bottle of absinthe"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject227 || (events_templateObject227 = events_taggedTemplateLiteral(["absinthe minded"]))))) {
    familiar((0,dist.$familiar)(events_templateObject228 || (events_templateObject228 = events_taggedTemplateLiteral(["Green Pixie"]))));
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject229 || (events_templateObject229 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject230 || (events_templateObject230 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject231 || (events_templateObject231 = events_taggedTemplateLiteral(["burning paper crane"])))) && (0,dist.get)("garbageFireProgress") + getRemainingFreeFights() >= 30) {
    familiar((0,dist.$familiar)(events_templateObject232 || (events_templateObject232 = events_taggedTemplateLiteral(["Garbage Fire"]))));
    /*} else if (
    ...
    familiar((0,dist.$familiar)(events_templateObject233 || (events_templateObject233 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else {
    familiar((0,dist.$familiar)(events_templateObject234 || (events_templateObject234 = events_taggedTemplateLiteral(["Machine Elf"]))));
  }
}
...
function levelAndDoQuests() {
  ...
  if (getRemainingFreeFights() > 0) {
    ...
    leveling: while (true) {
      ...
      if ((0,dist.have)((0,dist.$item)(main_templateObject21 || (main_templateObject21 = main_taggedTemplateLiteral(["robin's egg"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject22 || (main_templateObject22 = main_taggedTemplateLiteral(["robin's egg"])))); // Save the Garbage shirt for the last 37 fights
      // Swap from Iunion Crown to Wad of Used Tape once Myst is high enough

      var garbageShirt = (0,dist.$item)(main_templateObject23 || (main_templateObject23 = main_taggedTemplateLiteral(["makeshift garbage shirt"])));
      ...
      if ((0,external_kolmafia_.haveEquipped)(garbageShirt) || getRemainingFreeFights() <= 37) {
        ...
        (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject25 || (main_templateObject25 = main_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(main_templateObject26 || (main_templateObject26 = main_taggedTemplateLiteral(["Iunion Crown"]))));
      } else if ((0,external_kolmafia_.myBasestat)(mainstat) > 100) {
        equipWadOfUsedTape();
      } else {
        (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject27 || (main_templateObject27 = main_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(main_templateObject28 || (main_templateObject28 = main_taggedTemplateLiteral(["Iunion Crown"]))));
  ...
  shrugEffect((0,dist.$effect)(main_templateObject29 || (main_templateObject29 = main_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))));
  shrugEffect((0,dist.$effect)(main_templateObject30 || (main_templateObject30 = main_taggedTemplateLiteral(["Polka of Plenty"]))));
  wishEffect((0,dist.$effect)(main_templateObject31 || (main_templateObject31 = main_taggedTemplateLiteral(["Sparkly!"]))));
  ...
  if (haveQuest(Quest.SpellDamage)) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(main_templateObject32 || (main_templateObject32 = main_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"]))))) {
      ...
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject33 || (main_templateObject33 = main_taggedTemplateLiteral(["Deep Dark Visions"]))));
      (0,external_kolmafia_.print)("Current HP after Deep Dark Visions: ".concat((0,external_kolmafia_.myHp)()));
    }

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject34 || (main_templateObject34 = main_taggedTemplateLiteral(["Cowrruption"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject35 || (main_templateObject35 = main_taggedTemplateLiteral(["corrupted marrow"]))));
  ...
  shrugEffect((0,dist.$effect)(main_templateObject36 || (main_templateObject36 = main_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))));
  prepAndDoQuest(Quest.Mysticality);

  if (haveQuest(Quest.CombatFrequency)) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject37 || (main_templateObject37 = main_taggedTemplateLiteral(["Disgeist"]))));
  ...
  if (haveQuest(Quest.HotResist)) {
    ...
    if (!(0,external_kolmafia_.haveEquipped)((0,dist.$item)(main_templateObject41 || (main_templateObject41 = main_taggedTemplateLiteral(["cracker"]))))) {
  ...
  shrugEffect((0,dist.$effect)(main_templateObject42 || (main_templateObject42 = main_taggedTemplateLiteral(["The Sonata of Sneakiness"]))));
  ...
  if (haveQuest(Quest.FamiliarWeight)) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(main_templateObject45 || (main_templateObject45 = main_taggedTemplateLiteral(["Smart Drunk"]))))) {
      (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(main_templateObject46 || (main_templateObject46 = main_taggedTemplateLiteral(["The Ode to Booze"]))));
      (0,external_kolmafia_.drink)((0,dist.$item)(main_templateObject47 || (main_templateObject47 = main_taggedTemplateLiteral(["vintage smart drink"]))));
    }

    var icyRevenge = (0,dist.$item)(main_templateObject48 || (main_templateObject48 = main_taggedTemplateLiteral(["love song of icy revenge"])));

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject49 || (main_templateObject49 = main_taggedTemplateLiteral(["Cold Hearted"])))) && (0,dist.have)(icyRevenge)) {
  ...
  if (haveQuest(Quest.ItemDrop)) {
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject50 || (main_templateObject50 = main_taggedTemplateLiteral(["Trick-or-Treating Tot"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject51 || (main_templateObject51 = main_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(main_templateObject52 || (main_templateObject52 = main_taggedTemplateLiteral(["li'l ninja costume"]))));
...
function preCoilWire() {
  ...
  tryUse(1, (0,dist.$item)(main_templateObject53 || (main_templateObject53 = main_taggedTemplateLiteral(["letter from King Ralph XI"]))));
  tryUse(1, (0,dist.$item)(main_templateObject54 || (main_templateObject54 = main_taggedTemplateLiteral(["pork elf goodies sack"])))); // Only need one consult for a candy
  ...
  if ((0,external_kolmafia_.myLevel)() + (0,external_kolmafia_.mySpleenUse)() === 1) {
    ...
    (0,external_kolmafia_.autosell)(14 * (0,dist.get)("_universeCalculated"), (0,dist.$item)(main_templateObject58 || (main_templateObject58 = main_taggedTemplateLiteral(["moxie weed"]))));
  }
  ...
  checkAvailable((0,dist.$item)(main_templateObject59 || (main_templateObject59 = main_taggedTemplateLiteral(["your cowboy boots"]))));
  (0,external_kolmafia_.cliExecute)("Detective Solver");
  checkAvailable((0,dist.$item)(main_templateObject60 || (main_templateObject60 = main_taggedTemplateLiteral(["gold detective badge"]))));
  buffUpBeginning();

  if (!(0,dist.have)((0,dist.$effect)(main_templateObject61 || (main_templateObject61 = main_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))))) {
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=campaway&action=campaway_sky");
  }
  ...
  scavengeDaycare();
  if (!(0,dist.have)((0,dist.$item)(main_templateObject62 || (main_templateObject62 = main_taggedTemplateLiteral(["Brutal brogues"]))))) (0,external_kolmafia_.cliExecute)("bastille bbq brutalist gesture");
  ...
  if (!(0,dist.have)((0,dist.$skill)(main_templateObject63 || (main_templateObject63 = main_taggedTemplateLiteral(["Digitize"])))) && (0,dist.get)("_sourceTerminalDigitizeUses") < 1) {
    ...
    if (!(0,dist.have)((0,dist.$skill)(main_templateObject64 || (main_templateObject64 = main_taggedTemplateLiteral(["Digitize"]))))) {
      throw "Error: need to learn ".concat((0,dist.$skill)(main_templateObject65 || (main_templateObject65 = main_taggedTemplateLiteral(["Digitize"]))));
    }
  }

  if ((0,external_kolmafia_.myAdventures)() < 60) {
    if (!(0,dist.have)((0,dist.$item)(main_templateObject66 || (main_templateObject66 = main_taggedTemplateLiteral(["borrowed time"]))))) {
      (0,external_kolmafia_.create)(1, (0,dist.$item)(main_templateObject67 || (main_templateObject67 = main_taggedTemplateLiteral(["borrowed time"]))));
    }
...
function postCoilWire() {
  ...
  whitelist(MAIN_CLAN);
  acquireEffect((0,dist.$effect)(main_templateObject104 || (main_templateObject104 = main_taggedTemplateLiteral(["[1701]Hip to the Jive"])))); // drink Hot Socks (3 drunk, 5000 meat)
  // 7913 - 5000 = 2913 meat

  acquireEffect((0,dist.$effect)(main_templateObject105 || (main_templateObject105 = main_taggedTemplateLiteral(["In a Lather"])))); // drink Sockdollager (2 drunk, 500 meat)
  // 2913 - 500 = 2413 meat
  ...
  if ((0,dist.have)((0,dist.$item)(main_templateObject111 || (main_templateObject111 = main_taggedTemplateLiteral(["cold-filtered water"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject112 || (main_templateObject112 = main_taggedTemplateLiteral(["cold-filtered water"])))); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  if ((0,dist.have)((0,dist.$item)(main_templateObject113 || (main_templateObject113 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject114 || (main_templateObject114 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))));
