...
var oneOffEvents = {
  hipster: () => {
    if (!(0,dist.get)("_ironicMoustache")) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject144 || (events_templateObject144 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject145 || (events_templateObject145 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      familiar((0,dist.$familiar)(events_templateObject146 || (events_templateObject146 = events_taggedTemplateLiteral(["Mini-Hipster"]))));
...
function postCoilWire() {
  ...
  checkMainClan();
  (0,dist.$effects)(main_templateObject106 || (main_templateObject106 = main_taggedTemplateLiteral(["[1701]Hip to the Jive, In a Lather"]))).forEach(acquireEffect); // 5 drunk, 5500 meat
  // 9224 - 5500 = 3724 meat
