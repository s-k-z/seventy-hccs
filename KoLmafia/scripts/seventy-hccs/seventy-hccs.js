...
var questRecords = (_questRecords = {}, _defineProperty(_questRecords, Quest.Beginning.id, () => {
  ...
  return {
    ...
    equipment: new Map([[(0,dist.$slot)(_templateObject150 || (_templateObject150 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject151 || (_templateObject151 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject152 || (_templateObject152 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject153 || (_templateObject153 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject154 || (_templateObject154 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject155 || (_templateObject155 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject156 || (_templateObject156 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject157 || (_templateObject157 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject158 || (_templateObject158 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject159 || (_templateObject159 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
    retrocape: "moxie"
  };
}), _defineProperty(_questRecords, Quest.HP.id, () => {
  var candle = (0,dist.$item)(_templateObject160 || (_templateObject160 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  return {
    acquire: [(0,dist.$effect)(_templateObject161 || (_templateObject161 = quests_taggedTemplateLiteral(["Song of Starch"])))],
    check: [],
    equipment: new Map([[(0,dist.$slot)(_templateObject162 || (_templateObject162 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.have)(candle) ? candle : (0,dist.$item)(_templateObject163 || (_templateObject163 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject164 || (_templateObject164 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject165 || (_templateObject165 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject166 || (_templateObject166 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject167 || (_templateObject167 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject168 || (_templateObject168 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject169 || (_templateObject169 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject170 || (_templateObject170 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject171 || (_templateObject171 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questRecords, Quest.DeepDark.id, () => {
  var outfit = new Map([[(0,dist.$slot)(_templateObject172 || (_templateObject172 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject173 || (_templateObject173 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject174 || (_templateObject174 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject175 || (_templateObject175 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject176 || (_templateObject176 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject177 || (_templateObject177 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
  if ((0,dist.have)((0,dist.$item)(_templateObject178 || (_templateObject178 = quests_taggedTemplateLiteral(["burning paper crane"]))))) outfit.set((0,dist.$slot)(_templateObject179 || (_templateObject179 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject180 || (_templateObject180 = quests_taggedTemplateLiteral(["burning paper crane"]))));
  return {
    acquire: [],
    check: [],
    equipment: outfit,
  ...
  return {
    acquire: [(0,dist.$effect)(_templateObject181 || (_templateObject181 = quests_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"]))), (0,dist.$effect)(_templateObject182 || (_templateObject182 = quests_taggedTemplateLiteral(["Cowrruption"]))), (0,dist.$effect)(_templateObject183 || (_templateObject183 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,dist.$effect)(_templateObject184 || (_templateObject184 = quests_taggedTemplateLiteral(["Song of Sauce"]))), (0,dist.$effect)(_templateObject185 || (_templateObject185 = quests_taggedTemplateLiteral(["The Magic of LOV"])))],
    check: [(0,dist.$effect)(_templateObject186 || (_templateObject186 = quests_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(_templateObject187 || (_templateObject187 = quests_taggedTemplateLiteral(["Filled with Magic"]))), (0,dist.$effect)(_templateObject188 || (_templateObject188 = quests_taggedTemplateLiteral(["In a Lather"]))), (0,dist.$effect)(_templateObject189 || (_templateObject189 = quests_taggedTemplateLiteral(["Inner Elf"]))), (0,dist.$effect)(_templateObject190 || (_templateObject190 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject191 || (_templateObject191 = quests_taggedTemplateLiteral(["Nanobrainy"]))), (0,dist.$effect)(_templateObject192 || (_templateObject192 = quests_taggedTemplateLiteral(["Sparkly!"]))), (0,dist.$effect)(_templateObject193 || (_templateObject193 = quests_taggedTemplateLiteral(["Spit Upon"]))), (0,dist.$effect)(_templateObject194 || (_templateObject194 = quests_taggedTemplateLiteral(["Toxic Vengeance"]))), (0,dist.$effect)(_templateObject195 || (_templateObject195 = quests_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))],
    // TODO: handle spell damage candle
    //const candle = [$slot`off-hand`, $item`Abracandalabra`];
    equipment: new Map([[(0,dist.$slot)(_templateObject196 || (_templateObject196 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject197 || (_templateObject197 = quests_taggedTemplateLiteral(["wrench"])))], [(0,dist.$slot)(_templateObject198 || (_templateObject198 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject199 || (_templateObject199 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject200 || (_templateObject200 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject201 || (_templateObject201 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject202 || (_templateObject202 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject203 || (_templateObject203 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject204 || (_templateObject204 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject205 || (_templateObject205 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(_templateObject206 || (_templateObject206 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject207 || (_templateObject207 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [(0,dist.$slot)(_templateObject208 || (_templateObject208 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject209 || (_templateObject209 = quests_taggedTemplateLiteral(["astral statuette"])))]]),
    familiar: (0,dist.$familiar)(_templateObject210 || (_templateObject210 = quests_taggedTemplateLiteral(["Left-Hand Man"])))
  };
}), _defineProperty(_questRecords, Quest.WeaponDamage.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject211 || (_templateObject211 = quests_taggedTemplateLiteral(["Bow-Legged Swagger"]))), (0,dist.$effect)(_templateObject212 || (_templateObject212 = quests_taggedTemplateLiteral(["Cowrruption"]))), (0,dist.$effect)(_templateObject213 || (_templateObject213 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,dist.$effect)(_templateObject214 || (_templateObject214 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), (0,dist.$effect)(_templateObject215 || (_templateObject215 = quests_taggedTemplateLiteral(["Scowl of the Auk"]))), (0,dist.$effect)(_templateObject216 || (_templateObject216 = quests_taggedTemplateLiteral(["Song of the North"]))), (0,dist.$effect)(_templateObject217 || (_templateObject217 = quests_taggedTemplateLiteral(["Tenacity of the Snapper"]))), (0,dist.$effect)(_templateObject218 || (_templateObject218 = quests_taggedTemplateLiteral(["The Power of LOV"])))];
  var toCheck = [(0,dist.$effect)(_templateObject219 || (_templateObject219 = quests_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(_templateObject220 || (_templateObject220 = quests_taggedTemplateLiteral(["In a Lather"]))), (0,dist.$effect)(_templateObject221 || (_templateObject221 = quests_taggedTemplateLiteral(["Inner Elf"]))), (0,dist.$effect)(_templateObject222 || (_templateObject222 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject223 || (_templateObject223 = quests_taggedTemplateLiteral(["Spit Upon"])))];
  var outfit = new Map([[(0,dist.$slot)(_templateObject224 || (_templateObject224 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject225 || (_templateObject225 = quests_taggedTemplateLiteral(["broken champagne bottle"])))], [(0,dist.$slot)(_templateObject226 || (_templateObject226 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject227 || (_templateObject227 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject228 || (_templateObject228 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject229 || (_templateObject229 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject230 || (_templateObject230 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject231 || (_templateObject231 = quests_taggedTemplateLiteral(["Powerful Glove"])))]]);
  var candle = (0,dist.$item)(_templateObject232 || (_templateObject232 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  if ((0,dist.have)(candle)) outfit.set((0,dist.$slot)(_templateObject233 || (_templateObject233 = quests_taggedTemplateLiteral(["hat"]))), candle);
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: outfit
  ...
  return {
    acquire: [(0,dist.$effect)(_templateObject234 || (_templateObject234 = quests_taggedTemplateLiteral(["Quiet Judgement"])))],
    check: [(0,dist.$effect)(_templateObject235 || (_templateObject235 = quests_taggedTemplateLiteral(["Nanobrainy"]))), (0,dist.$effect)(_templateObject236 || (_templateObject236 = quests_taggedTemplateLiteral(["Spit Upon"]))), (0,dist.$effect)(_templateObject237 || (_templateObject237 = quests_taggedTemplateLiteral(["Witch Breaded"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject238 || (_templateObject238 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject239 || (_templateObject239 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject240 || (_templateObject240 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject241 || (_templateObject241 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject242 || (_templateObject242 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject243 || (_templateObject243 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject244 || (_templateObject244 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject245 || (_templateObject245 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
    retrocape: "mysticality"
  };
}), _defineProperty(_questRecords, Quest.CombatFrequency.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject246 || (_templateObject246 = quests_taggedTemplateLiteral(["Become Superficially interested"]))), (0,dist.$effect)(_templateObject247 || (_templateObject247 = quests_taggedTemplateLiteral(["Feeling Lonely"]))), (0,dist.$effect)(_templateObject248 || (_templateObject248 = quests_taggedTemplateLiteral(["Gummed Shoes"]))), (0,dist.$effect)(_templateObject249 || (_templateObject249 = quests_taggedTemplateLiteral(["Invisible Avatar"]))), (0,dist.$effect)(_templateObject250 || (_templateObject250 = quests_taggedTemplateLiteral(["Silent Running"]))), (0,dist.$effect)(_templateObject251 || (_templateObject251 = quests_taggedTemplateLiteral(["Smooth Movements"]))), (0,dist.$effect)(_templateObject252 || (_templateObject252 = quests_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), (0,dist.$effect)(_templateObject253 || (_templateObject253 = quests_taggedTemplateLiteral(["Throwing Some Shade"])))],
    check: [(0,dist.$effect)(_templateObject254 || (_templateObject254 = quests_taggedTemplateLiteral(["Silence of the God Lobster"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject255 || (_templateObject255 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject256 || (_templateObject256 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject257 || (_templateObject257 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject258 || (_templateObject258 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(_templateObject259 || (_templateObject259 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject260 || (_templateObject260 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject261 || (_templateObject261 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject262 || (_templateObject262 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]),
    familiar: (0,dist.$familiar)(_templateObject263 || (_templateObject263 = quests_taggedTemplateLiteral(["Disgeist"])))
  };
}), _defineProperty(_questRecords, Quest.HotResist.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject264 || (_templateObject264 = quests_taggedTemplateLiteral(["Astral Shell"]))), (0,dist.$effect)(_templateObject265 || (_templateObject265 = quests_taggedTemplateLiteral(["Elemental Saucesphere"]))), (0,dist.$effect)(_templateObject266 || (_templateObject266 = quests_taggedTemplateLiteral(["Empathy"])))],
    check: [(0,dist.$effect)(_templateObject267 || (_templateObject267 = quests_taggedTemplateLiteral(["Fireproof Foam Suit"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject268 || (_templateObject268 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject269 || (_templateObject269 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject270 || (_templateObject270 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject271 || (_templateObject271 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(_templateObject272 || (_templateObject272 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject273 || (_templateObject273 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject274 || (_templateObject274 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject275 || (_templateObject275 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject276 || (_templateObject276 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject277 || (_templateObject277 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject278 || (_templateObject278 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject279 || (_templateObject279 = quests_taggedTemplateLiteral(["cracker"])))]]),
    retrocape: "vampire hold",
    familiar: (0,dist.$familiar)(_templateObject280 || (_templateObject280 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.FamiliarWeight.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject281 || (_templateObject281 = quests_taggedTemplateLiteral(["Empathy"]))), (0,dist.$effect)(_templateObject282 || (_templateObject282 = quests_taggedTemplateLiteral(["Joy"]))), (0,dist.$effect)(_templateObject283 || (_templateObject283 = quests_taggedTemplateLiteral(["Man's Worst Enemy"]))), (0,dist.$effect)(_templateObject284 || (_templateObject284 = quests_taggedTemplateLiteral(["Robot Friends"]))), (0,dist.$effect)(_templateObject285 || (_templateObject285 = quests_taggedTemplateLiteral(["Shortly Stacked"]))), (0,dist.$effect)(_templateObject286 || (_templateObject286 = quests_taggedTemplateLiteral(["Whole Latte Love"])))],
    check: [(0,dist.$effect)(_templateObject287 || (_templateObject287 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), (0,dist.$effect)(_templateObject288 || (_templateObject288 = quests_taggedTemplateLiteral(["All Is Forgiven"]))), (0,dist.$effect)(_templateObject289 || (_templateObject289 = quests_taggedTemplateLiteral(["Bureaucratized"]))), (0,dist.$effect)(_templateObject290 || (_templateObject290 = quests_taggedTemplateLiteral(["Chorale of Companionship"]))), (0,dist.$effect)(_templateObject291 || (_templateObject291 = quests_taggedTemplateLiteral(["Down With Chow"]))), (0,dist.$effect)(_templateObject292 || (_templateObject292 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["Open Heart Surgery"]))), (0,dist.$effect)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["Optimist Primal"]))), (0,dist.$effect)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["Smart Drunk"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.have)((0,dist.$item)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["rope"])))) ? (0,dist.$item)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["rope"]))) : (0,dist.$item)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["familiar scrapbook"])))], [(0,dist.$slot)(_templateObject302 || (_templateObject302 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject303 || (_templateObject303 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject304 || (_templateObject304 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject305 || (_templateObject305 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject306 || (_templateObject306 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject307 || (_templateObject307 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject308 || (_templateObject308 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject309 || (_templateObject309 = quests_taggedTemplateLiteral(["cracker"])))]]),
    familiar: (0,dist.$familiar)(_templateObject310 || (_templateObject310 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.ItemDrop.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject311 || (_templateObject311 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), (0,dist.$effect)(_templateObject312 || (_templateObject312 = quests_taggedTemplateLiteral(["Ermine Eyes"]))), (0,dist.$effect)(_templateObject313 || (_templateObject313 = quests_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), (0,dist.$effect)(_templateObject314 || (_templateObject314 = quests_taggedTemplateLiteral(["Feeling Lost"]))), (0,dist.$effect)(_templateObject315 || (_templateObject315 = quests_taggedTemplateLiteral(["Nearly All-Natural"]))), (0,dist.$effect)(_templateObject316 || (_templateObject316 = quests_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), (0,dist.$effect)(_templateObject317 || (_templateObject317 = quests_taggedTemplateLiteral(["Steely-Eyed Squint"]))), (0,dist.$effect)(_templateObject318 || (_templateObject318 = quests_taggedTemplateLiteral(["The Spirit of Taking"])))];
  var toCheck = [(0,dist.$effect)(_templateObject319 || (_templateObject319 = quests_taggedTemplateLiteral(["Bat-Adjacent Form"]))), (0,dist.$effect)(_templateObject320 || (_templateObject320 = quests_taggedTemplateLiteral(["Synthesis: Collection"])))];
  var carrot = (0,external_kolmafia_.numericModifier)((0,dist.$item)(_templateObject321 || (_templateObject321 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))), "item drop") > 0;
  var candles = [(0,dist.$item)(_templateObject322 || (_templateObject322 = quests_taggedTemplateLiteral(["extra-large utility candle"]))), (0,dist.$item)(_templateObject323 || (_templateObject323 = quests_taggedTemplateLiteral(["novelty sparkling candle"]))), (0,dist.$item)(_templateObject324 || (_templateObject324 = quests_taggedTemplateLiteral(["runed taper candle"])))];
  var sparkler = (0,dist.$item)(_templateObject325 || (_templateObject325 = quests_taggedTemplateLiteral(["oversized sparkler"])));
  var outfit = new Map([[(0,dist.$slot)(_templateObject326 || (_templateObject326 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject327 || (_templateObject327 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject328 || (_templateObject328 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject329 || (_templateObject329 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject330 || (_templateObject330 = quests_taggedTemplateLiteral(["off-hand"]))), carrot ? (0,dist.$item)(_templateObject331 || (_templateObject331 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))) : (0,dist.$item)(_templateObject332 || (_templateObject332 = quests_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))], [(0,dist.$slot)(_templateObject333 || (_templateObject333 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject334 || (_templateObject334 = quests_taggedTemplateLiteral(["Guzzlr tablet"])))], [(0,dist.$slot)(_templateObject335 || (_templateObject335 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject336 || (_templateObject336 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject337 || (_templateObject337 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject338 || (_templateObject338 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject339 || (_templateObject339 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject340 || (_templateObject340 = quests_taggedTemplateLiteral(["li'l ninja costume"])))]]);
  if (!candles.some(dist.have) && (0,dist.have)(sparkler)) outfit.set((0,dist.$slot)(_templateObject341 || (_templateObject341 = quests_taggedTemplateLiteral(["weapon"]))), sparkler); // can only have one candle

  for (var _i = 0, _candles = candles; _i < _candles.length; _i++) {
    var c = _candles[_i];
    if ((0,dist.have)(c)) outfit.set((0,dist.$slot)(_templateObject342 || (_templateObject342 = quests_taggedTemplateLiteral(["weapon"]))), c);
  }
  ...
  return {
    ...
    check: toCheck,
    equipment: outfit,
    familiar: (0,dist.$familiar)(_templateObject343 || (_templateObject343 = quests_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
  };
...
function prep(quest) {
  ...
  var back = record.equipment.get((0,dist.$slot)(_templateObject344 || (_templateObject344 = quests_taggedTemplateLiteral(["back"]))));
