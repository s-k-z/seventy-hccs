...
var MacroList = {
  ...
  FreeFightStench: new dist.Macro().if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), dist.Macro.abort()).if_("monsterhpabove 250", dist.Macro.skill((0,dist.$skill)(combat_templateObject45 || (combat_templateObject45 = combat_taggedTemplateLiteral(["Curse of Weaksauce"]))))).skill((0,dist.$skill)(combat_templateObject46 || (combat_templateObject46 = combat_taggedTemplateLiteral(["Garbage Nova"])))),
  // Just runaway on its own causes a null pointer exception?
  Runaway: new dist.Macro().trySkill((0,dist.$skill)(combat_templateObject47 || (combat_templateObject47 = combat_taggedTemplateLiteral(["Saucy Salve"])))).step("runaway"),
  Banish: TryBanish,
  ...
  WitchessWitch: new dist.Macro().skill((0,dist.$skill)(combat_templateObject56 || (combat_templateObject56 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(combat_templateObject57 || (combat_templateObject57 = combat_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(),
  DMTSquare: new dist.Macro().if_("!monsterid ".concat(DMTSquareMon), Replace).skill((0,dist.$skill)(combat_templateObject58 || (combat_templateObject58 = combat_taggedTemplateLiteral(["Feel Envy"])))).step(DefaultMacro),
  ...
  BatFormRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject62 || (_templateObject62 = combat_taggedTemplateLiteral(["Become a Bat"])))).step("runaway"),
...
function mapMonster(location, monster, macro) {
  ...
  if (!(0,dist.get)("mappingMonsters")) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject68 || (_templateObject68 = combat_taggedTemplateLiteral(["Map the Monsters"]))));
...
function getPantogramPants() {
  ...
  var s1 = (0,dist.have)((0,dist.$item)(iotms_templateObject20 || (iotms_templateObject20 = iotms_taggedTemplateLiteral(["baconstone"])))) ? "".concat((0,external_kolmafia_.toInt)((0,dist.$item)(iotms_templateObject21 || (iotms_templateObject21 = iotms_taggedTemplateLiteral(["baconstone"])))), ",1") : "-2,0";
  var s2 = "-2,0"; // Spell Damage +20%

  var s3 = "-1,0"; // Monsters will be less attracted to you

  (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=&whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(iotms_templateObject22 || (iotms_templateObject22 = iotms_taggedTemplateLiteral(["portable pantogram"]))))));
  ...
  if (!(0,dist.have)((0,dist.$item)(iotms_templateObject23 || (iotms_templateObject23 = iotms_taggedTemplateLiteral(["pantogram pants"]))))) throw "Failed to create pantogram pants";
}
function harvestBatteries() {
  (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=&whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(iotms_templateObject24 || (iotms_templateObject24 = iotms_taggedTemplateLiteral(["potted power plant"]))))));
...
function spendAllMpOnLibrams() {
  while ((0,external_kolmafia_.myMp)() > (0,external_kolmafia_.mpCost)((0,dist.$skill)(iotms_templateObject25 || (iotms_templateObject25 = iotms_taggedTemplateLiteral(["Summon BRICKOs"]))))) {
    castBestLibram();
  }
}
var MoonSign;
...
function tuneMoon(moon) {
  (0,external_kolmafia_.visitUrl)("inv_use.php?whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(iotms_templateObject26 || (iotms_templateObject26 = iotms_taggedTemplateLiteral(["hewn moon-rune spoon"])))), "&doit=96&whichsign=").concat(moon));
}
function useDroppedItems() {
  for (var _i = 0, _arr = [(0,dist.$item)(iotms_templateObject27 || (iotms_templateObject27 = iotms_taggedTemplateLiteral(["pulled violet taffy"])))]; _i < _arr.length; _i++) {
  ...
  (0,dist.$item)(iotms_templateObject28 || (iotms_templateObject28 = iotms_taggedTemplateLiteral(["green candy heart"]))), (0,dist.$item)(iotms_templateObject29 || (iotms_templateObject29 = iotms_taggedTemplateLiteral(["pulled yellow taffy"]))), (0,dist.$item)(iotms_templateObject30 || (iotms_templateObject30 = iotms_taggedTemplateLiteral(["resolution: be feistier"]))), (0,dist.$item)(iotms_templateObject31 || (iotms_templateObject31 = iotms_taggedTemplateLiteral(["resolution: be happier"]))), (0,dist.$item)(iotms_templateObject32 || (iotms_templateObject32 = iotms_taggedTemplateLiteral(["resolution: be kinder"]))), (0,dist.$item)(iotms_templateObject33 || (iotms_templateObject33 = iotms_taggedTemplateLiteral(["resolution: be luckier"]))), (0,dist.$item)(iotms_templateObject34 || (iotms_templateObject34 = iotms_taggedTemplateLiteral(["resolution: be smarter"]))), (0,dist.$item)(iotms_templateObject35 || (iotms_templateObject35 = iotms_taggedTemplateLiteral(["resolution: be wealthier"]))), // other potions
  (0,dist.$item)(iotms_templateObject36 || (iotms_templateObject36 = iotms_taggedTemplateLiteral(["power pill"]))), (0,dist.$item)(iotms_templateObject37 || (iotms_templateObject37 = iotms_taggedTemplateLiteral(["short stack of pancakes"])))]; _i2 < _arr2.length; _i2++) {
...
var questRecords = (_questRecords = {}, _defineProperty(_questRecords, Quest.Beginning.id, () => {
  ...
  var pastalordShield = (0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject115 || (_templateObject115 = quests_taggedTemplateLiteral(["Pastamancer"]))) ? (0,dist.$effect)(_templateObject116 || (_templateObject116 = quests_taggedTemplateLiteral(["Shield of the Pastalord"]))) : (0,dist.$effect)(_templateObject117 || (_templateObject117 = quests_taggedTemplateLiteral(["Flimsy Shield of the Pastalord"])));
  var toAcquire = [pastalordShield, (0,dist.$effect)(_templateObject118 || (_templateObject118 = quests_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), (0,dist.$effect)(_templateObject119 || (_templateObject119 = quests_taggedTemplateLiteral(["Polka of Plenty"]))), (0,dist.$effect)(_templateObject120 || (_templateObject120 = quests_taggedTemplateLiteral(["Pride of the Puffin"]))), (0,dist.$effect)(_templateObject121 || (_templateObject121 = quests_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"])))];
  var toWear = new Map([[(0,dist.$slot)(_templateObject122 || (_templateObject122 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject123 || (_templateObject123 = quests_taggedTemplateLiteral(["LOV Epaulettes"])))], [(0,dist.$slot)(_templateObject124 || (_templateObject124 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject125 || (_templateObject125 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject126 || (_templateObject126 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject127 || (_templateObject127 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject128 || (_templateObject128 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject129 || (_templateObject129 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject130 || (_templateObject130 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject131 || (_templateObject131 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject132 || (_templateObject132 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.have)((0,dist.$item)(_templateObject133 || (_templateObject133 = quests_taggedTemplateLiteral(["battle broom"])))) ? (0,dist.$item)(_templateObject134 || (_templateObject134 = quests_taggedTemplateLiteral(["battle broom"]))) : (0,dist.$item)(_templateObject135 || (_templateObject135 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject136 || (_templateObject136 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject137 || (_templateObject137 = quests_taggedTemplateLiteral(["Beach Comb"])))]]);
  return {
    acquire: toAcquire,
    check: [],
    equipment: toWear
  ...
  var toWear = new Map([[(0,dist.$slot)(_templateObject138 || (_templateObject138 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject139 || (_templateObject139 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject140 || (_templateObject140 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject141 || (_templateObject141 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject142 || (_templateObject142 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject143 || (_templateObject143 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
  if ((0,dist.have)((0,dist.$item)(_templateObject144 || (_templateObject144 = quests_taggedTemplateLiteral(["burning paper crane"]))))) toWear.set((0,dist.$slot)(_templateObject145 || (_templateObject145 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject146 || (_templateObject146 = quests_taggedTemplateLiteral(["burning paper crane"]))));
  return {
    acquire: [(0,dist.$effect)(_templateObject147 || (_templateObject147 = quests_taggedTemplateLiteral(["Polka of Plenty"])))],
    check: [],
    equipment: toWear,
    retrocape: "vampire hold",
    familiar: (0,dist.$familiar)(_templateObject148 || (_templateObject148 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.Vintner.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject149 || (_templateObject149 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,dist.$effect)(_templateObject150 || (_templateObject150 = quests_taggedTemplateLiteral(["Polka of Plenty"]))), (0,dist.$effect)(_templateObject151 || (_templateObject151 = quests_taggedTemplateLiteral(["Sauce Monocle"]))), (0,dist.$effect)(_templateObject152 || (_templateObject152 = quests_taggedTemplateLiteral(["Song of Sauce"]))), (0,dist.$effect)(_templateObject153 || (_templateObject153 = quests_taggedTemplateLiteral(["Spirit of Bacon Grease"]))), (0,dist.$effect)(_templateObject154 || (_templateObject154 = quests_taggedTemplateLiteral(["Wizard Squint"])))];
  var toCheck = [(0,dist.$effect)(_templateObject155 || (_templateObject155 = quests_taggedTemplateLiteral(["Bastille Bourgeoisie"]))), (0,dist.$effect)(_templateObject156 || (_templateObject156 = quests_taggedTemplateLiteral(["critical.enh"]))), (0,dist.$effect)(_templateObject157 || (_templateObject157 = quests_taggedTemplateLiteral(["Sparkly!"]))), (0,dist.$effect)(_templateObject158 || (_templateObject158 = quests_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))];
  var toEquip = new Map([[(0,dist.$slot)(_templateObject159 || (_templateObject159 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject160 || (_templateObject160 = quests_taggedTemplateLiteral(["LOV Epaulettes"])))], [(0,dist.$slot)(_templateObject161 || (_templateObject161 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject162 || (_templateObject162 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject163 || (_templateObject163 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject164 || (_templateObject164 = quests_taggedTemplateLiteral(["wrench"])))], [(0,dist.$slot)(_templateObject165 || (_templateObject165 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject166 || (_templateObject166 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject167 || (_templateObject167 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject168 || (_templateObject168 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(_templateObject169 || (_templateObject169 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject170 || (_templateObject170 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject171 || (_templateObject171 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject172 || (_templateObject172 = quests_taggedTemplateLiteral(["backup camera"])))]]);
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: toEquip
  ...
  return {
    acquire: [(0,dist.$effect)(_templateObject173 || (_templateObject173 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), (0,dist.$effect)(_templateObject174 || (_templateObject174 = quests_taggedTemplateLiteral(["Phorcefullness"]))), (0,dist.$effect)(_templateObject175 || (_templateObject175 = quests_taggedTemplateLiteral(["Quiet Determination"]))), (0,dist.$effect)(_templateObject176 || (_templateObject176 = quests_taggedTemplateLiteral(["Rage of the Reindeer"])))],
    check: [(0,dist.$effect)(_templateObject177 || (_templateObject177 = quests_taggedTemplateLiteral(["Giant Growth"]))), (0,dist.$effect)(_templateObject178 || (_templateObject178 = quests_taggedTemplateLiteral(["Spit Upon"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject179 || (_templateObject179 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject180 || (_templateObject180 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject181 || (_templateObject181 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject182 || (_templateObject182 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject183 || (_templateObject183 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject184 || (_templateObject184 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject185 || (_templateObject185 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject186 || (_templateObject186 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject187 || (_templateObject187 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject188 || (_templateObject188 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
    retrocape: "muscle"
  };
}), _defineProperty(_questRecords, Quest.Moxie.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject189 || (_templateObject189 = quests_taggedTemplateLiteral(["Disco Fever"]))), (0,dist.$effect)(_templateObject190 || (_templateObject190 = quests_taggedTemplateLiteral(["Expert Oiliness"]))), (0,dist.$effect)(_templateObject191 || (_templateObject191 = quests_taggedTemplateLiteral(["Quiet Desperation"])))],
    check: [(0,dist.$effect)(_templateObject192 || (_templateObject192 = quests_taggedTemplateLiteral(["Sparkly!"]))), (0,dist.$effect)(_templateObject193 || (_templateObject193 = quests_taggedTemplateLiteral(["Spit Upon"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject194 || (_templateObject194 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject195 || (_templateObject195 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject196 || (_templateObject196 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject197 || (_templateObject197 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject198 || (_templateObject198 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject199 || (_templateObject199 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(_templateObject200 || (_templateObject200 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject201 || (_templateObject201 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject202 || (_templateObject202 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject203 || (_templateObject203 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject204 || (_templateObject204 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject205 || (_templateObject205 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
    retrocape: "moxie"
  };
}), _defineProperty(_questRecords, Quest.HP.id, () => {
  var candle = (0,dist.$item)(_templateObject206 || (_templateObject206 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  return {
    acquire: [(0,dist.$effect)(_templateObject207 || (_templateObject207 = quests_taggedTemplateLiteral(["Song of Starch"])))],
    check: [],
    equipment: new Map([[(0,dist.$slot)(_templateObject208 || (_templateObject208 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.have)(candle) ? candle : (0,dist.$item)(_templateObject209 || (_templateObject209 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject210 || (_templateObject210 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject211 || (_templateObject211 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject212 || (_templateObject212 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject213 || (_templateObject213 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject214 || (_templateObject214 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject215 || (_templateObject215 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject216 || (_templateObject216 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject217 || (_templateObject217 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]])
  };
}), _defineProperty(_questRecords, Quest.SpellDamage.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject218 || (_templateObject218 = quests_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"]))), (0,dist.$effect)(_templateObject219 || (_templateObject219 = quests_taggedTemplateLiteral(["Cowrruption"]))), (0,dist.$effect)(_templateObject220 || (_templateObject220 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,dist.$effect)(_templateObject221 || (_templateObject221 = quests_taggedTemplateLiteral(["Song of Sauce"]))), (0,dist.$effect)(_templateObject222 || (_templateObject222 = quests_taggedTemplateLiteral(["The Magic of LOV"])))],
    check: [(0,dist.$effect)(_templateObject223 || (_templateObject223 = quests_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(_templateObject224 || (_templateObject224 = quests_taggedTemplateLiteral(["Filled with Magic"]))), (0,dist.$effect)(_templateObject225 || (_templateObject225 = quests_taggedTemplateLiteral(["In a Lather"]))), (0,dist.$effect)(_templateObject226 || (_templateObject226 = quests_taggedTemplateLiteral(["Inner Elf"]))), (0,dist.$effect)(_templateObject227 || (_templateObject227 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject228 || (_templateObject228 = quests_taggedTemplateLiteral(["Nanobrainy"]))), (0,dist.$effect)(_templateObject229 || (_templateObject229 = quests_taggedTemplateLiteral(["Sparkly!"]))), (0,dist.$effect)(_templateObject230 || (_templateObject230 = quests_taggedTemplateLiteral(["Spit Upon"]))), (0,dist.$effect)(_templateObject231 || (_templateObject231 = quests_taggedTemplateLiteral(["Toxic Vengeance"]))), (0,dist.$effect)(_templateObject232 || (_templateObject232 = quests_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))],
    // TODO: handle spell damage candle
    //const candle = [$slot`off-hand`, $item`Abracandalabra`];
    equipment: new Map([[(0,dist.$slot)(_templateObject233 || (_templateObject233 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject234 || (_templateObject234 = quests_taggedTemplateLiteral(["wrench"])))], [(0,dist.$slot)(_templateObject235 || (_templateObject235 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject236 || (_templateObject236 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject237 || (_templateObject237 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject238 || (_templateObject238 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject239 || (_templateObject239 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject240 || (_templateObject240 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject241 || (_templateObject241 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject242 || (_templateObject242 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(_templateObject243 || (_templateObject243 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject244 || (_templateObject244 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [(0,dist.$slot)(_templateObject245 || (_templateObject245 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject246 || (_templateObject246 = quests_taggedTemplateLiteral(["astral statuette"])))]]),
    familiar: (0,dist.$familiar)(_templateObject247 || (_templateObject247 = quests_taggedTemplateLiteral(["Left-Hand Man"])))
  };
}), _defineProperty(_questRecords, Quest.WeaponDamage.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject248 || (_templateObject248 = quests_taggedTemplateLiteral(["Bow-Legged Swagger"]))), (0,dist.$effect)(_templateObject249 || (_templateObject249 = quests_taggedTemplateLiteral(["Cowrruption"]))), (0,dist.$effect)(_templateObject250 || (_templateObject250 = quests_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,dist.$effect)(_templateObject251 || (_templateObject251 = quests_taggedTemplateLiteral(["Rage of the Reindeer"]))), (0,dist.$effect)(_templateObject252 || (_templateObject252 = quests_taggedTemplateLiteral(["Scowl of the Auk"]))), (0,dist.$effect)(_templateObject253 || (_templateObject253 = quests_taggedTemplateLiteral(["Song of the North"]))), (0,dist.$effect)(_templateObject254 || (_templateObject254 = quests_taggedTemplateLiteral(["Tenacity of the Snapper"]))), (0,dist.$effect)(_templateObject255 || (_templateObject255 = quests_taggedTemplateLiteral(["The Power of LOV"])))];
  var toCheck = [(0,dist.$effect)(_templateObject256 || (_templateObject256 = quests_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(_templateObject257 || (_templateObject257 = quests_taggedTemplateLiteral(["In a Lather"]))), (0,dist.$effect)(_templateObject258 || (_templateObject258 = quests_taggedTemplateLiteral(["Inner Elf"]))), (0,dist.$effect)(_templateObject259 || (_templateObject259 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject260 || (_templateObject260 = quests_taggedTemplateLiteral(["Spit Upon"])))];
  var toWear = new Map([[(0,dist.$slot)(_templateObject261 || (_templateObject261 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject262 || (_templateObject262 = quests_taggedTemplateLiteral(["broken champagne bottle"])))], [(0,dist.$slot)(_templateObject263 || (_templateObject263 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject264 || (_templateObject264 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject265 || (_templateObject265 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject266 || (_templateObject266 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject267 || (_templateObject267 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject268 || (_templateObject268 = quests_taggedTemplateLiteral(["Powerful Glove"])))]]);
  var candle = (0,dist.$item)(_templateObject269 || (_templateObject269 = quests_taggedTemplateLiteral(["extra-wide head candle"])));
  if ((0,dist.have)(candle)) toWear.set((0,dist.$slot)(_templateObject270 || (_templateObject270 = quests_taggedTemplateLiteral(["hat"]))), candle);
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: toWear
  ...
  return {
    acquire: [(0,dist.$effect)(_templateObject271 || (_templateObject271 = quests_taggedTemplateLiteral(["Become Superficially interested"]))), (0,dist.$effect)(_templateObject272 || (_templateObject272 = quests_taggedTemplateLiteral(["Feeling Lonely"]))), (0,dist.$effect)(_templateObject273 || (_templateObject273 = quests_taggedTemplateLiteral(["Gummed Shoes"]))), (0,dist.$effect)(_templateObject274 || (_templateObject274 = quests_taggedTemplateLiteral(["Invisible Avatar"]))), (0,dist.$effect)(_templateObject275 || (_templateObject275 = quests_taggedTemplateLiteral(["Silent Running"]))), (0,dist.$effect)(_templateObject276 || (_templateObject276 = quests_taggedTemplateLiteral(["Smooth Movements"]))), (0,dist.$effect)(_templateObject277 || (_templateObject277 = quests_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), (0,dist.$effect)(_templateObject278 || (_templateObject278 = quests_taggedTemplateLiteral(["Throwing Some Shade"])))],
    check: [(0,dist.$effect)(_templateObject279 || (_templateObject279 = quests_taggedTemplateLiteral(["Silence of the God Lobster"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject280 || (_templateObject280 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject281 || (_templateObject281 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject282 || (_templateObject282 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject283 || (_templateObject283 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(_templateObject284 || (_templateObject284 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject285 || (_templateObject285 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject286 || (_templateObject286 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject287 || (_templateObject287 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]),
    familiar: (0,dist.$familiar)(_templateObject288 || (_templateObject288 = quests_taggedTemplateLiteral(["Disgeist"])))
  };
}), _defineProperty(_questRecords, Quest.HotResist.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject289 || (_templateObject289 = quests_taggedTemplateLiteral(["Astral Shell"]))), (0,dist.$effect)(_templateObject290 || (_templateObject290 = quests_taggedTemplateLiteral(["Elemental Saucesphere"]))), (0,dist.$effect)(_templateObject291 || (_templateObject291 = quests_taggedTemplateLiteral(["Empathy"])))],
    check: [(0,dist.$effect)(_templateObject292 || (_templateObject292 = quests_taggedTemplateLiteral(["Fireproof Foam Suit"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject302 || (_templateObject302 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject303 || (_templateObject303 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject304 || (_templateObject304 = quests_taggedTemplateLiteral(["cracker"])))]]),
    retrocape: "vampire hold",
    familiar: (0,dist.$familiar)(_templateObject305 || (_templateObject305 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.FamiliarWeight.id, () => {
  var rope = (0,dist.$item)(_templateObject306 || (_templateObject306 = quests_taggedTemplateLiteral(["rope"])));
  var crane = (0,dist.$item)(_templateObject307 || (_templateObject307 = quests_taggedTemplateLiteral(["burning paper crane"])));
  var offhand = (0,dist.have)(rope) ? rope : (0,dist.have)(crane) ? crane : (0,dist.$item)(_templateObject308 || (_templateObject308 = quests_taggedTemplateLiteral(["familiar scrapbook"])));
  return {
    acquire: [(0,dist.$effect)(_templateObject309 || (_templateObject309 = quests_taggedTemplateLiteral(["Empathy"]))), (0,dist.$effect)(_templateObject310 || (_templateObject310 = quests_taggedTemplateLiteral(["Joy"]))), (0,dist.$effect)(_templateObject311 || (_templateObject311 = quests_taggedTemplateLiteral(["Man's Worst Enemy"]))), (0,dist.$effect)(_templateObject312 || (_templateObject312 = quests_taggedTemplateLiteral(["Robot Friends"]))), (0,dist.$effect)(_templateObject313 || (_templateObject313 = quests_taggedTemplateLiteral(["Shortly Stacked"]))), (0,dist.$effect)(_templateObject314 || (_templateObject314 = quests_taggedTemplateLiteral(["Whole Latte Love"])))],
    check: [(0,dist.$effect)(_templateObject315 || (_templateObject315 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), (0,dist.$effect)(_templateObject316 || (_templateObject316 = quests_taggedTemplateLiteral(["All Is Forgiven"]))), (0,dist.$effect)(_templateObject317 || (_templateObject317 = quests_taggedTemplateLiteral(["Bureaucratized"]))), (0,dist.$effect)(_templateObject318 || (_templateObject318 = quests_taggedTemplateLiteral(["Chorale of Companionship"]))), (0,dist.$effect)(_templateObject319 || (_templateObject319 = quests_taggedTemplateLiteral(["Down With Chow"]))), (0,dist.$effect)(_templateObject320 || (_templateObject320 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject321 || (_templateObject321 = quests_taggedTemplateLiteral(["Open Heart Surgery"]))), (0,dist.$effect)(_templateObject322 || (_templateObject322 = quests_taggedTemplateLiteral(["You Can Really Taste the Dormouse"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject323 || (_templateObject323 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject324 || (_templateObject324 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject325 || (_templateObject325 = quests_taggedTemplateLiteral(["off-hand"]))), offhand], [(0,dist.$slot)(_templateObject326 || (_templateObject326 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject327 || (_templateObject327 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject328 || (_templateObject328 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject329 || (_templateObject329 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject330 || (_templateObject330 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject331 || (_templateObject331 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject332 || (_templateObject332 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject333 || (_templateObject333 = quests_taggedTemplateLiteral(["cracker"])))]]),
    familiar: (0,dist.$familiar)(_templateObject334 || (_templateObject334 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.ItemDrop.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject335 || (_templateObject335 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), (0,dist.$effect)(_templateObject336 || (_templateObject336 = quests_taggedTemplateLiteral(["Ermine Eyes"]))), (0,dist.$effect)(_templateObject337 || (_templateObject337 = quests_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), (0,dist.$effect)(_templateObject338 || (_templateObject338 = quests_taggedTemplateLiteral(["Feeling Lost"]))), (0,dist.$effect)(_templateObject339 || (_templateObject339 = quests_taggedTemplateLiteral(["Nearly All-Natural"]))), (0,dist.$effect)(_templateObject340 || (_templateObject340 = quests_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), (0,dist.$effect)(_templateObject341 || (_templateObject341 = quests_taggedTemplateLiteral(["Steely-Eyed Squint"]))), (0,dist.$effect)(_templateObject342 || (_templateObject342 = quests_taggedTemplateLiteral(["The Spirit of Taking"])))];
  var toCheck = [(0,dist.$effect)(_templateObject343 || (_templateObject343 = quests_taggedTemplateLiteral(["Bat-Adjacent Form"]))), (0,dist.$effect)(_templateObject344 || (_templateObject344 = quests_taggedTemplateLiteral(["Synthesis: Collection"])))];
  var carrot = (0,external_kolmafia_.numericModifier)((0,dist.$item)(_templateObject345 || (_templateObject345 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))), "item drop") > 0;
  var candles = [(0,dist.$item)(_templateObject346 || (_templateObject346 = quests_taggedTemplateLiteral(["extra-large utility candle"]))), (0,dist.$item)(_templateObject347 || (_templateObject347 = quests_taggedTemplateLiteral(["novelty sparkling candle"]))), (0,dist.$item)(_templateObject348 || (_templateObject348 = quests_taggedTemplateLiteral(["runed taper candle"])))];
  var sparkler = (0,dist.$item)(_templateObject349 || (_templateObject349 = quests_taggedTemplateLiteral(["oversized sparkler"])));
  var toWear = new Map([[(0,dist.$slot)(_templateObject350 || (_templateObject350 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject351 || (_templateObject351 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject352 || (_templateObject352 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject353 || (_templateObject353 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject354 || (_templateObject354 = quests_taggedTemplateLiteral(["off-hand"]))), carrot ? (0,dist.$item)(_templateObject355 || (_templateObject355 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))) : (0,dist.$item)(_templateObject356 || (_templateObject356 = quests_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))], [(0,dist.$slot)(_templateObject357 || (_templateObject357 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject358 || (_templateObject358 = quests_taggedTemplateLiteral(["Guzzlr tablet"])))], [(0,dist.$slot)(_templateObject359 || (_templateObject359 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject360 || (_templateObject360 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject361 || (_templateObject361 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject362 || (_templateObject362 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject363 || (_templateObject363 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject364 || (_templateObject364 = quests_taggedTemplateLiteral(["li'l ninja costume"])))]]);
  if (!candles.some(dist.have) && (0,dist.have)(sparkler)) toWear.set((0,dist.$slot)(_templateObject365 || (_templateObject365 = quests_taggedTemplateLiteral(["weapon"]))), sparkler); // can only have one candle

  for (var _i = 0, _candles = candles; _i < _candles.length; _i++) {
    var c = _candles[_i];
    if ((0,dist.have)(c)) toWear.set((0,dist.$slot)(_templateObject366 || (_templateObject366 = quests_taggedTemplateLiteral(["weapon"]))), c);
  }
  ...
  return {
    ...
    check: toCheck,
    equipment: toWear,
    familiar: (0,dist.$familiar)(_templateObject367 || (_templateObject367 = quests_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
  };
}), _defineProperty(_questRecords, Quest.Mysticality.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject368 || (_templateObject368 = quests_taggedTemplateLiteral(["Quiet Judgement"])))],
    check: [(0,dist.$effect)(_templateObject369 || (_templateObject369 = quests_taggedTemplateLiteral(["Nanobrainy"]))), (0,dist.$effect)(_templateObject370 || (_templateObject370 = quests_taggedTemplateLiteral(["Spit Upon"]))), (0,dist.$effect)(_templateObject371 || (_templateObject371 = quests_taggedTemplateLiteral(["Witch Breaded"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject372 || (_templateObject372 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject373 || (_templateObject373 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject374 || (_templateObject374 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject375 || (_templateObject375 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject376 || (_templateObject376 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject377 || (_templateObject377 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject378 || (_templateObject378 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject379 || (_templateObject379 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
...
function prep(quest) {
  ...
  var back = record.equipment.get((0,dist.$slot)(_templateObject380 || (_templateObject380 = quests_taggedTemplateLiteral(["back"]))));
...
function shrugExtraSongs(effectsToAcquire) {
  var songsToAlwaysKeep = (0,dist.$effects)(_templateObject381 || (_templateObject381 = quests_taggedTemplateLiteral(["Ode to Booze, Chorale of Companionship"])));
...
var events = {
  ...
  witchessRook: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject41 || (events_templateObject41 = events_taggedTemplateLiteral(["Sweetbreads Flamb\xE9"])))) - 1,
    run: () => {
      prep(Quest.LevelingML);
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject42 || (events_templateObject42 = events_taggedTemplateLiteral(["Witchess Rook"]))), MacroList.FreeFight);
      checkAvailable((0,dist.$item)(events_templateObject43 || (events_templateObject43 = events_taggedTemplateLiteral(["Greek fire"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject44 || (events_templateObject44 = events_taggedTemplateLiteral(["Greek fire"]))));
    }
  },
  upscaleDistrictKill: {
    max: 1,
    current: () => (0,dist.have)((0,dist.$effect)(events_templateObject45 || (events_templateObject45 = events_taggedTemplateLiteral(["Whole Latte Love"])))) ? 1 : (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject46 || (events_templateObject46 = events_taggedTemplateLiteral(["sprinkles"])))) - 54,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject47 || (events_templateObject47 = events_taggedTemplateLiteral(["Chocolate Lab"]))));
      var rope = (0,dist.$item)(events_templateObject48 || (events_templateObject48 = events_taggedTemplateLiteral(["rope"])));
      var crane = (0,dist.$item)(events_templateObject49 || (events_templateObject49 = events_taggedTemplateLiteral(["burning paper crane"])));
      var offhand = (0,dist.have)(rope) ? rope : (0,dist.have)(crane) ? crane : (0,dist.$item)(events_templateObject50 || (events_templateObject50 = events_taggedTemplateLiteral(["familiar scrapbook"])));
      withEquipment(() => adventure(upscaleDistrict, MacroList.Sprinkles), [[(0,dist.$slot)(events_templateObject51 || (events_templateObject51 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject52 || (events_templateObject52 = events_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(events_templateObject53 || (events_templateObject53 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject54 || (events_templateObject54 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(events_templateObject55 || (events_templateObject55 = events_taggedTemplateLiteral(["off-hand"]))), offhand], [(0,dist.$slot)(events_templateObject56 || (events_templateObject56 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject57 || (events_templateObject57 = events_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(events_templateObject58 || (events_templateObject58 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject59 || (events_templateObject59 = events_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(events_templateObject60 || (events_templateObject60 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject61 || (events_templateObject61 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]]);
      checkAvailable((0,dist.$item)(events_templateObject62 || (events_templateObject62 = events_taggedTemplateLiteral(["sprinkles"]))), 55);
    }
  },
  upscaleDistrictRunaway: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject63 || (events_templateObject63 = events_taggedTemplateLiteral(["Whole Latte Love"])))) - 1,
    run: () => {
      ...
      var latte = (0,dist.$item)(events_templateObject66 || (events_templateObject66 = events_taggedTemplateLiteral(["gingerbread spice latte"])));

      if ((0,dist.have)(latte)) {
        (0,external_kolmafia_.use)(latte);
        checkAvailable((0,dist.$item)(events_templateObject67 || (events_templateObject67 = events_taggedTemplateLiteral(["sprinkles"]))), 5);
  ...
  civicCenterRunaway: {
    ...
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject68 || (events_templateObject68 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject69 || (events_templateObject69 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(civicCenter, MacroList.Runaway);
      var cig = (0,dist.$item)(events_templateObject70 || (events_templateObject70 = events_taggedTemplateLiteral(["gingerbread cigarette"])));
  ...
  snojo: {
    ...
    run: () => {
      if (!(0,dist.get)("snojoSetting") !== (0,dist.$stat)(events_templateObject71 || (events_templateObject71 = events_taggedTemplateLiteral(["Muscle"])))) {
  ...
  witchessWitch: {
    max: 0,
    current: () => (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject72 || (events_templateObject72 = events_taggedTemplateLiteral(["battle broom"])))) - 1,
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject73 || (events_templateObject73 = events_taggedTemplateLiteral(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject74 || (events_templateObject74 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject75 || (events_templateObject75 = events_taggedTemplateLiteral(["battle broom"]))));
    }
  },
  eldritch: {
    max: 1,
    ...
    run: () => {
      selectBestFamiliar();
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject76 || (events_templateObject76 = events_taggedTemplateLiteral(["Evoke Eldritch Horror"])))); // In case Sssshhsssblllrrggghsssssggggrrgglsssshhssslblgl was summoned
  ...
  gingerbreadCig: {
    max: 5,
    current: () => 5 - (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject77 || (events_templateObject77 = events_taggedTemplateLiteral(["gingerbread cigarette"])))),
    run: () => {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  godLobster: {
    ...
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject78 || (events_templateObject78 = events_taggedTemplateLiteral(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      ...
      var ring = (0,dist.$item)(events_templateObject79 || (events_templateObject79 = events_taggedTemplateLiteral(["God Lobster's Ring"])));
      var scepter = (0,dist.$item)(events_templateObject80 || (events_templateObject80 = events_taggedTemplateLiteral(["God Lobster's Scepter"])));
      if ((0,dist.have)(ring)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject81 || (events_templateObject81 = events_taggedTemplateLiteral(["familiar"]))), ring);else if ((0,dist.have)(scepter)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject82 || (events_templateObject82 = events_taggedTemplateLiteral(["familiar"]))), scepter);
    }
  },
  witchessKing: {
    max: 0,
    current: () => (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject83 || (events_templateObject83 = events_taggedTemplateLiteral(["dented scepter"])))) - 1,
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject84 || (events_templateObject84 = events_taggedTemplateLiteral(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    max: 5,
    ...
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject85 || (events_templateObject85 = events_taggedTemplateLiteral(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  digitize: {
    max: 1,
    ...
    run: () => {
      var shirt = (0,dist.$item)(events_templateObject86 || (events_templateObject86 = events_taggedTemplateLiteral(["makeshift garbage shirt"])));
      if (!(0,dist.have)(shirt)) (0,external_kolmafia_.cliExecute)("fold ".concat(shirt));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject87 || (events_templateObject87 = events_taggedTemplateLiteral(["shirt"]))), shirt);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject88 || (events_templateObject88 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject89 || (events_templateObject89 = events_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
      selectBestFamiliar();
  ...
  vote: {
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(toxicTeacups, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject90 || (events_templateObject90 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject91 || (events_templateObject91 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
    }
  },
  dmtSquare: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject92 || (events_templateObject92 = events_taggedTemplateLiteral(["Joy"])))) + (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject93 || (events_templateObject93 = events_taggedTemplateLiteral(["abstraction: action"])))) - 1,
    run: () => {
      ...
      checkAvailable((0,dist.$item)(events_templateObject95 || (events_templateObject95 = events_taggedTemplateLiteral(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject96 || (events_templateObject96 = events_taggedTemplateLiteral(["Joy"])))) - 1,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject97 || (events_templateObject97 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable((0,dist.$item)(events_templateObject98 || (events_templateObject98 = events_taggedTemplateLiteral(["abstraction: joy"]))));
      (0,external_kolmafia_.chew)((0,dist.$item)(events_templateObject99 || (events_templateObject99 = events_taggedTemplateLiteral(["abstraction: joy"]))));
    }
  },
  dmt: {
    max: 5,
  ...
  chestXRay: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject101 || (events_templateObject101 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject102 || (events_templateObject102 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  ...
  shockingLick: {
    max: 1,
    current: () => 1 - (0,dist.get)("shockingLickCharges"),
    run: () => {
      selectBestFamiliar(FamiliarFlag.ToxicTeacups);
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  ...
  lecture: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject103 || (events_templateObject103 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject104 || (events_templateObject104 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      familiar((0,dist.$familiar)(events_templateObject105 || (events_templateObject105 = events_taggedTemplateLiteral(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  backupCamera: {
    max: 7,
    current: () => (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject106 || (events_templateObject106 = events_taggedTemplateLiteral(["sausage goblin"]))) ? (0,dist.get)("_backUpUses") : 7,
    run: () => {
  ...
  deepDark: {
    max: 0,
    current: () => (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject111 || (events_templateObject111 = events_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))) - 1,
    run: () => {
      prep(Quest.DeepDark);
      var resist = 1 - (0,external_kolmafia_.elementalResistance)((0,dist.$element)(events_templateObject112 || (events_templateObject112 = events_taggedTemplateLiteral(["spooky"])))) / 100;
      ...
      if ((0,external_kolmafia_.myHp)() < needed) (0,external_kolmafia_.cliExecute)("cast * ".concat((0,dist.$skill)(events_templateObject113 || (events_templateObject113 = events_taggedTemplateLiteral(["Cannelloni Cocoon"])))));
      if ((0,external_kolmafia_.myHp)() < needed) throw "Failed to heal enough for Deep Dark Visions?";
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject114 || (events_templateObject114 = events_taggedTemplateLiteral(["Deep Dark Visions"]))));

      while ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() * 0.9) {
        (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject115 || (events_templateObject115 = events_taggedTemplateLiteral(["Cannelloni Cocoon"]))));
      }
    }
  },
  vintnerBackup: {
    max: 11,
    current: () => (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject116 || (events_templateObject116 = events_taggedTemplateLiteral(["sausage goblin"]))) ? (0,dist.get)("_backUpUses") : 11,
    run: () => {
  ...
  latteRefills: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject117 || (events_templateObject117 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject118 || (events_templateObject118 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      if ((0,dist.get)("_latteDrinkUsed")) (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon vanilla");
      checkEffect((0,dist.$effect)(events_templateObject119 || (events_templateObject119 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject120 || (events_templateObject120 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  latteCarrot: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject121 || (events_templateObject121 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject122 || (events_templateObject122 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      checkEffect((0,dist.$effect)(events_templateObject123 || (events_templateObject123 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject124 || (events_templateObject124 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
...
var oneOffEvents = {
  hipster: () => {
    if (!(0,dist.get)("_ironicMoustache")) {
      familiar((0,dist.$familiar)(events_templateObject129 || (events_templateObject129 = events_taggedTemplateLiteral(["Mini-Hipster"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject130 || (events_templateObject130 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject131 || (events_templateObject131 = events_taggedTemplateLiteral(["none"]))));
      withEquipment(() => adventure(noobCave, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject132 || (events_templateObject132 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject133 || (events_templateObject133 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))]]);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject134 || (events_templateObject134 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject135 || (events_templateObject135 = events_taggedTemplateLiteral(["none"]))));
      checkAvailable((0,dist.$item)(events_templateObject136 || (events_templateObject136 = events_taggedTemplateLiteral(["ironic moustache"]))));
    }
  },
  mimic: () => {
    if (!(0,dist.get)("_bagOfCandy")) {
      familiar((0,dist.$familiar)(events_templateObject137 || (events_templateObject137 = events_taggedTemplateLiteral(["Stocking Mimic"]))));
      ...
      adventure(ghostLoc, MacroList.FreeFight);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject140 || (events_templateObject140 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject141 || (events_templateObject141 = events_taggedTemplateLiteral(["none"]))));
      checkAvailable((0,dist.$item)(events_templateObject142 || (events_templateObject142 = events_taggedTemplateLiteral(["bag of many confections"]))));
    }
  },
  ninjaCostume: () => {
    if (!(0,dist.have)((0,dist.$item)(events_templateObject143 || (events_templateObject143 = events_taggedTemplateLiteral(["li'l ninja costume"]))))) {
      selectBestFamiliar(FamiliarFlag.NoAttack);
      withEquipment(() => mapMonster(haikuDungeon, (0,dist.$monster)(events_templateObject144 || (events_templateObject144 = events_taggedTemplateLiteral(["amateur ninja"]))), MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject145 || (events_templateObject145 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject146 || (events_templateObject146 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]]);
      checkAvailable((0,dist.$item)(events_templateObject147 || (events_templateObject147 = events_taggedTemplateLiteral(["li'l ninja costume"]))));
    }
  },
  tropicalSkeleton: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject148 || (events_templateObject148 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject149 || (events_templateObject149 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject150 || (events_templateObject150 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      familiar((0,dist.$familiar)(events_templateObject151 || (events_templateObject151 = events_taggedTemplateLiteral(["Crimbo Shrub"]))));

      if (!(0,dist.get)("_shrubDecorated")) {
        (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=&which=99&whichitem=".concat((0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject152 || (events_templateObject152 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))))));
        (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=999&pwd=&option=1&topper=2&lights=5&garland=3&gift=2");
      }

      mapMonster(skeletonStore, (0,dist.$monster)(events_templateObject153 || (events_templateObject153 = events_taggedTemplateLiteral(["novelty tropical skeleton"]))), MacroList.TropicalSkeleton);
      checkEffect((0,dist.$effect)(events_templateObject154 || (events_templateObject154 = events_taggedTemplateLiteral(["Everything Looks Red"]))));
      (0,dist.$items)(events_templateObject155 || (events_templateObject155 = events_taggedTemplateLiteral(["cherry, grapefruit, lemon, strawberry"]))).forEach(fruit => checkAvailable(fruit));
    }
  },
  nanobrainy: () => {
    if (!(0,dist.get)("_gingerbreadClockAdvanced")) adventure(civicCenter, dist.Macro.abort());

    if (!(0,dist.have)((0,dist.$effect)(events_templateObject156 || (events_templateObject156 = events_taggedTemplateLiteral(["Nanobrainy"])))) && (0,dist.get)("_nanorhinoCharge") > 99) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject157 || (events_templateObject157 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject158 || (events_templateObject158 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject160 || (events_templateObject160 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      familiar((0,dist.$familiar)(events_templateObject161 || (events_templateObject161 = events_taggedTemplateLiteral(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
      checkEffect((0,dist.$effect)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["Nanobrainy"]))));
    }
  },
  innerElf: () => {
    if ((0,external_kolmafia_.myLevel)() >= 13 && !(0,dist.have)((0,dist.$effect)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["Inner Elf"]))))) {
      familiar((0,dist.$familiar)(events_templateObject164 || (events_templateObject164 = events_taggedTemplateLiteral(["Machine Elf"]))));
      ...
      checkEffect((0,dist.$effect)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["Inner Elf"]))));

      if (prev && (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["Mother Slime"])))) {
        (0,dist.set)("lastCopyableMonster", prev); // Need the property to be more accurate sometimes
      }
    }
  },
  meteorUngulith: () => {
    var fax = (0,dist.$item)(events_templateObject167 || (events_templateObject167 = events_taggedTemplateLiteral(["photocopied monster"])));
    var faxMon = (0,dist.$monster)(events_templateObject168 || (events_templateObject168 = events_taggedTemplateLiteral(["ungulith"])));
    ...
    (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject169 || (events_templateObject169 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject170 || (events_templateObject170 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
    ...
    checkAvailable((0,dist.$item)(events_templateObject172 || (events_templateObject172 = events_taggedTemplateLiteral(["corrupted marrow"]))));
  },
  foamYourself: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject174 || (events_templateObject174 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject175 || (events_templateObject175 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject176 || (events_templateObject176 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject177 || (events_templateObject177 = events_taggedTemplateLiteral(["industrial fire extinguisher"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject178 || (events_templateObject178 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(direWarren, MacroList.FoamForce);
      checkEffect((0,dist.$effect)(events_templateObject179 || (events_templateObject179 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))));
    }
  },
  meteorPleasureDome: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject180 || (events_templateObject180 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      tryUse((0,dist.$item)(events_templateObject181 || (events_templateObject181 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject184 || (events_templateObject184 = events_taggedTemplateLiteral(["Machine Elf"]))));

      if ((0,dist.have)((0,dist.$effect)(events_templateObject185 || (events_templateObject185 = events_taggedTemplateLiteral(["Absinthe-Minded"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject186 || (events_templateObject186 = events_taggedTemplateLiteral(["disintegrating spiky collar"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject187 || (events_templateObject187 = events_taggedTemplateLiteral(["Man's Worst Enemy"]))))) {
        mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject188 || (events_templateObject188 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.MeteorForce);
        checkAvailable((0,dist.$item)(events_templateObject189 || (events_templateObject189 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
        (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
      } else {
  ...
  batform: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject195 || (events_templateObject195 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject196 || (events_templateObject196 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.BatFormRunaway);
      checkEffect((0,dist.$effect)(events_templateObject197 || (events_templateObject197 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))));
    }
  }
};
...
function familiar(fam) {
  ...
  var costume = new Map([[(0,dist.$familiar)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["Machine Elf"]))), "mp"], [(0,dist.$familiar)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["Pocket Professor"]))), "hp"], [(0,dist.$familiar)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["Rockin' Robin"]))), "myst"], [(0,dist.$familiar)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["Vampire Vintner"]))), "meat"]]).get(fam);
...
function selectBestFamiliar() {
  ...
  if (flag === FamiliarFlag.Wine && !(0,dist.have)((0,dist.$item)(events_templateObject202 || (events_templateObject202 = events_taggedTemplateLiteral(["1950 Vampire Vintner wine"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["Wine-Befouled"]))))) {
    familiar((0,dist.$familiar)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["Vampire Vintner"]))));
  ...
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["robin's egg"]))))) {
    familiar((0,dist.$familiar)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["Rockin' Robin"]))));
  ...
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject215 || (events_templateObject215 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["burning paper crane"]))))) {
...
function preCoilWire() {
  ...
  [(0,dist.$item)(main_templateObject6 || (main_templateObject6 = main_taggedTemplateLiteral(["letter from King Ralph XI"]))), (0,dist.$item)(main_templateObject7 || (main_templateObject7 = main_taggedTemplateLiteral(["pork elf goodies sack"]))), (0,dist.$item)(main_templateObject8 || (main_templateObject8 = main_taggedTemplateLiteral(["banana candle"]))), (0,dist.$item)(main_templateObject9 || (main_templateObject9 = main_taggedTemplateLiteral(["ear candle"]))), (0,dist.$item)(main_templateObject10 || (main_templateObject10 = main_taggedTemplateLiteral(["natural magick candle"]))), (0,dist.$item)(main_templateObject11 || (main_templateObject11 = main_taggedTemplateLiteral(["rainbow glitter candle"]))), (0,dist.$item)(main_templateObject12 || (main_templateObject12 = main_taggedTemplateLiteral(["votive of confidence"])))].forEach(tryUse); // Only need one consult for a candy
  ...
  if ((0,dist.have)((0,dist.$item)(main_templateObject13 || (main_templateObject13 = main_taggedTemplateLiteral(["1952 Mickey Mantle card"]))))) (0,external_kolmafia_.autosell)(1, (0,dist.$item)(main_templateObject14 || (main_templateObject14 = main_taggedTemplateLiteral(["1952 Mickey Mantle card"]))));
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject15 || (main_templateObject15 = main_taggedTemplateLiteral(["Communism!"]))));
  ...
  openQuestZones();
  (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject16 || (main_templateObject16 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject17 || (main_templateObject17 = main_taggedTemplateLiteral(["Powerful Glove"])))); // Optimize away equipping & unequipping to buff up

  prep(Quest.Beginning); //prettier-ignore

  var _iterator = main_createForOfIteratorHelper([[(0,dist.$effect)(main_templateObject25 || (main_templateObject25 = main_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))), () => (0,external_kolmafia_.visitUrl)("place.php?whichplace=campaway&action=campaway_sky")], [(0,dist.$item)(main_templateObject26 || (main_templateObject26 = main_taggedTemplateLiteral(["\"DRINK ME\" potion"]))), () => (0,external_kolmafia_.visitUrl)("clan_viplounge.php?action=lookingglass&whichfloor=2")], [(0,dist.$item)(main_templateObject27 || (main_templateObject27 = main_taggedTemplateLiteral(["your cowboy boots"]))), () => (0,external_kolmafia_.visitUrl)("place.php?whichplace=town_right&action=townright_ltt")], [(0,dist.$item)(main_templateObject28 || (main_templateObject28 = main_taggedTemplateLiteral(["detuned radio"]))), () => {
    (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject29 || (main_templateObject29 = main_taggedTemplateLiteral(["detuned radio"])))); // 10001 - 285 = 9716 meat

    (0,external_kolmafia_.changeMcd)(10);
  }], [(0,dist.$item)(main_templateObject30 || (main_templateObject30 = main_taggedTemplateLiteral(["flimsy hardwood scraps"]))), () => (0,external_kolmafia_.visitUrl)("shop.php?whichshop=lathe")], [(0,dist.$item)(main_templateObject31 || (main_templateObject31 = main_taggedTemplateLiteral(["weeping willow wand"]))), () => {
    (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject32 || (main_templateObject32 = main_taggedTemplateLiteral(["weeping willow wand"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject33 || (main_templateObject33 = main_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(main_templateObject34 || (main_templateObject34 = main_taggedTemplateLiteral(["weeping willow wand"]))));
  }], [(0,dist.$item)(main_templateObject35 || (main_templateObject35 = main_taggedTemplateLiteral(["battery (AAA)"]))), () => harvestBatteries()], [(0,dist.$item)(main_templateObject36 || (main_templateObject36 = main_taggedTemplateLiteral(["battery (lantern)"]))), () => (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject37 || (main_templateObject37 = main_taggedTemplateLiteral(["battery (lantern)"]))))], [(0,dist.$item)(main_templateObject38 || (main_templateObject38 = main_taggedTemplateLiteral(["Brutal brogues"]))), () => (0,external_kolmafia_.cliExecute)("bastille bbq brutalist catapult")], [(0,dist.$item)(main_templateObject39 || (main_templateObject39 = main_taggedTemplateLiteral(["cop dollar"]))), () => (0,external_kolmafia_.cliExecute)("Detective Solver")], [(0,dist.$item)(main_templateObject40 || (main_templateObject40 = main_taggedTemplateLiteral(["cuppa Loyal tea"]))), () => (0,external_kolmafia_.cliExecute)("teatree loyal")], [(0,dist.$item)(main_templateObject41 || (main_templateObject41 = main_taggedTemplateLiteral(["green mana"]))), () => (0,external_kolmafia_.cliExecute)("cheat forest")], [(0,dist.$item)(main_templateObject42 || (main_templateObject42 = main_taggedTemplateLiteral(["wrench"]))), () => (0,external_kolmafia_.cliExecute)("cheat wrench")], [(0,dist.$item)(main_templateObject43 || (main_templateObject43 = main_taggedTemplateLiteral(["occult jelly donut"]))), () => (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject44 || (main_templateObject44 = main_taggedTemplateLiteral(["occult jelly donut"]))))], [(0,dist.$item)(main_templateObject45 || (main_templateObject45 = main_taggedTemplateLiteral(["sombrero-mounted sparkler"]))), () => (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject46 || (main_templateObject46 = main_taggedTemplateLiteral(["sombrero-mounted sparkler"]))))], // 9716 - 475 = 9241 meat
  [(0,dist.$item)(main_templateObject47 || (main_templateObject47 = main_taggedTemplateLiteral(["Yeg's Motel hand soap"]))), () => (0,external_kolmafia_.cliExecute)("cargo item ".concat((0,dist.$item)(main_templateObject48 || (main_templateObject48 = main_taggedTemplateLiteral(["Yeg's Motel hand soap"])))))], [(0,dist.$skill)(main_templateObject49 || (main_templateObject49 = main_taggedTemplateLiteral(["Seek out a Bird"]))), () => (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject50 || (main_templateObject50 = main_taggedTemplateLiteral(["Bird-a-Day calendar"]))))]]),
      _step;
  ...
  if (!(0,dist.get)("_borrowedTimeUsed")) {
    if (!(0,dist.have)((0,dist.$item)(main_templateObject18 || (main_templateObject18 = main_taggedTemplateLiteral(["borrowed time"]))))) (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject19 || (main_templateObject19 = main_taggedTemplateLiteral(["borrowed time"]))));
    (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject20 || (main_templateObject20 = main_taggedTemplateLiteral(["borrowed time"]))));
  }

  if ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() * 0.9) (0,external_kolmafia_.cliExecute)("hottub");
  if ((0,dist.get)("_sourceTerminalDigitizeUses") < 1) dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject21 || (main_templateObject21 = main_taggedTemplateLiteral(["Digitize"]))));
  oneOffEvents.hipster();

  if ((0,dist.get)("_sourceTerminalDigitizeUses") > 0) {
    dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject22 || (main_templateObject22 = main_taggedTemplateLiteral(["Compress"]))));
    dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject23 || (main_templateObject23 = main_taggedTemplateLiteral(["Extract"]))));
  ...
  acquireEffect((0,dist.$effect)(main_templateObject24 || (main_templateObject24 = main_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"]))));
  spendAllMpOnLibrams();
}

function postCoilWire() {
  gazeAtTheStars();
  if ((0,dist.have)((0,dist.$item)(main_templateObject51 || (main_templateObject51 = main_taggedTemplateLiteral(["occult jelly donut"]))))) (0,external_kolmafia_.eat)((0,dist.$item)(main_templateObject52 || (main_templateObject52 = main_taggedTemplateLiteral(["occult jelly donut"]))));
  ...
  [(0,dist.$effect)(main_templateObject53 || (main_templateObject53 = main_taggedTemplateLiteral(["All Is Forgiven"]))), (0,dist.$effect)(main_templateObject54 || (main_templateObject54 = main_taggedTemplateLiteral(["Sparkly!"]))), (0,dist.$effect)(main_templateObject55 || (main_templateObject55 = main_taggedTemplateLiteral(["Witch Breaded"])))].forEach(wishEffect);
  useDroppedItems(); // In case we obtained a green candy heart already, don't want to synthesize it later

  if (!(0,dist.get)("hasRange")) {
    var range = (0,dist.$item)(main_templateObject56 || (main_templateObject56 = main_taggedTemplateLiteral(["Dramatic\u2122 range"])));
  ...
  (0,dist.$skill)(main_templateObject57 || (main_templateObject57 = main_taggedTemplateLiteral(["Advanced Cocktailcrafting"]))), (0,dist.$skill)(main_templateObject58 || (main_templateObject58 = main_taggedTemplateLiteral(["Advanced Saucecrafting"]))), (0,dist.$skill)(main_templateObject59 || (main_templateObject59 = main_taggedTemplateLiteral(["Chubby and Plump"]))), (0,dist.$skill)(main_templateObject60 || (main_templateObject60 = main_taggedTemplateLiteral(["Perfect Freeze"]))), (0,dist.$skill)(main_templateObject61 || (main_templateObject61 = main_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))), // Only need Alice's Army and Crimbo Candy for now
  (0,dist.$skill)(main_templateObject62 || (main_templateObject62 = main_taggedTemplateLiteral(["Summon Alice's Army Cards"]))), //$skill`Summon Confiscated Things`,
  (0,dist.$skill)(main_templateObject63 || (main_templateObject63 = main_taggedTemplateLiteral(["Summon Crimbo Candy"]))) //$skill`Summon Geeky Gifts`,
  //$skill`Summon Tasteful Items`,
  ].forEach(skill => (0,external_kolmafia_.useSkill)(skill)); // 143 mp

  [(0,dist.$item)(main_templateObject64 || (main_templateObject64 = main_taggedTemplateLiteral(["oil of expertise"]))), (0,dist.$item)(main_templateObject65 || (main_templateObject65 = main_taggedTemplateLiteral(["philter of phorce"]))), (0,dist.$item)(main_templateObject66 || (main_templateObject66 = main_taggedTemplateLiteral(["ointment of the occult"]))), (0,dist.$item)(main_templateObject67 || (main_templateObject67 = main_taggedTemplateLiteral(["eyedrops of the ermine"])))].forEach(saucePotion => {
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject68 || (main_templateObject68 = main_taggedTemplateLiteral(["toy accordion"])))); // 10291 - 142 = 10149 meat
  //useSkill(2, $skill`The Ode to Booze`);

  acquireEffect((0,dist.$effect)(main_templateObject69 || (main_templateObject69 = main_taggedTemplateLiteral(["Ode to Booze"]))));
  checkMainClan();
  [(0,dist.$effect)(main_templateObject70 || (main_templateObject70 = main_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), (0,dist.$effect)(main_templateObject71 || (main_templateObject71 = main_taggedTemplateLiteral(["In a Lather"])))
  ...
  var toSynth = [(0,dist.$effect)(main_templateObject72 || (main_templateObject72 = main_taggedTemplateLiteral(["Synthesis: Collection"]))), (0,dist.$effect)(main_templateObject73 || (main_templateObject73 = main_taggedTemplateLiteral(["Synthesis: Smart"]))), (0,dist.$effect)(main_templateObject74 || (main_templateObject74 = main_taggedTemplateLiteral(["Synthesis: Learning"])))].filter(effect => !(0,dist.have)(effect));
  ...
  if (toSynth.length > 0) {
    ...
    var toKeep = [(0,dist.$item)(main_templateObject75 || (main_templateObject75 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))), (0,dist.$item)(main_templateObject76 || (main_templateObject76 = main_taggedTemplateLiteral(["sugar sheet"])))];
  ...
  var water = (0,dist.$item)(main_templateObject77 || (main_templateObject77 = main_taggedTemplateLiteral(["cold-filtered water"])));
  if ((0,dist.get)("tomeSummons") < 3 && !(0,dist.have)(water) && !(0,dist.have)((0,dist.$effect)(main_templateObject78 || (main_templateObject78 = main_taggedTemplateLiteral(["Purity of Spirit"]))))) (0,external_kolmafia_.create)(water);
  tryUse(water); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  [(0,dist.$item)(main_templateObject79 || (main_templateObject79 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))), (0,dist.$item)(main_templateObject80 || (main_templateObject80 = main_taggedTemplateLiteral(["Napalm In The Morning\u2122 candle"]))), (0,dist.$item)(main_templateObject81 || (main_templateObject81 = main_taggedTemplateLiteral(["Salsa Caliente\u2122 candle"]))), (0,dist.$item)(main_templateObject82 || (main_templateObject82 = main_taggedTemplateLiteral(["Smoldering Clover\u2122 candle"])))].forEach(tryUse);
  (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject83 || (main_templateObject83 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject84 || (main_templateObject84 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject85 || (main_templateObject85 = main_taggedTemplateLiteral(["turtle totem"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject86 || (main_templateObject86 = main_taggedTemplateLiteral(["saucepan"]))));
  prep(Quest.Leveling); // 316 mp

  if ((0,dist.have)((0,dist.$item)(main_templateObject87 || (main_templateObject87 = main_taggedTemplateLiteral(["LOV Epaulettes"]))))) prep(Quest.LevelingML);
}
...
function levelAndDoQuests() {
  ...
  if (getRemainingFreeFights() > 0) {
    (function () {
      ...
      leveling: while (true) {
        ...
        if ((0,dist.have)((0,dist.$effect)(main_templateObject88 || (main_templateObject88 = main_taggedTemplateLiteral(["Temporary Blindness"]))))) {
        ...
        if (chateauNapReady()) {
          ...
          }, [[(0,dist.$slot)(main_templateObject89 || (main_templateObject89 = main_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(main_templateObject90 || (main_templateObject90 = main_taggedTemplateLiteral(["familiar scrapbook"])))]]);
        }

        var maxMPGains = ((0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.myMp)()) / 15;
        var maxSoulFoodCasts = (0,external_kolmafia_.mySoulsauce)() / (0,external_kolmafia_.soulsauceCost)((0,dist.$skill)(main_templateObject91 || (main_templateObject91 = main_taggedTemplateLiteral(["Soul Food"]))));
        var soulFoodCasts = Math.floor(Math.min(maxMPGains, maxSoulFoodCasts));
        if (soulFoodCasts > 0) (0,external_kolmafia_.useSkill)(soulFoodCasts, (0,dist.$skill)(main_templateObject92 || (main_templateObject92 = main_taggedTemplateLiteral(["Soul Food"]))));

        while ((0,dist.have)((0,dist.$item)(main_templateObject93 || (main_templateObject93 = main_taggedTemplateLiteral(["magical sausage casing"])))) && ((0,dist.get)("_sausagesMade") + 1) * 111 < (0,external_kolmafia_.myMeat)() - MEAT_SAFE_LIMIT && (0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.myMp)() > 1000 && (0,external_kolmafia_.myMaxmp)() - (0,external_kolmafia_.mpCost)((0,dist.$skill)(main_templateObject94 || (main_templateObject94 = main_taggedTemplateLiteral(["Summon BRICKOs"])))) > MP_SAFE_LIMIT && (0,dist.get)("_sausagesEaten") < 23) {
          (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject95 || (main_templateObject95 = main_taggedTemplateLiteral(["magical sausage"]))));
          (0,external_kolmafia_.eat)((0,dist.$item)(main_templateObject96 || (main_templateObject96 = main_taggedTemplateLiteral(["magical sausage"]))));
        }

        while ((0,external_kolmafia_.myMp)() - (0,external_kolmafia_.mpCost)((0,dist.$skill)(main_templateObject97 || (main_templateObject97 = main_taggedTemplateLiteral(["Summon BRICKOs"])))) > MP_SAFE_LIMIT) {
          castBestLibram();
        ...
        while ((0,dist.have)((0,dist.$item)(main_templateObject98 || (main_templateObject98 = main_taggedTemplateLiteral(["BRICKO eye brick"])))) && (0,dist.have)((0,dist.$item)(main_templateObject99 || (main_templateObject99 = main_taggedTemplateLiteral(["BRICKO brick"]))), BRICKOS_PER_FIGHT)) {
          (0,external_kolmafia_.create)(BRICKO_TARGET_ITEM);
        }

        if ((0,dist.have)((0,dist.$item)(main_templateObject100 || (main_templateObject100 = main_taggedTemplateLiteral(["burning newspaper"]))))) (0,external_kolmafia_.create)((0,dist.$item)(main_templateObject101 || (main_templateObject101 = main_taggedTemplateLiteral(["burning paper crane"])))); // Turbo used a flag to cast pride

        if ((0,dist.get)("garbageShirtCharge") === 3) dist.SourceTerminal.educate((0,dist.$skill)(main_templateObject102 || (main_templateObject102 = main_taggedTemplateLiteral(["Turbo"]))));
  ...
  if (haveQuest(Quest.SpellDamage)) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(main_templateObject103 || (main_templateObject103 = main_taggedTemplateLiteral(["Cowrruption"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject104 || (main_templateObject104 = main_taggedTemplateLiteral(["corrupted marrow"]))));
  ...
  if (haveQuest(Quest.CombatFrequency)) {
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject105 || (main_templateObject105 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject106 || (main_templateObject106 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  ...
  if (haveQuest(Quest.FamiliarWeight)) {
    oneOffEvents.meteorPleasureDome();
    var loveSong = (0,dist.$item)(main_templateObject107 || (main_templateObject107 = main_taggedTemplateLiteral(["love song of icy revenge"])));
    var coldHeart = (0,dist.$effect)(main_templateObject108 || (main_templateObject108 = main_taggedTemplateLiteral(["Cold Hearted"])));
    ...
    var taffy = (0,dist.$item)(main_templateObject109 || (main_templateObject109 = main_taggedTemplateLiteral(["pulled blue taffy"])));
    if ((0,dist.have)(taffy)) (0,external_kolmafia_.use)(Math.min(4, (0,external_kolmafia_.itemAmount)(taffy)), taffy);
    var wine = (0,dist.$item)(main_templateObject110 || (main_templateObject110 = main_taggedTemplateLiteral(["1950 Vampire Vintner wine"])));

    if ((0,dist.have)(wine)) {
      acquireEffect((0,dist.$effect)(main_templateObject111 || (main_templateObject111 = main_taggedTemplateLiteral(["Ode to Booze"]))));
