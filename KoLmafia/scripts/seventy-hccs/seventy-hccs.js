...
[(0,dist.$effect)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["Over-Familiar With Dactyls"]))), Context.test], [(0,dist.$effect)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["Robot Friends"]))), Context.test], [(0,dist.$effect)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["Whole Latte Love"]))), Context.test], // Food/Booze/Spleen
[(0,dist.$effect)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), Context.special], [(0,dist.$effect)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["Joy"]))), Context.special], [(0,dist.$effect)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["Smart Drunk"]))), Context.special], // Librams
//[$effect`Cold Hearted`, Context.special],
//[$effect`Heart of Green`, Context.special],
// Wishes
[(0,dist.$effect)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["All Is Forgiven"]))), Context.special], [(0,dist.$effect)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["Bureaucratized"]))), Context.special], [(0,dist.$effect)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["Chorale of Companionship"]))), Context.special], [(0,dist.$effect)(_templateObject302 || (_templateObject302 = quests_taggedTemplateLiteral(["Down With Chow"]))), Context.special], // Other
[(0,dist.$effect)(_templateObject303 || (_templateObject303 = quests_taggedTemplateLiteral(["Meteor Showered"]))), Context.special], [(0,dist.$effect)(_templateObject304 || (_templateObject304 = quests_taggedTemplateLiteral(["Open Heart Surgery"]))), Context.special]])), _defineProperty(_questEffects, Quest.ItemDrop, new Map([[(0,dist.$effect)(_templateObject305 || (_templateObject305 = quests_taggedTemplateLiteral(["items.enh"]))), Context.beginning], [(0,dist.$effect)(_templateObject306 || (_templateObject306 = quests_taggedTemplateLiteral(["Uncucumbered"]))), Context.beginning], [(0,dist.$effect)(_templateObject307 || (_templateObject307 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject308 || (_templateObject308 = quests_taggedTemplateLiteral(["Blessing of your favorite Bird"]))), Context.leveling], [(0,dist.$effect)(_templateObject309 || (_templateObject309 = quests_taggedTemplateLiteral(["Ermine Eyes"]))), Context.leveling], [(0,dist.$effect)(_templateObject310 || (_templateObject310 = quests_taggedTemplateLiteral(["Hustlin'"]))), Context.leveling], [(0,dist.$effect)(_templateObject311 || (_templateObject311 = quests_taggedTemplateLiteral(["Leon's Phat Loot Lyric"]))), Context.leveling], [(0,dist.$effect)(_templateObject312 || (_templateObject312 = quests_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), Context.leveling], [(0,dist.$effect)(_templateObject313 || (_templateObject313 = quests_taggedTemplateLiteral(["Feeling Lost"]))), Context.test], [(0,dist.$effect)(_templateObject314 || (_templateObject314 = quests_taggedTemplateLiteral(["Nearly All-Natural"]))), Context.test], [(0,dist.$effect)(_templateObject315 || (_templateObject315 = quests_taggedTemplateLiteral(["Steely-Eyed Squint"]))), Context.test], [(0,dist.$effect)(_templateObject316 || (_templateObject316 = quests_taggedTemplateLiteral(["The Spirit of Taking"]))), Context.test], [(0,dist.$effect)(_templateObject317 || (_templateObject317 = quests_taggedTemplateLiteral(["Bat-Adjacent Form"]))), Context.special], [(0,dist.$effect)(_templateObject318 || (_templateObject318 = quests_taggedTemplateLiteral(["Synthesis: Collection"]))), Context.special]])), _defineProperty(_questEffects, Quest.Donate, new Map()), _questEffects);
...
var oneOffEvents = {
  ...
  mimic: function mimic() {
    if (!(0,dist.get)("_bagOfCandy")) {
      ...
      checkAvailable((0,dist.$item)(events_templateObject157 || (events_templateObject157 = events_taggedTemplateLiteral(["bag of many confections"]))));
    }
  },
  tropicalSkeleton: function tropicalSkeleton() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject158 || (events_templateObject158 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject160 || (events_templateObject160 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      familiar((0,dist.$familiar)(events_templateObject161 || (events_templateObject161 = events_taggedTemplateLiteral(["Crimbo Shrub"]))));

      if (!(0,dist.get)("_shrubDecorated")) {
        (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=".concat((0,external_kolmafia_.myHash)(), "&which=99&whichitem=").concat((0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))))));
      ...
      mapMonster(skeletonStore, (0,dist.$monster)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["novelty tropical skeleton"]))), MacroList.TropicalSkeleton);
      checkEffect((0,dist.$effect)(events_templateObject164 || (events_templateObject164 = events_taggedTemplateLiteral(["Everything Looks Red"]))));
      (0,dist.$items)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["cherry,grapefruit,lemon,strawberry"]))).forEach(function (fruit) {
  ...
  nanobrainy: function nanobrainy() {
    ...
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["Nanobrainy"]))))) {
  ...
  lavaCo: function lavaCo() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject176 || (events_templateObject176 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject177 || (events_templateObject177 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject178 || (events_templateObject178 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject179 || (events_templateObject179 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject180 || (events_templateObject180 = events_taggedTemplateLiteral(["factory overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject181 || (events_templateObject181 = events_taggedTemplateLiteral(["factory worker (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject182 || (events_templateObject182 = events_taggedTemplateLiteral(["lava golem"]))).name) ? MacroList.LavaCoFactory2 : MacroList.LavaCoFactory1;
  ...
  velvetGoldMine: function velvetGoldMine() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject183 || (events_templateObject183 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["healing crystal golem"]))).name) || banished.includes((0,dist.$monster)(events_templateObject191 || (events_templateObject191 = events_taggedTemplateLiteral(["mine overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["mine worker (male)"]))).name) ? MacroList.VelvetGoldMine2 : MacroList.VelvetGoldMine1;
      adventure(_velvetGoldMine, macro);
    }
  },
  mistform: function mistform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["Misty Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$item)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      ...
      checkEffect((0,dist.$effect)(events_templateObject197 || (events_templateObject197 = events_taggedTemplateLiteral(["Misty Form"]))));
    }
  },
  meteorShower: function meteorShower() {
    tryUse((0,dist.$item)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));

    if ((0,dist.have)((0,dist.$effect)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["absinthe minded"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["Meteor Showered"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject202 || (events_templateObject202 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.MeteorShowerForce);
      checkAvailable((0,dist.$item)(events_templateObject205 || (events_templateObject205 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
      checkEffect((0,dist.$effect)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["Meteor Showered"]))));
    }

    tryUse((0,dist.$item)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));

    if (!(0,dist.have)((0,dist.$effect)(events_templateObject208 || (events_templateObject208 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
  ...
  batform: function batform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject212 || (events_templateObject212 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$item)(events_templateObject213 || (events_templateObject213 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject215 || (events_templateObject215 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.BatForm);
      checkEffect((0,dist.$effect)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))));
    }
  }
};
...
function familiar(fam) {
  ...
  var costume = new Map([[(0,dist.$familiar)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["Green Pixie"]))), "mp"], [(0,dist.$familiar)(events_templateObject218 || (events_templateObject218 = events_taggedTemplateLiteral(["Machine Elf"]))), "meat"], [(0,dist.$familiar)(events_templateObject219 || (events_templateObject219 = events_taggedTemplateLiteral(["Melodramedary"]))), "myst"], [(0,dist.$familiar)(events_templateObject220 || (events_templateObject220 = events_taggedTemplateLiteral(["Pocket Professor"]))), "hp"], [(0,dist.$familiar)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))), "item"]]).get(fam);
...
function selectBestFamiliar() {
  ...
  if (!(0,dist.have)((0,dist.$effect)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["Spit Upon"]))))) {
    familiar((0,dist.$familiar)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["Melodramedary"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject224 || (events_templateObject224 = events_taggedTemplateLiteral(["short stack of pancakes"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject225 || (events_templateObject225 = events_taggedTemplateLiteral(["Shortly Stacked"]))))) {
    familiar((0,dist.$familiar)(events_templateObject226 || (events_templateObject226 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject227 || (events_templateObject227 = events_taggedTemplateLiteral(["tiny bottle of absinthe"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject228 || (events_templateObject228 = events_taggedTemplateLiteral(["absinthe minded"]))))) {
    familiar((0,dist.$familiar)(events_templateObject229 || (events_templateObject229 = events_taggedTemplateLiteral(["Green Pixie"]))));
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject230 || (events_templateObject230 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject231 || (events_templateObject231 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject232 || (events_templateObject232 = events_taggedTemplateLiteral(["burning paper crane"])))) && (0,dist.get)("garbageFireProgress") + getRemainingFreeFights() >= 30) {
    familiar((0,dist.$familiar)(events_templateObject233 || (events_templateObject233 = events_taggedTemplateLiteral(["Garbage Fire"]))));
    /*} else if (
    ...
    familiar((0,dist.$familiar)(events_templateObject234 || (events_templateObject234 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else {
    familiar((0,dist.$familiar)(events_templateObject235 || (events_templateObject235 = events_taggedTemplateLiteral(["Machine Elf"]))));
  }
}
...
function levelAndDoQuests() {
  ...
  if (getRemainingFreeFights() > 0) {
    ...
    leveling: while (true) {
      ...
      tryUse((0,dist.$item)(main_templateObject21 || (main_templateObject21 = main_taggedTemplateLiteral(["robin's egg"])))); // Save the Garbage shirt for the last 37 fights
