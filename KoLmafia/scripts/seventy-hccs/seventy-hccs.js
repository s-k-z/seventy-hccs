...
var questOutfits = (_questOutfits = {}, _defineProperty(_questOutfits, Quest.Beginning, function () {
  ...
  var outfit = new Map([[(0,dist.$slot)(quests_templateObject59 || (quests_templateObject59 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject60 || (quests_templateObject60 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject61 || (quests_templateObject61 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject62 || (quests_templateObject62 = quests_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))], [(0,dist.$slot)(quests_templateObject63 || (quests_templateObject63 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject64 || (quests_templateObject64 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(quests_templateObject65 || (quests_templateObject65 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject66 || (quests_templateObject66 = quests_taggedTemplateLiteral(["Beach Comb"])))]]);
  if ((0,dist.have)((0,dist.$item)(quests_templateObject67 || (quests_templateObject67 = quests_taggedTemplateLiteral(["LOV Epaulettes"]))))) outfit.set((0,dist.$slot)(quests_templateObject68 || (quests_templateObject68 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(quests_templateObject69 || (quests_templateObject69 = quests_taggedTemplateLiteral(["LOV Epaulettes"]))));
  if ((0,dist.have)((0,dist.$item)(quests_templateObject70 || (quests_templateObject70 = quests_taggedTemplateLiteral(["rope"]))))) outfit.set((0,dist.$slot)(quests_templateObject71 || (quests_templateObject71 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject72 || (quests_templateObject72 = quests_taggedTemplateLiteral(["rope"]))));
  return outfit;
}), _defineProperty(_questOutfits, Quest.Muscle, function () {
  return new Map([[(0,dist.$slot)(_templateObject73 || (_templateObject73 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject74 || (_templateObject74 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject75 || (_templateObject75 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject76 || (_templateObject76 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject77 || (_templateObject77 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject78 || (_templateObject78 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject79 || (_templateObject79 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject80 || (_templateObject80 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject81 || (_templateObject81 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject82 || (_templateObject82 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
}), _defineProperty(_questOutfits, Quest.Moxie, function () {
  return new Map([[(0,dist.$slot)(_templateObject83 || (_templateObject83 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject84 || (_templateObject84 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject85 || (_templateObject85 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject86 || (_templateObject86 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject87 || (_templateObject87 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject88 || (_templateObject88 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject89 || (_templateObject89 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject90 || (_templateObject90 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject91 || (_templateObject91 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject92 || (_templateObject92 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
}), _defineProperty(_questOutfits, Quest.HP, function () {
  return new Map([[(0,dist.$slot)(_templateObject93 || (_templateObject93 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject94 || (_templateObject94 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject95 || (_templateObject95 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject96 || (_templateObject96 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject97 || (_templateObject97 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject98 || (_templateObject98 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject99 || (_templateObject99 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject100 || (_templateObject100 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
}), _defineProperty(_questOutfits, Quest.DeepDark, function () {
  var outfit = new Map([[(0,dist.$slot)(_templateObject101 || (_templateObject101 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject102 || (_templateObject102 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject103 || (_templateObject103 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject104 || (_templateObject104 = quests_taggedTemplateLiteral(["pantogram pants"])))]]);
  if ((0,dist.have)((0,dist.$item)(_templateObject105 || (_templateObject105 = quests_taggedTemplateLiteral(["burning paper crane"]))))) outfit.set((0,dist.$slot)(_templateObject106 || (_templateObject106 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject107 || (_templateObject107 = quests_taggedTemplateLiteral(["burning paper crane"]))));
  return outfit;
}), _defineProperty(_questOutfits, Quest.SpellDamage, function () {
  return new Map([[(0,dist.$slot)(_templateObject108 || (_templateObject108 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject109 || (_templateObject109 = quests_taggedTemplateLiteral(["wrench"])))], [(0,dist.$slot)(_templateObject110 || (_templateObject110 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject111 || (_templateObject111 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject112 || (_templateObject112 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject113 || (_templateObject113 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject114 || (_templateObject114 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject115 || (_templateObject115 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject116 || (_templateObject116 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject117 || (_templateObject117 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(_templateObject118 || (_templateObject118 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject119 || (_templateObject119 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
}), _defineProperty(_questOutfits, Quest.WeaponDamage, function () {
  return new Map([[(0,dist.$slot)(_templateObject120 || (_templateObject120 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject121 || (_templateObject121 = quests_taggedTemplateLiteral(["broken champagne bottle"])))], [(0,dist.$slot)(_templateObject122 || (_templateObject122 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject123 || (_templateObject123 = quests_taggedTemplateLiteral(["dented scepter"])))], [(0,dist.$slot)(_templateObject124 || (_templateObject124 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject125 || (_templateObject125 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject126 || (_templateObject126 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject127 || (_templateObject127 = quests_taggedTemplateLiteral(["Powerful Glove"])))]]);
}), _defineProperty(_questOutfits, Quest.Mysticality, function () {
  return new Map([[(0,dist.$slot)(_templateObject128 || (_templateObject128 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject129 || (_templateObject129 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject130 || (_templateObject130 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject131 || (_templateObject131 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject132 || (_templateObject132 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject133 || (_templateObject133 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject134 || (_templateObject134 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject135 || (_templateObject135 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
}), _defineProperty(_questOutfits, Quest.CombatFrequency, function () {
  return new Map([[(0,dist.$slot)(_templateObject136 || (_templateObject136 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject137 || (_templateObject137 = quests_taggedTemplateLiteral(["very pointy crown"])))], [(0,dist.$slot)(_templateObject138 || (_templateObject138 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject139 || (_templateObject139 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(_templateObject140 || (_templateObject140 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject141 || (_templateObject141 = quests_taggedTemplateLiteral(["pantogram pants"])))], [(0,dist.$slot)(_templateObject142 || (_templateObject142 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject143 || (_templateObject143 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
}), _defineProperty(_questOutfits, Quest.HotResist, function () {
  return new Map([[(0,dist.$slot)(_templateObject144 || (_templateObject144 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject145 || (_templateObject145 = quests_taggedTemplateLiteral(["high-temperature mining mask"])))], [(0,dist.$slot)(_templateObject146 || (_templateObject146 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject147 || (_templateObject147 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject148 || (_templateObject148 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject149 || (_templateObject149 = quests_taggedTemplateLiteral(["meteorite guard"])))], [(0,dist.$slot)(_templateObject150 || (_templateObject150 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject151 || (_templateObject151 = quests_taggedTemplateLiteral(["lava-proof pants"])))], [(0,dist.$slot)(_templateObject152 || (_templateObject152 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject153 || (_templateObject153 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject154 || (_templateObject154 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject155 || (_templateObject155 = quests_taggedTemplateLiteral(["heat-resistant gloves"])))], [(0,dist.$slot)(_templateObject156 || (_templateObject156 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject157 || (_templateObject157 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
}), _defineProperty(_questOutfits, Quest.FamiliarWeight, function () {
  return new Map([[(0,dist.$slot)(_templateObject158 || (_templateObject158 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject159 || (_templateObject159 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject160 || (_templateObject160 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject161 || (_templateObject161 = quests_taggedTemplateLiteral(["rope"])))], [(0,dist.$slot)(_templateObject162 || (_templateObject162 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject163 || (_templateObject163 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject164 || (_templateObject164 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject165 || (_templateObject165 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject166 || (_templateObject166 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject167 || (_templateObject167 = quests_taggedTemplateLiteral(["Beach Comb"])))]]);
...
var events = {
  ...
  tenPercentBonus: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject72 || (events_templateObject72 = events_taggedTemplateLiteral(["a ten-percent bonus"]))));
    }
  },
  upscaleDistrictKill: {
    max: 1,
    current: function current() {
      return (0,dist.have)((0,dist.$effect)(events_templateObject73 || (events_templateObject73 = events_taggedTemplateLiteral(["Whole Latte Love"])))) ? this.max : (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject74 || (events_templateObject74 = events_taggedTemplateLiteral(["sprinkles"])))) - 54;
    },
    run: function run() {
      equipOutfit(Quest.Sprinkles);
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject75 || (events_templateObject75 = events_taggedTemplateLiteral(["Chocolate Lab"]))));
      adventure(upscaleDistrict, MacroList.Sprinkles);
      equipOutfit(Quest.Leveling);
      checkAvailable((0,dist.$item)(events_templateObject76 || (events_templateObject76 = events_taggedTemplateLiteral(["sprinkles"]))), 55);
    }
  },
  upscaleDistrictRunaway: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject77 || (events_templateObject77 = events_taggedTemplateLiteral(["Whole Latte Love"])))) - 1;
    },
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject78 || (events_templateObject78 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject79 || (events_templateObject79 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(upscaleDistrict, MacroList.PickpocketFreeRun);

      if ((0,dist.have)((0,dist.$item)(events_templateObject80 || (events_templateObject80 = events_taggedTemplateLiteral(["gingerbread spice latte"]))))) {
        (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject81 || (events_templateObject81 = events_taggedTemplateLiteral(["gingerbread spice latte"]))));
        checkAvailable((0,dist.$item)(events_templateObject82 || (events_templateObject82 = events_taggedTemplateLiteral(["sprinkles"]))), 5);
      } else if ((0,dist.get)("_gingerbreadCityTurns") > 5) {
        throw "Failed to obtain ".concat((0,dist.$item)(events_templateObject83 || (events_templateObject83 = events_taggedTemplateLiteral(["gingerbread spice latte"]))));
      }
    }
  },
  civicCenterRunaway: {
    ...
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject84 || (events_templateObject84 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject85 || (events_templateObject85 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(civicCenter, MacroList.PickpocketFreeRun);

      if (this.current() === this.max) {
        if (!(0,dist.have)((0,dist.$item)(events_templateObject86 || (events_templateObject86 = events_taggedTemplateLiteral(["gingerbread cigarette"]))), 5)) {
          throw "Failed to obtain ".concat((0,dist.$item)(events_templateObject87 || (events_templateObject87 = events_taggedTemplateLiteral(["gingerbread cigarette"]))));
        }
      }
    }
  },
  witchessRook: {
    ...
    run: function run() {
      acquireEffect((0,dist.$effect)(events_templateObject88 || (events_templateObject88 = events_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))));
      equipOutfit(Quest.Leveling);
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject89 || (events_templateObject89 = events_taggedTemplateLiteral(["Witchess Rook"]))), MacroList.FreeFight);
      checkAvailable((0,dist.$item)(events_templateObject90 || (events_templateObject90 = events_taggedTemplateLiteral(["Greek fire"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject91 || (events_templateObject91 = events_taggedTemplateLiteral(["Greek fire"]))));
    }
  },
  snojo: {
    max: 10,
    ...
    run: function run() {
      if ((0,dist.get)("snojoSetting") !== (0,dist.$stat)(events_templateObject92 || (events_templateObject92 = events_taggedTemplateLiteral(["Muscle"])))) {
  ...
  witchessWitch: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject93 || (events_templateObject93 = events_taggedTemplateLiteral(["battle broom"])))) - 1;
    },
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject94 || (events_templateObject94 = events_taggedTemplateLiteral(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject95 || (events_templateObject95 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject96 || (events_templateObject96 = events_taggedTemplateLiteral(["battle broom"]))));
    }
  },
  eldritch: {
    max: 1,
    ...
    run: function run() {
      selectBestFamiliar();
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject97 || (events_templateObject97 = events_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
  ...
  gingerbreadCig: {
    max: 5,
    current: function current() {
      return this.max - (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject98 || (events_templateObject98 = events_taggedTemplateLiteral(["gingerbread cigarette"]))));
    },
    run: function run() {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  vote: {
    ...
    run: function run() {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject99 || (events_templateObject99 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject100 || (events_templateObject100 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  godLobster: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject101 || (events_templateObject101 = events_taggedTemplateLiteral(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.visitUrl)("main.php?fightgodlobster=1");
      if ((0,external_kolmafia_.choiceFollowsFight)()) (0,external_kolmafia_.runChoice)(-1);

      if (!(0,dist.have)((0,dist.$effect)(events_templateObject102 || (events_templateObject102 = events_taggedTemplateLiteral(["Silence of the God Lobster"]))))) {
        if (events.godLobster.current() === events.godLobster.max) {
          throw "Failed to get ".concat((0,dist.$effect)(events_templateObject103 || (events_templateObject103 = events_taggedTemplateLiteral(["Silence of the God Lobster"]))));
        } else if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject104 || (events_templateObject104 = events_taggedTemplateLiteral(["God Lobster's Ring"])))) > 0) {
          (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject105 || (events_templateObject105 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject106 || (events_templateObject106 = events_taggedTemplateLiteral(["God Lobster's Ring"]))));
        } else if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject107 || (events_templateObject107 = events_taggedTemplateLiteral(["God Lobster's Scepter"])))) > 0) {
          (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject108 || (events_templateObject108 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject109 || (events_templateObject109 = events_taggedTemplateLiteral(["God Lobster's Scepter"]))));
        }
      }
    }
  },
  witchessKing: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject110 || (events_templateObject110 = events_taggedTemplateLiteral(["dented scepter"])))) - 1;
    },
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject111 || (events_templateObject111 = events_taggedTemplateLiteral(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    max: 5,
    ...
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject112 || (events_templateObject112 = events_taggedTemplateLiteral(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  dmtSquare: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject113 || (events_templateObject113 = events_taggedTemplateLiteral(["Joy"])))) + (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject114 || (events_templateObject114 = events_taggedTemplateLiteral(["abstraction: action"])))) - 1;
    },
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject115 || (events_templateObject115 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTSquare);
      checkAvailable((0,dist.$item)(events_templateObject116 || (events_templateObject116 = events_taggedTemplateLiteral(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject117 || (events_templateObject117 = events_taggedTemplateLiteral(["Joy"])))) - 1;
    },
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject118 || (events_templateObject118 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable((0,dist.$item)(events_templateObject119 || (events_templateObject119 = events_taggedTemplateLiteral(["abstraction: joy"]))));
      (0,external_kolmafia_.chew)((0,dist.$item)(events_templateObject120 || (events_templateObject120 = events_taggedTemplateLiteral(["abstraction: joy"]))));
    }
  },
  dmt: {
    max: 5,
    ...
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject121 || (events_templateObject121 = events_taggedTemplateLiteral(["Machine Elf"]))));
  ...
  lecture: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject124 || (events_templateObject124 = events_taggedTemplateLiteral(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  backupCamera: {
    ...
    run: function run() {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject125 || (events_templateObject125 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject126 || (events_templateObject126 = events_taggedTemplateLiteral(["backup camera"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  nep: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject129 || (events_templateObject129 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject130 || (events_templateObject130 = events_taggedTemplateLiteral(["Beach Comb"]))));
      selectBestFamiliar();
  ...
  latteRefills: {
    ...
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject139 || (events_templateObject139 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject140 || (events_templateObject140 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject141 || (events_templateObject141 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));

      if ((0,dist.get)("_latteDrinkUsed")) {
        (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon carrot");
      }

      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject142 || (events_templateObject142 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
...
var oneOffEvents = {
  hipster: function hipster() {
    if (!(0,dist.get)("_ironicMoustache")) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject143 || (events_templateObject143 = events_taggedTemplateLiteral(["Mini-Hipster"]))));
      ...
      checkAvailable((0,dist.$item)(events_templateObject146 || (events_templateObject146 = events_taggedTemplateLiteral(["ironic moustache"]))));
      (0,external_kolmafia_.cliExecute)("fold ".concat((0,dist.$item)(events_templateObject147 || (events_templateObject147 = events_taggedTemplateLiteral(["chiptune guitar"])))));
    }
  },
  mimic: function mimic() {
    if (!(0,dist.get)("_bagOfCandy")) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject148 || (events_templateObject148 = events_taggedTemplateLiteral(["Stocking Mimic"]))));
  ...
  tropicalSkeleton: function tropicalSkeleton() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject152 || (events_templateObject152 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject155 || (events_templateObject155 = events_taggedTemplateLiteral(["Crimbo Shrub"]))));

      if (!(0,dist.get)("_shrubDecorated")) {
        (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=".concat((0,external_kolmafia_.myHash)(), "&which=99&whichitem=").concat((0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject156 || (events_templateObject156 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))))));
      ...
      if (!(0,dist.have)((0,dist.$effect)(events_templateObject158 || (events_templateObject158 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
        throw "Failed to cast ".concat((0,dist.$skill)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["Open a Big Red Present"]))), "?");
      }

      (0,dist.$items)(events_templateObject160 || (events_templateObject160 = events_taggedTemplateLiteral(["cherry,grapefruit,lemon,strawberry"]))).forEach(function (fruit) {
  ...
  nanobrainy: function nanobrainy() {
    ...
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject161 || (events_templateObject161 = events_taggedTemplateLiteral(["Nanobrainy"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject164 || (events_templateObject164 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
    }
  },
  lavaCo: function lavaCo() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject167 || (events_templateObject167 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject170 || (events_templateObject170 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject171 || (events_templateObject171 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject172 || (events_templateObject172 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject174 || (events_templateObject174 = events_taggedTemplateLiteral(["factory overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject175 || (events_templateObject175 = events_taggedTemplateLiteral(["factory worker (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject176 || (events_templateObject176 = events_taggedTemplateLiteral(["lava golem"]))).name) ? MacroList.LavaCoFactory2 : MacroList.LavaCoFactory1;
  ...
  velvetGoldMine: function velvetGoldMine() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject177 || (events_templateObject177 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject184 || (events_templateObject184 = events_taggedTemplateLiteral(["healing crystal golem"]))).name) || banished.includes((0,dist.$monster)(events_templateObject185 || (events_templateObject185 = events_taggedTemplateLiteral(["mine overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject186 || (events_templateObject186 = events_taggedTemplateLiteral(["mine worker (male)"]))).name) ? MacroList.VelvetGoldMine2 : MacroList.VelvetGoldMine1;
      adventure(_velvetGoldMine, macro);
    }
  },
  mistform: function mistform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject187 || (events_templateObject187 = events_taggedTemplateLiteral(["Misty Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$item)(events_templateObject188 || (events_templateObject188 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject189 || (events_templateObject189 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.MistForm);
    }
  },
  meteorShower: function meteorShower() {
    if ((0,dist.have)((0,dist.$item)(events_templateObject191 || (events_templateObject191 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));

    if ((0,dist.have)((0,dist.$effect)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["absinthe minded"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["Meteor Showered"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject195 || (events_templateObject195 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) {
      ...
      mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.MeteorShowerForce);
      ...
      if (!(0,dist.have)((0,dist.$effect)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["Meteor Showered"]))))) throw "Failed to get Meteor howered?";
    }

    if ((0,dist.have)((0,dist.$item)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject202 || (events_templateObject202 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
    ...
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject205 || (events_templateObject205 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      adventure(direWarren, MacroList.MeteorShowerForce);
    }
  },
  batform: function batform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject209 || (events_templateObject209 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
...
function selectBestFamiliar() {
  ...
  if (!(0,dist.have)((0,dist.$effect)(events_templateObject210 || (events_templateObject210 = events_taggedTemplateLiteral(["Spit Upon"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject211 || (events_templateObject211 = events_taggedTemplateLiteral(["Melodramedary"]))));
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))));
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["Green Pixie"]))));
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Garbage Fire"]))));
    /*} else if (
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["Machine Elf"]))));
  }
}
...
function levelAndDoQuests() {
  ...
  if (getRemainingFreeFights() > 0) {
    ...
    leveling: while (true) {
      ...
      while ((0,external_kolmafia_.myLevel)() >= CHATEAU_REST_LEVEL && //myMaxmp() - myMp() > 150 &&
      (0,dist.get)("timesRested") < (0,external_kolmafia_.totalFreeRests)()) {
      ...
      if (!(0,dist.have)((0,dist.$effect)(main_templateObject8 || (main_templateObject8 = main_taggedTemplateLiteral(["Soulerskates"]))))) {
        if ((0,external_kolmafia_.mySoulsauce)() >= (0,external_kolmafia_.soulsauceCost)((0,dist.$skill)(main_templateObject9 || (main_templateObject9 = main_taggedTemplateLiteral(["Soulerskates"]))))) {
      ...
      var paperCrane = (0,dist.$item)(main_templateObject20 || (main_templateObject20 = main_taggedTemplateLiteral(["burning paper crane"])));

      if (!(0,dist.have)(paperCrane) && (0,dist.have)((0,dist.$item)(main_templateObject21 || (main_templateObject21 = main_taggedTemplateLiteral(["burning newspaper"]))))) {
...
function preCoilWire() {
  ...
  tryUse(1, (0,dist.$item)(main_templateObject52 || (main_templateObject52 = main_taggedTemplateLiteral(["letter from King Ralph XI"]))));
  tryUse(1, (0,dist.$item)(main_templateObject53 || (main_templateObject53 = main_taggedTemplateLiteral(["pork elf goodies sack"])))); // Only need one consult for a candy
...
function postCoilWire() {
  ...
  (0,dist.$skill)(main_templateObject94 || (main_templateObject94 = main_taggedTemplateLiteral(["Incredible Self-Esteem"])))].forEach(function (s) {
  ...
  if ((0,dist.have)((0,dist.$item)(main_templateObject110 || (main_templateObject110 = main_taggedTemplateLiteral(["cold-filtered water"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject111 || (main_templateObject111 = main_taggedTemplateLiteral(["cold-filtered water"])))); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  if ((0,dist.have)((0,dist.$item)(main_templateObject112 || (main_templateObject112 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject113 || (main_templateObject113 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))));
