...
(0,dist.$monster)(combat_templateObject25 || (combat_templateObject25 = combat_taggedTemplateLiteral(["amateur ninja"]))), (0,dist.$monster)(combat_templateObject26 || (combat_templateObject26 = combat_taggedTemplateLiteral(["novelty tropical skeleton"]))), (0,dist.$monster)(combat_templateObject27 || (combat_templateObject27 = combat_taggedTemplateLiteral(["toothless mastiff bitch"]))), // gingerbread city
(0,dist.$monster)(combat_templateObject28 || (combat_templateObject28 = combat_taggedTemplateLiteral(["gingerbread finance bro"]))), (0,dist.$monster)(combat_templateObject29 || (combat_templateObject29 = combat_taggedTemplateLiteral(["gingerbread gentrifier"]))), (0,dist.$monster)(combat_templateObject30 || (combat_templateObject30 = combat_taggedTemplateLiteral(["gingerbread tech bro"]))), // tunnel of L.O.V.E.
(0,dist.$monster)(combat_templateObject31 || (combat_templateObject31 = combat_taggedTemplateLiteral(["LOV Enforcer"]))), (0,dist.$monster)(combat_templateObject32 || (combat_templateObject32 = combat_taggedTemplateLiteral(["LOV Engineer"]))), (0,dist.$monster)(combat_templateObject33 || (combat_templateObject33 = combat_taggedTemplateLiteral(["LOV Equivocator"]))), // witchess
(0,dist.$monster)(combat_templateObject34 || (combat_templateObject34 = combat_taggedTemplateLiteral(["Witchess Pawn"]))), (0,dist.$monster)(combat_templateObject35 || (combat_templateObject35 = combat_taggedTemplateLiteral(["Witchess Knight"]))), (0,dist.$monster)(combat_templateObject36 || (combat_templateObject36 = combat_taggedTemplateLiteral(["Witchess Bishop"]))), (0,dist.$monster)(combat_templateObject37 || (combat_templateObject37 = combat_taggedTemplateLiteral(["Witchess Rook"]))), (0,dist.$monster)(combat_templateObject38 || (combat_templateObject38 = combat_taggedTemplateLiteral(["Witchess Ox"]))), (0,dist.$monster)(combat_templateObject39 || (combat_templateObject39 = combat_taggedTemplateLiteral(["Witchess King"]))), (0,dist.$monster)(combat_templateObject40 || (combat_templateObject40 = combat_taggedTemplateLiteral(["Witchess Witch"]))), (0,dist.$monster)(combat_templateObject41 || (combat_templateObject41 = combat_taggedTemplateLiteral(["Witchess Queen"]))), // more free combats
(0,dist.$monster)(combat_templateObject42 || (combat_templateObject42 = combat_taggedTemplateLiteral(["Eldritch Tentacle"]))), (0,dist.$monster)(combat_templateObject43 || (combat_templateObject43 = combat_taggedTemplateLiteral(["Sssshhsssblllrrggghsssssggggrrgglsssshhssslblgl"]))), (0,dist.$monster)(combat_templateObject44 || (combat_templateObject44 = combat_taggedTemplateLiteral(["God Lobster"]))), (0,dist.$monster)(combat_templateObject45 || (combat_templateObject45 = combat_taggedTemplateLiteral(["X-32-F Combat Training Snowman"]))), // BRICKOS
(0,dist.$monster)(combat_templateObject46 || (combat_templateObject46 = combat_taggedTemplateLiteral(["BRICKO ooze"]))), (0,dist.$monster)(combat_templateObject47 || (combat_templateObject47 = combat_taggedTemplateLiteral(["BRICKO bat"]))), (0,dist.$monster)(combat_templateObject48 || (combat_templateObject48 = combat_taggedTemplateLiteral(["BRICKO oyster"]))), (0,dist.$monster)(combat_templateObject49 || (combat_templateObject49 = combat_taggedTemplateLiteral(["BRICKO turtle"]))), (0,dist.$monster)(combat_templateObject50 || (combat_templateObject50 = combat_taggedTemplateLiteral(["BRICKO elephant"]))), (0,dist.$monster)(combat_templateObject51 || (combat_templateObject51 = combat_taggedTemplateLiteral(["BRICKO octopus"]))), (0,dist.$monster)(combat_templateObject52 || (combat_templateObject52 = combat_taggedTemplateLiteral(["BRICKO python"]))), // voter monsters
(0,dist.$monster)(combat_templateObject53 || (combat_templateObject53 = combat_taggedTemplateLiteral(["angry ghost"]))), (0,dist.$monster)(combat_templateObject54 || (combat_templateObject54 = combat_taggedTemplateLiteral(["annoyed snake"]))), (0,dist.$monster)(combat_templateObject55 || (combat_templateObject55 = combat_taggedTemplateLiteral(["government bureaucrat"]))), (0,dist.$monster)(combat_templateObject56 || (combat_templateObject56 = combat_taggedTemplateLiteral(["slime blob"]))), (0,dist.$monster)(combat_templateObject57 || (combat_templateObject57 = combat_taggedTemplateLiteral(["terrible mutant"]))), // deep machine tunnels
(0,dist.$monster)(combat_templateObject58 || (combat_templateObject58 = combat_taggedTemplateLiteral(["Performer of Actions"]))), (0,dist.$monster)(_templateObject59 || (_templateObject59 = combat_taggedTemplateLiteral(["Thinker of Thoughts"]))), // neverending party
(0,dist.$monster)(_templateObject60 || (_templateObject60 = combat_taggedTemplateLiteral(["biker"]))), (0,dist.$monster)(_templateObject61 || (_templateObject61 = combat_taggedTemplateLiteral(["burnout"]))), (0,dist.$monster)(_templateObject62 || (_templateObject62 = combat_taggedTemplateLiteral(["jock"]))), (0,dist.$monster)(_templateObject63 || (_templateObject63 = combat_taggedTemplateLiteral(["party girl"]))), (0,dist.$monster)(_templateObject64 || (_templateObject64 = combat_taggedTemplateLiteral(["\"plain\" girl"]))), // boss(es)
(0,dist.$monster)(_templateObject65 || (_templateObject65 = combat_taggedTemplateLiteral(["Mother Slime"]))), // toxic teacups
(0,dist.$monster)(_templateObject66 || (_templateObject66 = combat_taggedTemplateLiteral(["toxic beastie"]))), (0,dist.$monster)(_templateObject67 || (_templateObject67 = combat_taggedTemplateLiteral(["Black Crayon Slime"])))].map(m => "!monsterid ".concat(m.id)).join(" && ");
var Ghost = new dist.Macro().skill((0,dist.$skill)(_templateObject68 || (_templateObject68 = combat_taggedTemplateLiteral(["Summon Love Gnats"])))).skill((0,dist.$skill)(_templateObject69 || (_templateObject69 = combat_taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject70 || (_templateObject70 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(_templateObject71 || (_templateObject71 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(_templateObject72 || (_templateObject72 = combat_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,dist.$skill)(_templateObject73 || (_templateObject73 = combat_taggedTemplateLiteral(["Trap Ghost"])))).abort();
var TryBanish = new dist.Macro() // Reserve Snokebomb for Mother Slime
.trySkill((0,dist.$skill)(_templateObject74 || (_templateObject74 = combat_taggedTemplateLiteral(["Throw Latte on Opponent"])))).trySkill((0,dist.$skill)(_templateObject75 || (_templateObject75 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).trySkill((0,dist.$skill)(_templateObject76 || (_templateObject76 = combat_taggedTemplateLiteral(["Reflex Hammer"])))).trySkill((0,dist.$skill)(_templateObject77 || (_templateObject77 = combat_taggedTemplateLiteral(["Bowl a Curveball"])))).trySkill((0,dist.$skill)(_templateObject78 || (_templateObject78 = combat_taggedTemplateLiteral(["Feel Hatred"])))).abort();
var Replace = new dist.Macro().skill((0,dist.$skill)(_templateObject79 || (_templateObject79 = combat_taggedTemplateLiteral(["Macrometeorite"]))));
var Backup = new dist.Macro().if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject80 || (_templateObject80 = combat_taggedTemplateLiteral(["Back-Up to your Last Enemy"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject81 || (_templateObject81 = combat_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).skill((0,dist.$skill)(_templateObject82 || (_templateObject82 = combat_taggedTemplateLiteral(["Saucy Salve"])))));
var Pride = new dist.Macro().if_( // Turbo used a flag to cast pride
"hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject83 || (_templateObject83 = combat_taggedTemplateLiteral(["Turbo"]))))), dist.Macro.trySkill((0,dist.$skill)(_templateObject84 || (_templateObject84 = combat_taggedTemplateLiteral(["Feel Pride"])))));
var FreeInstaKill = new dist.Macro().skill((0,dist.$skill)(_templateObject85 || (_templateObject85 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).trySkill((0,dist.$skill)(_templateObject86 || (_templateObject86 = combat_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill((0,dist.$skill)(_templateObject87 || (_templateObject87 = combat_taggedTemplateLiteral(["Shattering Punch"])))).trySkill((0,dist.$skill)(_templateObject88 || (_templateObject88 = combat_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill((0,dist.$skill)(_templateObject89 || (_templateObject89 = combat_taggedTemplateLiteral(["Shocking Lick"])))).abort();
var CigKill = new dist.Macro().skill((0,dist.$skill)(_templateObject90 || (_templateObject90 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).tryItem((0,dist.$item)(_templateObject91 || (_templateObject91 = combat_taggedTemplateLiteral(["gingerbread cigarette"])))).abort();
var SingAndKill = new dist.Macro().skill((0,dist.$skill)(_templateObject92 || (_templateObject92 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).while_("!mpbelow ".concat((0,external_kolmafia_.mpCost)((0,dist.$skill)(_templateObject93 || (_templateObject93 = combat_taggedTemplateLiteral(["Saucestorm"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject94 || (_templateObject94 = combat_taggedTemplateLiteral(["Saucestorm"]))))).attack().repeat();
var DefaultMacro = new dist.Macro().if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject95 || (_templateObject95 = combat_taggedTemplateLiteral(["Shoot Ghost"]))))), Ghost).if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), dist.Macro.skill((0,dist.$skill)(_templateObject96 || (_templateObject96 = combat_taggedTemplateLiteral(["Summon Love Gnats"])))).step(FreeInstaKill)).if_("monsterid ".concat(amateurNinja), FreeInstaKill).if_("monsterid ".concat(noveltySkeleton), dist.Macro.trySkill((0,dist.$skill)(_templateObject97 || (_templateObject97 = combat_taggedTemplateLiteral(["Open a Big Red Present"])))).skill((0,dist.$skill)(_templateObject98 || (_templateObject98 = combat_taggedTemplateLiteral(["Use the Force"]))))).if_("monsterid ".concat(mastiff), dist.Macro.skill((0,dist.$skill)(_templateObject99 || (_templateObject99 = combat_taggedTemplateLiteral(["Meteor Shower"])))).skill((0,dist.$skill)(_templateObject100 || (_templateObject100 = combat_taggedTemplateLiteral(["Use the Force"]))))).if_("snarfblat ".concat(retailDistrict), CigKill).if_(notAllowList, TryBanish).trySkill((0,dist.$skill)(_templateObject101 || (_templateObject101 = combat_taggedTemplateLiteral(["Digitize"])))).skill((0,dist.$skill)(_templateObject102 || (_templateObject102 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(_templateObject103 || (_templateObject103 = combat_taggedTemplateLiteral(["Micrometeorite"])))).item((0,dist.$item)(_templateObject104 || (_templateObject104 = combat_taggedTemplateLiteral(["Time-Spinner"])))).if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject105 || (_templateObject105 = combat_taggedTemplateLiteral(["lecture on relativity"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject106 || (_templateObject106 = combat_taggedTemplateLiteral(["lecture on relativity"])))).skill((0,dist.$skill)(_templateObject107 || (_templateObject107 = combat_taggedTemplateLiteral(["Saucy Salve"]))))).if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject108 || (_templateObject108 = combat_taggedTemplateLiteral(["Bowl Straight Up"])))), " && !haseffect ").concat((0,external_kolmafia_.toInt)((0,dist.$effect)(_templateObject109 || (_templateObject109 = combat_taggedTemplateLiteral(["Cosmic Ball in the Air"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject110 || (_templateObject110 = combat_taggedTemplateLiteral(["Bowl Straight Up"]))))).step(SingAndKill);
var MacroList = {
  FreeFight: DefaultMacro,
  FastFreeFight: SingAndKill,
  StenchFreeFight: new dist.Macro().if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), dist.Macro.abort()).if_("monsterhpabove 300", dist.Macro.skill((0,dist.$skill)(_templateObject111 || (_templateObject111 = combat_taggedTemplateLiteral(["Curse of Weaksauce"]))))).if_("monsterhpabove 300", dist.Macro.skill((0,dist.$skill)(_templateObject112 || (_templateObject112 = combat_taggedTemplateLiteral(["Sing Along"]))))).skill((0,dist.$skill)(_templateObject113 || (_templateObject113 = combat_taggedTemplateLiteral(["Garbage Nova"])))),
  // Just runaway on its own causes a null pointer exception?
  Runaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject114 || (_templateObject114 = combat_taggedTemplateLiteral(["Saucy Salve"])))).step("runaway"),
  Banish: TryBanish,
  Nanobrainy: new dist.Macro().skill((0,dist.$skill)(_templateObject115 || (_templateObject115 = combat_taggedTemplateLiteral(["Entangling Noodles"])))).trySkill((0,dist.$skill)(_templateObject116 || (_templateObject116 = combat_taggedTemplateLiteral(["Giant Growth"])))).trySkill((0,dist.$skill)(_templateObject117 || (_templateObject117 = combat_taggedTemplateLiteral(["Become a Wolf"])))).step(TryBanish),
  Sprinkles: new dist.Macro().if_("monsterid ".concat(gentrifier), Replace).skill((0,dist.$skill)(_templateObject118 || (_templateObject118 = combat_taggedTemplateLiteral(["Meteor Shower"])))).step(FreeInstaKill),
  TunnelOfLOV: new dist.Macro().if_("monsterid ".concat(LOVEnforcer), dist.Macro.attack().repeat()).if_("monsterid ".concat(LOVEngineer), dist.Macro.skill((0,dist.$skill)(_templateObject119 || (_templateObject119 = combat_taggedTemplateLiteral(["Candyblast"])))).repeat()).step(DefaultMacro),
  WitchessQueen: new dist.Macro().item((0,dist.$item)(_templateObject120 || (_templateObject120 = combat_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat(),
  WitchessWitch: new dist.Macro().skill((0,dist.$skill)(_templateObject121 || (_templateObject121 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(_templateObject122 || (_templateObject122 = combat_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(),
  DMTSquare: new dist.Macro().if_(notAllowList, dist.Macro.abort()).if_("!monsterid ".concat(DMTSquare), Replace).skill((0,dist.$skill)(_templateObject123 || (_templateObject123 = combat_taggedTemplateLiteral(["Feel Envy"])))).step(DefaultMacro),
  DMTCircle: new dist.Macro().if_(notAllowList, dist.Macro.abort()).if_("!monsterid ".concat(DMTCircle), Replace).tryItem((0,dist.$item)(_templateObject124 || (_templateObject124 = combat_taggedTemplateLiteral(["abstraction: action"])))).step(DefaultMacro),
  MotherSlime: new dist.Macro().if_(notAllowList, dist.Macro.abort()).trySkill((0,dist.$skill)(_templateObject125 || (_templateObject125 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).skill((0,dist.$skill)(_templateObject126 || (_templateObject126 = combat_taggedTemplateLiteral(["Snokebomb"])))),
  BatFormRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject127 || (_templateObject127 = combat_taggedTemplateLiteral(["Become a Bat"])))).step("runaway"),
  LatteGulpRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject128 || (_templateObject128 = combat_taggedTemplateLiteral(["Gulp Latte"])))).step("runaway"),
  MeteorForce: new dist.Macro().skill((0,dist.$skill)(_templateObject129 || (_templateObject129 = combat_taggedTemplateLiteral(["Meteor Shower"])))).skill((0,dist.$skill)(_templateObject130 || (_templateObject130 = combat_taggedTemplateLiteral(["Use the Force"])))),
  FoamForce: new dist.Macro().skill((0,dist.$skill)(_templateObject131 || (_templateObject131 = combat_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).skill((0,dist.$skill)(_templateObject132 || (_templateObject132 = combat_taggedTemplateLiteral(["Use the Force"]))))
...
function mapMonster(location, monster, macro) {
  ...
  if (!(0,dist.get)("mappingMonsters")) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject133 || (_templateObject133 = combat_taggedTemplateLiteral(["Map the Monsters"]))));
...
var questRecords = (_questRecords = {}, _defineProperty(_questRecords, Quest.Beginning.id, () => {
  return {
    ...
    check: [],
    equipment: new Map([[(0,dist.$slot)(quests_templateObject8 || (quests_templateObject8 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject9 || (quests_templateObject9 = quests_taggedTemplateLiteral(["Daylight Shavings Helmet"])))], [(0,dist.$slot)(quests_templateObject10 || (quests_templateObject10 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(quests_templateObject11 || (quests_templateObject11 = quests_taggedTemplateLiteral(["protonic accelerator pack"])))], //[$slot`shirt`, $item`fresh coat of paint`],
    [(0,dist.$slot)(quests_templateObject12 || (quests_templateObject12 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject13 || (quests_templateObject13 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject14 || (quests_templateObject14 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(quests_templateObject15 || (quests_templateObject15 = quests_taggedTemplateLiteral(["familiar scrapbook"])))], [(0,dist.$slot)(quests_templateObject16 || (quests_templateObject16 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(quests_templateObject17 || (quests_templateObject17 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(quests_templateObject18 || (quests_templateObject18 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject19 || (quests_templateObject19 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(quests_templateObject20 || (quests_templateObject20 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject21 || (quests_templateObject21 = quests_taggedTemplateLiteral(["Powerful Glove"])))], [(0,dist.$slot)(quests_templateObject22 || (quests_templateObject22 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject23 || (quests_templateObject23 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]])
  };
}), _defineProperty(_questRecords, Quest.CoilWire.id, () => {
  var bloodSugar = (0,external_kolmafia_.myClass)() === (0,dist.$class)(quests_templateObject24 || (quests_templateObject24 = quests_taggedTemplateLiteral(["Sauceror"]))) ? (0,dist.$effect)(quests_templateObject25 || (quests_templateObject25 = quests_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"]))) : (0,dist.$effect)(quests_templateObject26 || (quests_templateObject26 = quests_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])));
  return {
    acquire: [bloodSugar],
    check: [],
    equipment: new Map([[(0,dist.$slot)(quests_templateObject27 || (quests_templateObject27 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject28 || (quests_templateObject28 = quests_taggedTemplateLiteral(["Iunion Crown"])))], [(0,dist.$slot)(quests_templateObject29 || (quests_templateObject29 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject30 || (quests_templateObject30 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject31 || (quests_templateObject31 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.have)((0,dist.$item)(quests_templateObject32 || (quests_templateObject32 = quests_taggedTemplateLiteral(["wrench"])))) ? (0,dist.$item)(quests_templateObject33 || (quests_templateObject33 = quests_taggedTemplateLiteral(["wrench"]))) : (0,dist.$item)(quests_templateObject34 || (quests_templateObject34 = quests_taggedTemplateLiteral(["industrial fire extinguisher"])))], [(0,dist.$slot)(quests_templateObject35 || (quests_templateObject35 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(quests_templateObject36 || (quests_templateObject36 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(quests_templateObject37 || (quests_templateObject37 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(quests_templateObject38 || (quests_templateObject38 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(quests_templateObject39 || (quests_templateObject39 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(quests_templateObject40 || (quests_templateObject40 = quests_taggedTemplateLiteral(["Retrospecs"])))], [(0,dist.$slot)(quests_templateObject41 || (quests_templateObject41 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(quests_templateObject42 || (quests_templateObject42 = quests_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]),
    retrocape: "heck thrill"
  };
}), _defineProperty(_questRecords, Quest.Leveling.id, () => {
  var toAcquire = [(0,dist.$effect)(quests_templateObject43 || (quests_templateObject43 = quests_taggedTemplateLiteral(["A Girl Named Sue"]))), (0,dist.$effect)(quests_templateObject44 || (quests_templateObject44 = quests_taggedTemplateLiteral(["Billiards Belligerence"]))), (0,dist.$effect)(quests_templateObject45 || (quests_templateObject45 = quests_taggedTemplateLiteral(["Broad-Spectrum Vaccine"]))), (0,dist.$effect)(quests_templateObject46 || (quests_templateObject46 = quests_taggedTemplateLiteral(["Favored by Lyle"]))), (0,dist.$effect)(quests_templateObject47 || (quests_templateObject47 = quests_taggedTemplateLiteral(["Fidoxene"]))), (0,dist.$effect)(quests_templateObject48 || (quests_templateObject48 = quests_taggedTemplateLiteral(["Grumpy and Ornery"]))), (0,dist.$effect)(quests_templateObject49 || (quests_templateObject49 = quests_taggedTemplateLiteral(["Hustlin'"]))), (0,dist.$effect)(quests_templateObject50 || (quests_templateObject50 = quests_taggedTemplateLiteral(["Loyal Tea"]))), (0,dist.$effect)(quests_templateObject51 || (quests_templateObject51 = quests_taggedTemplateLiteral(["Mental A-cue-ity"]))), (0,dist.$effect)(quests_templateObject52 || (quests_templateObject52 = quests_taggedTemplateLiteral(["Mystically Oiled"]))), (0,dist.$effect)(quests_templateObject53 || (quests_templateObject53 = quests_taggedTemplateLiteral(["Pisces in the Skyces"]))), (0,dist.$effect)(quests_templateObject54 || (quests_templateObject54 = quests_taggedTemplateLiteral(["Puzzle Champ"]))), (0,dist.$effect)(quests_templateObject55 || (quests_templateObject55 = quests_taggedTemplateLiteral(["Sigils of Yeg"]))), (0,dist.$effect)(quests_templateObject56 || (quests_templateObject56 = quests_taggedTemplateLiteral(["Starry-Eyed"]))), (0,dist.$effect)(quests_templateObject57 || (quests_templateObject57 = quests_taggedTemplateLiteral(["Total Protonic Reversal"]))), (0,dist.$effect)(quests_templateObject58 || (quests_templateObject58 = quests_taggedTemplateLiteral(["You Can Really Taste the Dormouse"]))), (0,dist.$effect)(quests_templateObject59 || (quests_templateObject59 = quests_taggedTemplateLiteral(["Warlock, Warstock, and Warbarrel"]))), (0,dist.$effect)(quests_templateObject60 || (quests_templateObject60 = quests_taggedTemplateLiteral(["items.enh"]))), (0,dist.$effect)(quests_templateObject61 || (quests_templateObject61 = quests_taggedTemplateLiteral(["meat.enh"]))), // Beach comb
  ...
  var toAcquire = [pastalordShield, (0,dist.$effect)(quests_templateObject123 || (quests_templateObject123 = quests_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), (0,dist.$effect)(quests_templateObject124 || (quests_templateObject124 = quests_taggedTemplateLiteral(["Polka of Plenty"]))), (0,dist.$effect)(quests_templateObject125 || (quests_templateObject125 = quests_taggedTemplateLiteral(["Pride of the Puffin"]))), (0,dist.$effect)(quests_templateObject126 || (quests_templateObject126 = quests_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"])))];
  var toWear = new Map([[(0,dist.$slot)(quests_templateObject127 || (quests_templateObject127 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(quests_templateObject128 || (quests_templateObject128 = quests_taggedTemplateLiteral(["Daylight Shavings Helmet"])))], [(0,dist.$slot)(quests_templateObject129 || (quests_templateObject129 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(quests_templateObject130 || (quests_templateObject130 = quests_taggedTemplateLiteral(["LOV Epaulettes"])))], [(0,dist.$slot)(quests_templateObject131 || (quests_templateObject131 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(quests_templateObject132 || (quests_templateObject132 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(quests_templateObject133 || (quests_templateObject133 = quests_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(_templateObject134 || (_templateObject134 = quests_taggedTemplateLiteral(["weeping willow wand"])))], [(0,dist.$slot)(_templateObject135 || (_templateObject135 = quests_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(_templateObject136 || (_templateObject136 = quests_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [(0,dist.$slot)(_templateObject137 || (_templateObject137 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject138 || (_templateObject138 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject139 || (_templateObject139 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.have)((0,dist.$item)(_templateObject140 || (_templateObject140 = quests_taggedTemplateLiteral(["battle broom"])))) ? (0,dist.$item)(_templateObject141 || (_templateObject141 = quests_taggedTemplateLiteral(["battle broom"]))) : (0,dist.$item)(_templateObject142 || (_templateObject142 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject143 || (_templateObject143 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject144 || (_templateObject144 = quests_taggedTemplateLiteral(["Beach Comb"])))]]);
  return {
    acquire: toAcquire,
    check: [],
    equipment: toWear
...
var preCoilEvents = {
  holidayCheck: {
    ...
    run: () => {
      ...
      if ((0,dist.get)("_banderRunaways") < 1) throw "Failed to increment _banderRunaways";
    }
  },
  ninjaCostume: {
  ...
  mimic: {
    ...
    run: () => {
      ...
      (0,external_kolmafia_.visitUrl)("questlog.php?which=1"); // check quest log protonic ghost location
  ...
  vote: {
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(noobCave, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject44 || (events_templateObject44 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject45 || (events_templateObject45 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
    }
  },
  tropicalSkeleton: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject46 || (events_templateObject46 = events_taggedTemplateLiteral(["Everything Looks Red"])))),
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject47 || (events_templateObject47 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject48 || (events_templateObject48 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      familiar((0,dist.$familiar)(events_templateObject49 || (events_templateObject49 = events_taggedTemplateLiteral(["Crimbo Shrub"])))); // Decorate Crimbo Shrub with LED Mandala, Jack-O-Lantern Lights, Popcorn Strands, and Big Red-Wrapped Presents

      if (!(0,dist.get)("_shrubDecorated")) {
        var decorations = (0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject50 || (events_templateObject50 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))));
      ...
      mapMonster(skeletonStore, (0,dist.$monster)(events_templateObject51 || (events_templateObject51 = events_taggedTemplateLiteral(["novelty tropical skeleton"]))), MacroList.FreeFight);
      checkEffect((0,dist.$effect)(events_templateObject52 || (events_templateObject52 = events_taggedTemplateLiteral(["Everything Looks Red"]))));
      (0,dist.$items)(events_templateObject53 || (events_templateObject53 = events_taggedTemplateLiteral(["cherry, grapefruit, lemon, strawberry"]))).forEach(fruit => checkAvailable(fruit));
    }
  }
};
var levelingEvents = {
  protonicGhost: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject54 || (events_templateObject54 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject55 || (events_templateObject55 = events_taggedTemplateLiteral(["protonic accelerator pack"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var ghostLoc = (0,dist.get)("ghostLocation");
  ...
  ghostCarol: {
    ready: () => ![(0,dist.$effect)(events_templateObject56 || (events_templateObject56 = events_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"]))), (0,dist.$effect)(events_templateObject57 || (events_templateObject57 = events_taggedTemplateLiteral(["Crimbo Wrapping"]))), (0,dist.$effect)(events_templateObject58 || (events_templateObject58 = events_taggedTemplateLiteral(["Do You Crush What I Crush?"]))), (0,dist.$effect)(events_templateObject59 || (events_templateObject59 = events_taggedTemplateLiteral(["Holiday Yoked"]))), (0,dist.$effect)(events_templateObject60 || (events_templateObject60 = events_taggedTemplateLiteral(["Let It Snow/Boil/Stink/Frighten/Grease"])))].some(carol => (0,dist.have)(carol)),
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject61 || (events_templateObject61 = events_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))));
      withEquipment(() => adventure(direWarren, MacroList.Banish), [[(0,dist.$slot)(events_templateObject62 || (events_templateObject62 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject63 || (events_templateObject63 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))]]);
      checkEffect((0,dist.$effect)(events_templateObject64 || (events_templateObject64 = events_taggedTemplateLiteral(["Do You Crush What I Crush?"]))));
    }
  },
  loveTunnel: {
    ...
    run: () => {
      ...
      checkEffect((0,dist.$effect)(events_templateObject65 || (events_templateObject65 = events_taggedTemplateLiteral(["Open Heart Surgery"]))));
      (0,dist.$items)(events_templateObject66 || (events_templateObject66 = events_taggedTemplateLiteral(["LOV Elixir #3, LOV Elixir #6, LOV Epaulettes"]))).forEach(l => checkAvailable(l));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject67 || (events_templateObject67 = events_taggedTemplateLiteral(["LOV Elixir #3"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject68 || (events_templateObject68 = events_taggedTemplateLiteral(["LOV Elixir #6"]))));
  ...
  tenPercentBonus: {
    ready: () => (0,dist.have)((0,dist.$item)(events_templateObject71 || (events_templateObject71 = events_taggedTemplateLiteral(["a ten-percent bonus"])))),
    run: () => {
      [(0,dist.$effect)(events_templateObject72 || (events_templateObject72 = events_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))), (0,dist.$effect)(events_templateObject73 || (events_templateObject73 = events_taggedTemplateLiteral(["Inscrutable Gaze"]))), (0,dist.$effect)(events_templateObject74 || (events_templateObject74 = events_taggedTemplateLiteral(["Synthesis: Learning"])))].forEach(checkEffect);
      checkAvailable((0,dist.$item)(events_templateObject75 || (events_templateObject75 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject76 || (events_templateObject76 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject77 || (events_templateObject77 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject78 || (events_templateObject78 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject79 || (events_templateObject79 = events_taggedTemplateLiteral(["familiar scrapbook"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject80 || (events_templateObject80 = events_taggedTemplateLiteral(["a ten-percent bonus"]))));
    }
  },
  chateau: {
    ready: () => (0,external_kolmafia_.myLevel)() >= 8 && (0,dist.get)("timesRested") < (0,external_kolmafia_.totalFreeRests)(),
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject81 || (events_templateObject81 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject82 || (events_templateObject82 = events_taggedTemplateLiteral(["LOV Epaulettes"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject83 || (events_templateObject83 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject84 || (events_templateObject84 = events_taggedTemplateLiteral(["familiar scrapbook"]))));
  ...
  witchessRook: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject85 || (events_templateObject85 = events_taggedTemplateLiteral(["Sweetbreads Flamb\xE9"])))),
    run: () => {
      prep(Quest.LevelingML);
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject86 || (events_templateObject86 = events_taggedTemplateLiteral(["Witchess Rook"]))), MacroList.FreeFight);
      checkAvailable((0,dist.$item)(events_templateObject87 || (events_templateObject87 = events_taggedTemplateLiteral(["Greek fire"]))));
      (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject88 || (events_templateObject88 = events_taggedTemplateLiteral(["Greek fire"]))));
    }
  },
  upscaleDistrictKill: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject89 || (events_templateObject89 = events_taggedTemplateLiteral(["Whole Latte Love"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject90 || (events_templateObject90 = events_taggedTemplateLiteral(["sprinkles"]))), 55),
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject91 || (events_templateObject91 = events_taggedTemplateLiteral(["Chocolate Lab"]))));
      var rope = (0,dist.$item)(events_templateObject92 || (events_templateObject92 = events_taggedTemplateLiteral(["rope"])));
      var crane = (0,dist.$item)(events_templateObject93 || (events_templateObject93 = events_taggedTemplateLiteral(["burning paper crane"])));
      var offhand = (0,dist.have)(rope) ? rope : (0,dist.have)(crane) ? crane : (0,dist.$item)(events_templateObject94 || (events_templateObject94 = events_taggedTemplateLiteral(["familiar scrapbook"])));
      withEquipment(() => adventure(upscaleDistrict, MacroList.Sprinkles), [[(0,dist.$slot)(events_templateObject95 || (events_templateObject95 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject96 || (events_templateObject96 = events_taggedTemplateLiteral(["protonic accelerator pack"])))], [(0,dist.$slot)(events_templateObject97 || (events_templateObject97 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject98 || (events_templateObject98 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(events_templateObject99 || (events_templateObject99 = events_taggedTemplateLiteral(["off-hand"]))), offhand], [(0,dist.$slot)(events_templateObject100 || (events_templateObject100 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject101 || (events_templateObject101 = events_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(events_templateObject102 || (events_templateObject102 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject103 || (events_templateObject103 = events_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(events_templateObject104 || (events_templateObject104 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject105 || (events_templateObject105 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]]);
      checkAvailable((0,dist.$item)(events_templateObject106 || (events_templateObject106 = events_taggedTemplateLiteral(["sprinkles"]))), 55);
    }
  },
  upscaleDistrictRunaway: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject107 || (events_templateObject107 = events_taggedTemplateLiteral(["Whole Latte Love"])))),
    run: () => {
      checkEffect((0,dist.$effect)(events_templateObject108 || (events_templateObject108 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject109 || (events_templateObject109 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(upscaleDistrict, MacroList.Runaway);
      var latte = (0,dist.$item)(events_templateObject110 || (events_templateObject110 = events_taggedTemplateLiteral(["gingerbread spice latte"])));

      if ((0,dist.have)(latte)) {
        (0,external_kolmafia_.use)(latte);
        checkAvailable((0,dist.$item)(events_templateObject111 || (events_templateObject111 = events_taggedTemplateLiteral(["sprinkles"]))), 5);
  ...
  civicCenterRunaway: {
    ...
    run: function run() {
      ...
      var cig = (0,dist.$item)(events_templateObject114 || (events_templateObject114 = events_taggedTemplateLiteral(["gingerbread cigarette"])));
  ...
  snojo: {
    ...
    run: () => {
      if (!(0,dist.get)("snojoSetting") !== (0,dist.$stat)(events_templateObject115 || (events_templateObject115 = events_taggedTemplateLiteral(["Muscle"])))) {
  ...
  witchessWitch: {
    ready: () => !(0,dist.have)((0,dist.$item)(events_templateObject116 || (events_templateObject116 = events_taggedTemplateLiteral(["battle broom"])))),
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject117 || (events_templateObject117 = events_taggedTemplateLiteral(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject118 || (events_templateObject118 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject119 || (events_templateObject119 = events_taggedTemplateLiteral(["battle broom"]))));
    }
  },
  eldritch: {
    ...
    run: () => {
      ...
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject120 || (events_templateObject120 = events_taggedTemplateLiteral(["Evoke Eldritch Horror"])))); // In case Sssshhsssblllrrggghsssssggggrrgglsssshhssslblgl was summoned

      if ((0,external_kolmafia_.myHp)() / (0,external_kolmafia_.myMaxhp)() < 0.5) (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject121 || (events_templateObject121 = events_taggedTemplateLiteral(["Cannelloni Cocoon"]))));
    }
  },
  gingerbreadCig: {
    ready: () => (0,dist.have)((0,dist.$item)(events_templateObject122 || (events_templateObject122 = events_taggedTemplateLiteral(["gingerbread cigarette"])))),
    run: () => {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  godLobster: {
    ...
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject123 || (events_templateObject123 = events_taggedTemplateLiteral(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      ...
      var ring = (0,dist.$item)(events_templateObject124 || (events_templateObject124 = events_taggedTemplateLiteral(["God Lobster's Ring"])));
      var scepter = (0,dist.$item)(events_templateObject125 || (events_templateObject125 = events_taggedTemplateLiteral(["God Lobster's Scepter"])));
      if ((0,dist.have)(ring)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject126 || (events_templateObject126 = events_taggedTemplateLiteral(["familiar"]))), ring);else if ((0,dist.have)(scepter)) (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject127 || (events_templateObject127 = events_taggedTemplateLiteral(["familiar"]))), scepter);
    }
  },
  witchessKing: {
    ready: () => !(0,dist.have)((0,dist.$item)(events_templateObject128 || (events_templateObject128 = events_taggedTemplateLiteral(["dented scepter"])))),
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject129 || (events_templateObject129 = events_taggedTemplateLiteral(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    ...
    run: () => {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject130 || (events_templateObject130 = events_taggedTemplateLiteral(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  digitize: {
    ...
    run: () => {
      ...
      dist.SourceTerminal.educate((0,dist.$skill)(events_templateObject131 || (events_templateObject131 = events_taggedTemplateLiteral(["Turbo"]))));
      var shirt = (0,dist.$item)(events_templateObject132 || (events_templateObject132 = events_taggedTemplateLiteral(["makeshift garbage shirt"])));
      if (!(0,dist.have)(shirt)) (0,external_kolmafia_.cliExecute)("fold ".concat(shirt));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject133 || (events_templateObject133 = events_taggedTemplateLiteral(["shirt"]))), shirt);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject134 || (events_templateObject134 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject135 || (events_templateObject135 = events_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
      selectBestFamiliar();
  ...
  vote: {
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(toxicTeacups, MacroList.FreeFight), [[(0,dist.$slot)(events_templateObject136 || (events_templateObject136 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject137 || (events_templateObject137 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]);
    }
  },
  holidayWanderer: {
    ...
    run: () => {
      ...
      familiar((0,dist.$familiar)(events_templateObject139 || (events_templateObject139 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(deepDarkJungle, MacroList.Runaway);
    }
  },
  dmtSquare: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject140 || (events_templateObject140 = events_taggedTemplateLiteral(["Joy"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject141 || (events_templateObject141 = events_taggedTemplateLiteral(["abstraction: action"])))),
    run: () => {
      ...
      checkAvailable((0,dist.$item)(events_templateObject143 || (events_templateObject143 = events_taggedTemplateLiteral(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject144 || (events_templateObject144 = events_taggedTemplateLiteral(["Joy"])))),
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject145 || (events_templateObject145 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable((0,dist.$item)(events_templateObject146 || (events_templateObject146 = events_taggedTemplateLiteral(["abstraction: joy"]))));
      (0,external_kolmafia_.chew)((0,dist.$item)(events_templateObject147 || (events_templateObject147 = events_taggedTemplateLiteral(["abstraction: joy"]))));
    }
  },
  dmt: {
    ready: () => (0,dist.get)("_machineTunnelsAdv") < 5,
    run: () => {
      familiar((0,dist.$familiar)(events_templateObject148 || (events_templateObject148 = events_taggedTemplateLiteral(["Machine Elf"]))));
  ...
  chestXRay: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject149 || (events_templateObject149 = events_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(events_templateObject150 || (events_templateObject150 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  ...
  lecture: {
    ...
    run: () => {
      ...
      familiar((0,dist.$familiar)(events_templateObject153 || (events_templateObject153 = events_taggedTemplateLiteral(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  backupCamera: {
    ready: () => (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject154 || (events_templateObject154 = events_taggedTemplateLiteral(["sausage goblin"]))) && (0,dist.get)("_backUpUses") < 7,
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject155 || (events_templateObject155 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject156 || (events_templateObject156 = events_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject157 || (events_templateObject157 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject158 || (events_templateObject158 = events_taggedTemplateLiteral(["backup camera"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  deepDark: {
    ready: () => !(0,dist.have)((0,dist.$effect)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))),
    run: () => {
      prep(Quest.DeepDark);
      var resist = 1 - (0,external_kolmafia_.elementalResistance)((0,dist.$element)(events_templateObject160 || (events_templateObject160 = events_taggedTemplateLiteral(["spooky"])))) / 100;
      ...
      if ((0,external_kolmafia_.myHp)() < needed) (0,external_kolmafia_.cliExecute)("cast * ".concat((0,dist.$skill)(events_templateObject161 || (events_templateObject161 = events_taggedTemplateLiteral(["Cannelloni Cocoon"])))));
      if ((0,external_kolmafia_.myHp)() < needed) throw "Failed to heal enough for Deep Dark Visions?";
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["Deep Dark Visions"]))));

      while ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() * 0.9) {
        (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["Cannelloni Cocoon"]))));
      }
    }
  },
  vintnerBackup: {
    ready: () => (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject164 || (events_templateObject164 = events_taggedTemplateLiteral(["sausage goblin"]))) && (0,dist.get)("_backUpUses") < 11,
    run: () => {
  ...
  latteRefills: {
    ...
    run: () => {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject167 || (events_templateObject167 = events_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(events_templateObject168 || (events_templateObject168 = events_taggedTemplateLiteral(["Cargo Cultist Shorts"]))));
      if ((0,dist.get)("_latteDrinkUsed")) (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon vanilla");
      checkEffect((0,dist.$effect)(events_templateObject169 || (events_templateObject169 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject170 || (events_templateObject170 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  latteCarrot: {
    ...
    run: () => {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(events_templateObject174 || (events_templateObject174 = events_taggedTemplateLiteral(["Cargo Cultist Shorts"]))));
      checkEffect((0,dist.$effect)(events_templateObject175 || (events_templateObject175 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject176 || (events_templateObject176 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  lastLatteRefill: {
    ...
    run: () => {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject179 || (events_templateObject179 = events_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(events_templateObject180 || (events_templateObject180 = events_taggedTemplateLiteral(["Cargo Cultist Shorts"]))));
      if ((0,dist.get)("_latteDrinkUsed")) (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon carrot");
      checkEffect((0,dist.$effect)(events_templateObject181 || (events_templateObject181 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject182 || (events_templateObject182 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.LatteGulpRunaway);
    }
  }
};
...
var oneOffEvents = {
  nanobrainy: () => {
    ...
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject183 || (events_templateObject183 = events_taggedTemplateLiteral(["Nanobrainy"])))) && (0,dist.get)("_nanorhinoCharge") > 99) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject184 || (events_templateObject184 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject185 || (events_templateObject185 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject186 || (events_templateObject186 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject187 || (events_templateObject187 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));
      familiar((0,dist.$familiar)(events_templateObject188 || (events_templateObject188 = events_taggedTemplateLiteral(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
      checkEffect((0,dist.$effect)(events_templateObject189 || (events_templateObject189 = events_taggedTemplateLiteral(["Nanobrainy"]))));
    }
  },
  innerElf: () => {
    if ((0,external_kolmafia_.myLevel)() >= 13 && !(0,dist.have)((0,dist.$effect)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["Inner Elf"]))))) {
      familiar((0,dist.$familiar)(events_templateObject191 || (events_templateObject191 = events_taggedTemplateLiteral(["Machine Elf"]))));
      ...
      checkEffect((0,dist.$effect)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["Inner Elf"]))));

      if (prev && (0,dist.get)("lastCopyableMonster") === (0,dist.$monster)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["Mother Slime"])))) {
        (0,dist.set)("lastCopyableMonster", prev); // Need the property to be more accurate sometimes
      }
    }
  },
  meteorUngulith: () => {
    var fax = (0,dist.$item)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["photocopied monster"])));
    var faxMon = (0,dist.$monster)(events_templateObject195 || (events_templateObject195 = events_taggedTemplateLiteral(["ungulith"])));
    ...
    familiar((0,dist.$familiar)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["Machine Elf"]))));
    adventureUrl("inv_use.php?pwd=&whichitem=".concat((0,external_kolmafia_.toInt)(fax)), MacroList.MeteorForce);
    checkAvailable((0,dist.$item)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["corrupted marrow"]))));
  },
  foamYourself: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))))) {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["industrial fire extinguisher"]))));
      familiar((0,dist.$familiar)(events_templateObject205 || (events_templateObject205 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(direWarren, MacroList.FoamForce);
      checkEffect((0,dist.$effect)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["Fireproof Foam Suit"]))));
    }
  },
  meteorShower: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      familiar((0,dist.$familiar)(events_templateObject211 || (events_templateObject211 = events_taggedTemplateLiteral(["Machine Elf"]))));
      var collar = (0,dist.$item)(events_templateObject212 || (events_templateObject212 = events_taggedTemplateLiteral(["disintegrating spiky collar"])));

      if ((0,dist.have)((0,dist.$effect)(events_templateObject213 || (events_templateObject213 = events_taggedTemplateLiteral(["Absinthe-Minded"])))) && !(0,dist.have)(collar) && !(0,dist.have)(itemToEffect(collar))) {
        mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.FreeFight);
  ...
  batform: () => {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["back"]))), (0,dist.$item)(events_templateObject218 || (events_templateObject218 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject219 || (events_templateObject219 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      familiar((0,dist.$familiar)(events_templateObject220 || (events_templateObject220 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.BatFormRunaway);
      checkEffect((0,dist.$effect)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))));
    }
  }
};
...
function familiar(fam) {
  ...
  var costume = new Map([[(0,dist.$familiar)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["Machine Elf"]))), "mp"], [(0,dist.$familiar)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["Pocket Professor"]))), "hp"], [(0,dist.$familiar)(events_templateObject224 || (events_templateObject224 = events_taggedTemplateLiteral(["Rockin' Robin"]))), "myst"]]).get(fam);

  if (fam === (0,dist.$familiar)(events_templateObject225 || (events_templateObject225 = events_taggedTemplateLiteral(["Machine Elf"])))) {
    while ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() && (0,external_kolmafia_.myMp)() > MP_SAFE_LIMIT) {
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject226 || (events_templateObject226 = events_taggedTemplateLiteral(["Cannelloni Cocoon"]))));
    }
  }
...
function selectBestFamiliar() {
  ...
  if (flag === FamiliarFlag.Wine && !(0,dist.have)((0,dist.$item)(events_templateObject227 || (events_templateObject227 = events_taggedTemplateLiteral(["1950 Vampire Vintner wine"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject228 || (events_templateObject228 = events_taggedTemplateLiteral(["Wine-Befouled"]))))) {
    familiar((0,dist.$familiar)(events_templateObject229 || (events_templateObject229 = events_taggedTemplateLiteral(["Vampire Vintner"]))));
  } else if (flag === FamiliarFlag.ToxicTeacups && (0,dist.get)("_hipsterAdv") < 7) {
    familiar((0,dist.$familiar)(events_templateObject230 || (events_templateObject230 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject231 || (events_templateObject231 = events_taggedTemplateLiteral(["robin's egg"]))))) {
    familiar((0,dist.$familiar)(events_templateObject232 || (events_templateObject232 = events_taggedTemplateLiteral(["Rockin' Robin"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject233 || (events_templateObject233 = events_taggedTemplateLiteral(["short stick of butter"]))))) {
  ...
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject238 || (events_templateObject238 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject239 || (events_templateObject239 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject240 || (events_templateObject240 = events_taggedTemplateLiteral(["burning paper crane"]))))) {
...
function checkReadyToAscend(checkVoteReady) {
  ...
  var voterPreCoilNotReady = (0,external_kolmafia_.totalTurnsPlayed)() % 11 !== 1;
  var voterPostCoilNotReady = ((0,external_kolmafia_.totalTurnsPlayed)() + 60) % 11 !== 1;

  if (checkVoteReady && voterPreCoilNotReady && voterPostCoilNotReady) {
    var turnsA = 11 - ((0,external_kolmafia_.totalTurnsPlayed)() % 11 + 10) % 11;
    var turnsB = 11 - (((0,external_kolmafia_.totalTurnsPlayed)() + 60) % 11 + 10) % 11;
