...
var questRecords = (_questRecords = {}, _defineProperty(_questRecords, Quest.Beginning.id, () => {
  ...
  var rope = (0,dist.$item)(_templateObject271 || (_templateObject271 = quests_taggedTemplateLiteral(["rope"])));
  var crane = (0,dist.$item)(_templateObject272 || (_templateObject272 = quests_taggedTemplateLiteral(["burning paper crane"])));
  var offhand = (0,dist.have)(rope) ? rope : (0,dist.have)(crane) ? crane : (0,dist.$item)(_templateObject273 || (_templateObject273 = quests_taggedTemplateLiteral(["familiar scrapbook"])));
  return {
    acquire: [(0,dist.$effect)(_templateObject274 || (_templateObject274 = quests_taggedTemplateLiteral(["Empathy"]))), (0,dist.$effect)(_templateObject275 || (_templateObject275 = quests_taggedTemplateLiteral(["Joy"]))), (0,dist.$effect)(_templateObject276 || (_templateObject276 = quests_taggedTemplateLiteral(["Man's Worst Enemy"]))), (0,dist.$effect)(_templateObject277 || (_templateObject277 = quests_taggedTemplateLiteral(["Robot Friends"]))), (0,dist.$effect)(_templateObject278 || (_templateObject278 = quests_taggedTemplateLiteral(["Shortly Stacked"]))), (0,dist.$effect)(_templateObject279 || (_templateObject279 = quests_taggedTemplateLiteral(["Whole Latte Love"])))],
    check: [(0,dist.$effect)(_templateObject280 || (_templateObject280 = quests_taggedTemplateLiteral(["[1701]Hip to the Jive"]))), (0,dist.$effect)(_templateObject281 || (_templateObject281 = quests_taggedTemplateLiteral(["All Is Forgiven"]))), (0,dist.$effect)(_templateObject282 || (_templateObject282 = quests_taggedTemplateLiteral(["Bureaucratized"]))), (0,dist.$effect)(_templateObject283 || (_templateObject283 = quests_taggedTemplateLiteral(["Chorale of Companionship"]))), (0,dist.$effect)(_templateObject284 || (_templateObject284 = quests_taggedTemplateLiteral(["Down With Chow"]))), (0,dist.$effect)(_templateObject285 || (_templateObject285 = quests_taggedTemplateLiteral(["Meteor Showered"]))), (0,dist.$effect)(_templateObject286 || (_templateObject286 = quests_taggedTemplateLiteral(["Open Heart Surgery"]))), (0,dist.$effect)(_templateObject287 || (_templateObject287 = quests_taggedTemplateLiteral(["Optimist Primal"]))), (0,dist.$effect)(_templateObject288 || (_templateObject288 = quests_taggedTemplateLiteral(["Smart Drunk"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject289 || (_templateObject289 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject290 || (_templateObject290 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject291 || (_templateObject291 = quests_taggedTemplateLiteral(["off-hand"]))), offhand], [(0,dist.$slot)(_templateObject292 || (_templateObject292 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject293 || (_templateObject293 = quests_taggedTemplateLiteral(["Brutal brogues"])))], [(0,dist.$slot)(_templateObject294 || (_templateObject294 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject295 || (_templateObject295 = quests_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [(0,dist.$slot)(_templateObject296 || (_templateObject296 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject297 || (_templateObject297 = quests_taggedTemplateLiteral(["Beach Comb"])))], [(0,dist.$slot)(_templateObject298 || (_templateObject298 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject299 || (_templateObject299 = quests_taggedTemplateLiteral(["cracker"])))]]),
    familiar: (0,dist.$familiar)(_templateObject300 || (_templateObject300 = quests_taggedTemplateLiteral(["Exotic Parrot"])))
  };
}), _defineProperty(_questRecords, Quest.ItemDrop.id, () => {
  var toAcquire = [(0,dist.$effect)(_templateObject301 || (_templateObject301 = quests_taggedTemplateLiteral(["Blessing of the Bird"]))), (0,dist.$effect)(_templateObject302 || (_templateObject302 = quests_taggedTemplateLiteral(["Ermine Eyes"]))), (0,dist.$effect)(_templateObject303 || (_templateObject303 = quests_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), (0,dist.$effect)(_templateObject304 || (_templateObject304 = quests_taggedTemplateLiteral(["Feeling Lost"]))), (0,dist.$effect)(_templateObject305 || (_templateObject305 = quests_taggedTemplateLiteral(["Nearly All-Natural"]))), (0,dist.$effect)(_templateObject306 || (_templateObject306 = quests_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), (0,dist.$effect)(_templateObject307 || (_templateObject307 = quests_taggedTemplateLiteral(["Steely-Eyed Squint"]))), (0,dist.$effect)(_templateObject308 || (_templateObject308 = quests_taggedTemplateLiteral(["The Spirit of Taking"])))];
  var toCheck = [(0,dist.$effect)(_templateObject309 || (_templateObject309 = quests_taggedTemplateLiteral(["Bat-Adjacent Form"]))), (0,dist.$effect)(_templateObject310 || (_templateObject310 = quests_taggedTemplateLiteral(["Synthesis: Collection"])))];
  var carrot = (0,external_kolmafia_.numericModifier)((0,dist.$item)(_templateObject311 || (_templateObject311 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))), "item drop") > 0;
  var candles = [(0,dist.$item)(_templateObject312 || (_templateObject312 = quests_taggedTemplateLiteral(["extra-large utility candle"]))), (0,dist.$item)(_templateObject313 || (_templateObject313 = quests_taggedTemplateLiteral(["novelty sparkling candle"]))), (0,dist.$item)(_templateObject314 || (_templateObject314 = quests_taggedTemplateLiteral(["runed taper candle"])))];
  var sparkler = (0,dist.$item)(_templateObject315 || (_templateObject315 = quests_taggedTemplateLiteral(["oversized sparkler"])));
  var outfit = new Map([[(0,dist.$slot)(_templateObject316 || (_templateObject316 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject317 || (_templateObject317 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject318 || (_templateObject318 = quests_taggedTemplateLiteral(["back"]))), (0,dist.$item)(_templateObject319 || (_templateObject319 = quests_taggedTemplateLiteral(["vampyric cloake"])))], [(0,dist.$slot)(_templateObject320 || (_templateObject320 = quests_taggedTemplateLiteral(["off-hand"]))), carrot ? (0,dist.$item)(_templateObject321 || (_templateObject321 = quests_taggedTemplateLiteral(["latte lovers member's mug"]))) : (0,dist.$item)(_templateObject322 || (_templateObject322 = quests_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))], [(0,dist.$slot)(_templateObject323 || (_templateObject323 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject324 || (_templateObject324 = quests_taggedTemplateLiteral(["Guzzlr tablet"])))], [(0,dist.$slot)(_templateObject325 || (_templateObject325 = quests_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(_templateObject326 || (_templateObject326 = quests_taggedTemplateLiteral(["gold detective badge"])))], [(0,dist.$slot)(_templateObject327 || (_templateObject327 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject328 || (_templateObject328 = quests_taggedTemplateLiteral(["your cowboy boots"])))], [(0,dist.$slot)(_templateObject329 || (_templateObject329 = quests_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(_templateObject330 || (_templateObject330 = quests_taggedTemplateLiteral(["li'l ninja costume"])))]]);
  if (!candles.some(dist.have) && (0,dist.have)(sparkler)) outfit.set((0,dist.$slot)(_templateObject331 || (_templateObject331 = quests_taggedTemplateLiteral(["weapon"]))), sparkler); // can only have one candle

  for (var _i = 0, _candles = candles; _i < _candles.length; _i++) {
    var c = _candles[_i];
    if ((0,dist.have)(c)) outfit.set((0,dist.$slot)(_templateObject332 || (_templateObject332 = quests_taggedTemplateLiteral(["weapon"]))), c);
  }
  ...
  return {
    ...
    check: toCheck,
    equipment: outfit,
    familiar: (0,dist.$familiar)(_templateObject333 || (_templateObject333 = quests_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
  };
}), _defineProperty(_questRecords, Quest.Mysticality.id, () => {
  return {
    acquire: [(0,dist.$effect)(_templateObject334 || (_templateObject334 = quests_taggedTemplateLiteral(["Quiet Judgement"])))],
    check: [(0,dist.$effect)(_templateObject335 || (_templateObject335 = quests_taggedTemplateLiteral(["Nanobrainy"]))), (0,dist.$effect)(_templateObject336 || (_templateObject336 = quests_taggedTemplateLiteral(["Spit Upon"]))), (0,dist.$effect)(_templateObject337 || (_templateObject337 = quests_taggedTemplateLiteral(["Witch Breaded"])))],
    equipment: new Map([[(0,dist.$slot)(_templateObject338 || (_templateObject338 = quests_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(_templateObject339 || (_templateObject339 = quests_taggedTemplateLiteral(["wad of used tape"])))], [(0,dist.$slot)(_templateObject340 || (_templateObject340 = quests_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(_templateObject341 || (_templateObject341 = quests_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [(0,dist.$slot)(_templateObject342 || (_templateObject342 = quests_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(_templateObject343 || (_templateObject343 = quests_taggedTemplateLiteral(["battle broom"])))], [(0,dist.$slot)(_templateObject344 || (_templateObject344 = quests_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(_templateObject345 || (_templateObject345 = quests_taggedTemplateLiteral(["\"I Voted!\" sticker"])))]]),
...
function prep(quest) {
  ...
  var back = record.equipment.get((0,dist.$slot)(_templateObject346 || (_templateObject346 = quests_taggedTemplateLiteral(["back"]))));
...
function postCoilWire() {
  ...
  [(0,dist.$item)(main_templateObject94 || (main_templateObject94 = main_taggedTemplateLiteral(["oil of expertise"]))), (0,dist.$item)(main_templateObject95 || (main_templateObject95 = main_taggedTemplateLiteral(["philter of phorce"]))), (0,dist.$item)(main_templateObject96 || (main_templateObject96 = main_taggedTemplateLiteral(["ointment of the occult"]))), (0,dist.$item)(main_templateObject97 || (main_templateObject97 = main_taggedTemplateLiteral(["eyedrops of the ermine"])))].forEach(saucePotion => {
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(main_templateObject98 || (main_templateObject98 = main_taggedTemplateLiteral(["toy accordion"]))));
  acquireEffect((0,dist.$effect)(main_templateObject99 || (main_templateObject99 = main_taggedTemplateLiteral(["Ode to Booze"])))); // 9366 - 142 = 9224 meat

  checkMainClan();
  (0,dist.$effects)(main_templateObject100 || (main_templateObject100 = main_taggedTemplateLiteral(["[1701]Hip to the Jive, In a Lather"]))).forEach(speakeasy => acquireEffect(speakeasy)); // 5 drunk, 5500 meat
  // 9224 - 5500 = 3724 meat
  ...
  var water = (0,dist.$item)(main_templateObject101 || (main_templateObject101 = main_taggedTemplateLiteral(["cold-filtered water"])));
  if ((0,dist.get)("tomeSummons") < 3 && !(0,dist.have)(water) && !(0,dist.have)((0,dist.$effect)(main_templateObject102 || (main_templateObject102 = main_taggedTemplateLiteral(["Purity of Spirit"]))))) (0,external_kolmafia_.create)(water);
  tryUse(water); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  [(0,dist.$item)(main_templateObject103 || (main_templateObject103 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))), (0,dist.$item)(main_templateObject104 || (main_templateObject104 = main_taggedTemplateLiteral(["Napalm In The Morning\u2122 candle"]))), (0,dist.$item)(main_templateObject105 || (main_templateObject105 = main_taggedTemplateLiteral(["Salsa Caliente\u2122 candle"]))), (0,dist.$item)(main_templateObject106 || (main_templateObject106 = main_taggedTemplateLiteral(["Smoldering Clover\u2122 candle"])))].forEach(tryUse);
  (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject107 || (main_templateObject107 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject108 || (main_templateObject108 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject109 || (main_templateObject109 = main_taggedTemplateLiteral(["turtle totem"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject110 || (main_templateObject110 = main_taggedTemplateLiteral(["saucepan"]))));
