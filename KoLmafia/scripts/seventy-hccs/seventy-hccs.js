...
.trySkill((0,dist.$skill)(_templateObject74 || (_templateObject74 = combat_taggedTemplateLiteral(["Throw Latte on Opponent"])))).trySkill((0,dist.$skill)(_templateObject75 || (_templateObject75 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).trySkill((0,dist.$skill)(_templateObject76 || (_templateObject76 = combat_taggedTemplateLiteral(["Reflex Hammer"])))).trySkill((0,dist.$skill)(_templateObject77 || (_templateObject77 = combat_taggedTemplateLiteral(["Feel Hatred"])))).abort();
var Replace = new dist.Macro().skill((0,dist.$skill)(_templateObject78 || (_templateObject78 = combat_taggedTemplateLiteral(["Macrometeorite"]))));
var Backup = new dist.Macro().if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject79 || (_templateObject79 = combat_taggedTemplateLiteral(["Back-Up to your Last Enemy"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject80 || (_templateObject80 = combat_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).skill((0,dist.$skill)(_templateObject81 || (_templateObject81 = combat_taggedTemplateLiteral(["Saucy Salve"])))));
var Pride = new dist.Macro().if_( // Turbo used a flag to cast pride
"hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject82 || (_templateObject82 = combat_taggedTemplateLiteral(["Turbo"]))))), dist.Macro.trySkill((0,dist.$skill)(_templateObject83 || (_templateObject83 = combat_taggedTemplateLiteral(["Feel Pride"])))));
var FreeInstaKill = new dist.Macro().skill((0,dist.$skill)(_templateObject84 || (_templateObject84 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).trySkill((0,dist.$skill)(_templateObject85 || (_templateObject85 = combat_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill((0,dist.$skill)(_templateObject86 || (_templateObject86 = combat_taggedTemplateLiteral(["Shattering Punch"])))).trySkill((0,dist.$skill)(_templateObject87 || (_templateObject87 = combat_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill((0,dist.$skill)(_templateObject88 || (_templateObject88 = combat_taggedTemplateLiteral(["Shocking Lick"])))).abort();
var CigKill = new dist.Macro().skill((0,dist.$skill)(_templateObject89 || (_templateObject89 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).tryItem((0,dist.$item)(_templateObject90 || (_templateObject90 = combat_taggedTemplateLiteral(["gingerbread cigarette"])))).abort();
var SingAndKill = new dist.Macro().skill((0,dist.$skill)(_templateObject91 || (_templateObject91 = combat_taggedTemplateLiteral(["Sing Along"])))).step(Pride).while_("!mpbelow ".concat((0,external_kolmafia_.mpCost)((0,dist.$skill)(_templateObject92 || (_templateObject92 = combat_taggedTemplateLiteral(["Saucestorm"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject93 || (_templateObject93 = combat_taggedTemplateLiteral(["Saucestorm"]))))).attack().repeat();
var DefaultMacro = new dist.Macro().if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject94 || (_templateObject94 = combat_taggedTemplateLiteral(["Shoot Ghost"]))))), Ghost).if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), dist.Macro.skill((0,dist.$skill)(_templateObject95 || (_templateObject95 = combat_taggedTemplateLiteral(["Summon Love Gnats"])))).step(FreeInstaKill)).if_("monsterid ".concat(amateurNinja), FreeInstaKill).if_("monsterid ".concat(noveltySkeleton), dist.Macro.trySkill((0,dist.$skill)(_templateObject96 || (_templateObject96 = combat_taggedTemplateLiteral(["Open a Big Red Present"])))).skill((0,dist.$skill)(_templateObject97 || (_templateObject97 = combat_taggedTemplateLiteral(["Use the Force"]))))).if_("monsterid ".concat(mastiff), dist.Macro.skill((0,dist.$skill)(_templateObject98 || (_templateObject98 = combat_taggedTemplateLiteral(["Meteor Shower"])))).skill((0,dist.$skill)(_templateObject99 || (_templateObject99 = combat_taggedTemplateLiteral(["Use the Force"]))))).if_("snarfblat ".concat(retailDistrict), CigKill).if_(notAllowList, TryBanish).trySkill((0,dist.$skill)(_templateObject100 || (_templateObject100 = combat_taggedTemplateLiteral(["Digitize"])))).trySkill((0,dist.$skill)(_templateObject101 || (_templateObject101 = combat_taggedTemplateLiteral(["%fn, spit on me!"])))).skill((0,dist.$skill)(_templateObject102 || (_templateObject102 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(_templateObject103 || (_templateObject103 = combat_taggedTemplateLiteral(["Micrometeorite"])))).item((0,dist.$item)(_templateObject104 || (_templateObject104 = combat_taggedTemplateLiteral(["Time-Spinner"])))).if_("hasskill ".concat((0,external_kolmafia_.toInt)((0,dist.$skill)(_templateObject105 || (_templateObject105 = combat_taggedTemplateLiteral(["lecture on relativity"]))))), dist.Macro.skill((0,dist.$skill)(_templateObject106 || (_templateObject106 = combat_taggedTemplateLiteral(["lecture on relativity"])))).skill((0,dist.$skill)(_templateObject107 || (_templateObject107 = combat_taggedTemplateLiteral(["Saucy Salve"]))))).step(SingAndKill);
var MacroList = {
  FreeFight: DefaultMacro,
  FastFreeFight: SingAndKill,
  StenchFreeFight: new dist.Macro().if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), dist.Macro.abort()).if_("monsterhpabove 300", dist.Macro.skill((0,dist.$skill)(_templateObject108 || (_templateObject108 = combat_taggedTemplateLiteral(["Curse of Weaksauce"]))))).if_("monsterhpabove 300", dist.Macro.skill((0,dist.$skill)(_templateObject109 || (_templateObject109 = combat_taggedTemplateLiteral(["Sing Along"]))))).skill((0,dist.$skill)(_templateObject110 || (_templateObject110 = combat_taggedTemplateLiteral(["Garbage Nova"])))),
  // Just runaway on its own causes a null pointer exception?
  Runaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject111 || (_templateObject111 = combat_taggedTemplateLiteral(["Saucy Salve"])))).step("runaway"),
  Banish: TryBanish,
  Nanobrainy: new dist.Macro().skill((0,dist.$skill)(_templateObject112 || (_templateObject112 = combat_taggedTemplateLiteral(["Entangling Noodles"])))).trySkill((0,dist.$skill)(_templateObject113 || (_templateObject113 = combat_taggedTemplateLiteral(["Giant Growth"])))).trySkill((0,dist.$skill)(_templateObject114 || (_templateObject114 = combat_taggedTemplateLiteral(["Become a Wolf"])))).step(TryBanish),
  Sprinkles: new dist.Macro().if_("monsterid ".concat(gentrifier), Replace).skill((0,dist.$skill)(_templateObject115 || (_templateObject115 = combat_taggedTemplateLiteral(["Meteor Shower"])))).step(FreeInstaKill),
  TunnelOfLOV: new dist.Macro().if_("monsterid ".concat(LOVEnforcer), dist.Macro.attack().repeat()).if_("monsterid ".concat(LOVEngineer), dist.Macro.skill((0,dist.$skill)(_templateObject116 || (_templateObject116 = combat_taggedTemplateLiteral(["Candyblast"])))).repeat()).step(DefaultMacro),
  WitchessQueen: new dist.Macro().item((0,dist.$item)(_templateObject117 || (_templateObject117 = combat_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat(),
  WitchessWitch: new dist.Macro().skill((0,dist.$skill)(_templateObject118 || (_templateObject118 = combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill((0,dist.$skill)(_templateObject119 || (_templateObject119 = combat_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(),
  DMTSquare: new dist.Macro().if_(notAllowList, dist.Macro.abort()).if_("!monsterid ".concat(DMTSquare), Replace).skill((0,dist.$skill)(_templateObject120 || (_templateObject120 = combat_taggedTemplateLiteral(["Feel Envy"])))).step(DefaultMacro),
  DMTCircle: new dist.Macro().if_(notAllowList, dist.Macro.abort()).if_("!monsterid ".concat(DMTCircle), Replace).tryItem((0,dist.$item)(_templateObject121 || (_templateObject121 = combat_taggedTemplateLiteral(["abstraction: action"])))).step(DefaultMacro),
  MotherSlime: new dist.Macro().if_(notAllowList, dist.Macro.abort()).trySkill((0,dist.$skill)(_templateObject122 || (_templateObject122 = combat_taggedTemplateLiteral(["KGB tranquilizer dart"])))).skill((0,dist.$skill)(_templateObject123 || (_templateObject123 = combat_taggedTemplateLiteral(["Snokebomb"])))),
  BatFormRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject124 || (_templateObject124 = combat_taggedTemplateLiteral(["Become a Bat"])))).step("runaway"),
  LatteGulpRunaway: new dist.Macro().trySkill((0,dist.$skill)(_templateObject125 || (_templateObject125 = combat_taggedTemplateLiteral(["Gulp Latte"])))).step("runaway"),
  MeteorForce: new dist.Macro().skill((0,dist.$skill)(_templateObject126 || (_templateObject126 = combat_taggedTemplateLiteral(["Meteor Shower"])))).skill((0,dist.$skill)(_templateObject127 || (_templateObject127 = combat_taggedTemplateLiteral(["Use the Force"])))),
  FoamForce: new dist.Macro().skill((0,dist.$skill)(_templateObject128 || (_templateObject128 = combat_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).skill((0,dist.$skill)(_templateObject129 || (_templateObject129 = combat_taggedTemplateLiteral(["Use the Force"]))))
...
function mapMonster(location, monster, macro) {
  ...
  if (!(0,dist.get)("mappingMonsters")) (0,external_kolmafia_.useSkill)((0,dist.$skill)(_templateObject130 || (_templateObject130 = combat_taggedTemplateLiteral(["Map the Monsters"]))));
