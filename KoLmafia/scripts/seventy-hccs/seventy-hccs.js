...
var events = {
  ...
  ungulith: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject34 || (events_templateObject34 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  latteCarrot: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject40 || (events_templateObject40 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  chateauPainting: {
    ...
    run: function run() {
      ...
      if (carols.includes(phylum)) {
        ...
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject46 || (events_templateObject46 = events_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))));
        ...
        (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject48 || (events_templateObject48 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
        MacroList.PickpocketFreeRun.setAutoAttack();
      }
  ...
  ghostCarol: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject52 || (events_templateObject52 = events_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))));
  ...
  upscaleDistrictKill: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject82 || (events_templateObject82 = events_taggedTemplateLiteral(["Chocolate Lab"]))));
  ...
  upscaleDistrictRunaway: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject86 || (events_templateObject86 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  civicCenterRunaway: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject92 || (events_templateObject92 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
  ...
  snojo: {
    ...
    run: function run() {
      if ((0,dist.get)("snojoSetting") !== (0,dist.$stat)(events_templateObject99 || (events_templateObject99 = events_taggedTemplateLiteral(["Muscle"])))) {
  ...
  witchessWitch: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject100 || (events_templateObject100 = events_taggedTemplateLiteral(["battle broom"])))) - 1;
    },
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject101 || (events_templateObject101 = events_taggedTemplateLiteral(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject102 || (events_templateObject102 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject103 || (events_templateObject103 = events_taggedTemplateLiteral(["battle broom"]))));
    }
  },
  eldritch: {
    max: 1,
    ...
    run: function run() {
      selectBestFamiliar();
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject104 || (events_templateObject104 = events_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
  ...
  gingerbreadCig: {
    max: 5,
    current: function current() {
      return this.max - (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject105 || (events_templateObject105 = events_taggedTemplateLiteral(["gingerbread cigarette"]))));
    },
    run: function run() {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  vote: {
    ...
    run: function run() {
      var prev = (0,external_kolmafia_.equippedItem)((0,dist.$slot)(events_templateObject106 || (events_templateObject106 = events_taggedTemplateLiteral(["acc3"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject107 || (events_templateObject107 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject108 || (events_templateObject108 = events_taggedTemplateLiteral(["\"I Voted!\" sticker"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject109 || (events_templateObject109 = events_taggedTemplateLiteral(["acc3"]))), prev);
    }
  },
  godLobster: {
    max: 3,
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject110 || (events_templateObject110 = events_taggedTemplateLiteral(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      (0,external_kolmafia_.visitUrl)("main.php?fightgodlobster=1");
      if ((0,external_kolmafia_.choiceFollowsFight)()) (0,external_kolmafia_.runChoice)(-1);

      if (!(0,dist.have)((0,dist.$effect)(events_templateObject111 || (events_templateObject111 = events_taggedTemplateLiteral(["Silence of the God Lobster"]))))) {
        if (events.godLobster.current() === events.godLobster.max) {
          throw "Failed to get ".concat((0,dist.$effect)(events_templateObject112 || (events_templateObject112 = events_taggedTemplateLiteral(["Silence of the God Lobster"]))));
        } else if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject113 || (events_templateObject113 = events_taggedTemplateLiteral(["God Lobster's Ring"])))) > 0) {
          (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject114 || (events_templateObject114 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject115 || (events_templateObject115 = events_taggedTemplateLiteral(["God Lobster's Ring"]))));
        } else if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject116 || (events_templateObject116 = events_taggedTemplateLiteral(["God Lobster's Scepter"])))) > 0) {
          (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject117 || (events_templateObject117 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject118 || (events_templateObject118 = events_taggedTemplateLiteral(["God Lobster's Scepter"]))));
        }
      }
    }
  },
  witchessKing: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject119 || (events_templateObject119 = events_taggedTemplateLiteral(["dented scepter"])))) - 1;
    },
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject120 || (events_templateObject120 = events_taggedTemplateLiteral(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    max: 5,
    ...
    run: function run() {
      selectBestFamiliar();
      fightWitchess((0,dist.$monster)(events_templateObject121 || (events_templateObject121 = events_taggedTemplateLiteral(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  dmtSquare: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject122 || (events_templateObject122 = events_taggedTemplateLiteral(["Joy"])))) + (0,external_kolmafia_.availableAmount)((0,dist.$item)(events_templateObject123 || (events_templateObject123 = events_taggedTemplateLiteral(["abstraction: action"])))) - 1;
    },
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject124 || (events_templateObject124 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTSquare);
      checkAvailable((0,dist.$item)(events_templateObject125 || (events_templateObject125 = events_taggedTemplateLiteral(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    max: 0,
    current: function current() {
      return (0,external_kolmafia_.haveEffect)((0,dist.$effect)(events_templateObject126 || (events_templateObject126 = events_taggedTemplateLiteral(["Joy"])))) - 1;
    },
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject127 || (events_templateObject127 = events_taggedTemplateLiteral(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable((0,dist.$item)(events_templateObject128 || (events_templateObject128 = events_taggedTemplateLiteral(["abstraction: joy"]))));
      (0,external_kolmafia_.chew)((0,dist.$item)(events_templateObject129 || (events_templateObject129 = events_taggedTemplateLiteral(["abstraction: joy"]))));
    }
  },
  dmt: {
    max: 5,
    ...
    run: function run() {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject130 || (events_templateObject130 = events_taggedTemplateLiteral(["Machine Elf"]))));
  ...
  lecture: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject133 || (events_templateObject133 = events_taggedTemplateLiteral(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  nep: {
    ...
    run: function run() {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject136 || (events_templateObject136 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject137 || (events_templateObject137 = events_taggedTemplateLiteral(["Beach Comb"]))));
      selectBestFamiliar();
  ...
  latteRefills: {
    ...
    run: function run() {
      checkEffect((0,dist.$effect)(events_templateObject146 || (events_templateObject146 = events_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject147 || (events_templateObject147 = events_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(events_templateObject148 || (events_templateObject148 = events_taggedTemplateLiteral(["latte lovers member's mug"]))));

      if ((0,dist.get)("_latteDrinkUsed")) {
        (0,external_kolmafia_.cliExecute)("latte refill pumpkin cinnamon carrot");
      }

      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject149 || (events_templateObject149 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
...
var oneOffEvents = {
  hipster: function hipster() {
    if (!(0,dist.get)("_ironicMoustache")) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject150 || (events_templateObject150 = events_taggedTemplateLiteral(["Mini-Hipster"]))));
      adventure(noobCave, MacroList.FreeFight);
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject151 || (events_templateObject151 = events_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(events_templateObject152 || (events_templateObject152 = events_taggedTemplateLiteral(["none"]))));
      checkAvailable((0,dist.$item)(events_templateObject153 || (events_templateObject153 = events_taggedTemplateLiteral(["ironic moustache"]))));
      (0,external_kolmafia_.cliExecute)("fold ".concat((0,dist.$item)(events_templateObject154 || (events_templateObject154 = events_taggedTemplateLiteral(["chiptune guitar"])))));
    }
  },
  mimic: function mimic() {
    if (!(0,dist.get)("_bagOfCandy")) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject155 || (events_templateObject155 = events_taggedTemplateLiteral(["Stocking Mimic"]))));
  ...
  tropicalSkeleton: function tropicalSkeleton() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject159 || (events_templateObject159 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject162 || (events_templateObject162 = events_taggedTemplateLiteral(["Crimbo Shrub"]))));

      if (!(0,dist.get)("_shrubDecorated")) {
        (0,external_kolmafia_.visitUrl)("inv_use.php?pwd=".concat((0,external_kolmafia_.myHash)(), "&which=99&whichitem=").concat((0,external_kolmafia_.toInt)((0,dist.$item)(events_templateObject163 || (events_templateObject163 = events_taggedTemplateLiteral(["box of old Crimbo decorations"]))))));
      ...
      if (!(0,dist.have)((0,dist.$effect)(events_templateObject165 || (events_templateObject165 = events_taggedTemplateLiteral(["Everything Looks Red"]))))) {
        throw "Failed to cast ".concat((0,dist.$skill)(events_templateObject166 || (events_templateObject166 = events_taggedTemplateLiteral(["Open a Big Red Present"]))), "?");
      }

      (0,dist.$items)(events_templateObject167 || (events_templateObject167 = events_taggedTemplateLiteral(["cherry,grapefruit,lemon,strawberry"]))).forEach(function (fruit) {
  ...
  nanobrainy: function nanobrainy() {
    ...
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject168 || (events_templateObject168 = events_taggedTemplateLiteral(["Nanobrainy"]))))) {
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject173 || (events_templateObject173 = events_taggedTemplateLiteral(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
    }
  },
  lavaCo: function lavaCo() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject174 || (events_templateObject174 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject177 || (events_templateObject177 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject178 || (events_templateObject178 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject179 || (events_templateObject179 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject180 || (events_templateObject180 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject181 || (events_templateObject181 = events_taggedTemplateLiteral(["factory overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject182 || (events_templateObject182 = events_taggedTemplateLiteral(["factory worker (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject183 || (events_templateObject183 = events_taggedTemplateLiteral(["lava golem"]))).name) ? MacroList.LavaCoFactory2 : MacroList.LavaCoFactory1;
      adventure(_lavaCo, macro);
    }
  },
  velvetGoldMine: function velvetGoldMine() {
    while (!(0,dist.have)((0,dist.$effect)(events_templateObject184 || (events_templateObject184 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      ...
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject187 || (events_templateObject187 = events_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(events_templateObject188 || (events_templateObject188 = events_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject189 || (events_templateObject189 = events_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(events_templateObject190 || (events_templateObject190 = events_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var banished = (0,dist.get)("banishedMonsters");
      var macro = banished.includes((0,dist.$monster)(events_templateObject191 || (events_templateObject191 = events_taggedTemplateLiteral(["healing crystal golem"]))).name) || banished.includes((0,dist.$monster)(events_templateObject192 || (events_templateObject192 = events_taggedTemplateLiteral(["mine overseer (male)"]))).name) || banished.includes((0,dist.$monster)(events_templateObject193 || (events_templateObject193 = events_taggedTemplateLiteral(["mine worker (male)"]))).name) ? MacroList.VelvetGoldMine2 : MacroList.VelvetGoldMine1;
      adventure(_velvetGoldMine, macro);
    }
  },
  mistform: function mistform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject194 || (events_templateObject194 = events_taggedTemplateLiteral(["Misty Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$item)(events_templateObject195 || (events_templateObject195 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(events_templateObject196 || (events_templateObject196 = events_taggedTemplateLiteral(["The Ode to Booze"]))));
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject197 || (events_templateObject197 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.MistForm);
    }
  },
  meteorShower: function meteorShower() {
    if ((0,dist.have)((0,dist.$item)(events_templateObject198 || (events_templateObject198 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject199 || (events_templateObject199 = events_taggedTemplateLiteral(["tiny bottle of absinthe"]))));

    if ((0,dist.have)((0,dist.$effect)(events_templateObject200 || (events_templateObject200 = events_taggedTemplateLiteral(["absinthe minded"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject201 || (events_templateObject201 = events_taggedTemplateLiteral(["Meteor Showered"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject202 || (events_templateObject202 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject203 || (events_templateObject203 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject204 || (events_templateObject204 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      mapMonster(statelyPleasureDome, (0,dist.$monster)(events_templateObject205 || (events_templateObject205 = events_taggedTemplateLiteral(["toothless mastiff bitch"]))), MacroList.MeteorShowerForce);
      checkAvailable((0,dist.$item)(events_templateObject206 || (events_templateObject206 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));
      if (!(0,dist.have)((0,dist.$effect)(events_templateObject207 || (events_templateObject207 = events_taggedTemplateLiteral(["Meteor Showered"]))))) throw "Failed to get Meteor howered?";
    }

    if ((0,dist.have)((0,dist.$item)(events_templateObject208 || (events_templateObject208 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(events_templateObject209 || (events_templateObject209 = events_taggedTemplateLiteral(["disintegrating spiky collar"]))));

    if (!(0,dist.have)((0,dist.$effect)(events_templateObject210 || (events_templateObject210 = events_taggedTemplateLiteral(["Meteor Showered"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(events_templateObject211 || (events_templateObject211 = events_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(events_templateObject212 || (events_templateObject212 = events_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
      adventure(direWarren, MacroList.MeteorShowerForce);
    }
  },
  batform: function batform() {
    if (!(0,dist.have)((0,dist.$effect)(events_templateObject213 || (events_templateObject213 = events_taggedTemplateLiteral(["Bat-Adjacent Form"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$item)(events_templateObject214 || (events_templateObject214 = events_taggedTemplateLiteral(["vampyric cloake"]))));
      ...
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject216 || (events_templateObject216 = events_taggedTemplateLiteral(["Frumious Bandersnatch"]))));
...
function selectBestFamiliar() {
  ...
  if (!(0,dist.have)((0,dist.$effect)(events_templateObject217 || (events_templateObject217 = events_taggedTemplateLiteral(["Spit Upon"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject218 || (events_templateObject218 = events_taggedTemplateLiteral(["Melodramedary"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject219 || (events_templateObject219 = events_taggedTemplateLiteral(["short stack of pancakes"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject220 || (events_templateObject220 = events_taggedTemplateLiteral(["Shortly Stacked"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject221 || (events_templateObject221 = events_taggedTemplateLiteral(["Shorter-Order Cook"]))));
  } else if (flag === FamiliarFlag.Default && !(0,dist.have)((0,dist.$item)(events_templateObject222 || (events_templateObject222 = events_taggedTemplateLiteral(["tiny bottle of absinthe"])))) && !(0,dist.have)((0,dist.$effect)(events_templateObject223 || (events_templateObject223 = events_taggedTemplateLiteral(["absinthe minded"]))))) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject224 || (events_templateObject224 = events_taggedTemplateLiteral(["Green Pixie"]))));
  } else if (!(0,dist.have)((0,dist.$item)(events_templateObject225 || (events_templateObject225 = events_taggedTemplateLiteral(["rope"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject226 || (events_templateObject226 = events_taggedTemplateLiteral(["burning newspaper"])))) && !(0,dist.have)((0,dist.$item)(events_templateObject227 || (events_templateObject227 = events_taggedTemplateLiteral(["burning paper crane"])))) && (0,dist.get)("garbageFireProgress") + getRemainingFreeFights() >= 30) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject228 || (events_templateObject228 = events_taggedTemplateLiteral(["Garbage Fire"]))));
    /*} else if (
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject229 || (events_templateObject229 = events_taggedTemplateLiteral(["Artistic Goth Kid"]))));
  } else {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(events_templateObject230 || (events_templateObject230 = events_taggedTemplateLiteral(["Machine Elf"]))));
  }
}
...
function levelAndDoQuests() {
  ...
  if (getRemainingFreeFights() > 0) {
    ...
    leveling: while (true) {
      ...
      if ((0,dist.have)((0,dist.$item)(main_templateObject24 || (main_templateObject24 = main_taggedTemplateLiteral(["burning newspaper"]))))) (0,external_kolmafia_.cliExecute)("make ".concat((0,dist.$item)(main_templateObject25 || (main_templateObject25 = main_taggedTemplateLiteral(["burning paper crane"])))));
      if ((0,dist.have)((0,dist.$item)(main_templateObject26 || (main_templateObject26 = main_taggedTemplateLiteral(["robin's egg"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject27 || (main_templateObject27 = main_taggedTemplateLiteral(["robin's egg"])))); // Save the Garbage shirt for the last 37 fights
      // Swap from Iunion Crown to Wad of Used Tape once Myst is high enough

      var garbageShirt = (0,dist.$item)(main_templateObject28 || (main_templateObject28 = main_taggedTemplateLiteral(["makeshift garbage shirt"])));
      ...
      if ((0,external_kolmafia_.haveEquipped)(garbageShirt) || getRemainingFreeFights() <= 37) {
        ...
        (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject29 || (main_templateObject29 = main_taggedTemplateLiteral(["shirt"]))), garbageShirt);
        ...
        (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject32 || (main_templateObject32 = main_taggedTemplateLiteral(["hat"]))), (0,dist.$item)(main_templateObject33 || (main_templateObject33 = main_taggedTemplateLiteral(["Iunion Crown"]))));
  ...
  shrugEffect((0,dist.$effect)(main_templateObject34 || (main_templateObject34 = main_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))));
  shrugEffect((0,dist.$effect)(main_templateObject35 || (main_templateObject35 = main_taggedTemplateLiteral(["Polka of Plenty"]))));
  wishEffect((0,dist.$effect)(main_templateObject36 || (main_templateObject36 = main_taggedTemplateLiteral(["Sparkly!"]))));
  ...
  if (haveQuest(Quest.SpellDamage)) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(main_templateObject37 || (main_templateObject37 = main_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"]))))) {
      ...
      (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject38 || (main_templateObject38 = main_taggedTemplateLiteral(["Deep Dark Visions"]))));
      (0,external_kolmafia_.print)("Current HP after Deep Dark Visions: ".concat((0,external_kolmafia_.myHp)()));
    }

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject39 || (main_templateObject39 = main_taggedTemplateLiteral(["Cowrruption"]))))) {
      (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject40 || (main_templateObject40 = main_taggedTemplateLiteral(["corrupted marrow"]))));
  ...
  shrugEffect((0,dist.$effect)(main_templateObject41 || (main_templateObject41 = main_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))));
  prepAndDoQuest(Quest.Mysticality);

  if (haveQuest(Quest.CombatFrequency)) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject42 || (main_templateObject42 = main_taggedTemplateLiteral(["Disgeist"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject43 || (main_templateObject43 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject44 || (main_templateObject44 = main_taggedTemplateLiteral(["Powerful Glove"]))));
    prepAndDoQuest(Quest.CombatFrequency);
  }

  if (haveQuest(Quest.HotResist)) {
    oneOffEvents.mistform();
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject45 || (main_templateObject45 = main_taggedTemplateLiteral(["Exotic Parrot"]))));

    if (!(0,external_kolmafia_.haveEquipped)((0,dist.$item)(main_templateObject46 || (main_templateObject46 = main_taggedTemplateLiteral(["cracker"]))))) {
  ...
  shrugEffect((0,dist.$effect)(main_templateObject47 || (main_templateObject47 = main_taggedTemplateLiteral(["The Sonata of Sneakiness"]))));

  if (haveQuest(Quest.FamiliarWeight)) {
    oneOffEvents.meteorShower();
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject48 || (main_templateObject48 = main_taggedTemplateLiteral(["Exotic Parrot"]))));

    if (!(0,external_kolmafia_.haveEquipped)((0,dist.$item)(main_templateObject49 || (main_templateObject49 = main_taggedTemplateLiteral(["cracker"]))))) {
      throw "Wrong familiar equipment?";
    }

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject50 || (main_templateObject50 = main_taggedTemplateLiteral(["Smart Drunk"]))))) {
      (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(main_templateObject51 || (main_templateObject51 = main_taggedTemplateLiteral(["The Ode to Booze"]))));
      (0,external_kolmafia_.drink)((0,dist.$item)(main_templateObject52 || (main_templateObject52 = main_taggedTemplateLiteral(["vintage smart drink"]))));
    }

    var icyRevenge = (0,dist.$item)(main_templateObject53 || (main_templateObject53 = main_taggedTemplateLiteral(["love song of icy revenge"])));

    if (!(0,dist.have)((0,dist.$effect)(main_templateObject54 || (main_templateObject54 = main_taggedTemplateLiteral(["Cold Hearted"])))) && (0,dist.have)(icyRevenge)) {
  ...
  if (haveQuest(Quest.ItemDrop)) {
    ...
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(main_templateObject55 || (main_templateObject55 = main_taggedTemplateLiteral(["Trick-or-Treating Tot"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject56 || (main_templateObject56 = main_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(main_templateObject57 || (main_templateObject57 = main_taggedTemplateLiteral(["li'l ninja costume"]))));
...
function preCoilWire() {
  ...
  tryUse(1, (0,dist.$item)(main_templateObject58 || (main_templateObject58 = main_taggedTemplateLiteral(["letter from King Ralph XI"]))));
  tryUse(1, (0,dist.$item)(main_templateObject59 || (main_templateObject59 = main_taggedTemplateLiteral(["pork elf goodies sack"])))); // Only need one consult for a candy
  ...
  if (!(0,dist.have)((0,dist.$item)(main_templateObject60 || (main_templateObject60 = main_taggedTemplateLiteral(["battery (AAA)"]))))) harvestBatteries();
  getPantogramPants();
  equipOutfit(Quest.Beginning); //
  // Let's get a buncha meat!
  //

  (0,dist.$items)(main_templateObject61 || (main_templateObject61 = main_taggedTemplateLiteral(["baconstone,hamethyst,porquoise"]))).forEach(function (gem) {
    return (0,external_kolmafia_.autosell)(5, gem);
  });
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(main_templateObject62 || (main_templateObject62 = main_taggedTemplateLiteral(["Communism!"]))));
  ...
  if ((0,external_kolmafia_.myLevel)() + (0,external_kolmafia_.mySpleenUse)() === 1) {
    ...
    (0,external_kolmafia_.autosell)(14 * (0,dist.get)("_universeCalculated"), (0,dist.$item)(main_templateObject63 || (main_templateObject63 = main_taggedTemplateLiteral(["moxie weed"]))));
  }
  ...
  checkAvailable((0,dist.$item)(main_templateObject64 || (main_templateObject64 = main_taggedTemplateLiteral(["your cowboy boots"]))));
  (0,external_kolmafia_.cliExecute)("Detective Solver");
  checkAvailable((0,dist.$item)(main_templateObject65 || (main_templateObject65 = main_taggedTemplateLiteral(["gold detective badge"]))));
  buffUpBeginning();

  if (!(0,dist.have)((0,dist.$effect)(main_templateObject66 || (main_templateObject66 = main_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))))) {
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=campaway&action=campaway_sky");
  }
  ...
  scavengeDaycare();
  if (!(0,dist.have)((0,dist.$item)(main_templateObject67 || (main_templateObject67 = main_taggedTemplateLiteral(["Brutal brogues"]))))) (0,external_kolmafia_.cliExecute)("bastille bbq brutalist gesture");
  ...
  if (!(0,dist.have)((0,dist.$skill)(main_templateObject68 || (main_templateObject68 = main_taggedTemplateLiteral(["Digitize"])))) && (0,dist.get)("_sourceTerminalDigitizeUses") < 1) {
    ...
    if (!(0,dist.have)((0,dist.$skill)(main_templateObject69 || (main_templateObject69 = main_taggedTemplateLiteral(["Digitize"]))))) {
      throw "Error: need to learn ".concat((0,dist.$skill)(main_templateObject70 || (main_templateObject70 = main_taggedTemplateLiteral(["Digitize"]))));
    }
  }

  if ((0,external_kolmafia_.myAdventures)() < 60) {
    if (!(0,dist.have)((0,dist.$item)(main_templateObject71 || (main_templateObject71 = main_taggedTemplateLiteral(["borrowed time"]))))) {
      (0,external_kolmafia_.create)(1, (0,dist.$item)(main_templateObject72 || (main_templateObject72 = main_taggedTemplateLiteral(["borrowed time"]))));
    }
  ...
  if ((0,dist.have)((0,dist.$skill)(main_templateObject74 || (main_templateObject74 = main_taggedTemplateLiteral(["Digitize"]))))) throw "Error: need to unlearn ".concat((0,dist.$skill)(main_templateObject75 || (main_templateObject75 = main_taggedTemplateLiteral(["Digitize"]))));
  ...
  if (!(0,external_kolmafia_.haveEquipped)(wand)) {
    ...
    if ((0,dist.have)((0,dist.$item)(main_templateObject77 || (main_templateObject77 = main_taggedTemplateLiteral(["flimsy hardwood scraps"]))))) {
  ...
  buyUpTo(1, (0,dist.$item)(main_templateObject79 || (main_templateObject79 = main_taggedTemplateLiteral(["detuned radio"])))); // 8600 - 285 = 8315 meat

  (0,external_kolmafia_.changeMcd)(10);
  buyUpTo(1, (0,dist.$item)(main_templateObject80 || (main_templateObject80 = main_taggedTemplateLiteral(["blue rocket"])))); // 8315 - 237 = 8078 meat
  ...
  if (!(0,dist.have)((0,dist.$item)(main_templateObject81 || (main_templateObject81 = main_taggedTemplateLiteral(["occult jelly donut"]))))) (0,external_kolmafia_.create)(1, (0,dist.$item)(main_templateObject82 || (main_templateObject82 = main_taggedTemplateLiteral(["occult jelly donut"]))));
...
function postCoilWire() {
  ...
  if (!(0,dist.have)((0,dist.$skill)(main_templateObject86 || (main_templateObject86 = main_taggedTemplateLiteral(["Seek out a Bird"]))))) (0,external_kolmafia_.use)(1, (0,dist.$item)(main_templateObject87 || (main_templateObject87 = main_taggedTemplateLiteral(["bird-a-day calendar"]))));
  ...
  (0,dist.$skill)(main_templateObject93 || (main_templateObject93 = main_taggedTemplateLiteral(["Advanced Saucecrafting"]))), (0,dist.$skill)(main_templateObject94 || (main_templateObject94 = main_taggedTemplateLiteral(["Advanced Cocktailcrafting"]))), (0,dist.$skill)(main_templateObject95 || (main_templateObject95 = main_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))), // Only need Alice's Army for now
  (0,dist.$skill)(main_templateObject96 || (main_templateObject96 = main_taggedTemplateLiteral(["Summon Alice's Army Cards"]))), (0,dist.$skill)(main_templateObject97 || (main_templateObject97 = main_taggedTemplateLiteral(["Summon Confiscated Things"]))), (0,dist.$skill)(main_templateObject98 || (main_templateObject98 = main_taggedTemplateLiteral(["Summon Geeky Gifts"]))), (0,dist.$skill)(main_templateObject99 || (main_templateObject99 = main_taggedTemplateLiteral(["Summon Tasteful Items"]))), // Buffs that can't fit elsewhere
  (0,dist.$skill)(main_templateObject100 || (main_templateObject100 = main_taggedTemplateLiteral(["Incredible Self-Esteem"])))].forEach(function (s) {
  ...
  if (!(0,dist.have)((0,dist.$item)(main_templateObject105 || (main_templateObject105 = main_taggedTemplateLiteral(["tiny black hole"]))))) (0,external_kolmafia_.cliExecute)("make ".concat((0,dist.$item)(main_templateObject106 || (main_templateObject106 = main_taggedTemplateLiteral(["tiny black hole"])))));
  buyUpTo(1, (0,dist.$item)(main_templateObject107 || (main_templateObject107 = main_taggedTemplateLiteral(["toy accordion"]))));
  acquireEffect((0,dist.$effect)(main_templateObject108 || (main_templateObject108 = main_taggedTemplateLiteral(["Ode to Booze"])))); // 9128 - 142 - 95 - 950 - 28 = 7913 meat

  whitelist(MAIN_CLAN);
  acquireEffect((0,dist.$effect)(main_templateObject109 || (main_templateObject109 = main_taggedTemplateLiteral(["[1701]Hip to the Jive"])))); // drink Hot Socks (3 drunk, 5000 meat)
  // 7913 - 5000 = 2913 meat

  acquireEffect((0,dist.$effect)(main_templateObject110 || (main_templateObject110 = main_taggedTemplateLiteral(["In a Lather"])))); // drink Sockdollager (2 drunk, 500 meat)
  // 2913 - 500 = 2413 meat
  ...
  [(0,dist.$skill)(main_templateObject111 || (main_templateObject111 = main_taggedTemplateLiteral(["Chubby and Plump"]))), (0,dist.$skill)(main_templateObject112 || (main_templateObject112 = main_taggedTemplateLiteral(["Summon Crimbo Candy"])))].forEach(function (s) {
    return (0,external_kolmafia_.useSkill)(s);
  });
  synthesize(); // If we didn't use a sugar sheet for synthesis we can make a cold-filtered water

  if ((0,dist.get)("tomeSummons") < 3 && !(0,dist.have)((0,dist.$item)(main_templateObject113 || (main_templateObject113 = main_taggedTemplateLiteral(["cold-filtered water"])))) && !(0,dist.have)((0,dist.$effect)(main_templateObject114 || (main_templateObject114 = main_taggedTemplateLiteral(["Purity of Spirit"]))))) {
    (0,external_kolmafia_.create)(1, (0,dist.$item)(main_templateObject115 || (main_templateObject115 = main_taggedTemplateLiteral(["cold-filtered water"]))));
  }

  if ((0,dist.have)((0,dist.$item)(main_templateObject116 || (main_templateObject116 = main_taggedTemplateLiteral(["cold-filtered water"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject117 || (main_templateObject117 = main_taggedTemplateLiteral(["cold-filtered water"])))); // If we didn't use a chubby and plump bar for synthesis we can use it for more HP and MP

  if ((0,dist.have)((0,dist.$item)(main_templateObject118 || (main_templateObject118 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))))) (0,external_kolmafia_.use)((0,dist.$item)(main_templateObject119 || (main_templateObject119 = main_taggedTemplateLiteral(["Chubby and Plump bar"]))));
  (0,external_kolmafia_.equip)((0,dist.$slot)(main_templateObject120 || (main_templateObject120 = main_taggedTemplateLiteral(["acc2"]))), (0,dist.$item)(main_templateObject121 || (main_templateObject121 = main_taggedTemplateLiteral(["Powerful Glove"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject122 || (main_templateObject122 = main_taggedTemplateLiteral(["turtle totem"]))));
  acquireGumOrHermitItem((0,dist.$item)(main_templateObject123 || (main_templateObject123 = main_taggedTemplateLiteral(["saucepan"]))));
  buffUpLeveling();
  equipOutfit(Quest.Leveling);
}
