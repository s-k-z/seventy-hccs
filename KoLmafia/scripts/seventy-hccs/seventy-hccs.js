...
var BRICKO_TARGET_ITEM = $item(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral8(["BRICKO bat"])));
var BRICKOS_PER_FIGHT = (_Map$get = (/* @__PURE__ */ new Map([[$item(_templateObject211 || (_templateObject211 = _taggedTemplateLiteral8(["BRICKO ooze"]))), 2], [$item(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral8(["BRICKO bat"]))), 5], [$item(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral8(["BRICKO oyster"]))), 8], [$item(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral8(["BRICKO turtle"]))), 11], [$item(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral8(["BRICKO elephant"]))), 23], [$item(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral8(["BRICKO octopus"]))), 37], [$item(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral8(["BRICKO python"]))), 69]])).get(BRICKO_TARGET_ITEM)) !== null && _Map$get !== void 0 ? _Map$get : 9999;
...
var recipes = /* @__PURE__ */ new Map([[$item(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral9(["bugged balaclava"]))), () => {
  (0, import_kolmafia15.useFamiliar)($familiar(_templateObject212 || (_templateObject212 = _taggedTemplateLiteral9(["Baby Bugged Bugbear"]))));
  (0, import_kolmafia15.visitUrl)("arena.php");
  (0, import_kolmafia15.cliExecute)("fold ".concat($item(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral9(["bugged balaclava"])))));
}], [$item(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral9(["blood-faced volleyball"]))), () => {
...
}], [$item(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral9(["cog and sprocket assembly"]))), () => (0, import_kolmafia15.cliExecute)("make ".concat($item(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral9(["cog and sprocket assembly"])))))], [$item(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral9(["dripping meat crossbow"]))), () => {
...
}], [$item(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral9(["hot buttered roll"]))), () => (0, import_kolmafia15.retrieveItem)($item(_templateObject152 || (_templateObject152 = _taggedTemplateLiteral9(["hot buttered roll"]))))], [$item(_templateObject162 || (_templateObject162 = _taggedTemplateLiteral9(["perfect dark and stormy"]))), () => (0, import_kolmafia15.cliExecute)("make ".concat($item(_templateObject172 || (_templateObject172 = _taggedTemplateLiteral9(["perfect dark and stormy"])))))], [$item(_templateObject182 || (_templateObject182 = _taggedTemplateLiteral9(["sprocket assembly"]))), () => (0, import_kolmafia15.cliExecute)("make ".concat($item(_templateObject192 || (_templateObject192 = _taggedTemplateLiteral9(["sprocket assembly"])))))], [$item(_templateObject202 || (_templateObject202 = _taggedTemplateLiteral9(["ravioli hat"]))), () => (0, import_kolmafia15.retrieveItem)($item(_templateObject213 || (_templateObject213 = _taggedTemplateLiteral9(["ravioli hat"]))))], [$item(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral9(["repeating crossbow"]))), () => (0, import_kolmafia15.cliExecute)("make ".concat($item(_templateObject233 || (_templateObject233 = _taggedTemplateLiteral9(["repeating crossbow"])))))], [$item(_templateObject243 || (_templateObject243 = _taggedTemplateLiteral9(["turtle totem"]))), () => (0, import_kolmafia15.retrieveItem)($item(_templateObject252 || (_templateObject252 = _taggedTemplateLiteral9(["turtle totem"]))))], [$item(_templateObject262 || (_templateObject262 = _taggedTemplateLiteral9(["useless powder"]))), () => {
  (0, import_kolmafia15.retrieveItem)($item(_templateObject272 || (_templateObject272 = _taggedTemplateLiteral9(["tenderizing hammer"]))));
...
}], [$item(_templateObject302 || (_templateObject302 = _taggedTemplateLiteral9(["wooden figurine"]))), () => (0, import_kolmafia15.retrieveItem)($item(_templateObject312 || (_templateObject312 = _taggedTemplateLiteral9(["wooden figurine"]))))]]);
var diabolicPizzas = {
  1: {
    ...
    ingredients: tuple($item(_templateObject342 || (_templateObject342 = _taggedTemplateLiteral9(["sprocket assembly"]))), $item(_templateObject352 || (_templateObject352 = _taggedTemplateLiteral9(["perfect dark and stormy"]))), $item(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral9(["ironic moustache"]))), $item(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral9(["turtle totem"]))))
  },
  2: {
    effect: $effect(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral9(["Bureaucratized"]))),
    equip: $item(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral9(["Pocket Professor memory chip"]))),
    familiar: $familiar(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral9(["Pocket Professor"]))),
    ingredients: tuple($item(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral9(["bugged balaclava"]))), $item(_templateObject422 || (_templateObject422 = _taggedTemplateLiteral9(["useless powder"]))), $item(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral9(["ravioli hat"]))), $item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral9(["eyedrops of the ermine"]))))
  },
  3: {
    effect: $effect(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral9(["Down With Chow"]))),
    equip: $item(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral9(["cracker"]))),
    familiar: $familiar(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral9(["Exotic Parrot"]))),
    ingredients: tuple($item(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral9(["dripping meat crossbow"]))), $item(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral9(["ointment of the occult"]))), $item(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral9(["wooden figurine"]))), $item(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral9(["blood-faced volleyball"]))))
  },
  4: {
    effect: $effect(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral9(["Chorale of Companionship"]))),
    equip: void 0,
    familiar: void 0,
    ingredients: tuple($item(_templateObject532 || (_templateObject532 = _taggedTemplateLiteral9(["cog and sprocket assembly"]))), $item(_templateObject542 || (_templateObject542 = _taggedTemplateLiteral9(["hot buttered roll"]))), $item(_templateObject552 || (_templateObject552 = _taggedTemplateLiteral9(["ointment of the occult"]))), $item(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral9(["repeating crossbow"]))))
  }
};
function eatPizzas() {
...
var noveltySkeleton = $monster(_templateObject214 || (_templateObject214 = _taggedTemplateLiteral10(["novelty tropical skeleton"]))).id;
var mastiff = $monster(_templateObject310 || (_templateObject310 = _taggedTemplateLiteral10(["toothless mastiff bitch"]))).id;
...
var notAllowList = [
  $monster(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral10(["sausage goblin"]))),
  ...
  $monster(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral10(["The ghost of Jim Unfortunato"]))),
  $monster(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral10(["The ghost of Lord Montague Spookyraven"]))),
  $monster(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral10(["the ghost of Monsieur Baguelle"]))),
  $monster(_templateObject183 || (_templateObject183 = _taggedTemplateLiteral10(["the ghost of Oily McBindle"]))),
  $monster(_templateObject193 || (_templateObject193 = _taggedTemplateLiteral10(["The ghost of Richard Cockingham"]))),
  $monster(_templateObject203 || (_templateObject203 = _taggedTemplateLiteral10(["The ghost of Sam McGee"]))),
  $monster(_templateObject215 || (_templateObject215 = _taggedTemplateLiteral10(['The ghost of Vanillica "Trashblossom" Gorton']))),
  ...
  $monster(_templateObject253 || (_templateObject253 = _taggedTemplateLiteral10(["amateur ninja"]))),
  $monster(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral10(["novelty tropical skeleton"]))),
  $monster(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral10(["toothless mastiff bitch"]))),
  ...
  $monster(_templateObject313 || (_templateObject313 = _taggedTemplateLiteral10(["gingerbread finance bro"]))),
  ...
  $monster(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral10(["Witchess Knight"]))),
  $monster(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral10(["Witchess Bishop"]))),
  $monster(_templateObject402 || (_templateObject402 = _taggedTemplateLiteral10(["Witchess Rook"]))),
  $monster(_templateObject412 || (_templateObject412 = _taggedTemplateLiteral10(["Witchess Ox"]))),
  ...
  $monster(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral10(["Sssshhsssblllrrggghsssssggggrrgglsssshhssslblgl"]))),
  $monster(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral10(["God Lobster"]))),
  $monster(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral10(["X-32-F Combat Training Snowman"]))),
...
var Pride = new Macro().if_("hasskill ".concat((0, import_kolmafia16.toInt)($skill(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral10(["Turbo"]))))), Macro.trySkill($skill(_templateObject87 || (_templateObject87 = _taggedTemplateLiteral10(["Feel Pride"])))));
...
var DefaultMacro = new Macro().if_("hasskill ".concat((0, import_kolmafia16.toInt)($skill(_templateObject98 || (_templateObject98 = _taggedTemplateLiteral10(["Shoot Ghost"]))))), Ghost).if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), Macro.skill($skill(_templateObject99 || (_templateObject99 = _taggedTemplateLiteral10(["Summon Love Gnats"])))).step(FreeInstaKill)).if_("monsterid ".concat(amateurNinja), FreeInstaKill).if_("monsterid ".concat(noveltySkeleton), Macro.trySkill($skill(_templateObject100 || (_templateObject100 = _taggedTemplateLiteral10(["Open a Big Red Present"])))).skill($skill(_templateObject101 || (_templateObject101 = _taggedTemplateLiteral10(["Use the Force"]))))).if_("monsterid ".concat(mastiff), Macro.skill($skill(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral10(["Meteor Shower"])))).skill($skill(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral10(["Use the Force"]))))).if_("snarfblat ".concat(retailDistrict), CigKill).if_(notAllowList, TryBanish).trySkill($skill(_templateObject1042 || (_templateObject1042 = _taggedTemplateLiteral10(["Digitize"])))).skill($skill(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral10(["Curse of Weaksauce"])))).skill($skill(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral10(["Micrometeorite"])))).item($item(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral10(["Time-Spinner"])))).if_("hasskill ".concat((0, import_kolmafia16.toInt)($skill(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral10(["lecture on relativity"]))))), Macro.skill($skill(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral10(["lecture on relativity"])))).skill($skill(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral10(["Saucy Salve"]))))).if_("hasskill ".concat((0, import_kolmafia16.toInt)($skill(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral10(["Bowl Straight Up"])))), " && !haseffect ").concat((0, import_kolmafia16.toInt)($effect(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral10(["Cosmic Ball in the Air"]))))), Macro.skill($skill(_templateObject1132 || (_templateObject1132 = _taggedTemplateLiteral10(["Bowl Straight Up"]))))).step(SingAndKill);
var MacroList = {
  FreeFight: DefaultMacro,
  FastFreeFight: SingAndKill,
  StenchFreeFight: new Macro().if_("monsterid ".concat(toxicBeastie), Backup).if_("monsterid ".concat(toxicBeastie), Macro.abort()).if_("monsterhpabove 300", Macro.skill($skill(_templateObject1142 || (_templateObject1142 = _taggedTemplateLiteral10(["Curse of Weaksauce"]))))).if_("monsterhpabove 300", Macro.skill($skill(_templateObject1152 || (_templateObject1152 = _taggedTemplateLiteral10(["Sing Along"]))))).skill($skill(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral10(["Garbage Nova"])))),
  Runaway: new Macro().trySkill($skill(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral10(["Saucy Salve"])))).step("runaway"),
  Banish: TryBanish,
  Nanobrainy: new Macro().skill($skill(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral10(["Entangling Noodles"])))).trySkill($skill(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral10(["Giant Growth"])))).trySkill($skill(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral10(["Become a Wolf"])))).step(TryBanish),
  Sprinkles: new Macro().if_("monsterid ".concat(gentrifier), Replace).skill($skill(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral10(["Meteor Shower"])))).step(FreeInstaKill),
  TunnelOfLOV: new Macro().if_("monsterid ".concat(LOVEnforcer), Macro.attack().repeat()).if_("monsterid ".concat(LOVEngineer), Macro.skill($skill(_templateObject1222 || (_templateObject1222 = _taggedTemplateLiteral10(["Candyblast"])))).repeat()).step(DefaultMacro),
  WitchessQueen: new Macro().item($item(_templateObject1232 || (_templateObject1232 = _taggedTemplateLiteral10(["Time-Spinner"])))).attack().repeat(),
  WitchessWitch: new Macro().skill($skill(_templateObject1242 || (_templateObject1242 = _taggedTemplateLiteral10(["Curse of Weaksauce"])))).skill($skill(_templateObject125 || (_templateObject125 = _taggedTemplateLiteral10(["Sing Along"])))).attack().repeat(),
  DMTSquare: new Macro().if_(notAllowList, Macro.abort()).if_("!monsterid ".concat(DMTSquare), Replace).skill($skill(_templateObject126 || (_templateObject126 = _taggedTemplateLiteral10(["Feel Envy"])))).step(DefaultMacro),
  DMTCircle: new Macro().if_(notAllowList, Macro.abort()).if_("!monsterid ".concat(DMTCircle), Replace).tryItem($item(_templateObject127 || (_templateObject127 = _taggedTemplateLiteral10(["abstraction: action"])))).step(DefaultMacro),
  MotherSlime: new Macro().if_(notAllowList, Macro.abort()).trySkill($skill(_templateObject128 || (_templateObject128 = _taggedTemplateLiteral10(["KGB tranquilizer dart"])))).skill($skill(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral10(["Snokebomb"])))),
  BatFormRunaway: new Macro().trySkill($skill(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral10(["Become a Bat"])))).step("runaway"),
  LatteGulpRunaway: new Macro().trySkill($skill(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral10(["Gulp Latte"])))).step("runaway"),
  MeteorForce: new Macro().skill($skill(_templateObject1322 || (_templateObject1322 = _taggedTemplateLiteral10(["Meteor Shower"])))).skill($skill(_templateObject1332 || (_templateObject1332 = _taggedTemplateLiteral10(["Use the Force"])))),
  FoamForce: new Macro().skill($skill(_templateObject1342 || (_templateObject1342 = _taggedTemplateLiteral10(["Fire Extinguisher: Foam Yourself"])))).skill($skill(_templateObject135 || (_templateObject135 = _taggedTemplateLiteral10(["Use the Force"]))))
};
...
function mapMonster(location, monster, macro) {
  ...
  if (!get("mappingMonsters"))
    (0, import_kolmafia16.useSkill)($skill(_templateObject136 || (_templateObject136 = _taggedTemplateLiteral10(["Map the Monsters"]))));
...
function castBestLibram() {
  var wantGreenCandy = !have($item(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral11(["green candy heart"])))) && !have($effect(_templateObject216 || (_templateObject216 = _taggedTemplateLiteral11(["Heart of Green"]))));
  ...
  if (wantGreenCandy && get("libramSummons") < 10) {
    (0, import_kolmafia17.useSkill)($skill(_templateObject311 || (_templateObject311 = _taggedTemplateLiteral11(["Summon Candy Heart"]))));
    ...
    (0, import_kolmafia17.useSkill)($skill(_templateObject138 || (_templateObject138 = _taggedTemplateLiteral11(["Summon Love Song"]))));
  } else {
...
function getPantogramPants() {
  if (!have($item(_templateObject154 || (_templateObject154 = _taggedTemplateLiteral11(["portable pantogram"])))) || have($item(_templateObject164 || (_templateObject164 = _taggedTemplateLiteral11(["pantogram pants"])))))
    return;
  var m = (/* @__PURE__ */ new Map([[$stat(_templateObject174 || (_templateObject174 = _taggedTemplateLiteral11(["Muscle"]))), 1], [$stat(_templateObject184 || (_templateObject184 = _taggedTemplateLiteral11(["Mysticality"]))), 2], [$stat(_templateObject194 || (_templateObject194 = _taggedTemplateLiteral11(["Moxie"]))), 3]])).get((0, import_kolmafia17.myPrimestat)());
  var element;
  (function(element2) {
  ...
  var s2 = "-2,0";
  var s3 = "-1,0";
  (0, import_kolmafia17.visitUrl)("inv_use.php?pwd=&whichitem=".concat((0, import_kolmafia17.toInt)($item(_templateObject204 || (_templateObject204 = _taggedTemplateLiteral11(["portable pantogram"]))))));
  ...
  if (!have($item(_templateObject217 || (_templateObject217 = _taggedTemplateLiteral11(["pantogram pants"])))))
...
function useDroppedItems() {
  (/* @__PURE__ */ new Map([[$item(_templateObject254 || (_templateObject254 = _taggedTemplateLiteral11(["pulled violet taffy"]))), 50]])).forEach((limit, multiUse) => {
  ...
  [
    $item(_templateObject264 || (_templateObject264 = _taggedTemplateLiteral11(["green candy heart"]))),
    $item(_templateObject274 || (_templateObject274 = _taggedTemplateLiteral11(["pulled yellow taffy"]))),
    ...
    $item(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral11(["resolution: be luckier"]))),
...
var questRecords = (_questRecords = {}, _defineProperty7(_questRecords, Quest.Beginning.id, () => {
  return {
    acquire: [$effect(_templateObject139 || (_templateObject139 = _taggedTemplateLiteral12(["Feeling Excited"]))), $effect(_templateObject218 || (_templateObject218 = _taggedTemplateLiteral12(["Feeling Peaceful"]))), $effect(_templateObject315 || (_templateObject315 = _taggedTemplateLiteral12(["Inscrutable Gaze"]))), $effect(_templateObject413 || (_templateObject413 = _taggedTemplateLiteral12(["Spirit of Peppermint"]))), $effect(_templateObject513 || (_templateObject513 = _taggedTemplateLiteral12(["Triple-Sized"]))), $effect(_templateObject611 || (_templateObject611 = _taggedTemplateLiteral12(["Uncucumbered"]))), $effect(_templateObject711 || (_templateObject711 = _taggedTemplateLiteral12(["substats.enh"])))],
    check: [],
    equipment: /* @__PURE__ */ new Map([
      ...
      [$slot(_templateObject1211 || (_templateObject1211 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject1310 || (_templateObject1310 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))],
      [$slot(_templateObject146 || (_templateObject146 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject155 || (_templateObject155 = _taggedTemplateLiteral12(["familiar scrapbook"])))],
      [$slot(_templateObject165 || (_templateObject165 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject175 || (_templateObject175 = _taggedTemplateLiteral12(["Cargo Cultist Shorts"])))],
      [$slot(_templateObject185 || (_templateObject185 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject195 || (_templateObject195 = _taggedTemplateLiteral12(["hewn moon-rune spoon"])))],
      [$slot(_templateObject205 || (_templateObject205 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject219 || (_templateObject219 = _taggedTemplateLiteral12(["Powerful Glove"])))],
  ...
  var bloodSugar = (0, import_kolmafia18.myClass)() === $class(_templateObject246 || (_templateObject246 = _taggedTemplateLiteral12(["Sauceror"]))) ? $effect(_templateObject255 || (_templateObject255 = _taggedTemplateLiteral12(["[1458]Blood Sugar Sauce Magic"]))) : $effect(_templateObject265 || (_templateObject265 = _taggedTemplateLiteral12(["[1457]Blood Sugar Sauce Magic"])));
  return {
    acquire: [bloodSugar],
    check: [],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject275 || (_templateObject275 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject285 || (_templateObject285 = _taggedTemplateLiteral12(["Iunion Crown"])))], [$slot(_templateObject295 || (_templateObject295 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject305 || (_templateObject305 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject316 || (_templateObject316 = _taggedTemplateLiteral12(["off-hand"]))), have($item(_templateObject325 || (_templateObject325 = _taggedTemplateLiteral12(["wrench"])))) ? $item(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral12(["wrench"]))) : $item(_templateObject345 || (_templateObject345 = _taggedTemplateLiteral12(["industrial fire extinguisher"])))], [$slot(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral12(["Cargo Cultist Shorts"])))], [$slot(_templateObject375 || (_templateObject375 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject383 || (_templateObject383 = _taggedTemplateLiteral12(["hewn moon-rune spoon"])))], [$slot(_templateObject393 || (_templateObject393 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject403 || (_templateObject403 = _taggedTemplateLiteral12(["Retrospecs"])))], [$slot(_templateObject414 || (_templateObject414 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject424 || (_templateObject424 = _taggedTemplateLiteral12(["Kremlin's Greatest Briefcase"])))]]),
  ...
  var toAcquire = [
    ...
    $effect(_templateObject463 || (_templateObject463 = _taggedTemplateLiteral12(["Favored by Lyle"]))),
    $effect(_templateObject473 || (_templateObject473 = _taggedTemplateLiteral12(["Fidoxene"]))),
    $effect(_templateObject483 || (_templateObject483 = _taggedTemplateLiteral12(["Grumpy and Ornery"]))),
  ...
  var toWear = /* @__PURE__ */ new Map([
    ...
    [$slot(_templateObject1143 || (_templateObject1143 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject1153 || (_templateObject1153 = _taggedTemplateLiteral12(["Beach Comb"])))]
  ]);
  ...
  var toAcquire = [pastalordShield, $effect(_templateObject1233 || (_templateObject1233 = _taggedTemplateLiteral12(["Drescher's Annoying Noise"]))), $effect(_templateObject1243 || (_templateObject1243 = _taggedTemplateLiteral12(["Polka of Plenty"]))), $effect(_templateObject1252 || (_templateObject1252 = _taggedTemplateLiteral12(["Pride of the Puffin"]))), $effect(_templateObject1262 || (_templateObject1262 = _taggedTemplateLiteral12(["Ur-Kel's Aria of Annoyance"])))];
  var toWear = /* @__PURE__ */ new Map([[$slot(_templateObject1272 || (_templateObject1272 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject1282 || (_templateObject1282 = _taggedTemplateLiteral12(["Daylight Shavings Helmet"])))], [$slot(_templateObject1292 || (_templateObject1292 = _taggedTemplateLiteral12(["back"]))), $item(_templateObject1302 || (_templateObject1302 = _taggedTemplateLiteral12(["LOV Epaulettes"])))], [$slot(_templateObject1312 || (_templateObject1312 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject1323 || (_templateObject1323 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject1333 || (_templateObject1333 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject1343 || (_templateObject1343 = _taggedTemplateLiteral12(["weeping willow wand"])))], [$slot(_templateObject1352 || (_templateObject1352 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject1362 || (_templateObject1362 = _taggedTemplateLiteral12(["Cargo Cultist Shorts"])))], [$slot(_templateObject1372 || (_templateObject1372 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject1382 || (_templateObject1382 = _taggedTemplateLiteral12(["hewn moon-rune spoon"])))], [$slot(_templateObject1392 || (_templateObject1392 = _taggedTemplateLiteral12(["acc2"]))), have($item(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral12(["battle broom"])))) ? $item(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral12(["battle broom"]))) : $item(_templateObject1422 || (_templateObject1422 = _taggedTemplateLiteral12(["gold detective badge"])))], [$slot(_templateObject1432 || (_templateObject1432 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject1442 || (_templateObject1442 = _taggedTemplateLiteral12(["Beach Comb"])))]]);
  return {
    acquire: toAcquire,
    check: [],
    equipment: toWear
  ...
  var toWear = /* @__PURE__ */ new Map([[$slot(_templateObject1452 || (_templateObject1452 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject1462 || (_templateObject1462 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject148 || (_templateObject148 = _taggedTemplateLiteral12(["pantogram pants"])))], [$slot(_templateObject149 || (_templateObject149 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral12(["Kremlin's Greatest Briefcase"])))]]);
  if (have($item(_templateObject151 || (_templateObject151 = _taggedTemplateLiteral12(["burning paper crane"])))))
    toWear.set($slot(_templateObject1522 || (_templateObject1522 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject1532 || (_templateObject1532 = _taggedTemplateLiteral12(["burning paper crane"]))));
  return {
    acquire: [$effect(_templateObject1542 || (_templateObject1542 = _taggedTemplateLiteral12(["Polka of Plenty"])))],
    check: [],
    equipment: toWear,
    retrocape: "vampire hold",
    familiar: $familiar(_templateObject1552 || (_templateObject1552 = _taggedTemplateLiteral12(["Exotic Parrot"])))
  };
}), _defineProperty7(_questRecords, Quest.Vintner.id, () => {
  var toAcquire = [$effect(_templateObject156 || (_templateObject156 = _taggedTemplateLiteral12(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral12(["Polka of Plenty"]))), $effect(_templateObject158 || (_templateObject158 = _taggedTemplateLiteral12(["Sauce Monocle"]))), $effect(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral12(["Song of Sauce"]))), $effect(_templateObject160 || (_templateObject160 = _taggedTemplateLiteral12(["Wizard Squint"])))];
  var toCheck = [$effect(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral12(["Bastille Bourgeoisie"]))), $effect(_templateObject1622 || (_templateObject1622 = _taggedTemplateLiteral12(["Pointy Wizard Beard"]))), $effect(_templateObject1632 || (_templateObject1632 = _taggedTemplateLiteral12(["Sparkly!"]))), $effect(_templateObject1642 || (_templateObject1642 = _taggedTemplateLiteral12(["Visions of the Deep Dark Deeps"])))];
  var toEquip = /* @__PURE__ */ new Map([[$slot(_templateObject1652 || (_templateObject1652 = _taggedTemplateLiteral12(["back"]))), $item(_templateObject166 || (_templateObject166 = _taggedTemplateLiteral12(["LOV Epaulettes"])))], [$slot(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject168 || (_templateObject168 = _taggedTemplateLiteral12(["weeping willow wand"])))], [$slot(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral12(["wrench"])))], [$slot(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject1722 || (_templateObject1722 = _taggedTemplateLiteral12(["pantogram pants"])))], [$slot(_templateObject1732 || (_templateObject1732 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject1742 || (_templateObject1742 = _taggedTemplateLiteral12(["Powerful Glove"])))], [$slot(_templateObject1752 || (_templateObject1752 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject176 || (_templateObject176 = _taggedTemplateLiteral12(["battle broom"])))], [$slot(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral12(["backup camera"])))]]);
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: toEquip
  ...
  return {
    acquire: [$effect(_templateObject179 || (_templateObject179 = _taggedTemplateLiteral12(["Expert Oiliness"]))), $effect(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral12(["Phorcefullness"]))), $effect(_templateObject181 || (_templateObject181 = _taggedTemplateLiteral12(["Quiet Determination"]))), $effect(_templateObject1822 || (_templateObject1822 = _taggedTemplateLiteral12(["Rage of the Reindeer"])))],
    check: [$effect(_templateObject1832 || (_templateObject1832 = _taggedTemplateLiteral12(["Giant Growth"]))), $effect(_templateObject1842 || (_templateObject1842 = _taggedTemplateLiteral12(["Spit Upon"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject1852 || (_templateObject1852 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject186 || (_templateObject186 = _taggedTemplateLiteral12(["wad of used tape"])))], [$slot(_templateObject187 || (_templateObject187 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject189 || (_templateObject189 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral12(["dented scepter"])))], [$slot(_templateObject191 || (_templateObject191 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject1922 || (_templateObject1922 = _taggedTemplateLiteral12(["Brutal brogues"])))], [$slot(_templateObject1932 || (_templateObject1932 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject1942 || (_templateObject1942 = _taggedTemplateLiteral12(['"I Voted!" sticker'])))]]),
    retrocape: "muscle"
  };
}), _defineProperty7(_questRecords, Quest.Moxie.id, () => {
  return {
    acquire: [$effect(_templateObject1952 || (_templateObject1952 = _taggedTemplateLiteral12(["Disco Fever"]))), $effect(_templateObject196 || (_templateObject196 = _taggedTemplateLiteral12(["Expert Oiliness"]))), $effect(_templateObject197 || (_templateObject197 = _taggedTemplateLiteral12(["Quiet Desperation"])))],
    check: [$effect(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral12(["Sparkly!"]))), $effect(_templateObject199 || (_templateObject199 = _taggedTemplateLiteral12(["Spit Upon"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject200 || (_templateObject200 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral12(["very pointy crown"])))], [$slot(_templateObject2022 || (_templateObject2022 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject2032 || (_templateObject2032 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject2042 || (_templateObject2042 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject2052 || (_templateObject2052 = _taggedTemplateLiteral12(["industrial fire extinguisher"])))], [$slot(_templateObject206 || (_templateObject206 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject207 || (_templateObject207 = _taggedTemplateLiteral12(["your cowboy boots"])))], [$slot(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject209 || (_templateObject209 = _taggedTemplateLiteral12(["Beach Comb"])))], [$slot(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject2112 || (_templateObject2112 = _taggedTemplateLiteral12(['"I Voted!" sticker'])))]]),
    retrocape: "moxie"
  };
}), _defineProperty7(_questRecords, Quest.HP.id, () => {
  var candle = $item(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral12(["extra-wide head candle"])));
  return {
    acquire: [$effect(_templateObject2132 || (_templateObject2132 = _taggedTemplateLiteral12(["Song of Starch"])))],
    check: [],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject2142 || (_templateObject2142 = _taggedTemplateLiteral12(["hat"]))), have(candle) ? candle : $item(_templateObject2152 || (_templateObject2152 = _taggedTemplateLiteral12(["wad of used tape"])))], [$slot(_templateObject2162 || (_templateObject2162 = _taggedTemplateLiteral12(["back"]))), $item(_templateObject2172 || (_templateObject2172 = _taggedTemplateLiteral12(["vampyric cloake"])))], [$slot(_templateObject2182 || (_templateObject2182 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject2192 || (_templateObject2192 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject220 || (_templateObject220 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject221 || (_templateObject221 = _taggedTemplateLiteral12(["Cargo Cultist Shorts"])))], [$slot(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject2232 || (_templateObject2232 = _taggedTemplateLiteral12(['"I Voted!" sticker'])))]])
  };
}), _defineProperty7(_questRecords, Quest.SpellDamage.id, () => {
  var candle = $item(_templateObject2242 || (_templateObject2242 = _taggedTemplateLiteral12(["Abracandalabra"])));
  return {
    acquire: [$effect(_templateObject2252 || (_templateObject2252 = _taggedTemplateLiteral12(["Arched Eyebrow of the Archmage"]))), $effect(_templateObject2262 || (_templateObject2262 = _taggedTemplateLiteral12(["Cowrruption"]))), $effect(_templateObject227 || (_templateObject227 = _taggedTemplateLiteral12(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral12(["Song of Sauce"]))), $effect(_templateObject229 || (_templateObject229 = _taggedTemplateLiteral12(["The Magic of LOV"])))],
    check: [$effect(_templateObject230 || (_templateObject230 = _taggedTemplateLiteral12(["Do You Crush What I Crush?"]))), $effect(_templateObject231 || (_templateObject231 = _taggedTemplateLiteral12(["Filled with Magic"]))), $effect(_templateObject2322 || (_templateObject2322 = _taggedTemplateLiteral12(["In a Lather"]))), $effect(_templateObject2332 || (_templateObject2332 = _taggedTemplateLiteral12(["Inner Elf"]))), $effect(_templateObject2342 || (_templateObject2342 = _taggedTemplateLiteral12(["Meteor Showered"]))), $effect(_templateObject2352 || (_templateObject2352 = _taggedTemplateLiteral12(["Nanobrainy"]))), $effect(_templateObject2362 || (_templateObject2362 = _taggedTemplateLiteral12(["Sparkly!"]))), $effect(_templateObject237 || (_templateObject237 = _taggedTemplateLiteral12(["Spit Upon"]))), $effect(_templateObject238 || (_templateObject238 = _taggedTemplateLiteral12(["Toxic Vengeance"]))), $effect(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral12(["Visions of the Deep Dark Deeps"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject240 || (_templateObject240 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject241 || (_templateObject241 = _taggedTemplateLiteral12(["wrench"])))], [$slot(_templateObject2422 || (_templateObject2422 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject2432 || (_templateObject2432 = _taggedTemplateLiteral12(["weeping willow wand"])))], [$slot(_templateObject2442 || (_templateObject2442 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject2452 || (_templateObject2452 = _taggedTemplateLiteral12(["pantogram pants"])))], [$slot(_templateObject2462 || (_templateObject2462 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral12(["battle broom"])))], [$slot(_templateObject248 || (_templateObject248 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral12(["Powerful Glove"])))], [$slot(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral12(["Kremlin's Greatest Briefcase"])))], [$slot(_templateObject2522 || (_templateObject2522 = _taggedTemplateLiteral12(["familiar"]))), have(candle) ? candle : $item(_templateObject2532 || (_templateObject2532 = _taggedTemplateLiteral12(["astral statuette"])))]]),
    familiar: $familiar(_templateObject2542 || (_templateObject2542 = _taggedTemplateLiteral12(["Left-Hand Man"])))
  };
}), _defineProperty7(_questRecords, Quest.WeaponDamage.id, () => {
  var toAcquire = [$effect(_templateObject2552 || (_templateObject2552 = _taggedTemplateLiteral12(["Bow-Legged Swagger"]))), $effect(_templateObject256 || (_templateObject256 = _taggedTemplateLiteral12(["Cowrruption"]))), $effect(_templateObject257 || (_templateObject257 = _taggedTemplateLiteral12(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject258 || (_templateObject258 = _taggedTemplateLiteral12(["Rage of the Reindeer"]))), $effect(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral12(["Scowl of the Auk"]))), $effect(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral12(["Song of the North"]))), $effect(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral12(["Tenacity of the Snapper"]))), $effect(_templateObject2622 || (_templateObject2622 = _taggedTemplateLiteral12(["The Power of LOV"])))];
  var toCheck = [$effect(_templateObject2632 || (_templateObject2632 = _taggedTemplateLiteral12(["Do You Crush What I Crush?"]))), $effect(_templateObject2642 || (_templateObject2642 = _taggedTemplateLiteral12(["In a Lather"]))), $effect(_templateObject2652 || (_templateObject2652 = _taggedTemplateLiteral12(["Inner Elf"]))), $effect(_templateObject266 || (_templateObject266 = _taggedTemplateLiteral12(["Meteor Showered"]))), $effect(_templateObject267 || (_templateObject267 = _taggedTemplateLiteral12(["Spit Upon"])))];
  var toWear = /* @__PURE__ */ new Map([[$slot(_templateObject268 || (_templateObject268 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral12(["broken champagne bottle"])))], [$slot(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral12(["dented scepter"])))], [$slot(_templateObject2722 || (_templateObject2722 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject2732 || (_templateObject2732 = _taggedTemplateLiteral12(["Brutal brogues"])))], [$slot(_templateObject2742 || (_templateObject2742 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject2752 || (_templateObject2752 = _taggedTemplateLiteral12(["Powerful Glove"])))]]);
  var candle = $item(_templateObject276 || (_templateObject276 = _taggedTemplateLiteral12(["extra-wide head candle"])));
  if (have(candle))
    toWear.set($slot(_templateObject277 || (_templateObject277 = _taggedTemplateLiteral12(["hat"]))), candle);
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: toWear
  ...
  return {
    acquire: [$effect(_templateObject278 || (_templateObject278 = _taggedTemplateLiteral12(["Feeling Lonely"]))), $effect(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral12(["Gummed Shoes"]))), $effect(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral12(["Invisible Avatar"]))), $effect(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral12(["Shortly Buttered"]))), $effect(_templateObject2822 || (_templateObject2822 = _taggedTemplateLiteral12(["Silent Running"]))), $effect(_templateObject2832 || (_templateObject2832 = _taggedTemplateLiteral12(["Smooth Movements"]))), $effect(_templateObject2842 || (_templateObject2842 = _taggedTemplateLiteral12(["The Sonata of Sneakiness"]))), $effect(_templateObject2852 || (_templateObject2852 = _taggedTemplateLiteral12(["Throwing Some Shade"])))],
    check: [$effect(_templateObject286 || (_templateObject286 = _taggedTemplateLiteral12(["Silence of the God Lobster"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject288 || (_templateObject288 = _taggedTemplateLiteral12(["very pointy crown"])))], [$slot(_templateObject289 || (_templateObject289 = _taggedTemplateLiteral12(["back"]))), $item(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral12(["protonic accelerator pack"])))], [$slot(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral12(["pants"]))), $item(_templateObject2922 || (_templateObject2922 = _taggedTemplateLiteral12(["pantogram pants"])))], [$slot(_templateObject2932 || (_templateObject2932 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject2942 || (_templateObject2942 = _taggedTemplateLiteral12(["Kremlin's Greatest Briefcase"])))]]),
    familiar: $familiar(_templateObject2952 || (_templateObject2952 = _taggedTemplateLiteral12(["Disgeist"])))
  };
}), _defineProperty7(_questRecords, Quest.HotResist.id, () => {
  return {
    acquire: [$effect(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral12(["Astral Shell"]))), $effect(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral12(["Elemental Saucesphere"]))), $effect(_templateObject298 || (_templateObject298 = _taggedTemplateLiteral12(["Empathy"])))],
    check: [$effect(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral12(["Fireproof Foam Suit"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject300 || (_templateObject300 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject301 || (_templateObject301 = _taggedTemplateLiteral12(["Daylight Shavings Helmet"])))], [$slot(_templateObject3022 || (_templateObject3022 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject3032 || (_templateObject3032 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject3042 || (_templateObject3042 = _taggedTemplateLiteral12(["off-hand"]))), $item(_templateObject3052 || (_templateObject3052 = _taggedTemplateLiteral12(["industrial fire extinguisher"])))], [$slot(_templateObject306 || (_templateObject306 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject307 || (_templateObject307 = _taggedTemplateLiteral12(["Brutal brogues"])))], [$slot(_templateObject308 || (_templateObject308 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral12(["hewn moon-rune spoon"])))], [$slot(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral12(["Beach Comb"])))], [$slot(_templateObject3122 || (_templateObject3122 = _taggedTemplateLiteral12(["familiar"]))), $item(_templateObject3132 || (_templateObject3132 = _taggedTemplateLiteral12(["cracker"])))]]),
    retrocape: "vampire hold",
    familiar: $familiar(_templateObject3142 || (_templateObject3142 = _taggedTemplateLiteral12(["Exotic Parrot"])))
  };
}), _defineProperty7(_questRecords, Quest.FamiliarWeight.id, () => {
  var rope = $item(_templateObject3152 || (_templateObject3152 = _taggedTemplateLiteral12(["rope"])));
  var crane = $item(_templateObject3162 || (_templateObject3162 = _taggedTemplateLiteral12(["burning paper crane"])));
  var offhand = have(rope) ? rope : have(crane) ? crane : $item(_templateObject317 || (_templateObject317 = _taggedTemplateLiteral12(["familiar scrapbook"])));
  return {
    acquire: [$effect(_templateObject318 || (_templateObject318 = _taggedTemplateLiteral12(["Empathy"]))), $effect(_templateObject319 || (_templateObject319 = _taggedTemplateLiteral12(["Joy"]))), $effect(_templateObject320 || (_templateObject320 = _taggedTemplateLiteral12(["Robot Friends"]))), $effect(_templateObject321 || (_templateObject321 = _taggedTemplateLiteral12(["Shortly Stacked"]))), $effect(_templateObject3222 || (_templateObject3222 = _taggedTemplateLiteral12(["Whole Latte Love"])))],
    check: [$effect(_templateObject3232 || (_templateObject3232 = _taggedTemplateLiteral12(["[1701]Hip to the Jive"]))), $effect(_templateObject3242 || (_templateObject3242 = _taggedTemplateLiteral12(["All Is Forgiven"]))), $effect(_templateObject3252 || (_templateObject3252 = _taggedTemplateLiteral12(["Bureaucratized"]))), $effect(_templateObject326 || (_templateObject326 = _taggedTemplateLiteral12(["Chorale of Companionship"]))), $effect(_templateObject327 || (_templateObject327 = _taggedTemplateLiteral12(["Down With Chow"]))), $effect(_templateObject328 || (_templateObject328 = _taggedTemplateLiteral12(["Meteor Showered"]))), $effect(_templateObject329 || (_templateObject329 = _taggedTemplateLiteral12(["Open Heart Surgery"]))), $effect(_templateObject330 || (_templateObject330 = _taggedTemplateLiteral12(["You Can Really Taste the Dormouse"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject331 || (_templateObject331 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject3322 || (_templateObject3322 = _taggedTemplateLiteral12(["Daylight Shavings Helmet"])))], [$slot(_templateObject3332 || (_templateObject3332 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject3342 || (_templateObject3342 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject3352 || (_templateObject3352 = _taggedTemplateLiteral12(["off-hand"]))), offhand], [$slot(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject337 || (_templateObject337 = _taggedTemplateLiteral12(["Brutal brogues"])))], [$slot(_templateObject338 || (_templateObject338 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral12(["hewn moon-rune spoon"])))], [$slot(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral12(["Beach Comb"])))], [$slot(_templateObject3422 || (_templateObject3422 = _taggedTemplateLiteral12(["familiar"]))), $item(_templateObject3432 || (_templateObject3432 = _taggedTemplateLiteral12(["cracker"])))]]),
    familiar: $familiar(_templateObject3442 || (_templateObject3442 = _taggedTemplateLiteral12(["Exotic Parrot"])))
  };
}), _defineProperty7(_questRecords, Quest.ItemDrop.id, () => {
  var toAcquire = [$effect(_templateObject3452 || (_templateObject3452 = _taggedTemplateLiteral12(["Blessing of the Bird"]))), $effect(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral12(["Ermine Eyes"]))), $effect(_templateObject347 || (_templateObject347 = _taggedTemplateLiteral12(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject348 || (_templateObject348 = _taggedTemplateLiteral12(["Feeling Lost"]))), $effect(_templateObject349 || (_templateObject349 = _taggedTemplateLiteral12(["Nearly All-Natural"]))), $effect(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral12(["Singer's Faithful Ocelot"]))), $effect(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral12(["Steely-Eyed Squint"]))), $effect(_templateObject3522 || (_templateObject3522 = _taggedTemplateLiteral12(["The Spirit of Taking"])))];
  var toCheck = [$effect(_templateObject3532 || (_templateObject3532 = _taggedTemplateLiteral12(["Bat-Adjacent Form"])))];
  var carrot = (0, import_kolmafia18.numericModifier)($item(_templateObject3542 || (_templateObject3542 = _taggedTemplateLiteral12(["latte lovers member's mug"]))), "item drop") > 0;
  var toWear = /* @__PURE__ */ new Map([[$slot(_templateObject3552 || (_templateObject3552 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject356 || (_templateObject356 = _taggedTemplateLiteral12(["wad of used tape"])))], [$slot(_templateObject357 || (_templateObject357 = _taggedTemplateLiteral12(["back"]))), $item(_templateObject358 || (_templateObject358 = _taggedTemplateLiteral12(["vampyric cloake"])))], [$slot(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral12(["off-hand"]))), carrot ? $item(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral12(["latte lovers member's mug"]))) : $item(_templateObject361 || (_templateObject361 = _taggedTemplateLiteral12(["Kramco Sausage-o-Matic\u2122"])))], [$slot(_templateObject3622 || (_templateObject3622 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject3632 || (_templateObject3632 = _taggedTemplateLiteral12(["Guzzlr tablet"])))], [$slot(_templateObject3642 || (_templateObject3642 = _taggedTemplateLiteral12(["acc2"]))), $item(_templateObject3652 || (_templateObject3652 = _taggedTemplateLiteral12(["gold detective badge"])))], [$slot(_templateObject366 || (_templateObject366 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject367 || (_templateObject367 = _taggedTemplateLiteral12(["your cowboy boots"])))], [$slot(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral12(["familiar"]))), $item(_templateObject369 || (_templateObject369 = _taggedTemplateLiteral12(["li'l ninja costume"])))]]);
  var candles = [$item(_templateObject370 || (_templateObject370 = _taggedTemplateLiteral12(["extra-large utility candle"]))), $item(_templateObject371 || (_templateObject371 = _taggedTemplateLiteral12(["novelty sparkling candle"]))), $item(_templateObject3722 || (_templateObject3722 = _taggedTemplateLiteral12(["runed taper candle"])))];
  var sparkler = $item(_templateObject3732 || (_templateObject3732 = _taggedTemplateLiteral12(["oversized sparkler"])));
  if (!candles.some(have) && have(sparkler))
    toWear.set($slot(_templateObject3742 || (_templateObject3742 = _taggedTemplateLiteral12(["weapon"]))), sparkler);
  for (var _i = 0, _candles = candles; _i < _candles.length; _i++) {
    var c = _candles[_i];
    if (have(c))
      toWear.set($slot(_templateObject3752 || (_templateObject3752 = _taggedTemplateLiteral12(["weapon"]))), c);
  }
  return {
    acquire: toAcquire,
    check: toCheck,
    equipment: toWear,
    familiar: $familiar(_templateObject376 || (_templateObject376 = _taggedTemplateLiteral12(["Trick-or-Treating Tot"])))
  };
}), _defineProperty7(_questRecords, Quest.Mysticality.id, () => {
  return {
    acquire: [$effect(_templateObject377 || (_templateObject377 = _taggedTemplateLiteral12(["Quiet Judgement"])))],
    check: [$effect(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral12(["Nanobrainy"]))), $effect(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral12(["Spit Upon"]))), $effect(_templateObject380 || (_templateObject380 = _taggedTemplateLiteral12(["Witch Breaded"])))],
    equipment: /* @__PURE__ */ new Map([[$slot(_templateObject381 || (_templateObject381 = _taggedTemplateLiteral12(["hat"]))), $item(_templateObject3822 || (_templateObject3822 = _taggedTemplateLiteral12(["wad of used tape"])))], [$slot(_templateObject3832 || (_templateObject3832 = _taggedTemplateLiteral12(["weapon"]))), $item(_templateObject384 || (_templateObject384 = _taggedTemplateLiteral12(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject385 || (_templateObject385 = _taggedTemplateLiteral12(["acc1"]))), $item(_templateObject386 || (_templateObject386 = _taggedTemplateLiteral12(["battle broom"])))], [$slot(_templateObject387 || (_templateObject387 = _taggedTemplateLiteral12(["acc3"]))), $item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral12(['"I Voted!" sticker'])))]]),
...
function prep(quest) {
  ...
  var back = record.equipment.get($slot(_templateObject389 || (_templateObject389 = _taggedTemplateLiteral12(["back"]))));
  if (back && record.retrocape)
  ...
  if (record.retrocape)
    (0, import_kolmafia18.cliExecute)("retrocape ".concat(record.retrocape));
...
function shrugExtraSongs(effectsToAcquire) {
  ...
  Object.entries((0, import_kolmafia18.myEffects)()).forEach((_ref) => {
...
var direWarren = $location(_templateObject394 || (_templateObject394 = _taggedTemplateLiteral13(["The Dire Warren"])));
var deepDarkJungle = $location(_templateObject415 || (_templateObject415 = _taggedTemplateLiteral13(["The Deep Dark Jungle"])));
...
var toxicTeacups = $location(_templateObject1311 || (_templateObject1311 = _taggedTemplateLiteral13(["The Toxic Teacups"])));
...
var preCoilEvents = {
  ...
  ninjaCostume: {
    ready: () => !have($item(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral13(["li'l ninja costume"])))),
    run: () => {
      ...
      withEquipment(() => mapMonster(haikuDungeon, $monster(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral13(["amateur ninja"]))), MacroList.FreeFight), [[$slot(_templateObject2110 || (_templateObject2110 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject2210 || (_templateObject2210 = _taggedTemplateLiteral13(["Lil' Doctor\u2122 bag"])))]]);
  ...
  mimic: {
    ...
    run: () => {
      ...
      checkAvailable($item(_templateObject3110 || (_templateObject3110 = _taggedTemplateLiteral13(["bag of many confections"]))));
  ...
  hipster: {
    ...
    run: () => {
      ...
      if (get("_sourceTerminalDigitizeUses") < 1)
        SourceTerminal_exports.educate($skill(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral13(["Digitize"]))));
      withEquipment(() => adventure(noobCave, MacroList.FreeFight), [[$slot(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral13(["Kramco Sausage-o-Matic\u2122"])))]]);
      if (get("_sourceTerminalDigitizeUses") > 0) {
        SourceTerminal_exports.educate($skill(_templateObject395 || (_templateObject395 = _taggedTemplateLiteral13(["Compress"]))));
        SourceTerminal_exports.educate($skill(_templateObject404 || (_templateObject404 = _taggedTemplateLiteral13(["Extract"]))));
      } else
        throw "Failed to cast digitize?";
      (0, import_kolmafia19.equip)($slot(_templateObject416 || (_templateObject416 = _taggedTemplateLiteral13(["familiar"]))), $item(_templateObject425 || (_templateObject425 = _taggedTemplateLiteral13(["none"]))));
      checkAvailable($item(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral13(["ironic moustache"]))));
    }
  },
  vote: {
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(noobCave, MacroList.FreeFight), [[$slot(_templateObject445 || (_templateObject445 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject455 || (_templateObject455 = _taggedTemplateLiteral13(['"I Voted!" sticker'])))]]);
    }
  },
  tropicalSkeleton: {
    ready: () => !have($effect(_templateObject464 || (_templateObject464 = _taggedTemplateLiteral13(["Everything Looks Red"])))),
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject474 || (_templateObject474 = _taggedTemplateLiteral13(["weapon"]))), $item(_templateObject484 || (_templateObject484 = _taggedTemplateLiteral13(["Fourth of May Cosplay Saber"]))));
      familiar($familiar(_templateObject494 || (_templateObject494 = _taggedTemplateLiteral13(["Crimbo Shrub"]))));
      if (!get("_shrubDecorated")) {
        var decorations = (0, import_kolmafia19.toInt)($item(_templateObject504 || (_templateObject504 = _taggedTemplateLiteral13(["box of old Crimbo decorations"]))));
      ...
      mapMonster(skeletonStore, $monster(_templateObject516 || (_templateObject516 = _taggedTemplateLiteral13(["novelty tropical skeleton"]))), MacroList.FreeFight);
      checkEffect($effect(_templateObject525 || (_templateObject525 = _taggedTemplateLiteral13(["Everything Looks Red"]))));
      $items(_templateObject535 || (_templateObject535 = _taggedTemplateLiteral13(["cherry, grapefruit, lemon, strawberry"]))).forEach((fruit) => checkAvailable(fruit));
    }
  }
};
var levelingEvents = {
  protonicGhost: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral13(["protonic accelerator pack"]))));
      selectBestFamiliar(FamiliarFlag.NoAttack);
      var ghostLoc = get("ghostLocation");
      if (!ghostLoc)
  ...
  ghostCarol: {
    ready: () => ![$effect(_templateObject564 || (_templateObject564 = _taggedTemplateLiteral13(["All I Want For Crimbo Is Stuff"]))), $effect(_templateObject574 || (_templateObject574 = _taggedTemplateLiteral13(["Crimbo Wrapping"]))), $effect(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral13(["Do You Crush What I Crush?"]))), $effect(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral13(["Holiday Yoked"]))), $effect(_templateObject603 || (_templateObject603 = _taggedTemplateLiteral13(["Let It Snow/Boil/Stink/Frighten/Grease"])))].some((carol) => have(carol)),
    run: () => {
      familiar($familiar(_templateObject614 || (_templateObject614 = _taggedTemplateLiteral13(["Ghost of Crimbo Carols"]))));
      withEquipment(() => adventure(direWarren, MacroList.Banish), [[$slot(_templateObject624 || (_templateObject624 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral13(["Kremlin's Greatest Briefcase"])))]]);
      checkEffect($effect(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral13(["Do You Crush What I Crush?"]))));
    }
  },
  loveTunnel: {
    ...
    run: () => {
      ...
      if ((0, import_kolmafia19.handlingChoice)())
        throw "Stuck in LOV?";
      checkEffect($effect(_templateObject654 || (_templateObject654 = _taggedTemplateLiteral13(["Open Heart Surgery"]))));
      $items(_templateObject664 || (_templateObject664 = _taggedTemplateLiteral13(["LOV Elixir #3, LOV Elixir #6, LOV Epaulettes"]))).forEach((l) => checkAvailable(l));
      (0, import_kolmafia19.use)($item(_templateObject673 || (_templateObject673 = _taggedTemplateLiteral13(["LOV Elixir #3"]))));
      (0, import_kolmafia19.use)($item(_templateObject683 || (_templateObject683 = _taggedTemplateLiteral13(["LOV Elixir #6"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject693 || (_templateObject693 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject703 || (_templateObject703 = _taggedTemplateLiteral13(["LOV Epaulettes"]))));
    }
  },
  tenPercentBonus: {
    ready: () => have($item(_templateObject714 || (_templateObject714 = _taggedTemplateLiteral13(["a ten-percent bonus"])))),
    run: () => {
      [$effect(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral13(["That's Just Cloud-Talk, Man"]))), $effect(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral13(["Inscrutable Gaze"]))), $effect(_templateObject744 || (_templateObject744 = _taggedTemplateLiteral13(["Synthesis: Learning"])))].forEach(checkEffect);
      checkAvailable($item(_templateObject754 || (_templateObject754 = _taggedTemplateLiteral13(["LOV Epaulettes"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject763 || (_templateObject763 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject773 || (_templateObject773 = _taggedTemplateLiteral13(["LOV Epaulettes"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject783 || (_templateObject783 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject793 || (_templateObject793 = _taggedTemplateLiteral13(["familiar scrapbook"]))));
      (0, import_kolmafia19.use)($item(_templateObject803 || (_templateObject803 = _taggedTemplateLiteral13(["a ten-percent bonus"]))));
    }
  },
  chateau: {
    ready: () => (0, import_kolmafia19.myLevel)() >= 8 && get("timesRested") < (0, import_kolmafia19.totalFreeRests)(),
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject814 || (_templateObject814 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject824 || (_templateObject824 = _taggedTemplateLiteral13(["LOV Epaulettes"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject844 || (_templateObject844 = _taggedTemplateLiteral13(["familiar scrapbook"]))));
  ...
  witchessRook: {
    ready: () => !have($effect(_templateObject854 || (_templateObject854 = _taggedTemplateLiteral13(["Sweetbreads Flamb\xE9"])))),
    run: () => {
      prep(Quest.LevelingML);
      selectBestFamiliar();
      fightWitchess($monster(_templateObject863 || (_templateObject863 = _taggedTemplateLiteral13(["Witchess Rook"]))), MacroList.FreeFight);
      checkAvailable($item(_templateObject873 || (_templateObject873 = _taggedTemplateLiteral13(["Greek fire"]))));
      (0, import_kolmafia19.use)($item(_templateObject883 || (_templateObject883 = _taggedTemplateLiteral13(["Greek fire"]))));
    }
  },
  upscaleDistrictKill: {
    ready: () => !have($effect(_templateObject893 || (_templateObject893 = _taggedTemplateLiteral13(["Whole Latte Love"])))) && !have($item(_templateObject903 || (_templateObject903 = _taggedTemplateLiteral13(["sprinkles"]))), 55),
    run: () => {
      familiar($familiar(_templateObject914 || (_templateObject914 = _taggedTemplateLiteral13(["Chocolate Lab"]))));
      var rope = $item(_templateObject924 || (_templateObject924 = _taggedTemplateLiteral13(["rope"])));
      var crane = $item(_templateObject934 || (_templateObject934 = _taggedTemplateLiteral13(["burning paper crane"])));
      var offhand = have(rope) ? rope : have(crane) ? crane : $item(_templateObject944 || (_templateObject944 = _taggedTemplateLiteral13(["familiar scrapbook"])));
      withEquipment(() => adventure(upscaleDistrict, MacroList.Sprinkles), [[$slot(_templateObject953 || (_templateObject953 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject963 || (_templateObject963 = _taggedTemplateLiteral13(["protonic accelerator pack"])))], [$slot(_templateObject973 || (_templateObject973 = _taggedTemplateLiteral13(["weapon"]))), $item(_templateObject983 || (_templateObject983 = _taggedTemplateLiteral13(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject993 || (_templateObject993 = _taggedTemplateLiteral13(["off-hand"]))), offhand], [$slot(_templateObject1003 || (_templateObject1003 = _taggedTemplateLiteral13(["acc1"]))), $item(_templateObject1014 || (_templateObject1014 = _taggedTemplateLiteral13(["hewn moon-rune spoon"])))], [$slot(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral13(["acc2"]))), $item(_templateObject1034 || (_templateObject1034 = _taggedTemplateLiteral13(["Brutal brogues"])))], [$slot(_templateObject1044 || (_templateObject1044 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject1053 || (_templateObject1053 = _taggedTemplateLiteral13(["Lil' Doctor\u2122 bag"])))]]);
      checkAvailable($item(_templateObject1063 || (_templateObject1063 = _taggedTemplateLiteral13(["sprinkles"]))), 55);
    }
  },
  upscaleDistrictRunaway: {
    ready: () => !have($effect(_templateObject1073 || (_templateObject1073 = _taggedTemplateLiteral13(["Whole Latte Love"])))),
    run: () => {
      checkEffect($effect(_templateObject1083 || (_templateObject1083 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1093 || (_templateObject1093 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
      adventure(upscaleDistrict, MacroList.Runaway);
      var latte = $item(_templateObject1103 || (_templateObject1103 = _taggedTemplateLiteral13(["gingerbread spice latte"])));
      if (have(latte)) {
        (0, import_kolmafia19.use)(latte);
        checkAvailable($item(_templateObject1114 || (_templateObject1114 = _taggedTemplateLiteral13(["sprinkles"]))), 5);
  ...
  civicCenterRunaway: {
    ...
    run: function run() {
      checkEffect($effect(_templateObject1124 || (_templateObject1124 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1134 || (_templateObject1134 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
      adventure(civicCenter, MacroList.Runaway);
      var cig = $item(_templateObject1144 || (_templateObject1144 = _taggedTemplateLiteral13(["gingerbread cigarette"])));
  ...
  snojo: {
    ...
    run: () => {
      if (!get("snojoSetting") !== $stat(_templateObject1154 || (_templateObject1154 = _taggedTemplateLiteral13(["Muscle"])))) {
  ...
  witchessWitch: {
    ready: () => !have($item(_templateObject1163 || (_templateObject1163 = _taggedTemplateLiteral13(["battle broom"])))),
    run: () => {
      selectBestFamiliar();
      fightWitchess($monster(_templateObject1173 || (_templateObject1173 = _taggedTemplateLiteral13(["Witchess Witch"]))), MacroList.WitchessWitch);
      (0, import_kolmafia19.equip)($slot(_templateObject1183 || (_templateObject1183 = _taggedTemplateLiteral13(["acc2"]))), $item(_templateObject1193 || (_templateObject1193 = _taggedTemplateLiteral13(["battle broom"]))));
    }
  },
  eldritch: {
    ...
    run: () => {
      ...
      (0, import_kolmafia19.useSkill)($skill(_templateObject1203 || (_templateObject1203 = _taggedTemplateLiteral13(["Evoke Eldritch Horror"]))));
      if ((0, import_kolmafia19.myHp)() / (0, import_kolmafia19.myMaxhp)() < 0.5)
        (0, import_kolmafia19.useSkill)($skill(_templateObject1214 || (_templateObject1214 = _taggedTemplateLiteral13(["Cannelloni Cocoon"]))));
    }
  },
  gingerbreadCig: {
    ready: () => have($item(_templateObject1224 || (_templateObject1224 = _taggedTemplateLiteral13(["gingerbread cigarette"])))),
    run: () => {
      selectBestFamiliar(FamiliarFlag.NoAttack);
  ...
  godLobster: {
    ...
    run: () => {
      familiar($familiar(_templateObject1234 || (_templateObject1234 = _taggedTemplateLiteral13(["God Lobster"]))));
      MacroList.FreeFight.setAutoAttack();
      ...
      var ring = $item(_templateObject1244 || (_templateObject1244 = _taggedTemplateLiteral13(["God Lobster's Ring"])));
      var scepter = $item(_templateObject1253 || (_templateObject1253 = _taggedTemplateLiteral13(["God Lobster's Scepter"])));
      if (have(ring))
        (0, import_kolmafia19.equip)($slot(_templateObject1263 || (_templateObject1263 = _taggedTemplateLiteral13(["familiar"]))), ring);
      else if (have(scepter))
        (0, import_kolmafia19.equip)($slot(_templateObject1273 || (_templateObject1273 = _taggedTemplateLiteral13(["familiar"]))), scepter);
    }
  },
  witchessKing: {
    ready: () => !have($item(_templateObject1283 || (_templateObject1283 = _taggedTemplateLiteral13(["dented scepter"])))),
    run: () => {
      selectBestFamiliar();
      fightWitchess($monster(_templateObject1293 || (_templateObject1293 = _taggedTemplateLiteral13(["Witchess King"]))), MacroList.FreeFight);
    }
  },
  witchess: {
    ...
    run: () => {
      selectBestFamiliar();
      fightWitchess($monster(_templateObject1303 || (_templateObject1303 = _taggedTemplateLiteral13(["Witchess Queen"]))), MacroList.WitchessQueen);
    }
  },
  digitize: {
    ready: () => get("_sourceTerminalDigitizeMonsterCount") < 1,
    run: () => {
      SourceTerminal_exports.educate($skill(_templateObject1313 || (_templateObject1313 = _taggedTemplateLiteral13(["Turbo"]))));
      var shirt = $item(_templateObject1324 || (_templateObject1324 = _taggedTemplateLiteral13(["makeshift garbage shirt"])));
      if (!have(shirt))
        (0, import_kolmafia19.cliExecute)("fold ".concat(shirt));
      (0, import_kolmafia19.equip)($slot(_templateObject1334 || (_templateObject1334 = _taggedTemplateLiteral13(["shirt"]))), shirt);
      (0, import_kolmafia19.equip)($slot(_templateObject1344 || (_templateObject1344 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject1353 || (_templateObject1353 = _taggedTemplateLiteral13(["unwrapped knock-off retro superhero cape"]))));
      selectBestFamiliar();
  ...
  vote: {
    ...
    run: () => {
      selectBestFamiliar();
      withEquipment(() => adventure(toxicTeacups, MacroList.FreeFight), [[$slot(_templateObject1363 || (_templateObject1363 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject1373 || (_templateObject1373 = _taggedTemplateLiteral13(['"I Voted!" sticker'])))]]);
    }
  },
  holidayWanderer: {
    ready: () => isHolidayWandererDay() && deepDarkJungle.combatQueue.length < 1,
    run: () => {
      checkEffect($effect(_templateObject1383 || (_templateObject1383 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1393 || (_templateObject1393 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
      adventure(deepDarkJungle, MacroList.Runaway);
    }
  },
  dmtSquare: {
    ready: () => !have($effect(_templateObject1402 || (_templateObject1402 = _taggedTemplateLiteral13(["Joy"])))) && !have($item(_templateObject1412 || (_templateObject1412 = _taggedTemplateLiteral13(["abstraction: action"])))),
    run: () => {
      familiar($familiar(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral13(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTSquare);
      checkAvailable($item(_templateObject1433 || (_templateObject1433 = _taggedTemplateLiteral13(["abstraction: action"]))));
    }
  },
  dmtCircle: {
    ready: () => !have($effect(_templateObject1443 || (_templateObject1443 = _taggedTemplateLiteral13(["Joy"])))),
    run: () => {
      familiar($familiar(_templateObject1453 || (_templateObject1453 = _taggedTemplateLiteral13(["Machine Elf"]))));
      adventure(deepMachineTunnels, MacroList.DMTCircle);
      checkAvailable($item(_templateObject1463 || (_templateObject1463 = _taggedTemplateLiteral13(["abstraction: joy"]))));
      (0, import_kolmafia19.chew)($item(_templateObject1472 || (_templateObject1472 = _taggedTemplateLiteral13(["abstraction: joy"]))));
    }
  },
  dmt: {
    ready: () => get("_machineTunnelsAdv") < 5,
    run: () => {
      familiar($familiar(_templateObject1482 || (_templateObject1482 = _taggedTemplateLiteral13(["Machine Elf"]))));
  ...
  chestXRay: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1492 || (_templateObject1492 = _taggedTemplateLiteral13(["acc1"]))), $item(_templateObject1502 || (_templateObject1502 = _taggedTemplateLiteral13(["Lil' Doctor\u2122 bag"]))));
  ...
  lecture: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1512 || (_templateObject1512 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1523 || (_templateObject1523 = _taggedTemplateLiteral13(["Kramco Sausage-o-Matic\u2122"]))));
      familiar($familiar(_templateObject1533 || (_templateObject1533 = _taggedTemplateLiteral13(["Pocket Professor"]))));
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  backupCamera: {
    ready: () => get("lastCopyableMonster") === $monster(_templateObject1543 || (_templateObject1543 = _taggedTemplateLiteral13(["sausage goblin"]))) && get("_backUpUses") < 7,
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1553 || (_templateObject1553 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1562 || (_templateObject1562 = _taggedTemplateLiteral13(["Kramco Sausage-o-Matic\u2122"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject1572 || (_templateObject1572 = _taggedTemplateLiteral13(["acc3"]))), $item(_templateObject1582 || (_templateObject1582 = _taggedTemplateLiteral13(["backup camera"]))));
      selectBestFamiliar();
      adventure(toxicTeacups, MacroList.FreeFight);
    }
  },
  deepDark: {
    ready: () => !have($effect(_templateObject1592 || (_templateObject1592 = _taggedTemplateLiteral13(["Visions of the Deep Dark Deeps"])))),
    run: () => {
      prep(Quest.DeepDark);
      var resist = 1 - (0, import_kolmafia19.elementalResistance)($element(_templateObject1602 || (_templateObject1602 = _taggedTemplateLiteral13(["spooky"])))) / 100;
      if (resist <= 0)
      ...
      if ((0, import_kolmafia19.myHp)() < needed)
        (0, import_kolmafia19.cliExecute)("cast * ".concat($skill(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral13(["Cannelloni Cocoon"])))));
      if ((0, import_kolmafia19.myHp)() < needed)
        throw "Failed to heal enough for Deep Dark Visions?";
      (0, import_kolmafia19.useSkill)($skill(_templateObject1623 || (_templateObject1623 = _taggedTemplateLiteral13(["Deep Dark Visions"]))));
      while ((0, import_kolmafia19.myHp)() < (0, import_kolmafia19.myMaxhp)() * 0.9) {
        (0, import_kolmafia19.useSkill)($skill(_templateObject1633 || (_templateObject1633 = _taggedTemplateLiteral13(["Cannelloni Cocoon"]))));
      }
    }
  },
  vintnerBackup: {
    ready: () => get("lastCopyableMonster") === $monster(_templateObject1643 || (_templateObject1643 = _taggedTemplateLiteral13(["sausage goblin"]))) && get("_backUpUses") < 11,
    run: () => {
  ...
  latteRefills: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1653 || (_templateObject1653 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1662 || (_templateObject1662 = _taggedTemplateLiteral13(["latte lovers member's mug"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject1672 || (_templateObject1672 = _taggedTemplateLiteral13(["pants"]))), $item(_templateObject1682 || (_templateObject1682 = _taggedTemplateLiteral13(["Cargo Cultist Shorts"]))));
      if (get("_latteDrinkUsed"))
        (0, import_kolmafia19.cliExecute)("latte refill pumpkin cinnamon vanilla");
      checkEffect($effect(_templateObject1692 || (_templateObject1692 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1702 || (_templateObject1702 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
  ...
  latteCarrot: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1723 || (_templateObject1723 = _taggedTemplateLiteral13(["latte lovers member's mug"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject1733 || (_templateObject1733 = _taggedTemplateLiteral13(["pants"]))), $item(_templateObject1743 || (_templateObject1743 = _taggedTemplateLiteral13(["Cargo Cultist Shorts"]))));
      checkEffect($effect(_templateObject1753 || (_templateObject1753 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1762 || (_templateObject1762 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
  ...
  lastLatteRefill: {
    ...
    run: () => {
      (0, import_kolmafia19.equip)($slot(_templateObject1772 || (_templateObject1772 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1782 || (_templateObject1782 = _taggedTemplateLiteral13(["latte lovers member's mug"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject1792 || (_templateObject1792 = _taggedTemplateLiteral13(["pants"]))), $item(_templateObject1802 || (_templateObject1802 = _taggedTemplateLiteral13(["Cargo Cultist Shorts"]))));
      if (get("_latteDrinkUsed"))
        (0, import_kolmafia19.cliExecute)("latte refill pumpkin cinnamon carrot");
      checkEffect($effect(_templateObject1812 || (_templateObject1812 = _taggedTemplateLiteral13(["Ode to Booze"]))));
      familiar($familiar(_templateObject1823 || (_templateObject1823 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.LatteGulpRunaway);
    }
  }
};
...
var oneOffEvents = {
  nanobrainy: () => {
    ...
    if (!have($effect(_templateObject1833 || (_templateObject1833 = _taggedTemplateLiteral13(["Nanobrainy"])))) && get("_nanorhinoCharge") > 99) {
      (0, import_kolmafia19.equip)($slot(_templateObject1843 || (_templateObject1843 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject1853 || (_templateObject1853 = _taggedTemplateLiteral13(["vampyric cloake"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject1862 || (_templateObject1862 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject1872 || (_templateObject1872 = _taggedTemplateLiteral13(["latte lovers member's mug"]))));
      familiar($familiar(_templateObject1882 || (_templateObject1882 = _taggedTemplateLiteral13(["Nanorhino"]))));
      adventure(upscaleDistrict, MacroList.Nanobrainy);
      checkEffect($effect(_templateObject1892 || (_templateObject1892 = _taggedTemplateLiteral13(["Nanobrainy"]))));
    }
  },
  innerElf: () => {
    if ((0, import_kolmafia19.myLevel)() >= 13 && !have($effect(_templateObject1902 || (_templateObject1902 = _taggedTemplateLiteral13(["Inner Elf"]))))) {
      familiar($familiar(_templateObject1912 || (_templateObject1912 = _taggedTemplateLiteral13(["Machine Elf"]))));
      var prev = get("lastCopyableMonster");
      Clan.with(FAX_AND_SLIME_CLAN, () => adventure(slimeTube, MacroList.MotherSlime));
      checkEffect($effect(_templateObject1923 || (_templateObject1923 = _taggedTemplateLiteral13(["Inner Elf"]))));
      if (prev && get("lastCopyableMonster") === $monster(_templateObject1933 || (_templateObject1933 = _taggedTemplateLiteral13(["Mother Slime"])))) {
        _set("lastCopyableMonster", prev);
      }
    }
  },
  meteorUngulith: () => {
    var fax = $item(_templateObject1943 || (_templateObject1943 = _taggedTemplateLiteral13(["photocopied monster"])));
    var faxMon = $monster(_templateObject1953 || (_templateObject1953 = _taggedTemplateLiteral13(["ungulith"])));
    if (!have(fax))
      Clan.with(FAX_AND_SLIME_CLAN, () => (0, import_kolmafia19.cliExecute)("fax receive"));
    ...
    (0, import_kolmafia19.equip)($slot(_templateObject1962 || (_templateObject1962 = _taggedTemplateLiteral13(["weapon"]))), $item(_templateObject1972 || (_templateObject1972 = _taggedTemplateLiteral13(["Fourth of May Cosplay Saber"]))));
    familiar($familiar(_templateObject1982 || (_templateObject1982 = _taggedTemplateLiteral13(["Machine Elf"]))));
    adventureUrl("inv_use.php?pwd=&whichitem=".concat((0, import_kolmafia19.toInt)(fax)), MacroList.MeteorForce);
    checkAvailable($item(_templateObject1992 || (_templateObject1992 = _taggedTemplateLiteral13(["corrupted marrow"]))));
  },
  foamYourself: () => {
    if (!have($effect(_templateObject2002 || (_templateObject2002 = _taggedTemplateLiteral13(["Fireproof Foam Suit"]))))) {
      (0, import_kolmafia19.equip)($slot(_templateObject2012 || (_templateObject2012 = _taggedTemplateLiteral13(["weapon"]))), $item(_templateObject2023 || (_templateObject2023 = _taggedTemplateLiteral13(["Fourth of May Cosplay Saber"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject2033 || (_templateObject2033 = _taggedTemplateLiteral13(["off-hand"]))), $item(_templateObject2043 || (_templateObject2043 = _taggedTemplateLiteral13(["industrial fire extinguisher"]))));
      familiar($familiar(_templateObject2053 || (_templateObject2053 = _taggedTemplateLiteral13(["Machine Elf"]))));
      adventure(direWarren, MacroList.FoamForce);
      checkEffect($effect(_templateObject2062 || (_templateObject2062 = _taggedTemplateLiteral13(["Fireproof Foam Suit"]))));
    }
  },
  meteorShower: () => {
    if (!have($effect(_templateObject2072 || (_templateObject2072 = _taggedTemplateLiteral13(["Meteor Showered"]))))) {
      tryUse($item(_templateObject2082 || (_templateObject2082 = _taggedTemplateLiteral13(["tiny bottle of absinthe"]))));
      (0, import_kolmafia19.equip)($slot(_templateObject2092 || (_templateObject2092 = _taggedTemplateLiteral13(["weapon"]))), $item(_templateObject2103 || (_templateObject2103 = _taggedTemplateLiteral13(["Fourth of May Cosplay Saber"]))));
      familiar($familiar(_templateObject2113 || (_templateObject2113 = _taggedTemplateLiteral13(["Machine Elf"]))));
      var collar = $item(_templateObject2123 || (_templateObject2123 = _taggedTemplateLiteral13(["disintegrating spiky collar"])));
      if (have($effect(_templateObject2133 || (_templateObject2133 = _taggedTemplateLiteral13(["Absinthe-Minded"])))) && !have(collar) && !have(itemToEffect(collar))) {
        mapMonster(statelyPleasureDome, $monster(_templateObject2143 || (_templateObject2143 = _taggedTemplateLiteral13(["toothless mastiff bitch"]))), MacroList.FreeFight);
        checkAvailable(collar);
        (0, import_kolmafia19.use)(collar);
      } else {
        adventure(direWarren, MacroList.MeteorForce);
      }
      checkEffect($effect(_templateObject2153 || (_templateObject2153 = _taggedTemplateLiteral13(["Meteor Showered"]))));
    }
  },
  batform: () => {
    if (!have($effect(_templateObject2163 || (_templateObject2163 = _taggedTemplateLiteral13(["Bat-Adjacent Form"]))))) {
      (0, import_kolmafia19.equip)($slot(_templateObject2173 || (_templateObject2173 = _taggedTemplateLiteral13(["back"]))), $item(_templateObject2183 || (_templateObject2183 = _taggedTemplateLiteral13(["vampyric cloake"]))));
      (0, import_kolmafia19.useSkill)($skill(_templateObject2193 || (_templateObject2193 = _taggedTemplateLiteral13(["The Ode to Booze"]))));
      familiar($familiar(_templateObject2202 || (_templateObject2202 = _taggedTemplateLiteral13(["Frumious Bandersnatch"]))));
      adventure(direWarren, MacroList.BatFormRunaway);
      checkEffect($effect(_templateObject2212 || (_templateObject2212 = _taggedTemplateLiteral13(["Bat-Adjacent Form"]))));
    }
  }
};
function familiar(fam) {
  (0, import_kolmafia19.useFamiliar)(fam);
  var costume = (/* @__PURE__ */ new Map([[$familiar(_templateObject2223 || (_templateObject2223 = _taggedTemplateLiteral13(["Machine Elf"]))), "mp"], [$familiar(_templateObject2233 || (_templateObject2233 = _taggedTemplateLiteral13(["Pocket Professor"]))), "hp"], [$familiar(_templateObject2243 || (_templateObject2243 = _taggedTemplateLiteral13(["Rockin' Robin"]))), "myst"]])).get(fam);
  if (fam === $familiar(_templateObject2253 || (_templateObject2253 = _taggedTemplateLiteral13(["Machine Elf"])))) {
    while ((0, import_kolmafia19.myHp)() < (0, import_kolmafia19.myMaxhp)() && (0, import_kolmafia19.myMp)() > MP_SAFE_LIMIT) {
      (0, import_kolmafia19.useSkill)($skill(_templateObject2263 || (_templateObject2263 = _taggedTemplateLiteral13(["Cannelloni Cocoon"]))));
    }
  }
...
function selectBestFamiliar() {
  ...
  if (flag === FamiliarFlag.Wine && !have($item(_templateObject2272 || (_templateObject2272 = _taggedTemplateLiteral13(["1950 Vampire Vintner wine"])))) && !have($effect(_templateObject2282 || (_templateObject2282 = _taggedTemplateLiteral13(["Wine-Befouled"]))))) {
    familiar($familiar(_templateObject2292 || (_templateObject2292 = _taggedTemplateLiteral13(["Vampire Vintner"]))));
  } else if (flag === FamiliarFlag.ToxicTeacups && get("_hipsterAdv") < 7) {
    familiar($familiar(_templateObject2302 || (_templateObject2302 = _taggedTemplateLiteral13(["Artistic Goth Kid"]))));
  } else if (!have($item(_templateObject2312 || (_templateObject2312 = _taggedTemplateLiteral13(["robin's egg"]))))) {
    familiar($familiar(_templateObject2323 || (_templateObject2323 = _taggedTemplateLiteral13(["Rockin' Robin"]))));
  } else if (flag === FamiliarFlag.Default && !have($item(_templateObject2333 || (_templateObject2333 = _taggedTemplateLiteral13(["short stick of butter"]))))) {
    familiar($familiar(_templateObject2343 || (_templateObject2343 = _taggedTemplateLiteral13(["Shorter-Order Cook"]))));
  } else if (flag === FamiliarFlag.Default && !have($item(_templateObject2353 || (_templateObject2353 = _taggedTemplateLiteral13(["tiny bottle of absinthe"])))) && !have($effect(_templateObject2363 || (_templateObject2363 = _taggedTemplateLiteral13(["Absinthe-Minded"]))))) {
    familiar($familiar(_templateObject2372 || (_templateObject2372 = _taggedTemplateLiteral13(["Green Pixie"]))));
  } else if (!have($item(_templateObject2382 || (_templateObject2382 = _taggedTemplateLiteral13(["rope"])))) && !have($item(_templateObject2392 || (_templateObject2392 = _taggedTemplateLiteral13(["burning newspaper"])))) && !have($item(_templateObject2402 || (_templateObject2402 = _taggedTemplateLiteral13(["burning paper crane"]))))) {
    familiar($familiar(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral13(["Garbage Fire"]))));
  } else {
    familiar($familiar(_templateObject2423 || (_templateObject2423 = _taggedTemplateLiteral13(["Machine Elf"]))));
  }
}
...
function checkReadyToAscend(checkVoteReady) {
  ...
  var banish = $monster(_templateObject396 || (_templateObject396 = _taggedTemplateLiteral14(["Perceiver of Sensations"])));
...
function tier(effect) {
  switch (effect) {
    case $effect(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral15(["Synthesis: Hot"]))):
    case $effect(_templateObject2101 || (_templateObject2101 = _taggedTemplateLiteral15(["Synthesis: Cold"]))):
    case $effect(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral15(["Synthesis: Pungent"]))):
    case $effect(_templateObject417 || (_templateObject417 = _taggedTemplateLiteral15(["Synthesis: Scary"]))):
    ...
    case $effect(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral15(["Synthesis: Movement"]))):
...
function synthesize(targetEffects, reserveCandies) {
  ...
  if (test) {
    ...
    candies.simple = [{
      candy: $item(_templateObject3111 || (_templateObject3111 = _taggedTemplateLiteral15(["Chubby and Plump bar"]))),
      count: 1
    }];
  ...
  var reserved = new Map([].concat(_toConsumableArray5(reserveCandies), [$item(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral15(["Ultra Mega Sour Ball"])))]).map((r) => [r, 999999]));
...
function preCoilWire() {
  ...
  [$item(_templateObject716 || (_templateObject716 = _taggedTemplateLiteral16(["letter from King Ralph XI"]))), $item(_templateObject816 || (_templateObject816 = _taggedTemplateLiteral16(["pork elf goodies sack"]))), $item(_templateObject916 || (_templateObject916 = _taggedTemplateLiteral16(["pack of KWE trading card"]))), $item(_templateObject1016 || (_templateObject1016 = _taggedTemplateLiteral16(["banana candle"]))), $item(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral16(["ear candle"]))), $item(_templateObject1216 || (_templateObject1216 = _taggedTemplateLiteral16(["natural magick candle"]))), $item(_templateObject1315 || (_templateObject1315 = _taggedTemplateLiteral16(["rainbow glitter candle"]))), $item(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral16(["votive of confidence"])))].forEach(tryUse);
  ...
  var hasSolution = () => Object.keys((0, import_kolmafia22.reverseNumberology)()).includes(calculation);
  ...
  if (have($item(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral16(["1952 Mickey Mantle card"])))))
    (0, import_kolmafia22.autosell)(1, $item(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral16(["1952 Mickey Mantle card"]))));
  (0, import_kolmafia22.useSkill)($skill(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral16(["Communism!"]))));
  ...
  openQuestZones();
  (0, import_kolmafia22.equip)($slot(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral16(["acc2"]))), $item(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral16(["Powerful Glove"]))));
  prep(Quest.Beginning);
  var _iterator2 = _createForOfIteratorHelper7([
    [$effect(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral16(["That's Just Cloud-Talk, Man"]))), () => (0, import_kolmafia22.visitUrl)("place.php?whichplace=campaway&action=campaway_sky")],
    [$item(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral16(['"DRINK ME" potion']))), () => (0, import_kolmafia22.visitUrl)("clan_viplounge.php?action=lookingglass&whichfloor=2")],
    [$item(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral16(["detuned radio"]))), () => (0, import_kolmafia22.retrieveItem)($item(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral16(["detuned radio"]))))],
    [$item(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral16(["toy accordion"]))), () => (0, import_kolmafia22.retrieveItem)($item(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral16(["toy accordion"]))))],
    [$item(_templateObject3012 || (_templateObject3012 = _taggedTemplateLiteral16(["turtle totem"]))), () => (0, import_kolmafia22.retrieveItem)($item(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral16(["turtle totem"]))))],
    [$item(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral16(["saucepan"]))), () => (0, import_kolmafia22.retrieveItem)($item(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral16(["saucepan"]))))],
    [$item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral16(["battery (AAA)"]))), () => harvestBatteries()],
    [$item(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral16(["battery (lantern)"]))), () => (0, import_kolmafia22.create)($item(_templateObject3611 || (_templateObject3611 = _taggedTemplateLiteral16(["battery (lantern)"]))))],
    [$item(_templateObject3711 || (_templateObject3711 = _taggedTemplateLiteral16(["Brutal brogues"]))), () => (0, import_kolmafia22.cliExecute)("bastille bbq brutalist catapult")],
    [$item(_templateObject3811 || (_templateObject3811 = _taggedTemplateLiteral16(["cop dollar"]))), () => (0, import_kolmafia22.cliExecute)("Detective Solver")],
    [$item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral16(["cuppa Loyal tea"]))), () => (0, import_kolmafia22.cliExecute)("teatree loyal")],
    [$item(_templateObject405 || (_templateObject405 = _taggedTemplateLiteral16(["flimsy hardwood scraps"]))), () => (0, import_kolmafia22.visitUrl)("shop.php?whichshop=lathe")],
    [$item(_templateObject419 || (_templateObject419 = _taggedTemplateLiteral16(["weeping willow wand"]))), () => (0, import_kolmafia22.create)($item(_templateObject426 || (_templateObject426 = _taggedTemplateLiteral16(["weeping willow wand"]))))],
    [$item(_templateObject436 || (_templateObject436 = _taggedTemplateLiteral16(["green mana"]))), () => (0, import_kolmafia22.cliExecute)("cheat forest")],
    [$item(_templateObject446 || (_templateObject446 = _taggedTemplateLiteral16(["wrench"]))), () => (0, import_kolmafia22.cliExecute)("cheat wrench")],
    [$item(_templateObject456 || (_templateObject456 = _taggedTemplateLiteral16(["occult jelly donut"]))), () => (0, import_kolmafia22.create)($item(_templateObject465 || (_templateObject465 = _taggedTemplateLiteral16(["occult jelly donut"]))))],
    [$item(_templateObject475 || (_templateObject475 = _taggedTemplateLiteral16(["sombrero-mounted sparkler"]))), () => (0, import_kolmafia22.retrieveItem)($item(_templateObject485 || (_templateObject485 = _taggedTemplateLiteral16(["sombrero-mounted sparkler"]))))],
    [$item(_templateObject495 || (_templateObject495 = _taggedTemplateLiteral16(["Yeg's Motel hand soap"]))), () => (0, import_kolmafia22.cliExecute)("cargo item ".concat($item(_templateObject505 || (_templateObject505 = _taggedTemplateLiteral16(["Yeg's Motel hand soap"])))))],
    [$item(_templateObject519 || (_templateObject519 = _taggedTemplateLiteral16(["your cowboy boots"]))), () => (0, import_kolmafia22.visitUrl)("place.php?whichplace=town_right&action=townright_ltt")],
    [$skill(_templateObject526 || (_templateObject526 = _taggedTemplateLiteral16(["Seek out a Bird"]))), () => (0, import_kolmafia22.use)($item(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral16(["Bird-a-Day calendar"]))))]
  ]), _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      var _step2$value = _slicedToArray9(_step2.value, 2), check = _step2$value[0], retrieve = _step2$value[1];
      if (!have(check))
        retrieve();
    }
  } catch (err) {
  ...
  if (!get("hasRange")) {
    var range = $item(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral16(["Dramatic\u2122 range"])));
    if (!have(range))
  ...
  if (!get("_borrowedTimeUsed")) {
    if (!have($item(_templateObject2114 || (_templateObject2114 = _taggedTemplateLiteral16(["borrowed time"])))))
      (0, import_kolmafia22.create)($item(_templateObject2213 || (_templateObject2213 = _taggedTemplateLiteral16(["borrowed time"]))));
    (0, import_kolmafia22.use)($item(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral16(["borrowed time"]))));
  }
...
function postCoilWire() {
  if (have($item(_templateObject546 || (_templateObject546 = _taggedTemplateLiteral16(["occult jelly donut"])))))
    (0, import_kolmafia22.eat)($item(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral16(["occult jelly donut"]))));
  (0, import_kolmafia22.cliExecute)("Briefcase e spell spooky -combat");
  [
    $skill(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral16(["Advanced Cocktailcrafting"]))),
    $skill(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral16(["Advanced Saucecrafting"]))),
    $skill(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral16(["Chubby and Plump"]))),
    $skill(_templateObject595 || (_templateObject595 = _taggedTemplateLiteral16(["Perfect Freeze"]))),
    $skill(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral16(["Prevent Scurvy and Sobriety"]))),
    $skill(_templateObject617 || (_templateObject617 = _taggedTemplateLiteral16(["Summon Alice's Army Cards"]))),
    $skill(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral16(["Summon Crimbo Candy"])))
  ].forEach((skill) => (0, import_kolmafia22.useSkill)(skill));
  acquireEffect($effect(_templateObject635 || (_templateObject635 = _taggedTemplateLiteral16(["Ode to Booze"]))));
  ...
  $effects(_templateObject645 || (_templateObject645 = _taggedTemplateLiteral16(["All Is Forgiven, Sparkly!, Witch Breaded"]))).forEach(wishEffect);
  useDroppedItems();
  [$item(_templateObject655 || (_templateObject655 = _taggedTemplateLiteral16(["oil of expertise"]))), $item(_templateObject665 || (_templateObject665 = _taggedTemplateLiteral16(["philter of phorce"]))), $item(_templateObject674 || (_templateObject674 = _taggedTemplateLiteral16(["ointment of the occult"]))), $item(_templateObject684 || (_templateObject684 = _taggedTemplateLiteral16(["eyedrops of the ermine"])))].forEach((saucePotion) => {
    if (!have(saucePotion) && !have(itemToEffect(saucePotion)))
      (0, import_kolmafia22.create)(saucePotion);
  });
  checkMainClan();
  $effects(_templateObject694 || (_templateObject694 = _taggedTemplateLiteral16(["[1701]Hip to the Jive, In a Lather"]))).forEach(acquireEffect);
  ...
  var toSynth = [$effect(_templateObject704 || (_templateObject704 = _taggedTemplateLiteral16(["Synthesis: Smart"]))), $effect(_templateObject717 || (_templateObject717 = _taggedTemplateLiteral16(["Synthesis: Learning"])))].filter((effect) => !have(effect));
  if (toSynth.length > 0) {
    (0, import_kolmafia22.cliExecute)("garden pick");
    (0, import_kolmafia22.cliExecute)("refresh inventory");
    var wantToKeep = [$item(_templateObject725 || (_templateObject725 = _taggedTemplateLiteral16(["Chubby and Plump bar"]))), $item(_templateObject735 || (_templateObject735 = _taggedTemplateLiteral16(["sugar sheet"])))];
    for (var tries = 0; tries <= wantToKeep.length; tries++) {
      var toKeep = new Set(wantToKeep.slice(tries));
      if (!toKeep.has($item(_templateObject745 || (_templateObject745 = _taggedTemplateLiteral16(["sugar sheet"])))))
        (0, import_kolmafia22.useSkill)($skill(_templateObject755 || (_templateObject755 = _taggedTemplateLiteral16(["Summon Sugar Sheets"]))));
  ...
  var water = $item(_templateObject764 || (_templateObject764 = _taggedTemplateLiteral16(["cold-filtered water"])));
  if (get("tomeSummons") < 3 && !have(water) && !have(itemToEffect(water)))
    (0, import_kolmafia22.create)(water);
  tryUse(water);
  [
    $item(_templateObject774 || (_templateObject774 = _taggedTemplateLiteral16(["Chubby and Plump bar"]))),
    $item(_templateObject784 || (_templateObject784 = _taggedTemplateLiteral16(["Napalm In The Morning\u2122 candle"]))),
    $item(_templateObject794 || (_templateObject794 = _taggedTemplateLiteral16(["Salsa Caliente\u2122 candle"]))),
    $item(_templateObject804 || (_templateObject804 = _taggedTemplateLiteral16(["Smoldering Clover\u2122 candle"])))
  ].forEach(tryUse);
  (0, import_kolmafia22.equip)($slot(_templateObject817 || (_templateObject817 = _taggedTemplateLiteral16(["acc2"]))), $item(_templateObject825 || (_templateObject825 = _taggedTemplateLiteral16(["Powerful Glove"]))));
  prep(Quest.Leveling);
  if (have($item(_templateObject835 || (_templateObject835 = _taggedTemplateLiteral16(["LOV Epaulettes"])))))
    prep(Quest.LevelingML);
}
function levelAndDoQuests() {
  ...
  if (hasRemainingFreeFights()) {
    ...
    leveling:
      while (true) {
        var blindness = $effect(_templateObject845 || (_templateObject845 = _taggedTemplateLiteral16(["Temporary Blindness"])));
        ...
        var maxSoulFoodCasts = (0, import_kolmafia22.mySoulsauce)() / (0, import_kolmafia22.soulsauceCost)($skill(_templateObject855 || (_templateObject855 = _taggedTemplateLiteral16(["Soul Food"]))));
        var soulFoodCasts = Math.floor(Math.min(maxMPGains, maxSoulFoodCasts));
        if (soulFoodCasts > 0)
          (0, import_kolmafia22.useSkill)(soulFoodCasts, $skill(_templateObject864 || (_templateObject864 = _taggedTemplateLiteral16(["Soul Food"]))));
        while (have($item(_templateObject874 || (_templateObject874 = _taggedTemplateLiteral16(["magical sausage casing"])))) && (get("_sausagesMade") + 1) * 111 < (0, import_kolmafia22.myMeat)() - MEAT_SAFE_LIMIT && (0, import_kolmafia22.myMaxmp)() - (0, import_kolmafia22.myMp)() > 1e3 && (0, import_kolmafia22.myMaxmp)() - (0, import_kolmafia22.mpCost)($skill(_templateObject884 || (_templateObject884 = _taggedTemplateLiteral16(["Summon BRICKOs"])))) > MP_SAFE_LIMIT && get("_sausagesEaten") < 23) {
          (0, import_kolmafia22.create)($item(_templateObject894 || (_templateObject894 = _taggedTemplateLiteral16(["magical sausage"]))));
          (0, import_kolmafia22.eat)($item(_templateObject904 || (_templateObject904 = _taggedTemplateLiteral16(["magical sausage"]))));
        }
        while ((0, import_kolmafia22.myMp)() - (0, import_kolmafia22.mpCost)($skill(_templateObject917 || (_templateObject917 = _taggedTemplateLiteral16(["Summon BRICKOs"])))) > MP_SAFE_LIMIT) {
          castBestLibram();
          continue leveling;
        }
        useDroppedItems();
        while (have($item(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral16(["BRICKO eye brick"])))) && have($item(_templateObject935 || (_templateObject935 = _taggedTemplateLiteral16(["BRICKO brick"]))), BRICKOS_PER_FIGHT)) {
          (0, import_kolmafia22.create)(BRICKO_TARGET_ITEM);
        }
        if (have($item(_templateObject945 || (_templateObject945 = _taggedTemplateLiteral16(["burning newspaper"])))))
          (0, import_kolmafia22.create)($item(_templateObject954 || (_templateObject954 = _taggedTemplateLiteral16(["burning paper crane"]))));
  ...
  if (haveQuest(Quest.SpellDamage)) {
    ...
    if (!have($effect(_templateObject964 || (_templateObject964 = _taggedTemplateLiteral16(["Cowrruption"])))))
      (0, import_kolmafia22.use)($item(_templateObject974 || (_templateObject974 = _taggedTemplateLiteral16(["corrupted marrow"]))));
  ...
  if (haveQuest(Quest.CombatFrequency)) {
    (0, import_kolmafia22.equip)($slot(_templateObject984 || (_templateObject984 = _taggedTemplateLiteral16(["acc2"]))), $item(_templateObject994 || (_templateObject994 = _taggedTemplateLiteral16(["Powerful Glove"]))));
  ...
  if (haveQuest(Quest.FamiliarWeight)) {
    ...
    var loveSong = $item(_templateObject1004 || (_templateObject1004 = _taggedTemplateLiteral16(["love song of icy revenge"])));
    ...
    var taffy = $item(_templateObject1017 || (_templateObject1017 = _taggedTemplateLiteral16(["pulled blue taffy"])));
    var swayed = itemToEffect(taffy);
    var wine = $item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral16(["1950 Vampire Vintner wine"])));
    var needWeight = () => (0, import_kolmafia22.familiarWeight)((0, import_kolmafia22.myFamiliar)()) + (0, import_kolmafia22.weightAdjustment)() < 295;
    ...
    if (needWeight() && have(wine)) {
      acquireEffect($effect(_templateObject1035 || (_templateObject1035 = _taggedTemplateLiteral16(["Ode to Booze"]))));
